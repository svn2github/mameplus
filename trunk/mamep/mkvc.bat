...
mingw32-make MSVC_BUILD=1 PREFIX= MAXOPT= NO_FORCEINLINE=1 obj/windows/mamep/emu/cpu/mips/mips3drc.o
mingw32-make MSVC_BUILD=1 PREFIX= MAXOPT= NO_FORCEINLINE=1 obj/windows/mamep/osd/windows/scale/hlq_mmx.o
