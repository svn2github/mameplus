...
static int cheat_main_menu(running_machine *machine, cheat_menu_stack *menu)
{
	...
	menu_item[total++].text = _("Cheat Options");
	menu_item[total++].text = _("Cheat Commands");
#ifdef MAME_DEBUG
		...
		if(traverse->layer_index == current_layer)
		{
			...
			else
			{
				...
				else if((traverse->flags & kCheatFlag_Null) == 0)
				{
					...
					{
						menu_sub_item[total] = _("Set");
						traverse->flags &= ~kCheatFlag_RequestArrow;
					}
					else
					{
						if(traverse->flags & kCheatFlag_Active)
							menu_sub_item[total] = _("On");
						else
							menu_sub_item[total] = _("Off");
...
static int edit_cheat_menu(running_machine *machine, cheat_menu_stack *menu)
{
	...
	for(i = 0; i < entry->actionListLength; i++)
	{
...

		{
			...
			menuItem[total] = _("Operation Extend");
...
static int select_search_region_menu(running_machine *machine, cheat_menu_stack *menu)
{
	...
	/********** MENU CONSTRUCTION **********/
	/* ##### SEARCH SPEED ##### */
	menu_item[total] = _("Search Speed");
	...
	else
	{
		...
		menu_item[total] = _("No Search Region");
		menu_sub_item[total++] = NULL;
	}
...
static int command_watch_menu(running_machine *machine, cheat_menu_stack *menu)
{
	...
	/********** MENU CONSTRUCION **********/
	menuItem[total++].text = _("Edit Watchpoint");
	menuItem[total++].text = _("Disable Watchpoint");
	menuItem[total++].text = _("Disable All Watchpoints");
	menuItem[total++].text = _("Reset Watchpoint");
	menuItem[total++].text = _("Reset All Watchpoints");
	menuItem[total++].text = _("Add as Cheat Code");
	menuItem[total++].text = _("Add as Watch Code");
	menuItem[total++].text = _("Save as Cheat Code");
	menuItem[total++].text = _("Save as Watch Code");
	menuItem[total++].text = _("Add New Watchpoint");
	menuItem[total++].text = _("Delete Watchpoint");
