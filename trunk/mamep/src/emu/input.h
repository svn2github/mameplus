...
enum
{
	...
	JOYCODE_BUTTON17 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON17),
	JOYCODE_BUTTON18 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON18),
	JOYCODE_BUTTON19 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON19),
	JOYCODE_BUTTON20 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON20),
	JOYCODE_BUTTON21 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON21),
	JOYCODE_BUTTON22 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON22),
	JOYCODE_BUTTON23 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON23),
	JOYCODE_BUTTON24 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON24),
	JOYCODE_BUTTON25 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON25),
	JOYCODE_BUTTON26 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON26),
	JOYCODE_BUTTON27 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON27),
	JOYCODE_BUTTON28 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON28),
	JOYCODE_BUTTON29 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON29),
	JOYCODE_BUTTON30 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON30),
	JOYCODE_BUTTON31 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON31),
	JOYCODE_BUTTON32 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON32),
