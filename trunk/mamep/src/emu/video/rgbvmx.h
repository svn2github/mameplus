...
{
	vector signed char temp = vec_perm(vec_lde(0, &color), vec_splat_s32(0), vec_lvsl(0, &color));
...
{
	vector signed int temp = vec_splat((vector signed int)vec_packsu(*color, *color), 0);
	rgb_t result;
...
INLINE void rgbint_blend(rgbint *color1, const rgbint *color2, UINT8 color1scale)
{
	*color1 = vec_mergeh(*color1, *color2);
	vector signed int temp = vec_msum(*color1, rgbvmx_statics.scale_table[color1scale], vec_splat_s32(0));
	temp = vec_sr(temp, vec_splat_s32(8));
...
INLINE void rgbint_scale_and_clamp(rgbint *color, INT16 colorscale)
{
	...
	vecscale = vec_perm(vecscale, vecscale, splatmap);
	*color = vec_mergeh(*color, vec_splat_s32(0));
	vector signed int temp = vec_msum(*color, vecscale, vec_splat_s32(0));
	temp = vec_sr(temp, vec_splat_s32(8));
...
{
	rgbint color00 = vec_perm(vec_lde(0, &rgb00), vec_splat_s32(0), vec_lvsl(0, &rgb00));
	rgbint color01 = vec_perm(vec_lde(0, &rgb01), vec_splat_s32(0), vec_lvsl(0, &rgb01));
	rgbint color10 = vec_perm(vec_lde(0, &rgb10), vec_splat_s32(0), vec_lvsl(0, &rgb10));
	rgbint color11 = vec_perm(vec_lde(0, &rgb11), vec_splat_s32(0), vec_lvsl(0, &rgb11));
	...
	color01 = vec_sr((vector signed int)color01, vec_splat_s32(1));
	color11 = vec_sl((vector signed int)color11, vec_splat_s32(15));
	color01 = vec_max(color01, color11);
	color01 = vec_msum(color01, rgbvmx_statics.scale_table[v], vec_splat_s32(0));
	color01 = vec_sr((vector signed int)color01, vec_splat_s32(15));
	color01 = vec_packs((vector signed int)color01, (vector signed int)color01);
	color01 = vec_packsu(color01, color01);
	rgb_t result;
	vec_ste((vector signed int)color01, 0, &result);
	return result;
}
...
{
	rgbaint color00 = vec_perm(vec_lde(0, &rgb00), vec_splat_s32(0), vec_lvsl(0, &rgb00));
	rgbaint color01 = vec_perm(vec_lde(0, &rgb01), vec_splat_s32(0), vec_lvsl(0, &rgb01));
	rgbaint color10 = vec_perm(vec_lde(0, &rgb10), vec_splat_s32(0), vec_lvsl(0, &rgb10));
	rgbaint color11 = vec_perm(vec_lde(0, &rgb11), vec_splat_s32(0), vec_lvsl(0, &rgb11));
