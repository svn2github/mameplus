...
static void input_port_list_custom(device_t &device, ioport_list &portlist, astring &errorbuf)
{
	...
	if (nplayer > 0)
		(*constructor)(device, ipt_custom1p, errorbuf);
	if (nplayer > 1)
		(*constructor)(device, ipt_custom2p, errorbuf);
	if (nplayer > 2)
		(*constructor)(device, ipt_custom3p, errorbuf);
	if (nplayer > 3)
		(*constructor)(device, ipt_custom4p, errorbuf);
	if (nplayer > 4)
		(*constructor)(device, ipt_custom5p, errorbuf);
	if (nplayer > 5)
		(*constructor)(device, ipt_custom6p, errorbuf);
	if (nplayer > 6)
		(*constructor)(device, ipt_custom7p, errorbuf);
	if (nplayer > 7)
		(*constructor)(device, ipt_custom8p, errorbuf);
}
#endif /* USE_CUSTOM_BUTTON */
