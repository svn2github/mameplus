...
{
	s3c2440_interface_core m_iface_core;
	s3c2440_interface_gpio m_iface_gpio;
	s3c2440_interface_i2c m_iface_i2c;
	s3c2440_interface_adc m_iface_adc;
	s3c2440_interface_i2s m_iface_i2s;
	s3c2440_interface_nand m_iface_nand;
	s3c2440_interface_lcd m_iface_lcd;
};
