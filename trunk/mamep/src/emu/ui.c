...
static INT32 slider_brightness(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		sprintf(buffer, _("%s Brightness %.3f"), slider_get_screen_desc(screen), settings.brightness);
	}
...
static INT32 slider_contrast(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, _("%s Contrast %.3f"), slider_get_screen_desc(screen), settings.contrast);
	}
...
static INT32 slider_gamma(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, _("%s Gamma %.3f"), slider_get_screen_desc(screen), settings.gamma);
	}
...
static INT32 slider_xscale(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, "%s %s %.3f", slider_get_screen_desc(screen), _("Horiz Stretch"), settings.xscale);
	}
...
static INT32 slider_yscale(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, "%s %s %.3f", slider_get_screen_desc(screen), _("Vert Stretch"), settings.yscale);
	}
...
static INT32 slider_xoffset(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, "%s %s %.3f", slider_get_screen_desc(screen), _("Horiz Position"), settings.xoffset);
	}
...
static INT32 slider_yoffset(running_machine *machine, INT32 newval, char *buffer, void *arg)
{
	...
	if (buffer != NULL)
	{
		...
		render_container_set_user_settings(container, &settings);
		sprintf(buffer, "%s %s %.3f", slider_get_screen_desc(screen), _("Vert Position"), settings.yoffset);
	}
