...
static ADDRESS_MAP_START( a7800_mem, AS_PROGRAM, 8, a7800_state )
	AM_RANGE(0x0000, 0x001f) AM_MIRROR(0x300) AM_READWRITE_LEGACY(a7800_TIA_r, a7800_TIA_w)
	AM_RANGE(0x0020, 0x003f) AM_MIRROR(0x300) AM_READWRITE_LEGACY(a7800_MARIA_r, a7800_MARIA_w)
	AM_RANGE(0x0040, 0x00ff) AM_READ_BANK("bank5") AM_WRITE_LEGACY(a7800_RAM0_w)	/* RAM (6116 block 0) */
	...
	AM_RANGE(0x4000, 0xffff) AM_WRITE_LEGACY(a7800_cart_w)
ADDRESS_MAP_END
