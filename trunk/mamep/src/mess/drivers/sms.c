...
static MACHINE_DRIVER_START( sms_sdisp )
	...
	MDRV_CARTSLOT_ADD("cart6")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart7")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart8")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart9")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart10")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart11")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart12")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart13")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart14")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart15")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)

	MDRV_CARTSLOT_ADD("cart16")
	MDRV_CARTSLOT_EXTENSION_LIST("sms,bin")
	MDRV_CARTSLOT_NOT_MANDATORY
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)
