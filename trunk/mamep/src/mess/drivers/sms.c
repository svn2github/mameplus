...
static ADDRESS_MAP_START( sms_io, ADDRESS_SPACE_IO, 8 )
	...
	AM_RANGE(0x80, 0x80) AM_MIRROR(0x3e) AM_DEVREADWRITE("sms_vdp", sms_ms_vdp_data_r, sms_ms_vdp_data_w)
	AM_RANGE(0x81, 0x81) AM_MIRROR(0x3e) AM_DEVREADWRITE("sms_vdp", sms_ms_vdp_ctrl_r, sms_ms_vdp_ctrl_w)
...
static INPUT_PORTS_START( sms )
	...
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR( X, 1.0, 0.0, 0 ) PORT_SENSITIVITY(50) PORT_KEYDELTA(15) PORT_CATEGORY(11) PORT_PLAYER(1)
...
static MACHINE_DRIVER_START( sms_cartslot )
	...
	MDRV_CARTSLOT_INTERFACE("sms_cart")
...
static MACHINE_DRIVER_START( gg_cartslot )
	...
	MDRV_CARTSLOT_INTERFACE("gamegear_cart")
	MDRV_CARTSLOT_START(sms_cart)
	MDRV_CARTSLOT_LOAD(sms_cart)
...
static MACHINE_DRIVER_START( sms_sdisp )
	...
	MDRV_SMSSDISP_CARTSLOT_ADD("cart2")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart3")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart4")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart5")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart6")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart7")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart8")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart9")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart10")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart11")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart12")
	MDRV_SMSSDISP_CARTSLOT_ADD("cart13")
