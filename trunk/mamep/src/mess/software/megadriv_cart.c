...
/* F-22 Interceptor (September 1991) (Euro, USA), Cart manufactured By Electronic Arts, (c)1991 on board */
SOFTWARE_START( f22a )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "f-22_intercept_f-202-4.u1", 0x000000, 0x080000, CRC(649771f8) SHA1(6daeca39841f06549373f3a4fd746f3e1c95c328) )
...
/* FIFA Soccer 97 (Euro, USA), Cart manufactured by Electronics Art, (c)1995 on board, Includes ROM, RAM, battery etc. */
...
/* James Bond 007 - The Duel (Euro, Rev. A), Cart manufactured by Sega, Board type 171-5703 */
SOFTWARE_START( jb007 )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "mpr-15312a", 0x000000, 0x080000, CRC(66635364) SHA1(6e7a3ad1d6f55aed082ed4ea22e222282cfcb704) )
	/*
    Rom Labeled
...
/* James Pond - Underwater Agent (Euro, USA), Cart manufactured by Electronic Arts, (c)1990 on board */
SOFTWARE_START( jpond )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "james_pond_u1_jam03", 0x000000, 0x080000, CRC(d0e7b466) SHA1(b4e1c945c3ccea2e76b296d6694c0931a1ec1310) )
	/*
    Rom Labeled

    JAMES POND U1 JAM03
    (c)ELECTRONIC ARTS'91
    ALL RIGHTS RESERVED
    JAPAN 9108 D
    */
SOFTWARE_END

/* James Pond 2 - Robocod (Euro, USA), Cart manufactured by Electronic Arts, (c)1991 on board */
SOFTWARE_START( jpond2 )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
...
/* Lotus Turbo Challenge (Euro, USA), Cart manufactured by Electronic Arts, (c)1992 on board */
SOFTWARE_START( lotust )
    ...
    LOTUS TURBO LOT03
    (c)Electronic Arts 1992
    All Rights Reserved
    */
SOFTWARE_END

/* NHL '94 (Euro, USA), Cart manufactured by Electronics Art, Includes ROM, RAM, battery etc. */
...
/* PGA Tour Golf II (Euro, USA), Cart manufactured by Electronics Art, (c)1992 on board, Includes ROM, RAM, battery etc. */
SOFTWARE_START( pga2a )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "pga_tour_golf_pgt04", 0x000000, 0x100000, CRC(8d980bb4) SHA1(89b50dae5c88f633458a6faeb4ee288fcc94c1b1) )
	/*
    Rom Labeled
...
/* Rise of the Robots (Euro), Cart manufactured by Acclaim, Board type 670121 REV 3 */
SOFTWARE_START( riserbot )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "es133-1_rise_of_the_robots.u1", 0x000000, 0x200000, CRC(ed583ef7) SHA1(b9f43d5bf31819a1d76c1495e81cfa1d38bcde1c) )
	ROM_LOAD16_WORD_SWAP( "es133-2_rise_of_the_robots.u2", 0x200000, 0x100000, CRC(fcf18470) SHA1(09f8ba0b295da42359c354e71b9b7c780a465046) )
	/*
    Roms Labeled
...
SOFTWARE_START( splatt2j )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "sh2j", 0x000000, 0x100000, CRC(adbd991b) SHA1(1a0032faec53f8cf21d3178939bbc5b2f844782a) )
SOFTWARE_END

/* Zero Tolerance (Euro, USA), Cart manufactured by Accolade, LHR 1994 on board, Board type 7100-00010 REV A */
SOFTWARE_START( zerotol )
	ROM_REGION( 0x400000, CARTRIDGE_REGION_ROM, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "zetsg_hi_7500-00033a.u1", 0x000000, 0x200000, CRC(af362b8c) SHA1(2e5c1e4809d763513fa5bb8dc72c97a873fc732b) )
	ROM_LOAD16_WORD_SWAP( "zetsg_lo_7500-00034a.u2", 0x200000, 0x100000, CRC(b9c2d518) SHA1(e5e7c36746233f441af5e03d0e2b63c6d916df24) )
	/*
    Roms Labeled
...
MEGADRIVE_SSF2_ROM_LOAD( ssf2,     "super street fighter ii - the new challengers (euro).bin",                           0x500000,  CRC(682c192f) SHA1(56768a0524fa13fcd76474c8bb89b995bb471847) )
MEGADRIVE_SSF2_ROM_LOAD( ssf2j,    "super street fighter ii - the new challengers (jpn).bin",                            0x500000,  CRC(d8eeb2bd) SHA1(24c8634f59a481118f8350125fa6e00d33e04c95) )
...
MEGADRIVE_SSF2_ROM_LOAD( 12in1,    "12-in-1 (unl).bin",                                                                  0x200000,  CRC(a98bf454) SHA1(7313c20071de0ab1cd84ac1352cb0ed1c4a4afa8) )
MEGADRIVE_SSF2_ROM_LOAD( 4in1pb,   "4-in-1 (pirate).bin",                                                                0x200000,  CRC(be72857b) SHA1(2aceca16f13d6a7a6a1bff8543d31bded179df3b) )
MEGADRIVE_SSF2_ROM_LOAD( chinf3,   "chinese fighter iii (unl).bin",                                                      0x200000,  CRC(e833bc6e) SHA1(ecca9d2d21c8e27fc7584d53f557fdd8b4cbffa7) )
MEGADRIVE_SSF2_ROM_LOAD( earthdef, "earth defense (usa) (unl).bin",                                                      0x80000,   CRC(3519c422) SHA1(9bf4cda850495d7811df578592289018862df575) )
MEGADRIVE_SSF2_ROM_LOAD( funnywld, "funny world & balloon boy (usa) (unl).bin",                                          0x80000,   CRC(a82f05f0) SHA1(17481c8327433bfce8f7bae493fc044194e400a4) )
...
MEGADRIVE_SSF2_ROM_LOAD( lionkin3, "shi zi wang 3 - the lion king 3 (china) (unl).bin",                                  0x200000,  CRC(c004219d) SHA1(54ffd355b0805741f58329fa38ed3d9f8f7c80ca) )
MEGADRIVE_SSF2_ROM_LOAD( pokestad, "pokemon stadium (unl).bin",                                                          0x200000,  CRC(fe187c5d) SHA1(f65af5d86aba33bd3f4f91a0cd7428778bcceedf) )
MEGADRIVE_SSF2_ROM_LOAD( redcliff, "the battle of red cliffs - romance of the three kingdoms (unl).bin",                 0x200005,  CRC(44463492) SHA1(244334583fde808a56059c0b0eef77742c18274d) )
...
MEGADRIVE_SSF2_ROM_LOAD( sdkong99, "super donkey kong 99 (unl) (protected).bin",                                         0x300000,  CRC(43be4dd5) SHA1(5d3c84bd18f821b20212941a6f7a1a272eb0d7e3) )
MEGADRIVE_SSF2_ROM_LOAD( skkong99, "super king kong 99 (unl).bin",                                                       0x200000,  CRC(413dfee2) SHA1(6973598d77a755beafff31ce85595f9610f8afa5) )
MEGADRIVE_SSF2_ROM_LOAD( topfight, "top fighter 2000 mk viii (unl).bin",                                                 0x200000,  CRC(f75519dc) SHA1(617be8de1444ae0c6610d73967f3f0e67541b05a) )
MEGADRIVE_SSF2_ROM_LOAD( whacacri, "whac-a-critter (usa) (unl).bin",                                                     0x80000,   CRC(1bdd02b8) SHA1(4b45801b112a641fee936e41a31728ee7aa2f834) )


MEGADRIVE_ROM_LOAD( 007shitou, "007 shitou - the duel (jpn).bin",                                                        0x000000, 0x80000,   CRC(aeb4b262) SHA1(7e0de7011a60a1462dc48594f3caa956ff942281) )
MEGADRIVE_ROM_LOAD( 16ton,     "16 ton (jpn) (sn).bin",                                                                  0x000000, 0x40000,   CRC(537f04b6) SHA1(fd978f7f643311de21de17ed7ed1e7c737b518ee) )
MEGADRIVE_ROM_LOAD( 16tongnk,  "16 ton (jpn) (gnk).bin",                                                                 0x000000, 0x40000,   CRC(98149eaf) SHA1(ff564e8db95697103caca81c45efb29f47e7e7e0) )
MEGADRIVE_ROM_LOAD( 16zhan,    "16 zhang ma jiang (china) (unl).bin",                                                    0x000000, 0x100000,  CRC(36407c82) SHA1(7857c797245b52641a3d1d4512089bccb0ed5359) )
...
MEGADRIVE_ROM_LOAD( aaahhrm,   "aaahh!!! real monsters (euro).bin",                                                      0x000000, 0x200000,  CRC(7ad115ff) SHA1(9f6361fecbeee1c703b5c988d10a5cb09751ad2a) )
...
MEGADRIVE_ROM_LOAD( aaharima,  "aa harimanada (jpn).bin",                                                                0x000000, 0x200000,  CRC(065f6021) SHA1(fcc4b27aaaea0439fb256f40fb79c823d90a9d88) )
MEGADRIVE_ROM_LOAD( action52,  "action 52 (usa) (unl).bin",                                                              0x000000, 0x200000,  CRC(29ff58ae) SHA1(1d5b26a5598eea268d15fa16d43816f8c3e4f8c6) )
MEGADRIVE_ROM_LOAD( action52a, "action 52 (usa) (alt) (unl).bin",                                                        0x000000, 0x200000,  CRC(8809d666) SHA1(fe9936517f45bd0262613ce4422ace873112210a) )
MEGADRIVE_ROM_LOAD( addamfam,  "mpr-16147.bin",                                                                          0x000000, 0x100000,  CRC(71f58614) SHA1(1cd7ac493a448c7486eefde2300240c3675986a9) )
...
MEGADRIVE_ROM_LOAD( adveboy,   "adventurous boy - mao xian xiao zi (china) (unl).bin",                                   0x000000, 0x80000,   CRC(d4403913) SHA1(f6e5bba7254f7f73a007f234f1001ddcb0b62484) )
MEGADRIVE_ROM_LOAD( advemm,    "adventures of mighty max, the (euro).bin",                                               0x000000, 0x100000,  CRC(24f1a3bb) SHA1(e60eec1d39b32ce5cc2125cffd3016b4070a65c3) )
...
MEGADRIVE_ROM_LOAD( aerobiz,   "aerobiz (usa).bin",                                                                      0x000000, 0x100000,  CRC(cfaa9bce) SHA1(104ad3c6f5aaba08270faf427991d6a256c6e67c) )
MEGADRIVE_ROM_LOAD( aerobizs,  "aerobiz supersonic (usa).bin",                                                           0x000000, 0x100000,  CRC(9377f1b5) SHA1(f29b148c052f50a89e3b877ce027a0d5aaa387d1) )
MEGADRIVE_ROM_LOAD( aerobl,    "aero blasters (jpn).bin",                                                                0x000000, 0x80000,   CRC(a00da987) SHA1(64d1964c3b6293f521427d3d83e4defe363cc129) )
...
MEGADRIVE_ROM_LOAD( airdiverj, "air diver (jpn).bin",                                                                    0x000000, 0x80000,   CRC(9e2d5b91) SHA1(540460e95f6a82256ca2a16f347a7b6524f3053f) )
MEGADRIVE_ROM_LOAD( airman,    "air management - oozora ni kakeru (jpn).bin",                                            0x000000, 0x100000,  CRC(b3db0c71) SHA1(b4e5752453cb3e4b3f6cb4fd9ad6473b4b8addd4) )
MEGADRIVE_ROM_LOAD( airman2,   "air management ii - koukuuou o mezase (jpn).bin",                                        0x000000, 0x100000,  CRC(4582817b) SHA1(6ed89fc3302023bc95c2bba0d45fe1d30e1c5d86) )
MEGADRIVE_ROM_LOAD( akumajou,  "akumajou dracula - vampire killer (jpn).bin",                                            0x000000, 0x100000,  CRC(91b57d2b) SHA1(3e709bd27577056abbbd6735021eaffd90caa140) )
MEGADRIVE_ROM_LOAD( aladdin,   "mpr-15939.bin",                                                                          0x000000, 0x200000,  CRC(d1845e8f) SHA1(42debba01ba3555f61d1e9b445542a05d01451dd) )
MEGADRIVE_ROM_LOAD( aladdin2,  "aladdin ii (unl).bin",                                                                   0x000000, 0x200000,  CRC(be5f9397) SHA1(9980997458dff7897009301a873cf84441f8a01f) )
MEGADRIVE_ROM_LOAD( aladdinj,  "aladdin (jpn).bin",                                                                      0x000000, 0x200000,  CRC(fb5aacf0) SHA1(43753dafd0b816c39aca87fc0788e598fb4bb4f3) )
...
MEGADRIVE_ROM_LOAD( alexkidd1, "alex kidd in the enchanted castle (euro).bin",                                           0x000000, 0x40000,   CRC(c3a52529) SHA1(fd033ad9bd60d57adf52fa8cd0c1a5968d083f46) )
MEGADRIVE_ROM_LOAD( alexkiddj, "alex kidd - tenkuu majou (jpn).bin",                                                     0x000000, 0x40000,   CRC(8a5ed856) SHA1(0bd83099edd3938a0f127ed399cb01046e36ac32) )
MEGADRIVE_ROM_LOAD( alexkiddk, "alex kidd - cheongong maseong (kor).bin",                                                0x000000, 0x40000,   CRC(5b0678fb) SHA1(aa9f686045fe83ee5f86640e5a711f80cad16b1e) )
...
MEGADRIVE_ROM_LOAD( alien3a,   "mpr-15061.bin",                                                                          0x000000, 0x80000,   CRC(a3b00d6e) SHA1(1f4b969592f98d2692cb06eca550da9c03062593) )
MEGADRIVE_ROM_LOAD( aliens,    "alien soldier (euro).bin",                                                               0x000000, 0x200000,  CRC(0496e06c) SHA1(fa141778bd6540775194d77318f27d2a934e1ac1) )
MEGADRIVE_ROM_LOAD( aliensj,   "alien soldier (jpn).bin",                                                                0x000000, 0x200000,  CRC(90fa1539) SHA1(8f6eb584ed9487b8504fbc21d86783f58e6c9cd6) )
MEGADRIVE_ROM_LOAD( alienstm,  "mpr-13941.bin",                                                                          0x000000, 0x80000,   CRC(f5ac8de5) SHA1(e4f8774c5f96db76a781c31476d06203ec16811a) )
MEGADRIVE_ROM_LOAD( alisiad,   "alisia dragoon (euro).bin",                                                              0x000000, 0x100000,  CRC(28165bd1) SHA1(c8a3667631fdbd4d0073e42ada9f7199d09c0cfa) )
MEGADRIVE_ROM_LOAD( alisiadj,  "alisia dragoon (jpn).bin",                                                               0x000000, 0x100000,  CRC(4d476722) SHA1(04cf02a0004f2eba16af781dd55b946176bb9dbf) )
MEGADRIVE_ROM_LOAD( alisiadu,  "alisia dragoon (usa).bin",                                                               0x000000, 0x100000,  CRC(d28d5c40) SHA1(69bf7a9ebcb851e0d571f93b26d785ca87621b01) )
...
MEGADRIVE_ROM_LOAD( anotherw,  "another world (euro).bin",                                                               0x000000, 0x100000,  CRC(e9742041) SHA1(9d98d6817b3e3651837bb2692f7a2a60a608c055) )
MEGADRIVE_ROM_LOAD( aof,       "art of fighting (euro).bin",                                                             0x000000, 0x200000,  CRC(9970c422) SHA1(a58b1efbbdfa8c4ee6f3d06d474c3771ebe36ca4) )
...
MEGADRIVE_ROM_LOAD( aokioo,    "aoki ookami to shiroki meshika - genchou hishi (jpn).bin",                               0x000000, 0x140000,  CRC(10be1d93) SHA1(0de0f798f636285da2b4d248f9894bf975b45304) )
MEGADRIVE_ROM_LOAD( aqrenk,    "aq renkan awa (china) (unl).bin",                                                        0x000000, 0x100000,  CRC(2c6cbd77) SHA1(fcd1c7fcfb9027ae7baad9c67847ef5f1090991a) )
MEGADRIVE_ROM_LOAD( aquaticg,  "aqua01.bin",                                                                             0x000000, 0x80000,   CRC(400f4ba7) SHA1(3bbd0853099f655cd33b52d32811f8ccb64b0418) )
...
MEGADRIVE_ROM_LOAD( arcusj,    "arcus odyssey (jpn).bin",                                                                0x000000, 0x100000,  CRC(41c5fb4f) SHA1(8e1a9a9f9ba50bca0a377bd8f795b7c9c1275815) )
MEGADRIVE_ROM_LOAD( aresshik,  "a ressha de ikou md (jpn).bin",                                                          0x000000, 0x80000,   CRC(3d45de4f) SHA1(d0d0aaad68978fd15c5857773141ae639de1abc7) )
MEGADRIVE_ROM_LOAD( ariel,     "mpr-15153.bin",                                                                          0x000000, 0x80000,   CRC(58e297df) SHA1(201105569535b7c8f11bd97b93cbee884c7845c4) )
...
MEGADRIVE_ROM_LOAD( assmgp,    "mpr-14861.bin",                                                                          0x000000, 0x100000,  CRC(60af0f76) SHA1(373fb1744170a114ef99802db987bc9aae009032) )
MEGADRIVE_ROM_LOAD( assmgpu,   "ayrton senna's super monaco gp ii (usa).bin",                                            0x000000, 0x100000,  CRC(eac8ded6) SHA1(1ee87744d86c4bdd4958cc70d77538351aa206e6) )
MEGADRIVE_ROM_LOAD( asterix,   "mpr-15961+mpr-15962.bin",                                                                0x000000, 0x200000,  CRC(4735fee6) SHA1(e6353362ba261f1f8efb31e624250e74e1ca0da1) ) // two chips cart, needs a proper dump
...
MEGADRIVE_ROM_LOAD( asterpgb,  "asterix and the power of the gods (euro) (beta).bin",                                    0x000000, 0x200000,  CRC(45c8b5b7) SHA1(0905252a58dc5ce0aaa06f1129516fefbda65ddb) )
...
MEGADRIVE_ROM_LOAD( atptour,   "atp tour (euro).bin",                                                                    0x000000, 0x200000,  CRC(1a3da8c5) SHA1(c5fe0fe967369e9d9e855fd3c7826c8f583c49e3) )
MEGADRIVE_ROM_LOAD( atptourp1, "atp tour championship tennis (prototype - aug 02, 1994).bin",                            0x000000, 0x200000,  CRC(686a9fa1) SHA1(3e29c757cedf2334d830f4375242c066f83e0d36) )
MEGADRIVE_ROM_LOAD( atptourp2, "atp tour championship tennis (prototype - aug 05, 1994).bin",                            0x000000, 0x200000,  CRC(a1fef967) SHA1(9fae94e52de4bde42ac45f0e3d3964ccd094b375) )
MEGADRIVE_ROM_LOAD( atptourp3, "atp tour championship tennis (prototype - aug 08, 1994).bin",                            0x000000, 0x200000,  CRC(e6398864) SHA1(2cade1465fd5a835523b688bb675f67a7012e67d) )
MEGADRIVE_ROM_LOAD( atptourp4, "atp tour championship tennis (prototype - jul 19, 1994).bin",                            0x000000, 0x200000,  CRC(cb927488) SHA1(e0e94be5c1f76465151cf6c6357d67ba68170676) )
MEGADRIVE_ROM_LOAD( atptourp5, "atp tour championship tennis (prototype - jul 23, 1994).bin",                            0x000000, 0x200000,  CRC(a15d5051) SHA1(88005e79f325e20c804e04a7a310a6d19b7f7cce) )
MEGADRIVE_ROM_LOAD( atptourp6, "atp tour championship tennis (prototype - jul 25, 1994).bin",                            0x000000, 0x200000,  CRC(a15d5051) SHA1(88005e79f325e20c804e04a7a310a6d19b7f7cce) )
MEGADRIVE_ROM_LOAD( atptourp7, "atp tour championship tennis (prototype - may 09, 1994).bin",                            0x000000, 0x200000,  CRC(b17a8dbc) SHA1(dbaa2f60df5811026539d1f4c6ad50b596b1356a) )
MEGADRIVE_ROM_LOAD( atptourp8, "atp tour championship tennis (prototype - sep 08, 1994).bin",                            0x000000, 0x200000,  CRC(b83f4ca4) SHA1(c2e277d1cf4fa9def71014dc7cf6ebe34d521281) )
...
MEGADRIVE_ROM_LOAD( austrarl,  "australian rugby league (euro).bin",                                                     0x000000, 0x200000,  CRC(ac5bc26a) SHA1(b54754180f22d52fc56bab3aeb7a1edd64c13fef) )
...
MEGADRIVE_ROM_LOAD( aworgj,    "aworg (jpn) (sn).bin",                                                                   0x000000, 0x40000,   CRC(069c27c1) SHA1(8316433112fb4b80bbbaf905f93bbfa95f5cb8b2) )
...
MEGADRIVE_ROM_LOAD( badomen,   "bad omen (jpn, kor).bin",                                                                0x000000, 0x80000,   CRC(975693ce) SHA1(5378af243fb6f592f1e1cd17e3722e2c5e807e72) )
MEGADRIVE_ROM_LOAD( bahamuts,  "mpr-13677.bin",                                                                          0x000000, 0x80000,   CRC(b1e268da) SHA1(cee49b613298e060d938de523dfcbb27e790b5af) )
MEGADRIVE_ROM_LOAD( ballja,    "ball jacks (euro, jpn).bin",                                                             0x000000, 0x40000,   CRC(f5c3c54f) SHA1(c8aa71c5632a5cc59da430ca3870cffb37fbd30f) )
MEGADRIVE_ROM_LOAD( ballz3d,   "ballz 3d - fighting at its ballziest (euro, usa).bin",                                   0x000000, 0x200000,  CRC(b362b705) SHA1(4825cb9245a701cc59900c57a7a5fa70edc160f0) )
...
MEGADRIVE_ROM_LOAD( barkley,   "barkley shut up and jam! (euro, usa).bin",                                               0x000000, 0x100000,  CRC(63fbf497) SHA1(fc60a682412b4f7f851c5eb7f6ae68fcee3d2dd1) )
...
MEGADRIVE_ROM_LOAD( bartnigt,  "simpsons, the - bart's nightmare (euro, usa).bin",                                       0x000000, 0x100000,  CRC(24d7507c) SHA1(fb95b7fdf12dcf62883dabf65d2bf8ffa83786fc) )
MEGADRIVE_ROM_LOAD( bartvssm,  "mpr-14759a.bin",                                                                         0x000000, 0x80000,   CRC(db70e8ca) SHA1(2d42143c83ec3b4167860520ee0a9030ef563333) )
MEGADRIVE_ROM_LOAD( bartvssm1, "simpsons, the - bart vs the space mutants (euro, usa).bin",                              0x000000, 0x80000,   CRC(c8620574) SHA1(3cf4447a0a883c78645c6faded28c51e0d8c0d63) )
MEGADRIVE_ROM_LOAD( barver,    "barver battle saga - tai kong zhan shi (china) (unl).bin",                               0x000000, 0x200000,  CRC(d37a37c6) SHA1(6d49a0db7687ccad3441f47fbc483c87cd6eab53) )
...
MEGADRIVE_ROM_LOAD( batmanj,   "batman (jpn).bin",                                                                       0x000000, 0x80000,   CRC(d7b4febf) SHA1(7f96c72cc7bbdb4a7847d1058f5a751b2dc00ab5) )
...
MEGADRIVE_ROM_LOAD( battlema,  "battle mania (jpn).bin",                                                                 0x000000, 0x80000,   CRC(a76c4a29) SHA1(9886dd39cfd8fe505860fc4d0119aacec7484a4e) )
MEGADRIVE_ROM_LOAD( battlemd,  "battle mania daiginjou (jpn, kor).bin",                                                  0x000000, 0x100000,  CRC(312fa0f2) SHA1(fbcf7e899ff964f52ade160793d6cb22bf68375c) )
...
MEGADRIVE_ROM_LOAD( battlesq,  "battle squadron (euro, usa).bin",                                                        0x000000, 0x80000,   CRC(0feaa8bf) SHA1(f003f7af0f7edccc317c944b88e57f4c9b66935a) )
...
MEGADRIVE_ROM_LOAD( battlyui,  "battle golfer yui (jpn).bin",                                                            0x000000, 0x80000,   CRC(4aa03e4e) SHA1(84db25ff7a0d2db6afddcfe4cdc7c26e20d0dd72) )
MEGADRIVE_ROM_LOAD( beast,     "sha01.bin",                                                                              0x000000, 0x100000,  CRC(bd385c27) SHA1(2f6f5165d3aa40213c8020149d5e4b29f86dfba8) )
MEGADRIVE_ROM_LOAD( beast2,    "shadow of the beast ii (euro, usa).bin",                                                 0x000000, 0x100000,  CRC(2dede3db) SHA1(260a497348313c22f2d1a626150b0915990720c2) )
MEGADRIVE_ROM_LOAD( beastj,    "shadow of the beast - mashou no okite (jpn).bin",                                        0x000000, 0x100000,  CRC(0cd09d31) SHA1(6e4bb7fb1a0f642d72cf58376bf2637e0ac6ef50) )
...
MEGADRIVE_ROM_LOAD( beastwj,   "beast warriors (jpn).bin",                                                               0x000000, 0x100000,  CRC(4646c694) SHA1(b504a09e3283716f0f9b0464ea9c20cd40110408) )
...
MEGADRIVE_ROM_LOAD( beavis,    "beavis and butt-head (euro).bin",                                                        0x000000, 0x200000,  CRC(c7b6435e) SHA1(0d132afbc76589b95a0c617d39122f0715eab2c6) )
...
MEGADRIVE_ROM_LOAD( berens1,    "berenstain bears' camping adventure, the (prototype - apr 28, 1994).bin",               0x000000, 0x100000,  CRC(f222e946) SHA1(349fc63222fe59bc8e7e71e6b0358ac7b03a00ca) )
MEGADRIVE_ROM_LOAD( berens2,    "berenstain bears' camping adventure, the (prototype - apr 29, 1994).bin",               0x000000, 0x100000,  CRC(e21493b4) SHA1(4607bf96959809c86c4e5ed244c9d29ad2584637) )
MEGADRIVE_ROM_LOAD( berens3,    "berenstain bears' camping adventure, the (prototype - aug 01, 1994).bin",               0x000000, 0x100000,  CRC(b7cd465c) SHA1(d60e4e0542d1c0a4bdbb7a433373051718549055) )
MEGADRIVE_ROM_LOAD( berens4,    "berenstain bears' camping adventure, the (prototype - aug 02, 1994).bin",               0x000000, 0x100000,  CRC(383ad564) SHA1(faf4801049124ab2f63d514f04adc757a66382b5) )
MEGADRIVE_ROM_LOAD( berens5,    "berenstain bears' camping adventure, the (prototype - aug 03, 1994).bin",               0x000000, 0x100000,  CRC(18f268a6) SHA1(5f496994fa770db96afac4579d7314d56a8f15d5) )
MEGADRIVE_ROM_LOAD( berens6,    "berenstain bears' camping adventure, the (prototype - aug 05, 1994).bin",               0x000000, 0x100000,  CRC(24159b6f) SHA1(1b4e21aeffba372820c25517d98c181731bbd007) )
MEGADRIVE_ROM_LOAD( berens7,    "berenstain bears' camping adventure, the (prototype - aug 08, 1994).bin",               0x000000, 0x100000,  CRC(58b6b0fc) SHA1(ba0e3fc9d04e37a81b37d4e9ff21097bfc4fc0f1) )
MEGADRIVE_ROM_LOAD( berens8,    "berenstain bears' camping adventure, the (prototype - jul 09, 1994).bin",               0x000000, 0x100000,  CRC(bf6aa405) SHA1(8172369e0a73d1be60e1124a2ea8df41cfddfb55) )
MEGADRIVE_ROM_LOAD( berens9,    "berenstain bears' camping adventure, the (prototype - jul 16, 1994).bin",               0x000000, 0x100000,  CRC(c84aad8e) SHA1(758f5e7072d8bc4bd6325fb7629ebb9f11d1ce10) )
MEGADRIVE_ROM_LOAD( berens10,    "berenstain bears' camping adventure, the (prototype - jul 20, 1994).bin",              0x000000, 0x100000,  CRC(abee4c5e) SHA1(ebc3d134494ce02932b44bbda3720176089d7604) )
MEGADRIVE_ROM_LOAD( berens11,    "berenstain bears' camping adventure, the (prototype - jun 02, 1994).bin",              0x000000, 0x100000,  CRC(83cf19e4) SHA1(fe2fa9060a2cf13720c79a5fc8568a33c2adad0a) )
MEGADRIVE_ROM_LOAD( berens12,    "berenstain bears' camping adventure, the (prototype - jun 10, 1994).bin",              0x000000, 0x100000,  CRC(a748e2cf) SHA1(32ee3d750ea8ff06adb28c7b5812670f4e92d952) )
MEGADRIVE_ROM_LOAD( berens13,    "berenstain bears' camping adventure, the (prototype - mar 23, 1994).bin",              0x000000, 0x100000,  CRC(bfbcd7cc) SHA1(2ace984e92740fe93b762c66ee12663c7d8805b9) )
MEGADRIVE_ROM_LOAD( berens14,    "berenstain bears' camping adventure, the (prototype - may 06, 1994).bin",              0x000000, 0x100000,  CRC(713c14d8) SHA1(fedd6c08d4bd7f8f554bcfd1e7431ba9248c1fe7) )
MEGADRIVE_ROM_LOAD( berens15,    "berenstain bears' camping adventure, the (prototype - may 11, 1994).bin",              0x000000, 0x100000,  CRC(f7b81c6a) SHA1(9ab467062576cf087f73bd9ef9ecc428ce638f3a) )
MEGADRIVE_ROM_LOAD( berens16,    "berenstain bears' camping adventure, the (prototype - may 17, 1994).bin",              0x000000, 0x100000,  CRC(e1855ade) SHA1(391c1bdeb7546bc19c3f866cb17079f529044b3c) )
MEGADRIVE_ROM_LOAD( berens17,    "berenstain bears' camping adventure, the (prototype - may 19, 1994).bin",              0x000000, 0x100000,  CRC(07c9f71f) SHA1(617284c4964117e2c7ac9fab8ef4ea19a89fa0ea) )
MEGADRIVE_ROM_LOAD( berens18,    "berenstain bears' camping adventure, the (prototype - may 23, 1994).bin",              0x000000, 0x100000,  CRC(913887b7) SHA1(4b866f0b0f491a3d73d1ce1895df9720c93a79f2) )
MEGADRIVE_ROM_LOAD( berens19,    "berenstain bears' camping adventure, the (prototype - may 26, 1994).bin",              0x000000, 0x100000,  CRC(d33c0fa4) SHA1(4315949e9c7f3c938d0ef15f0ce361e7f47042a1) )
MEGADRIVE_ROM_LOAD( berens20,    "berenstain bears' camping adventure, the (prototype - may 30, 1994).bin",              0x000000, 0x100000,  CRC(9c3bf429) SHA1(33c292b28518f25e1d87c41fff3cf5f2da635993) )
MEGADRIVE_ROM_LOAD( bestof,    "best of the best - championship karate (usa).bin",                                       0x000000, 0x100000,  CRC(c3d6a5d4) SHA1(1fafc2d289215d0f835fa6c74a8bf68f8d36bcc8) )
MEGADRIVE_ROM_LOAD( bestofb,   "best of the best - championship karate (euro) (beta).bin",                               0x000000, 0x100000,  CRC(f842240b) SHA1(c7ffaa2af35d0365340075555b6a5c3f252d33b3) )
...
MEGADRIVE_ROM_LOAD( bibleadv,  "bible adventures (usa) (unl).bin",                                                       0x000000, 0x80000,   CRC(64446b77) SHA1(0163b6cd6397ab4c1016f9fcf4f2e6d2bca8454f) )
...
MEGADRIVE_ROM_LOAD( bk2b,      "bare knuckle ii (jpn) (beta).bin",                                                       0x000000, 0x130000,  CRC(0cf2acbe) SHA1(ee3bee676944bc5a3cab163c209825f678dc8204) )
MEGADRIVE_ROM_LOAD( bk3,       "bare knuckle iii (jpn).bin",                                                             0x000000, 0x300000,  CRC(5d09236f) SHA1(b9b2b4a98a9d8f4c49aa1e5395e2279339517fdb) )
MEGADRIVE_ROM_LOAD( bk3b,      "bare knuckle iii (jpn) (beta).bin",                                                      0x000000, 0x300000,  CRC(e7ff99db) SHA1(1d75372571ce970545f6ce63977cea9fa811e23f) )
MEGADRIVE_ROM_LOAD( blades,    "blades of vengeance (euro, usa).bin",                                                    0x000000, 0x100000,  CRC(74c65a49) SHA1(11f342ec4be17dcf7a4a6a80649b6b5ff19940a5) )
...
MEGADRIVE_ROM_LOAD( blocko,    "bloc-u1_blo03+bloc-u2_blo03.bin,mpr-14247.bin",                                          0x000000, 0x20000,   CRC(5e2966f1) SHA1(f6620d3b712f3bd333d0bb355c08cf992af6e12d) ) // Western release contains two chips (blo03.u1, blo03.u2), Japanese release only one (mpr-14247), but aggregated checksum is the same; needs a proper dump
MEGADRIVE_ROM_LOAD( bloods,    "es210.bin",                                                                              0x000000, 0x200000,  CRC(f9f2bceb) SHA1(513005efd123539a905986130d15125085837559) )
MEGADRIVE_ROM_LOAD( bluealma,  "blue almanac (jpn).bin",                                                                 0x000000, 0x100000,  CRC(7222ebb3) SHA1(0be0d4d3e192beb4106c0a95c1fb0aec952c3917) )
MEGADRIVE_ROM_LOAD( bob,       "b.o.b. (euro, usa).bin",                                                                 0x000000, 0x100000,  CRC(eaa2acb7) SHA1(84d63c848d68d844dbcf360040a87a0c93d67f74) )
MEGADRIVE_ROM_LOAD( bobb,      "b.o.b. (usa) (beta).bin",                                                                0x000000, 0x100000,  CRC(e3e8421e) SHA1(eb5e4221b13372f2155ac80e88eb1114a6e2ccc7) )
MEGADRIVE_ROM_LOAD( bodyco,    "body count (euro).bin",                                                                  0x000000, 0x100000,  CRC(3575a030) SHA1(3098f3c7ea9e25bf86219d7ed0795bf363338714) )
MEGADRIVE_ROM_LOAD( bodycob,   "body count (euro) (beta).bin",                                                           0x000000, 0x100000,  CRC(b4ffb6ce) SHA1(a01971cdce4d98e770d9c083a5accb8cb5260112) )
...
MEGADRIVE_ROM_LOAD( bonanz1,   "bonanza bros. (euro, jpn).bin",                                                          0x000000, 0x80000,   CRC(adf6476c) SHA1(ce46f2b53988f06e0bdfaad1b0dc3e9ca936e1e8) )
MEGADRIVE_ROM_LOAD( bonanz2,   "bonanza bros. (usa, kor).bin",                                                           0x000000, 0x80000,   CRC(20d1ad4c) SHA1(31c589bc0d1605502cdd04069dc4877811e84e58) )
MEGADRIVE_ROM_LOAD( bonkers,   "bonkers (euro, usa).bin",                                                                0x000000, 0x100000,  CRC(d1e66017) SHA1(938642252fdb1c5aedc785bce2ba383fc683c917) )
...
MEGADRIVE_ROM_LOAD( booger,    "boogerman - a pick and flick adventure (euro).bin",                                      0x000000, 0x300000,  CRC(dbc4340c) SHA1(4fd33eeaf1e804d005793a6e1185122fd7e9a751) )
...
MEGADRIVE_ROM_LOAD( boogie,    "boogie woogie bowling (jpn).bin",                                                        0x000000, 0x80000,   CRC(ccf52828) SHA1(57599254461bf05ac0822c42e0bb223a68d4cd71) )
MEGADRIVE_ROM_LOAD( boxlgnd,   "boxing legends of the ring (usa).bin",                                                   0x000000, 0x100000,  CRC(00f225ac) SHA1(4004af082d0e917d6b05c137ab5cff55e11c12a9) )
MEGADRIVE_ROM_LOAD( bramst,    "bram stoker's dracula (euro).bin",                                                       0x000000, 0x100000,  CRC(9ba5a063) SHA1(d1e2bb4febf973e3510118d2ea71b4c6594480a9) )
...
MEGADRIVE_ROM_LOAD( brianl,    "brian lara cricket (euro) (june 1995).bin",                                              0x000000, 0x100000,  CRC(408cf5c3) SHA1(032eb1a15c95540b392b52ee17eef7eee6ac436d) )
MEGADRIVE_ROM_LOAD( brianl1,   "brian lara cricket (euro) (march 1995).bin",                                             0x000000, 0x100000,  CRC(90f5c2b7) SHA1(0f4bec98af08027fc034b9801c28bb299a04be35) )
MEGADRIVE_ROM_LOAD( brianl96,  "brian lara cricket 96 (euro) (april 1996).bin",                                          0x000000, 0x100000,  CRC(fe52f7e1) SHA1(3e1ef39e9008a4a55fd57b25948668c8c52ba9e3) )
MEGADRIVE_ROM_LOAD( brianl96a, "mdbl_9844.bin",                                                                          0x000000, 0x100000,  CRC(fa3024af) SHA1(0b08788a0f8214c5d07b8e2293f0b954dd05bef5) )
MEGADRIVE_ROM_LOAD( brutal,    "brutal - paws of fury (euro).bin",                                                       0x000000, 0x200000,  CRC(7e9a8d32) SHA1(8667fa820e90911f12b682fcd1ac870b84b6b60b) )
...
MEGADRIVE_ROM_LOAD( bubba,     "bubba'n'stix (euro).bin",                                                                0x000000, 0x100000,  CRC(b467432e) SHA1(4039dfb41c08d17047d2acf90d0ab8bb7932cabd) )
MEGADRIVE_ROM_LOAD( bubbab,    "bubba'n'stix (euro) (beta).bin",                                                         0x000000, 0x100000,  CRC(a8731cb4) SHA1(3e10ed88ac29b084d3665579a79c23ff2921b832) )
...
MEGADRIVE_ROM_LOAD( bubble,    "bubble and squeak (euro).bin",                                                           0x000000, 0x80000,   CRC(86151bf1) SHA1(092b21f33991e42f993fb8ee1de1c31553a75f68) )
...
MEGADRIVE_ROM_LOAD( bubsy,     "bubsy in claws encounters of the furred kind (euro, usa).bin",                           0x000000, 0x200000,  CRC(3e30d365) SHA1(719140754763e5062947ef9e76ee748cfad38202) )
...
MEGADRIVE_ROM_LOAD( budokan,   "budokan - the martial spirit (euro).bin",                                                0x000000, 0x80000,   CRC(97add5bd) SHA1(004f3d6f333795315a072f3f0661ce4e5e91a4ae) )
...
MEGADRIVE_ROM_LOAD( bugslife,  "bug's life, a (unl).bin",                                                                0x000000, 0x100000,  CRC(10458e09) SHA1(b620c2bebd5bab39bc9258a925169b4c93614599) )
MEGADRIVE_ROM_LOAD( bullvsbl,  "bulls versus blazers and the nba playoffs (euro, usa).bin",                              0x000000, 0x100000,  CRC(d4e4b4e8) SHA1(6db65704e2132c2f6e0501e8481abde7f2c7078d) )
MEGADRIVE_ROM_LOAD( bullvsla,  "bulls vs lakers and the nba playoffs (euro, usa).bin",                                   0x000000, 0x100000,  CRC(e56023a0) SHA1(102652dcd218e3420ea9c4116231fa62f8fcd770) )
MEGADRIVE_ROM_LOAD( burninf,   "burning force (euro).bin",                                                               0x000000, 0x80000,   CRC(776ff6ff) SHA1(a25930ee55a2d88838e3999fb5939d9392fd0efa) )
MEGADRIVE_ROM_LOAD( burninfj,  "burning force (jpn).bin",                                                                0x000000, 0x80000,   CRC(0c1deb47) SHA1(8849253262f545fbaf6140bfa5ca67a3caac9a80) )
...
MEGADRIVE_ROM_LOAD( cadash,    "cadash (usa, asia, kor).bin",                                                            0x000000, 0x80000,   CRC(13bdf374) SHA1(5791cc9a1b118c58fc5209bf2e64156ffdb80134) )
MEGADRIVE_ROM_LOAD( caesar,    "caesar no yabou (jpn).bin",                                                              0x000000, 0x100000,  CRC(69796e93) SHA1(4a5b9169262caf81fb7ae76fc3835107769f28a1) )
MEGADRIVE_ROM_LOAD( caesar2,   "caesar no yabou ii (jpn).bin",                                                           0x000000, 0x100000,  CRC(4f327b3a) SHA1(cdb2f47bde3ff412c7b1f560637f2ccec023980f) )
...
MEGADRIVE_ROM_LOAD( cal50,     "caliber .50 (usa).bin",                                                                  0x000000, 0x100000,  CRC(44f4fa05) SHA1(a68f3b9350a3a05850c17d157b56de88556cd26a) )
...
MEGADRIVE_ROM_LOAD( cannon,    "cannon fodder (euro).bin",                                                               0x000000, 0x180000,  CRC(ad217654) SHA1(ced5f0967e30c3b4c4c2a81007a7db2910b1885d) )
...
MEGADRIVE_ROM_LOAD( captplan,  "captain planet and the planeteers (euro).bin",                                           0x000000, 0x80000,   CRC(7672efa5) SHA1(b048f922db83802a4a78d1e8197a5ec52b73a89f) )
...
MEGADRIVE_ROM_LOAD( castlill,  "castle of illusion starring mickey mouse (euro, usa).bin",                               0x000000, 0x80000,   CRC(ba4e9fd0) SHA1(4ac3687634a5acc55ac7f156c6de9749158713e4) )
MEGADRIVE_ROM_LOAD( castlillj, "mpr-13498.bin",                                                                          0x000000, 0x80000,   CRC(ce8333c6) SHA1(0679162757f375751a677fd05195c9248abc84f0) )
MEGADRIVE_ROM_LOAD( centur,    "centurion - defender of rome (euro, usa).bin",                                           0x000000, 0xc0000,   CRC(21283b14) SHA1(8cc2a28309b2dc61da68c77d8a6545af05660e8b) ) // Centurion seems to suffer the same dumping problems of F22 September 1991 revision, needs a proper redump
MEGADRIVE_ROM_LOAD( chakan,    "chakan (euro, usa).bin",                                                                 0x000000, 0x100000,  CRC(046a48de) SHA1(7eae088f0b15e4bcd9a6a38849df5a20446be548) )
...
MEGADRIVE_ROM_LOAD( chaoji,    "chao ji da fu weng (china) (unl).bin",                                                   0x000000, 0x100000,  CRC(2e2ea687) SHA1(be1a66bd1f75f5b1b37b8ae18e6334c36291e63d) )
MEGADRIVE_ROM_LOAD( chaose,    "chaos engine, the (euro).bin",                                                           0x000000, 0x180000,  CRC(bd9eecf4) SHA1(b72d36565e13ab04dc20c547e0dcee1f67bcdb42) )
MEGADRIVE_ROM_LOAD( chaose2p,  "chaos engine 2, the (euro) (prototype).bin",                                             0x000000, 0x100000,  CRC(3fb045c2) SHA1(9e2e12e90b60e6ca28af6a5afb213cafe1868a95) )
...
MEGADRIVE_ROM_LOAD( cheese,    "cheese cat-astrophe starring speedy gonzales (euro).bin",                                0x000000, 0x200000,  CRC(ff634b28) SHA1(12bb0d838c675b34cecc9041d3560fe35145ec39) )
MEGADRIVE_ROM_LOAD( chelnov,   "chelnov (jpn).bin",                                                                      0x000000, 0x100000,  CRC(b2fe74d8) SHA1(ac1ae7b38f6498472bc4f072726a4ca069e41204) )
MEGADRIVE_ROM_LOAD( chess,     "chess (unl).bin",                                                                        0x000000, 0x80000,   CRC(47380edd) SHA1(42e56fc5543dcb40da73447b582c84c4ff50a825) )
...
MEGADRIVE_ROM_LOAD( chibim,    "chibi maruko-chan - wakuwaku shopping (jpn).bin",                                        0x000000, 0x80000,   CRC(91a144b8) SHA1(39d4da607d020bd20063c34b0a617a5e6cb7c5aa) )
...
MEGADRIVE_ROM_LOAD( chiki,     "chiki chiki boys (euro, usa).bin",                                                       0x000000, 0x100000,  CRC(813a7d62) SHA1(3cbeb068751c39790116aa8f422dd6f333be42e0) )
MEGADRIVE_ROM_LOAD( chikij,    "chiki chiki boys (jpn, kor).bin",                                                        0x000000, 0x100000,  CRC(06918c17) SHA1(77191eaee3775a425147ae7140ddf6ed3b6b41d2) )
MEGADRIVE_ROM_LOAD( chinesec,  "chinese chess (unl).bin",                                                                0x000000, 0x80000,   CRC(475215a0) SHA1(3907bf058493e7b9db9720493030f0284797908c) )
MEGADRIVE_ROM_LOAD( chinf3a,    "chinese fighter iii (unl).bin",                                                         0x000000, 0x200000,  CRC(6f98247d) SHA1(cc212b1564dc7c73ffdc55f9fde3269a83fee399) )
MEGADRIVE_ROM_LOAD( chuckrck,  "chuck rock (euro).bin",                                                                  0x000000, 0x100000,  CRC(7cd40bea) SHA1(832a18eb028630e31b5bacd05f9694f4a827268b) )
...
MEGADRIVE_ROM_LOAD( chucks,    "chuck's excellent art tool animator (usa) (unl).bin",                                    0x000000, 0x60000,   CRC(6360ee58) SHA1(191726e84fb80ccb992d7cf4188008e23f644432) )
MEGADRIVE_ROM_LOAD( chukrck2,  "chuck rock ii - son of chuck (euro).bin",                                                0x000000, 0x100000,  CRC(1ade9488) SHA1(f57ed0e6201b706abd5e837d9043723a1b3b4de5) )
MEGADRIVE_ROM_LOAD( chukrck2j, "chuck rock ii (jpn).bin",                                                                0x000000, 0x100000,  CRC(bfd24be8) SHA1(e9217b089ade7f7b9566233e7bff66ba363ad6cb) )
...
MEGADRIVE_ROM_LOAD( chukrck2ub,"chuck rock ii - son of chuck (usa) (beta).bin",                                          0x000000, 0x100000,  CRC(d6a3b324) SHA1(12faedb14e8ce02461b3529cce81ac9d4e854110) )
MEGADRIVE_ROM_LOAD( classicc,  "classic collection (euro).bin",                                                          0x000000, 0x200000,  CRC(73f948b1) SHA1(80629bb91a1123ae832f6997f9f3c0e070ce81ca) )
...
MEGADRIVE_ROM_LOAD( cliff,     "cliffhanger (euro).bin",                                                                 0x000000, 0x100000,  CRC(35bff1fd) SHA1(c453130b2789fa5682367f9c071206e06952b951) )
...
MEGADRIVE_ROM_LOAD( columns3j, "columns iii - taiketsu! columns world (jpn, kor).bin",                                   0x000000, 0x80000,   CRC(cd07462f) SHA1(2e850c2b737098b9926ac0fc9b8b2116fc5aa48a) )
...
MEGADRIVE_ROM_LOAD( combatca,  "combat cars (euro, usa).bin",                                                            0x000000, 0x100000,  CRC(e439b101) SHA1(0c7ca93b412c8ab5753ae047de49a3e41271cc3b) )
MEGADRIVE_ROM_LOAD( comix,     "mpr-18301.bin",                                                                          0x000000, 0x200000,  CRC(1318e923) SHA1(9523cf8e485a3246027f5a02ecbcee3c5ba690f0) )
MEGADRIVE_ROM_LOAD( comix1,    "comix zone (euro) (prototype - jun 28, 1995).bin",                                       0x000000, 0x200000,  CRC(939efd4c) SHA1(62b6f4ac864862bf5360e72f3fb8b45700e4fcfa) )
MEGADRIVE_ROM_LOAD( comixj,    "comix zone (jpn).bin",                                                                   0x000000, 0x200000,  CRC(7a6027b8) SHA1(44f8c2a102971d0afcb0d9bd9081ccf51ff830a9) )
...
MEGADRIVE_ROM_LOAD( comixp10,  "comix zone (prototype - may 26, 1995).bin",                                              0x000000, 0x200000,  CRC(36029a1f) SHA1(dbce6c71b1b1c193a57416dd4ccacc876a9e64af) )
MEGADRIVE_ROM_LOAD( comixp11,  "comix zone (prototype - may 30, 1995).bin",                                              0x000000, 0x200000,  CRC(a72eca2c) SHA1(c751ec1ba09abda3ea3252a3e211383f054a507c) )
MEGADRIVE_ROM_LOAD( comixpk,   "comix zone (korea) (prototype - jun 09, 1995).bin",                                      0x000000, 0x200000,  CRC(e45a15f4) SHA1(2427e7e3932da731eb172ae22ad779c0abfced13) )
...
MEGADRIVE_ROM_LOAD( contra,    "contra - hard corps (usa, kor).bin",                                                     0x000000, 0x200000,  CRC(c579f45e) SHA1(68ea84146105bda91f6056932ff4fb42aa3eb4a7) )
MEGADRIVE_ROM_LOAD( contraj,   "contra - the hard corps (jpn).bin",                                                      0x000000, 0x200000,  CRC(2ab26380) SHA1(0a9d263490497c85d7010979765c48f98d9927bd) )
MEGADRIVE_ROM_LOAD( coolsp,    "mpr-15477.bin",                                                                          0x000000, 0x100000,  CRC(5f09fa41) SHA1(b6dc5d4c29b2161f7252828cf267117e726d8e82) )
MEGADRIVE_ROM_LOAD( coolspj,   "cool spot (jpn, kor).bin",                                                               0x000000, 0x100000,  CRC(e869efb1) SHA1(e32826ca9ae5173d5ef9722b52bfcb4ad390a7bb) )
...
MEGADRIVE_ROM_LOAD( cosmic,    "cosmic spacehead (euro, usa).bin",                                                       0x000000, 0x100000,  CRC(c593d31c) SHA1(95a3eb13e5d28db8c8ea5ff3e95b0d3e614def69) )
...
MEGADRIVE_ROM_LOAD( crackd1,   "crack down (euro, jpn).bin",                                                             0x000000, 0x80000,   CRC(538aaa5d) SHA1(1082c89920699dbc6f6672c9b0519b3d0f626ba5) )
...
MEGADRIVE_ROM_LOAD( crayon,    "crayon shin-chan - arashi o yobu enji (jpn).bin",                                        0x000000, 0x200000,  CRC(97fc42d2) SHA1(46214898990ebc5e74413a53f7304ad466875fbe) )
MEGADRIVE_ROM_LOAD( crossf,    "cross fire (usa).bin",                                                                   0x000000, 0x80000,   CRC(cc73f3a9) SHA1(cc681bb62483dfb3ee3ef976dff29cc80ad01820) )
MEGADRIVE_ROM_LOAD( crudeb,    "crude buster (jpn).bin",                                                                 0x000000, 0x100000,  CRC(affb4b00) SHA1(9122ef0e920133449266cf437a87a110e0343425) )
MEGADRIVE_ROM_LOAD( crue,      "crue06.bin",                                                                             0x000000, 0x80000,   CRC(4b195fc0) SHA1(f0c62f1beb4126d1d1d1b634d11fcd81f2723704) )
MEGADRIVE_ROM_LOAD( cruej,     "crue ball (jpn).bin",                                                                    0x000000, 0x80000,   CRC(514c53e2) SHA1(1ceb4370dacaa8e3ab4b8beb6ff008db269d0387) )
...
MEGADRIVE_ROM_LOAD( crying,    "crying - aseimei sensou (jpn).bin",                                                      0x000000, 0x100000,  CRC(4aba1d6a) SHA1(c45b6da77021d57df6a9cb511cc93a5bf83ecf1c) )
...
MEGADRIVE_ROM_LOAD( crysta0,   "crystal's pony tale (prototype - jul 01, 1994).bin",                                     0x000000, 0x100000,  CRC(16ac2e4f) SHA1(37e6369f0c5f8969003fd4ec1c291e06900c617a) )
MEGADRIVE_ROM_LOAD( crysta1,   "crystal's pony tale (prototype - jul 02, 1994).bin",                                     0x000000, 0x100000,  CRC(24bc4354) SHA1(fa14565f90a254bbe8cff18e62f65e9ff1da1736) )
MEGADRIVE_ROM_LOAD( crysta2,   "crystal's pony tale (prototype - jul 03, 1994).bin",                                     0x000000, 0x100000,  CRC(6d67a87c) SHA1(decec86674df91d1b9d29881745e279759470125) )
MEGADRIVE_ROM_LOAD( crysta3,   "crystal's pony tale (prototype - jul 12, 1994 - b).bin",                                 0x000000, 0x100000,  CRC(3577dc72) SHA1(db225126e319380d89c0a5ab58d9f75d97419e6a) )
MEGADRIVE_ROM_LOAD( crysta4,   "crystal's pony tale (prototype - jul 12, 1994).bin",                                     0x000000, 0xff554,   CRC(2bfc0a53) SHA1(9ac7eba7cb238602925ed2a23f870b81b413991e) )
MEGADRIVE_ROM_LOAD( crysta5,   "crystal's pony tale (prototype - jul 13, 1994).bin",                                     0x000000, 0x100000,  CRC(c67b6dba) SHA1(58e56c2cbb94f81205c6f38656a0c75dcf27e267) )
MEGADRIVE_ROM_LOAD( crysta6,   "crystal's pony tale (prototype - jun 01, 1994).bin",                                     0x000000, 0x100000,  CRC(14c6347c) SHA1(170db22a5bfc30afe19ece372ad0cceea1961cd7) )
MEGADRIVE_ROM_LOAD( crysta7,   "crystal's pony tale (prototype - jun 06, 1994).bin",                                     0x000000, 0x100000,  CRC(83e8cac9) SHA1(2941ae87e22de10eadd0b7f75bf2e003396d4c99) )
MEGADRIVE_ROM_LOAD( crysta8,   "crystal's pony tale (prototype - jun 10, 1994).bin",                                     0x000000, 0x100000,  CRC(9e1dd267) SHA1(cd0ebcdca3b8fdd763c8748bc2ebc91690bebd7f) )
MEGADRIVE_ROM_LOAD( crysta9,   "crystal's pony tale (prototype - jun 23, 1994).bin",                                     0x000000, 0x100000,  CRC(4ccc19af) SHA1(2220bcb6baa349f5086c3a42ead63c7efeb49631) )
MEGADRIVE_ROM_LOAD( crysta10,  "crystal's pony tale (prototype - jun 28, 1994).bin",                                     0x000000, 0x100000,  CRC(03be7f66) SHA1(ca3abcc3403c34fa7b2ea6ff56b1967267d96fce) )
MEGADRIVE_ROM_LOAD( crysta11,  "crystal's pony tale (prototype - jun 30, 1994).bin",                                     0x000000, 0x100000,  CRC(dd8c73fb) SHA1(4db4a0b358a88f9c04f2f3c73d7b9ce1ac87a8da) )
MEGADRIVE_ROM_LOAD( crysta12,  "crystal's pony tale (prototype - may 11, 1994).bin",                                     0x000000, 0x100000,  CRC(eac9d74b) SHA1(53cd0e287b54a49ddf1d6075fab4b3a7f1ddc396) )
MEGADRIVE_ROM_LOAD( crysta13,  "crystal's pony tale (prototype - may 19, 1994).bin",                                     0x000000, 0x100000,  CRC(dc50b741) SHA1(b9c271296977e2b304a8a808cb2d5e9fb44467b1) )
MEGADRIVE_ROM_LOAD( crysta14,  "crystal's pony tale (prototype - may 26, 1994).bin",                                     0x000000, 0x100000,  CRC(a2eaba55) SHA1(16278beee4d39ea9f70ce6225373b193881cb2b0) )
MEGADRIVE_ROM_LOAD( curse,     "curse (jpn).bin",                                                                        0x000000, 0x80000,   CRC(a4fbf9a9) SHA1(978780d9575022450d415591f32e1118c7fac5ad) )
MEGADRIVE_ROM_LOAD( cutiesuz,  "cutie suzuki no ringside angel (jpn).bin",                                               0x000000, 0x80000,   CRC(13795dca) SHA1(4e3f222c7333d39fc5452b37aebc14fa09ff8d5e) )
MEGADRIVE_ROM_LOAD( cutthr,    "cutthroat island (euro, usa).bin",                                                       0x000000, 0x200000,  CRC(ebabbc70) SHA1(1b1648e02bb2e915286c35f01476358a8401608f) )
MEGADRIVE_ROM_LOAD( cvania,    "castlevania - the new generation (euro).bin",                                            0x000000, 0x100000,  CRC(4dd4e4a5) SHA1(61aabb1053f090fb6c13968c86170357c5df4eba) )
MEGADRIVE_ROM_LOAD( cvaniab,   "castlevania - the new generation (euro) (beta).bin",                                     0x000000, 0x100000,  CRC(84cd103a) SHA1(8c4004c0d8cbe211ffa3919fd609653221a0078b) )
...
MEGADRIVE_ROM_LOAD( daffy,     "daffy duck in hollywood (euro).bin",                                                     0x000000, 0x200000,  CRC(1fdc66b0) SHA1(67cc61b724d4ccb94dc2b59cc8ea1b0eb9a8cf4e) )
MEGADRIVE_ROM_LOAD( daffyb,    "daffy duck in hollywood (euro) (beta).bin",                                              0x000000, 0x200000,  CRC(0eaa4740) SHA1(7d869208846ce10ccf799c581cb09034c81aa3e5) )
MEGADRIVE_ROM_LOAD( dahnam,    "dahna megami tanjou (jpn).bin",                                                          0x000000, 0x100000,  CRC(4602584f) SHA1(da0246a063e6f70933e251b9ae84587fe620d4f0) )
MEGADRIVE_ROM_LOAD( dahnamk,   "mpr-14636.bin",                                                                          0x000000, 0x100000,  CRC(10829ea1) SHA1(655486eaf3b197063902224a8f1cc15b664f7637) )
MEGADRIVE_ROM_LOAD( daik,      "daikoukai jidai (jpn).bin",                                                              0x000000, 0x100000,  CRC(5a652458) SHA1(a4552b23079b161da9ad47ac7cb9c4ecb3731967) )
MEGADRIVE_ROM_LOAD( daik2,     "daikoukai jidai ii (jpn).bin",                                                           0x000000, 0x200000,  CRC(e040f0da) SHA1(74f61092067d82127cae3306d5a66d3efe946bc3) )
MEGADRIVE_ROM_LOAD( daimakai,  "dai makaimura (jpn).bin",                                                                0x000000, 0xa0000,   CRC(5659f379) SHA1(a08a5764dc8651d31ef72466028cfb87fb6dd166) )
MEGADRIVE_ROM_LOAD( danger,    "dangerous seed (jpn).bin",                                                               0x000000, 0x80000,   CRC(a2990031) SHA1(32b2b1de0947fb713787020679efacffd29ec04e) )
MEGADRIVE_ROM_LOAD( darius2,   "darius ii (jpn).bin",                                                                    0x000000, 0x100000,  CRC(25dfe62a) SHA1(93593e4014e13db90fedc1903a402c6f7d885a2f) )
MEGADRIVE_ROM_LOAD( darkcast,  "dark castle (euro, usa).bin",                                                            0x000000, 0x80000,   CRC(0464aca4) SHA1(23e1ad9822338362113e55087d60fb9a1674bf8a) )
MEGADRIVE_ROM_LOAD( darwin,    "darwin 4081 (jpn, kor).bin",                                                             0x000000, 0x80000,   CRC(7a33b0cb) SHA1(e9decc48451aba62d949a7710e466e1d041a2210) )
...
MEGADRIVE_ROM_LOAD( daze,      "daze before christmas (aus).bin",                                                        0x000000, 0x200000,  CRC(b95e25c9) SHA1(240c0d9487d7659a4b2999e0394d552ab17bee8a) )
MEGADRIVE_ROM_LOAD( dazeb,     "daze before christmas (aus) (beta).bin",                                                 0x000000, 0x200000,  CRC(317c9491) SHA1(a63cdb54c31b1c1219467987a81e761ee92feee3) )
MEGADRIVE_ROM_LOAD( dbz,       "dragon ball z - buyuu retsuden (jpn).bin",                                               0x000000, 0x200000,  CRC(af8f3371) SHA1(dc6336dfbbe76c24ada735009d0d667ce27843f6) )
...
MEGADRIVE_ROM_LOAD( dcup,      "davis cup world tour (euro, usa) (july 1993).bin",                                       0x000000, 0x100000,  CRC(894686f0) SHA1(735cf7c84869bfa795114f5eff835a74252a4adc) )
...
MEGADRIVE_ROM_LOAD( dcupa,     "davis cup world tour (euro, usa) (june 1993).bin",                                       0x000000, 0x100000,  CRC(7c6b0646) SHA1(bce5937d930e016bb14eca80c833071df4bdc0f8) )
MEGADRIVE_ROM_LOAD( ddragon,   "double dragon (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(054f5d53) SHA1(f054fb2c16a78ce5f5ce20a36bf0f2634f169969) )
MEGADRIVE_ROM_LOAD( ddragon2,  "double dragon ii - the revenge (jpn).bin",                                               0x000000, 0x80000,   CRC(a8bfdbd6) SHA1(68dc151ada307ed0ed34f98873e0be5f65f1b573) )
MEGADRIVE_ROM_LOAD( ddragon3,  "double dragon 3 - the arcade game (euro, usa).bin",                                      0x000000, 0x100000,  CRC(b36ab75c) SHA1(663dfeebd21409942bcc446633b9b9f0dd238aa8) )
...
MEGADRIVE_ROM_LOAD( ddwares,   "dungeons & dragons - warriors of the eternal sun (euro, usa).bin",                       0x000000, 0x100000,  CRC(af4a9cd7) SHA1(9135f7fda03ef7da92dfade9c0df75808214f693) )
...
MEGADRIVE_ROM_LOAD( demoman,   "demolition man (euro, usa).bin",                                                         0x000000, 0x200000,  CRC(5ff71877) SHA1(40d71f6bd6cd44f8003bfaff8c953b0693ec1b01) )
MEGADRIVE_ROM_LOAD( demomanb,  "demolition man (usa) (beta).bin",                                                        0x000000, 0x200000,  CRC(57ffad7a) SHA1(33a33bff7277c2aab45d0d843d13728ce2c62ab2) )
MEGADRIVE_ROM_LOAD( desert,    "desert demolition starring road runner and wile e. coyote (euro, usa).bin",              0x000000, 0x100000,  CRC(c287343d) SHA1(afc95f7ce66e30abbe10f8d5cd6b791407c7a0bc) )
...
MEGADRIVE_ROM_LOAD( devilc,    "devil crash md (jpn).bin",                                                               0x000000, 0x80000,   CRC(4c4caad8) SHA1(58d447ecd6a6af9845cdd90ac3df0b5503535117) )
...
MEGADRIVE_ROM_LOAD( dfury,     "dragon's fury (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(58037bc6) SHA1(bcbafa6c4ab0b16ddb4f316a1ef8c0eecd0cd990) )
MEGADRIVE_ROM_LOAD( dhead,     "mpr-16990.bin",                                                                          0x000000, 0x200000,  CRC(3dfeeb77) SHA1(e843decdff262791b1237f1545f5b17c56712d5f) )
MEGADRIVE_ROM_LOAD( dheadj,    "dynamite headdy (jpn).bin",                                                              0x000000, 0x200000,  CRC(d03cdb53) SHA1(02727a217e654f3cdf5a3fcd33b2f38d404a467d) )
MEGADRIVE_ROM_LOAD( dheadpj,   "dynamite headdy (jpn) (beta).bin",                                                       0x000000, 0x200000,  CRC(5c25e934) SHA1(9889510234dd8771fd14c4022710028c5928d152) )
...
MEGADRIVE_ROM_LOAD( dialqo,    "dial q o mawase! (jpn) (unl).bin",                                                       0x000000, 0x100000,  CRC(c632e5af) SHA1(08967e04d992264f193ecdfd0e0457baaf25f4f2) )
...
MEGADRIVE_ROM_LOAD( dinodini,  "dino dini's soccer (euro).bin",                                                          0x000000, 0x100000,  CRC(4608f53a) SHA1(49d4a654dd2f393e43a363ed171e73cd4c8ff4f4) )
...
MEGADRIVE_ROM_LOAD( dinolandj, "chou touryuu retsuden - dino land (jpn).bin",                                            0x000000, 0x80000,   CRC(81f939de) SHA1(4bee752cd2205d60b9d3c7a58e0e90a4837522de) )
...
MEGADRIVE_ROM_LOAD( disncoll,  "disney collection, the (euro).bin",                                                      0x000000, 0x100000,  CRC(adfde883) SHA1(991e22d7f258cba94306d16d5dd37172a34da9d3) )
MEGADRIVE_ROM_LOAD( divine,    "divine sealing (jpn) (unl).bin",                                                         0x000000, 0x100000,  CRC(ca72973c) SHA1(29cc95622a1c9602e7981bdc5a66164c47939028) )
MEGADRIVE_ROM_LOAD( djboy,     "mpr-14560.bin",                                                                          0x000000, 0x80000,   CRC(860e749a) SHA1(d2f111c240d0165a231c236e9ae6e62e73ca9caa) )
MEGADRIVE_ROM_LOAD( djboyj,    "dj boy (jpn).bin",                                                                       0x000000, 0x80000,   CRC(202abaa8) SHA1(c66b2e00b8a9172a76f5e699730c7d88740b5dd7) )
MEGADRIVE_ROM_LOAD( djboyu,    "dj boy (usa).bin",                                                                       0x000000, 0x80000,   CRC(dc9f02db) SHA1(981f0eeffa28210cc55702413305244aaf36d71c) )
MEGADRIVE_ROM_LOAD( doki,      "ikazuse! koi no doki doki penguin land md (jpn) (sn).bin",                               0x000000, 0x40000,   CRC(0053bfd6) SHA1(37bc8429a6259582b840e219a2cf412cea5fc873) )
MEGADRIVE_ROM_LOAD( dokignk,   "ikazuse! koi no doki doki penguin land md (jpn) (gnk).bin",                              0x000000, 0x40000,   CRC(22736650) SHA1(e64e4c127158db366e95e8c3cc6b4d5906ad78ec) )
MEGADRIVE_ROM_LOAD( domino,    "domino (unl).bin",                                                                       0x000000, 0x100000,  CRC(a64409be) SHA1(7000ea86d91bbb5642425b6a6f577fab9e2b3a51) )
...
MEGADRIVE_ROM_LOAD( dongguri,  "dong gu ri te chi jak jeon (kor).bin",                                                   0x000000, 0x100000,  CRC(e32f0b1c) SHA1(a698c4eda62032d1f98b3e4f824b6475c2612859) )
...
MEGADRIVE_ROM_LOAD( doraemon,  "doraemon - yume dorobou to 7-nin no gozans (jpn).bin",                                   0x000000, 0x80000,   CRC(eeed1130) SHA1(aa92c04afd6b1916fcc6c64285d8dffe0b2b895f) )
MEGADRIVE_ROM_LOAD( doublecl,  "double clutch (euro).bin",                                                               0x000000, 0x40000,   CRC(d98c623c) SHA1(e19905cfcf74185e56fa94ae292f78451c8f4e2e) )
MEGADRIVE_ROM_LOAD( dragon,    "dragon - the bruce lee story (euro).bin",                                                0x000000, 0x200000,  CRC(fdeed51d) SHA1(d6fb86d73e1abc7b7f1aecf77a52fa3f759aedb1) )
...
MEGADRIVE_ROM_LOAD( dragrev,   "dragon's revenge (euro, usa).bin",                                                       0x000000, 0x100000,  CRC(841edbc0) SHA1(75854a732d4cf9a310c4359092cf5c2482df49a7) )
MEGADRIVE_ROM_LOAD( draxos,    "jashin draxos (jpn, kor).bin",                                                           0x000000, 0x100000,  CRC(1ea07af2) SHA1(9652b8ed0e36ee17ef6c0b007ca3ad237c13a7a0) )
MEGADRIVE_ROM_LOAD( dreamteam, "dream team usa (jpn).bin",                                                               0x000000, 0x100000,  CRC(e2e21b72) SHA1(48b36852b31f74d33e00b33df04ae1e9e9b0cb1c) )
MEGADRIVE_ROM_LOAD( drrobotn,  "dr. robotnik's mean bean machine (euro).bin",                                            0x000000, 0x100000,  CRC(70680706) SHA1(8cdaca024585aab557e9a09732a298e5112ee15b) )
...
MEGADRIVE_ROM_LOAD( drscj,     "david robinson basketball (jpn).bin",                                                    0x000000, 0x80000,   CRC(56164b00) SHA1(eeac902df31240c246afe2b97a5b25104dd9f0e5) )
MEGADRIVE_ROM_LOAD( dslayer,   "dragon slayer - eiyuu densetsu (jpn).bin",                                               0x000000, 0x200000,  CRC(01bc1604) SHA1(f67c9139bbc93f171e274a5cd3fba66480cd8244) )
MEGADRIVE_ROM_LOAD( dslayer2,  "dragon slayer - eiyuu densetsu ii (jpn).bin",                                            0x000000, 0x200000,  CRC(46924dc3) SHA1(79b6201301acb5d9e9c56dcf65a9bcf9d9a931ab) )
MEGADRIVE_ROM_LOAD( dstrike,   "desert strike (euro, usa).bin",                                                          0x000000, 0x100000,  CRC(67a9860b) SHA1(d7e7d8c358eb845b84fb08f904cc0b95d0a4053d) )
MEGADRIVE_ROM_LOAD( dstrikej,  "desert strike (jpn, kor).bin",                                                           0x000000, 0x100000,  CRC(1e740145) SHA1(9e01c6c45670e2950242facfba6c5b79052550ed) )
MEGADRIVE_ROM_LOAD( dukenu3d,  "duke nukem 3d (bra).bin",                                                                0x000000, 0x400000,  CRC(6bd2accb) SHA1(a4663f2b96787a92db604a92491fa27e2b5ced9e) )
MEGADRIVE_ROM_LOAD( dune2,     "dune ii - battle for arrakis (euro).bin",                                                0x000000, 0x100000,  CRC(b58ae71d) SHA1(133cc86b43afe133fc9c9142b448340c17fa668e) )
...
MEGADRIVE_ROM_LOAD( duneu,     "dune - the battle for arrakis (usa).bin",                                                0x000000, 0x100000,  CRC(4dea40ba) SHA1(0f7c1c130cb39abc97f57545933e1ef6c481783d) )
MEGADRIVE_ROM_LOAD( dynabr,    "dyna brothers (jpn).bin",                                                                0x000000, 0x100000,  CRC(360c1b20) SHA1(7e57c6fd5c20e356f9c967dbf168db53574eda84) )
MEGADRIVE_ROM_LOAD( dynabr2,   "dyna brothers 2 (jpn).bin",                                                              0x000000, 0x200000,  CRC(47e0a64e) SHA1(0d6c3d9eb0cb9a56ab91b7507b09473b078e773c) )
...
MEGADRIVE_ROM_LOAD( eahockey,  "ea hockey (euro).bin",                                                                   0x000000, 0x80000,   CRC(9bfc279c) SHA1(118419e596bf07047a18d1828290019fbc4afc45) )
MEGADRIVE_ROM_LOAD( eahockeyj, "ea hockey (jpn).bin",                                                                    0x000000, 0x80000,   CRC(9dcdc894) SHA1(40166e9c2b40f35ba7d7cf5d07865c824c323757) )
...
MEGADRIVE_ROM_LOAD( ecco2,     "ecco - the tides of time (euro).bin",                                                    0x000000, 0x200000,  CRC(7b1bf89c) SHA1(cb7d44a40992cff6c31d685866814d6cb85add59) )
MEGADRIVE_ROM_LOAD( ecco2p,    "ecco - the tides of time (beta).bin",                                                    0x000000, 0x200000,  CRC(8db60749) SHA1(3120625e8ff6b289ae6c398b8afe1ab5ff6396e3) )
MEGADRIVE_ROM_LOAD( ecco2p1,   "ecco - the tides of time (beta).bin",                                                    0x000000, 0x200000,  CRC(1d1470ea) SHA1(364523cd30615ce4a94793ebbc189c0db6adc38f) )
MEGADRIVE_ROM_LOAD( ecco2j,    "mpr-16996.bin",                                                                          0x000000, 0x200000,  CRC(062d439c) SHA1(0ca535d0e0d430c67e413ab904ef867516ce9fad) )
MEGADRIVE_ROM_LOAD( ecco2px11, "ecco - the tides of time (prototype x11 - apr 13, 1994).bin",                            0x000000, 0x200000,  CRC(b5d64817) SHA1(6cc1ea0b6c4be29ed7a02cd5e01f9504d272323e) )
...
MEGADRIVE_ROM_LOAD( eccojr,    "ecco jr. (usa, aus) (february 1995).bin",                                                0x000000, 0x100000,  CRC(6c6f4b89) SHA1(0b493ef23874f82606d4fd22c2380b289247aa9f) )
MEGADRIVE_ROM_LOAD( eccojr1,   "ecco jr. (usa, aus) (march 1995).bin",                                                   0x000000, 0x100000,  CRC(3c517975) SHA1(636d2fb5f865f916e4a9fe0ff1819fcbc61b4258) )
MEGADRIVE_ROM_LOAD( ejim,      "earthworm jim (euro).bin",                                                               0x000000, 0x300000,  CRC(1c07b337) SHA1(d5dc11009e3a5cc2381dd2a75cb81ce2e7428342) )
MEGADRIVE_ROM_LOAD( ejim2,     "earthworm jim 2 (euro).bin",                                                             0x000000, 0x300000,  CRC(af235fdf) SHA1(b8e93ea8b42c688a218b83797e4a18eda659f3e0) )
...
MEGADRIVE_ROM_LOAD( elemastj,  "elemental master (jpn).bin",                                                             0x000000, 0x80000,   CRC(5f553e29) SHA1(6cbe2cd607aa9850306970a8a61cb9fa82445293) )
MEGADRIVE_ROM_LOAD( elfwor,    "elf wor (china) (unl).bin",                                                              0x000000, 0x100000,  CRC(e24ac6b2) SHA1(5fc4591fbb1acc64e184466c7b6287c7f64e0b7a) )
MEGADRIVE_ROM_LOAD( elimin,    "eliminate down (jpn).bin",                                                               0x000000, 0x100000,  CRC(48467542) SHA1(53b418bde065011e161e703dd7c175aa48a04fe5) )
...
MEGADRIVE_ROM_LOAD( elvientj,  "el viento (jpn).bin",                                                                    0x000000, 0x100000,  CRC(6091c36e) SHA1(564ffd2a40b9bebe30587182a644050de474aa5a) )
MEGADRIVE_ROM_LOAD( empire,    "empire of steel (euro).bin",                                                             0x000000, 0x100000,  CRC(e5517b77) SHA1(00109e6de5b823525b3ba519222fecc4e229f6d1) )
...
MEGADRIVE_ROM_LOAD( espnhnb,   "espn national hockey night (usa) (beta).bin",                                            0x000000, 0x200000,  CRC(a427814a) SHA1(c890fc232ca46a9499bb4e3107a519ae2d8edb81) )
...
MEGADRIVE_ROM_LOAD( eswat,     "eswat - city under siege (usa).bin",                                                     0x000000, 0x80000,   CRC(e72f8a36) SHA1(5cb96061bd2b00c82f8d6b46ab9802e2b1820c86) )
MEGADRIVE_ROM_LOAD( eswatj,    "mpr-13192.bin",                                                                          0x000000, 0x80000,   CRC(87b636a2) SHA1(353f7d136a2c464ee976402b4620b0a42b8b7267) )
MEGADRIVE_ROM_LOAD( eternalc,  "mpr-16212+mpr-16213.bin",                                                                0x000000, 0x300000,  CRC(b9512f5e) SHA1(578475a736bef8c76ba158110cebadf495c2f252) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( eternalcb, "eternal champions (euro) (beta).bin",                                                    0x000000, 0x300000,  CRC(e0665f06) SHA1(c06f2d9ff29b6e6ec2dbec06eab2eac21e80e423) )
MEGADRIVE_ROM_LOAD( eternalcj, "eternal champions (jpn, kor).bin",                                                       0x000000, 0x300000,  CRC(66aa3c64) SHA1(1b115e64e138ca045acfe64e2337fc68172be576) )
MEGADRIVE_ROM_LOAD( eternalcp, "eternal champions (jpn) (prototype - nov 17, 1993).bin",                                 0x000000, 0x2ff4b0,  CRC(c486b439) SHA1(ba82947bef2c42021cc35512c21d91430c6fc55c) )
...
MEGADRIVE_ROM_LOAD( europa,    "europa sensen (jpn).bin",                                                                0x000000, 0x100000,  CRC(b0416c60) SHA1(d382f977ea3071f133a947ceb3528904e72f9bc9) )
MEGADRIVE_ROM_LOAD( europecs,  "mpr-14776.bin",                                                                          0x000000, 0x80000,   CRC(6a5cf104) SHA1(03e1a6c7fb8003e196c0f0bf787276a14daa313e) )
MEGADRIVE_ROM_LOAD( evander,   "mpr-14860.bin",                                                                          0x000000, 0x80000,   CRC(4fef37c8) SHA1(eb4aca22f8b5837a0a0b10491c46714948b09844) )
MEGADRIVE_ROM_LOAD( exile,     "exile (usa).bin",                                                                        0x000000, 0x100000,  CRC(1b569dc2) SHA1(28377e9a68c2dcdfdb4133c2eb0b634aec552958) )
MEGADRIVE_ROM_LOAD( exilej,    "exile - toki no hazama e (jpn).bin",                                                     0x000000, 0x100000,  CRC(880bf311) SHA1(14ef77cbf6c023365e168f54456d5486679292ef) )
MEGADRIVE_ROM_LOAD( exmutant,  "ex-mutants (euro, usa).bin",                                                             0x000000, 0x100000,  CRC(33b1979f) SHA1(20b282ff8220291d98853888cfe504692c04e654) )
MEGADRIVE_ROM_LOAD( exodus,    "exodus - journey to the promised land (usa) (unl).bin",                                  0x000000, 0x80000,   CRC(22e6fc04) SHA1(a85fb15d29dc43d3bf4a06de83506c77aba8a7d5) )
MEGADRIVE_ROM_LOAD( exosq,     "exo squad (euro).bin",                                                                   0x000000, 0x100000,  CRC(b599b9f9) SHA1(672c12b9cdfb2c7d8e0b1c389627c02a7c970cb3) )
MEGADRIVE_ROM_LOAD( exosqu,    "exo squad (usa).bin",                                                                    0x000000, 0x100000,  CRC(10ec03f3) SHA1(d958c3f2365162cb2ffa37fcea36695a1d4ab287) )
MEGADRIVE_ROM_LOAD( exosqub,   "exo squad (usa) (beta).bin",                                                             0x000000, 0x100000,  CRC(70edf964) SHA1(d165e0057a5d290ae02ff6cae9f99c2ebc8a3f7c) )
MEGADRIVE_ROM_LOAD( exranza,   "mpr-15585.bin",                                                                          0x000000, 0x100000,  CRC(349bb68d) SHA1(0006f55e826148cff9e717b582a39a04adf100df) )
MEGADRIVE_ROM_LOAD( exranzab,  "ex-ranza (jpn) (beta).bin",                                                              0x000000, 0x100000,  CRC(c642fdf4) SHA1(f1c883f3bc6343c8a8181261ead3a534520a447f) )
MEGADRIVE_ROM_LOAD( f1,        "mpr-15834.bin",                                                                          0x000000, 0x100000,  CRC(fbdd4520) SHA1(a8327157f6537f4cd5daaff648864e8e0bf945f1) )
MEGADRIVE_ROM_LOAD( f117,      "f-117 night storm (euro, usa).bin",                                                      0x000000, 0x200000,  CRC(1bf67a07) SHA1(906c7ac3ea3c460e9093d5082c68e35f1bb1bb0e) )
MEGADRIVE_ROM_LOAD( f117j,     "f-117 stealth - operation night storm (jpn).bin",                                        0x000000, 0x200000,  CRC(ea6e421a) SHA1(ded62d63676664c5b9e8a38e36ce1d2659d1c8d6) )
MEGADRIVE_ROM_LOAD( f15str,    "f-15 strike eagle ii (euro).bin",                                                        0x000000, 0x100000,  CRC(e98ee370) SHA1(190508c5fe65c47f289d85768f7d79b1a235f3d5) )
MEGADRIVE_ROM_LOAD( f15stru,   "f-15 strike eagle ii (usa).bin",                                                         0x000000, 0x100000,  CRC(412c4d60) SHA1(d5f0d3d3b9cb7557d85bd54465072555f60c25a1) )
MEGADRIVE_ROM_LOAD( f15strub,  "f-15 strike eagle ii (usa) (beta).bin",                                                  0x000000, 0x100000,  CRC(fd4f5a01) SHA1(2ee364462f3206d220bbcebe50ca35e039967cf2) )
MEGADRIVE_ROM_LOAD( f1circus,  "f1 circus md (jpn).bin",                                                                 0x000000, 0x80000,   CRC(5d30befb) SHA1(2efb8d46163e785a57421e726991328024ecd2a7) )
MEGADRIVE_ROM_LOAD( f1wc,      "f1 - world championship edition (euro).bin",                                             0x000000, 0x200000,  CRC(74cee0a7) SHA1(c50f66c7a220c58ae29a4610faa9ea6e39a54dfe) )
MEGADRIVE_ROM_LOAD( f1wcb,     "f1 - world championship edition (euro) (beta).bin",                                      0x000000, 0x200000,  CRC(2269ed6b) SHA1(6b9984e92eee0044ac245ea534ed667425747e7b) )
MEGADRIVE_ROM_LOAD( f22,       "f-22 interceptor (euro, usa) (june 1992).bin",                                           0x000000, 0xc0000,   CRC(dd19b2b3) SHA1(32a479ed7571c5f99b2181829afc517370e3051a) ) // this needs a proper dump like the September 1991 revision
MEGADRIVE_ROM_LOAD( f22b,      "f-22 interceptor (euro, usa) (beta).bin",                                                0x000000, 0xc0000,   CRC(d6a880a4) SHA1(f104e6fab831fb482b0426bae98f04a65a05f392) )
MEGADRIVE_ROM_LOAD( f22j,      "f-22 interceptor (jpn).bin",                                                             0x000000, 0xc0000,   CRC(fb55c785) SHA1(a6d0cf179d40ab7844d2a9f8a412a320a0639eec) ) // this Japanese F22 release doesn't seem to suffer the same dumping problems of the September 1991 revision
MEGADRIVE_ROM_LOAD( faerytal,  "faery tale adventure, the (euro, usa).bin",                                              0x000000, 0x80000,   CRC(963f4969) SHA1(5d9a448d741743c7e75e5fe462e0da0ea3d18a13) )
MEGADRIVE_ROM_LOAD( famfeud,   "family feud (usa).bin",                                                                  0x000000, 0x80000,   CRC(1aa628b0) SHA1(8277f86faf6968e277638ab6dfa410a5b3daf5b6) )
...
MEGADRIVE_ROM_LOAD( fantdz,    "fantastic dizzy (euro, usa).bin",                                                        0x000000, 0x80000,   CRC(46447e7a) SHA1(b320174d3b43f30b477818a27b4da30462a52003) )
MEGADRIVE_ROM_LOAD( fantdz1,   "fantastic dizzy (euro, usa) (alt).bin",                                                  0x000000, 0x80000,   CRC(86b2a235) SHA1(ddda3664e0e7e2999815cce50e3c02170a8fec52) )
MEGADRIVE_ROM_LOAD( fastest1,  "fastest 1 (jpn).bin",                                                                    0x000000, 0x80000,   CRC(bb43f0de) SHA1(837a19b4b821076f1cd01d53d90b4553a0252340) )
MEGADRIVE_ROM_LOAD( fatalf,    "fatal fury (euro, kor).bin",                                                             0x000000, 0x180000,  CRC(2e730a91) SHA1(e0a74238cd4592d900f88d033314c668d1522b72) )
MEGADRIVE_ROM_LOAD( fatalf2,   "fatal fury 2 (usa, kor).bin",                                                            0x000000, 0x300000,  CRC(1b1754cb) SHA1(52a269de38ed43ea5c6623906af6b64f01696ffb) )
...
MEGADRIVE_ROM_LOAD( fatalrew,  "fatal rewind (euro, usa).bin",                                                           0x000000, 0x80000,   CRC(e91aed05) SHA1(02634d919ec7d08f3c6833f229b5127dd52c9e8a) )
MEGADRIVE_ROM_LOAD( fatlab,    "fatal labyrinth (euro, usa).bin",                                                        0x000000, 0x20000,   CRC(5f0bd984) SHA1(c136cb3fae1914a8fe079eb28c4533af5d8774e2) )
MEGADRIVE_ROM_LOAD( fatman,    "fatman (jpn).bin",                                                                       0x000000, 0xa0000,   CRC(7867da3a) SHA1(9c2791e44f1ff236cbab742c2942defc7b378e2c) )
MEGADRIVE_ROM_LOAD( fengku,    "feng kuang tao hua yuan (china) (unl).bin",                                              0x000000, 0x100000,  CRC(8d40d64f) SHA1(0330611a5fcb1f3ca173fcb3387fd35b865f1131) )
MEGADRIVE_ROM_LOAD( fengsh,    "feng shen ying jie chuan (china) (unl).bin",                                             0x000000, 0x200000,  CRC(6a382b60) SHA1(7a6e06846a94df2df2417d6509e398c29354dc68) )
MEGADRIVE_ROM_LOAD( ferias,    "ferias frustradas do pica-pau (bra).bin",                                                0x000000, 0x100000,  CRC(7b2e416d) SHA1(ec546d1c00c88554b5e9135f097cb1c388cfd68f) )
MEGADRIVE_ROM_LOAD( ferrari,   "mpr-14770a.bin",                                                                         0x000000, 0x100000,  CRC(250111df) SHA1(0e33965994a6f53aca93c3cb164726b913789fc1) )
MEGADRIVE_ROM_LOAD( ferrarib,  "ferrari grand prix challenge (beta).bin",                                                0x000000, 0x100000,  CRC(d48d02d4) SHA1(133e362ab58a309d5b77fa0544423591cc535ec9) )
MEGADRIVE_ROM_LOAD( ferrariu,  "ferrari grand prix challenge (usa).bin",                                                 0x000000, 0x100000,  CRC(f73f6bec) SHA1(bd08e2e0857c7b385c15d96e555f25d12457c917) )
MEGADRIVE_ROM_LOAD( feverp,    "fever pitch soccer (euro).bin",                                                          0x000000, 0x200000,  CRC(fac29677) SHA1(e3489b80a4b21049170fedee7630111773fe592c) )
...
MEGADRIVE_ROM_LOAD( fifa2k,    "fifa soccer 2000 gold edition (pirate) (unl).bin",                                       0x000000, 0x200000,  CRC(647df504) SHA1(ed29312dbd9574514c06e5701e24c6474ed84898) )
...
MEGADRIVE_ROM_LOAD( fifa98,    "fifa 98 - road to world cup (euro).bin",                                                 0x000000, 0x200000,  CRC(96947f57) SHA1(6613f13da5494aaaba3222ed5e730ec9ce3c09a7) )
MEGADRIVE_ROM_LOAD( fifa99,    "fifa soccer 99 (pirate) (unl).bin",                                                      0x000000, 0x200000,  CRC(c5c5a4b0) SHA1(2c8c1dc0aaa711e3ab3fe0d74b79184f33127350) )
...
MEGADRIVE_ROM_LOAD( fightmj,   "fighting masters (jpn, kor).bin",                                                        0x000000, 0x80000,   CRC(39be80ec) SHA1(f944a8314d615ef58f0207e5760767fb417cbeb9) )
MEGADRIVE_ROM_LOAD( finalb,    "final blow (jpn).bin",                                                                   0x000000, 0x80000,   CRC(48ad505d) SHA1(610c3136e6ddccc41ab216affd07034fa46341a8) )
MEGADRIVE_ROM_LOAD( finalz,    "final zone -- fz senki axis (usa, jpn).bin",                                             0x000000, 0x80000,   CRC(731fa4a1) SHA1(e891e5c89fa13e3f9813d5a45feeed0cb7710acb) )
MEGADRIVE_ROM_LOAD( firemust,  "fire mustang (jpn).bin",                                                                 0x000000, 0x80000,   CRC(eb7e36c3) SHA1(6daa07738b8f62659f2a3be01d3adc8557b879c5) )
...
MEGADRIVE_ROM_LOAD( flashbj,   "flashback (jpn).bin",                                                                    0x000000, 0x180000,  CRC(b790e3b4) SHA1(5082180974a125b5f9c01c96410c0fdbfb707d2b) )
...
MEGADRIVE_ROM_LOAD( flicky,    "flicky (euro, usa).bin",                                                                 0x000000, 0x20000,   CRC(4291c8ab) SHA1(83d8bbf0a9b38c42a0bf492d105cc3abe9644a96) )
MEGADRIVE_ROM_LOAD( flink,     "flink (euro).bin",                                                                       0x000000, 0x100000,  CRC(bef9a4f4) SHA1(f37518380d3e41598cbff16519ca15fcb751de57) )
MEGADRIVE_ROM_LOAD( flint, "flintstones, the (euro).bin",                                                                0x000000, 0x80000,   CRC(21845d61) SHA1(6350da9fa81a84a7a73d0238be135b1331147599) )
MEGADRIVE_ROM_LOAD( flintj, "flintstone (jpn).bin",                                                                      0x000000, 0x80000,   CRC(920a3031) SHA1(a3dc66bb5b35916a188b2ef4b6b783f3c5ffc03c) )
...
MEGADRIVE_ROM_LOAD( flux, "flux (euro).bin",                                                                             0x000000, 0x40000,   CRC(2a1da08c) SHA1(6357f38db012278bc889c77c5780a82d535760fd) )
...
MEGADRIVE_ROM_LOAD( forgottn, "forgotten worlds (world) (v1.1).bin",                                                     0x000000, 0x80000,   CRC(95513985) SHA1(79aadecc1069f47a2a8b4a0a1d55712d4f9cb8ef) )
MEGADRIVE_ROM_LOAD( forgottn1, "mpr-12672.bin",                                                                          0x000000, 0x80000,   CRC(d0ee6434) SHA1(8b9a37c206c332ef23dc71f09ec40e1a92b1f83a) )
...
MEGADRIVE_ROM_LOAD( franken, "mary shelley's frankenstein (usa).bin",                                                    0x000000, 0x200000,  CRC(48993dc3) SHA1(2dd34478495a2988fe5839ef7281499f08bf7294) )
MEGADRIVE_ROM_LOAD( frankt, "frank thomas big hurt baseball (euro, usa).bin",                                            0x000000, 0x400000,  CRC(863e0950) SHA1(9c978aaab10e16be59558561b07a0c610c74b43e) )
...
MEGADRIVE_ROM_LOAD( funnga, "fun 'n' games (euro).bin",                                                                  0x000000, 0x100000,  CRC(da4ab3cd) SHA1(3677dfe5450c0800d29cfff31f226389696bfb32) )
...
MEGADRIVE_ROM_LOAD( futbol, "futbol argentino 98 - pasion de multitudes (unl).bin",                                      0x000000, 0x200000,  CRC(5c015888) SHA1(44adb1cf6c1ce6e53314dc336168c5cf3313a739) )
...
MEGADRIVE_ROM_LOAD( gaiares, "gaiares (usa, jpn).bin",                                                                   0x000000, 0x100000,  CRC(5d8bf68b) SHA1(f62e8be872dc116c4cc331c50ae63a63f013eb58) )
...
MEGADRIVE_ROM_LOAD( gamblerj, "gambler jiko chuushinha - katayama masayuki no mahjong doujou (jpn).bin",                 0x000000, 0x80000,   CRC(05650b7a) SHA1(42814f8921f42c023c1fff433a2e9399aaff5d2e) )
MEGADRIVE_ROM_LOAD( gamenko, "game no kandume otokuyou (jpn).bin",                                                       0x000000, 0x300000,  CRC(cdad7e6b) SHA1(31c66bd13abf4ae8271c09ec5286a0ee0289dbbc) ) // apparently a rip from Dream Passport 3 for Dreamcast, further info needed
MEGADRIVE_ROM_LOAD( gameto, "mpr-12750a.bin",                                                                            0x000000, 0x20000,   CRC(c185c819) SHA1(9673b519c16883c146924c347ec6764281fa3a57) )
MEGADRIVE_ROM_LOAD( garfield, "garfield - caught in the act (euro, usa).bin",                                            0x000000, 0x200000,  CRC(f0ff078e) SHA1(9fff7dea16c4d0e6c9d6dbaade20c7048bb485ec) )
...
MEGADRIVE_ROM_LOAD( garoud, "garou densetsu - shukumei no tatakai (jpn).bin",                                            0x000000, 0x180000,  CRC(bf3e3fa4) SHA1(b9eb37dbc77d0c6919ad78e587fa4c3403e9e9af) )
MEGADRIVE_ROM_LOAD( garoud2, "mpr-16704+mpr-16710.bin",                                                                  0x000000, 0x300000,  CRC(2af4427f) SHA1(08eadaf6177d884b8e1fb66c5949850f10c5d77c) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( gaunt, "gauntlet iv (euro, usa) (september 1993).bin",                                               0x000000, 0x100000,  CRC(f9d60510) SHA1(d28e22207121f0e2980dd409b4fb24f9fb8967ae) )
MEGADRIVE_ROM_LOAD( gaunt1, "gauntlet iv (euro, usa) (august 1993).bin",                                                 0x000000, 0x100000,  CRC(3bf46dce) SHA1(26c26ee2bb9571d51537d9328a5fd2a91b4e9dc1) )
MEGADRIVE_ROM_LOAD( gauntj, "gauntlet (jpn).bin",                                                                        0x000000, 0x100000,  CRC(f9872055) SHA1(30208982dd1f50634943d894e7458a556127f8e4) )
...
MEGADRIVE_ROM_LOAD( gaxe3, "golden axe iii (jpn).bin",                                                                   0x000000, 0x100000,  CRC(c7862ea3) SHA1(cd9ecc1df4e01d69af9bebcf45bbd944f1b17f9f) )
...
MEGADRIVE_ROM_LOAD( genchaos, "general chaos (euro, usa).bin",                                                           0x000000, 0x100000,  CRC(f1ecc4df) SHA1(aea1dfa67b0e583a3d367a67499948998cb92f56) )
MEGADRIVE_ROM_LOAD( genchaosj, "general chaos daikonsen (jpn).bin",                                                      0x000000, 0x100000,  CRC(05cc7369) SHA1(9f205fc916df523ec84e0defbd0f1400a495cf8a) )
MEGADRIVE_ROM_LOAD( genelost, "generations lost (euro, usa).bin",                                                        0x000000, 0x100000,  CRC(131f36a6) SHA1(86af34198a8c67bd92fb03241d14861b2a9e270a) )
...
MEGADRIVE_ROM_LOAD( georgeko, "george foreman's ko boxing (euro).bin",                                                   0x000000, 0x100000,  CRC(bd556381) SHA1(c93298ee3ad6164ce497bd49d0ab6638854acb79) )
...
MEGADRIVE_ROM_LOAD( ghouls, "mpr-12605a+mpr-12606a.bin",                                                                 0x000000, 0xa0000,   CRC(4f2561d5) SHA1(aab6d20f01db51576b1d7cafab46e613dddf7f8a) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( ghouls1, "mpr-12605+mpr-12606.bin",                                                                  0x000000, 0xa0000,   CRC(d31bd910) SHA1(3a3e9eb5caaf6cfb75e99ed2843d58b3dda7284f) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( ghw, "mpr-16211.bin",                                                                                0x000000, 0x200000,  CRC(9778c181) SHA1(db28d70f9b744004cadd06eb77d6223534f59215) )
MEGADRIVE_ROM_LOAD( ghwj, "greatest heavyweights (jpn).bin",                                                             0x000000, 0x200000,  CRC(7ef8b162) SHA1(1d5fe812df75e0dc1ff379c563058e078b839a09) )
...
MEGADRIVE_ROM_LOAD( gleylanc, "advanced busterhawk gleylancer (jpn).bin",                                                0x000000, 0x100000,  CRC(42cf9b5b) SHA1(529d88f96eb7082bfbc00be3f42a1b2e365c34b7) )
...
MEGADRIVE_ROM_LOAD( gods, "gods (euro).bin",                                                                             0x000000, 0x100000,  CRC(6c415016) SHA1(404bc6e67cd4942615ccb7bd894d780278ec6da7) )
MEGADRIVE_ROM_LOAD( godsj, "gods (jpn).bin",                                                                             0x000000, 0x100000,  CRC(e4f50206) SHA1(804fd783c6fb7c226fbe4b227ed5c665d668ff57) )
...
MEGADRIVE_ROM_LOAD( gomora, "uchuu senkan gomora (jpn).bin",                                                             0x000000, 0x100000,  CRC(c511e8d2) SHA1(4e1d77cc1bf081e42abfd1c489fbd0073f0236af) )
...
MEGADRIVE_ROM_LOAD( gouket, "gouketsuji ichizoku (jpn).bin",                                                             0x000000, 0x300000,  CRC(abe9c415) SHA1(db6b2046e8b6373f141e8c5db68450f2db377dd8) )
MEGADRIVE_ROM_LOAD( granada, "granada (usa, jpn) (v1.1).bin",                                                            0x000000, 0x80000,   CRC(e89d1e66) SHA1(4eb8bbdb9ee8adcefaa202281cb88c19970437f7) )
MEGADRIVE_ROM_LOAD( granada1, "granada (usa, jpn).bin",                                                                  0x000000, 0x80000,   CRC(7f45719b) SHA1(6830d6ca1d7e2b220eb4431b42d33382e16e2791) )
MEGADRIVE_ROM_LOAD( grandsl, "mpr-15208.bin",                                                                            0x000000, 0x80000,   CRC(8c2670de) SHA1(4fd5ce8207c4568da07bb28c6ab38a23084c801a) )
MEGADRIVE_ROM_LOAD( grandslj, "grandslam - the tennis tournament '92 (jpn).bin",                                         0x000000, 0x80000,   CRC(30cf37d0) SHA1(f51c4332235a9545b86a7b121ba30644c33be098) )
MEGADRIVE_ROM_LOAD( greatc, "great circus mystery - mickey to minnie magical adventure 2 (jpn).bin",                     0x000000, 0x200000,  CRC(5aa0f3a0) SHA1(0341c231c268b61add922c5c3bf5ab2f9dfbf88f) )
...
MEGADRIVE_ROM_LOAD( grindst, "grind stormer (usa).bin",                                                                  0x000000, 0x100000,  CRC(7e6bef15) SHA1(8f93445e2d0b1798f680dda26a3d31f8aee88f01) )
MEGADRIVE_ROM_LOAD( growl, "growl (usa).bin",                                                                            0x000000, 0x80000,   CRC(f60ef143) SHA1(63a08057fe9fd489590f39c5c06709266f625ab0) )
MEGADRIVE_ROM_LOAD( gunship, "gunship (euro).bin",                                                                       0x000000, 0x100000,  CRC(da1440c9) SHA1(3820eac00b888b17c02f271fab5fd08af99d5ef9) )
MEGADRIVE_ROM_LOAD( gunstar, "gunstar heroes (euro).bin",                                                                0x000000, 0x100000,  CRC(866ed9d0) SHA1(a7b265f49ec74f7febb8463c64535ceda15c8398) )
MEGADRIVE_ROM_LOAD( gunstarj, "gunstar heroes (jpn).bin",                                                                0x000000, 0x100000,  CRC(1cfd0383) SHA1(64ae3ef9d063d21b290849809902c221f6ab10d5) )
MEGADRIVE_ROM_LOAD( gunstarjs, "gunstar heroes (jpn) (sample).bin",                                                      0x000000, 0x100000,  CRC(6f90b502) SHA1(a8d7f502d877b0ea3ff2431c94001e9d5dd84868) )
...
MEGADRIVE_ROM_LOAD( gynougj, "gynoug (jpn).bin",                                                                         0x000000, 0x80000,   CRC(1b69241f) SHA1(9b99b109f5f1f221f08672a7c4752a94067b62b0) )
...
MEGADRIVE_ROM_LOAD( hard94, "hardball '94 (euro, usa).bin",                                                              0x000000, 0x200000,  CRC(ea9c4878) SHA1(eceeecb3d520f9b350e41d0dd010abefbcfbbdab) )
...
MEGADRIVE_ROM_LOAD( haunting, "haunting starring polterguy (euro, usa).bin",                                             0x000000, 0x200000,  CRC(c9fc876d) SHA1(d6227ef00fdded9184676edf5dd2f6cae9b244a5) )
MEGADRIVE_ROM_LOAD( havoc, "capt'n havoc (euro).bin",                                                                    0x000000, 0x100000,  CRC(76e6d20d) SHA1(6e0344aace03b703cb05a9a0e10c47ebe404a247) )
MEGADRIVE_ROM_LOAD( havocu, "high seas havoc (usa).bin",                                                                 0x000000, 0x100000,  CRC(17be551c) SHA1(0dc1969098716ba332978b89356f62961417682b) )
...
MEGADRIVE_ROM_LOAD( heavyu, "heavy unit - mega drive special (jpn).bin",                                                 0x000000, 0x80000,   CRC(1acbe608) SHA1(198e243cc21e4aea97e2c6aca376cb2ae70bc1c9) )
MEGADRIVE_ROM_LOAD( heitao, "hei tao 2 - super big 2 (china) (unl).bin",                                                 0x000000, 0x100000,  CRC(31449113) SHA1(e1e4c439c5c22fa5cfcecaab421c55bf1746b5de) )
MEGADRIVE_ROM_LOAD( hellfire, "mpr-14430.bin",                                                                           0x000000, 0x80000,   CRC(cf30acec) SHA1(3cee325f4e8d12157b20c4ca7093bf806f5f9148) )
MEGADRIVE_ROM_LOAD( hellfirej, "hellfire (jpn).bin",                                                                     0x000000, 0x80000,   CRC(8e5e13ba) SHA1(17bbf3da65757cad3c7ff82c094e54cc68fd2f73) )
...
MEGADRIVE_ROM_LOAD( herc2, "hercules 2 (unl).bin",                                                                       0x000000, 0x200000,  CRC(292623db) SHA1(7104a37f588f291b85eb8f62685cb1111373572c) )
MEGADRIVE_ROM_LOAD( hercul, "hercules (unl).bin",                                                                        0x000000, 0x100000,  CRC(ff75d9d0) SHA1(6d89f589aeefaceda85a6f592d5d5b9062472b7a) )
MEGADRIVE_ROM_LOAD( herzog, "herzog zwei (euro, usa).bin",                                                               0x000000, 0x80000,   CRC(a605b65b) SHA1(8f7262102c2b2334f0bc88ee6fd6b08797919176) )
MEGADRIVE_ROM_LOAD( herzogj, "herzog zwei (jpn).bin",                                                                    0x000000, 0x80000,   CRC(4cf676b3) SHA1(851be7abad64a4fb05e4c51ce26fbe5efe12ea42) )
...
MEGADRIVE_ROM_LOAD( hokuto, "hokuto no ken - shin seikimatsu kyuuseishu densetsu (jpn).bin",                             0x000000, 0x80000,   CRC(1b6585e7) SHA1(7d489e1087a0816e2091261f6550f42a61474915) )
...
MEGADRIVE_ROM_LOAD( hook, "hook (usa).bin",                                                                              0x000000, 0x100000,  CRC(2c48e712) SHA1(67031af6ec4b771bd8d69a44c9945562a063593e) )
MEGADRIVE_ROM_LOAD( huamul, "hua mu lan - mulan (china) (unl).bin",                                                      0x000000, 0x200000,  CRC(796882b8) SHA1(d8936c1023db646e1e20f9208b68271afbd6dbf4) )
MEGADRIVE_ROM_LOAD( huanle, "huan le tao qi shu - smart mouse (china) (unl).bin",                                        0x000000, 0x80000,   CRC(decdf740) SHA1(df7a2527875317406b466175f0614d343dd32117) )
...
MEGADRIVE_ROM_LOAD( hurric, "hurricanes (euro).bin",                                                                     0x000000, 0x200000,  CRC(deccc874) SHA1(87ea7e663a0573f02440f9c5661b1df91b4d3ffb) )
MEGADRIVE_ROM_LOAD( hybridf, "hybrid front, the (jpn).bin",                                                              0x000000, 0x200000,  CRC(a1f1cfe7) SHA1(ed592c78ef60d91a6c5723d11cd553d3798524e1) )
MEGADRIVE_ROM_LOAD( hybridfb, "hybrid front, the (jpn) (beta).bin",                                                      0x000000, 0x300000,  CRC(04f02687) SHA1(b6e72b69a22869f966c52e7d58d146bc48b5eb84) )
MEGADRIVE_ROM_LOAD( hyokko, "hyokkori hyoutanjima - daitouryou o mezase! (jpn).bin",                                     0x000000, 0x80000,   CRC(72253bdb) SHA1(32a73559f84dbab5460bfd1e266acfc8f4391ae4) )
MEGADRIVE_ROM_LOAD( hyperd, "hyper dunk (euro).bin",                                                                     0x000000, 0x200000,  CRC(f27c576a) SHA1(91560ddf53f50bb5b9f4b48be906ce27e9c05742) )
MEGADRIVE_ROM_LOAD( hyperdj, "fz009a1.bin",                                                                              0x000000, 0x200000,  CRC(5baf53d7) SHA1(ef5c13926ee6eb32593b9e750ec342b98f48d1ef) )
MEGADRIVE_ROM_LOAD( hyperdjb, "hyper dunk - the playoff edition (jpn) (beta).in",                                        0x000000, 0x200000,  CRC(db124bbb) SHA1(87a2d58614fab2799e2a4456a08436fc7acc745b) )
MEGADRIVE_ROM_LOAD( hyperm, "hyper marbles (jpn) (sn).bin",                                                              0x000000, 0x40000,   CRC(83bb2799) SHA1(b2c5c78084b988de1873c89eedfa984124404c0c) )
MEGADRIVE_ROM_LOAD( hypermgnk, "hyper marbles (jpn) (gnk).bin",                                                          0x000000, 0x40000,   CRC(9ed72146) SHA1(d8dc95512aec41db7c758d4c971dc0194ddb960a) )
MEGADRIVE_ROM_LOAD( ichir, "puzzle & action - ichidanto-r (jpn).bin",                                                    0x000000, 0x200000,  CRC(7bdec762) SHA1(2e43ea1870dd3352e3c153373507554d97d51edf) )
MEGADRIVE_ROM_LOAD( imgint, "img international tour tennis (euro, usa).bin",                                             0x000000, 0x200000,  CRC(e04ffc2b) SHA1(1f1b410d17b39851785dee3eee332fff489db395) )
MEGADRIVE_ROM_LOAD( immortal, "immortal, the (euro, usa).bin",                                                           0x000000, 0x100000,  CRC(f653c508) SHA1(71fc189fe2ba5687e9d45b68830baed27194f627) )
MEGADRIVE_ROM_LOAD( immortalj, "wizard of the immortal (jpn).bin",                                                       0x000000, 0x200000,  CRC(c99fad92) SHA1(f36d088c37bbdcf473615b23e1cb21c0b70d8f05) )
...
MEGADRIVE_ROM_LOAD( incrhulk, "incredible hulk, the (euro, usa).bin",                                                    0x000000, 0x200000,  CRC(84a5a2dc) SHA1(41247e3166ec42b7cada33615da49e53d48fd809) )
...
MEGADRIVE_ROM_LOAD( insectxj, "insector x (jpn, kor).bin",                                                               0x000000, 0x80000,   CRC(9625c434) SHA1(204351b97aff579853cdba646b427ea299b1eddf) )
...
MEGADRIVE_ROM_LOAD( intrugby, "international rugby (euro).bin",                                                          0x000000, 0x80000,   CRC(d97d1699) SHA1(8cea50f668fbfba7dd10244a001172c1e648c352) )
MEGADRIVE_ROM_LOAD( iraqwar, "iraq war 2003 (unl).bin",                                                                  0x000000, 0x100000,  CRC(49dd6f52) SHA1(cc8b69debd68ba7c6d72d47d4c33530a1e7ef07c) )
MEGADRIVE_ROM_LOAD( ishido, "mb834200a.bin",                                                                             0x000000, 0x20000,   CRC(b1de7d5e) SHA1(3bd159e323d86e69031bf1ee9febeb6f9bb078d4) )
MEGADRIVE_ROM_LOAD( issdx, "international superstar soccer deluxe (euro).bin",                                           0x000000, 0x200000,  CRC(9bb3b180) SHA1(ccc60352b43f8c3d536267dd05a8f2c0f3b73df6) )
...
MEGADRIVE_ROM_LOAD( izzyqst, "izzy's quest for the olympic rings (euro, usa).bin",                                       0x000000, 0x200000,  CRC(77b416e4) SHA1(0f05e0c333d6ee58a254ee420a70d6020488ac54) )
MEGADRIVE_ROM_LOAD( jacknick, "jack nicklaus' power challenge golf (euro, usa).bin",                                     0x000000, 0x100000,  CRC(5545e909) SHA1(8d7edfe87da732ecd9820a6afbb9c5700cce43b2) )
...
MEGADRIVE_ROM_LOAD( janout, "janou touryuumon (jpn).bin",                                                                0x000000, 0x100000,  CRC(b5ef97c6) SHA1(4f307e0146e944fbbd4537f5cdc5da136204fc9b) )
MEGADRIVE_ROM_LOAD( jantei, "jantei monogatari (jpn).bin",                                                               0x000000, 0x100000,  CRC(8a1b19ad) SHA1(8e109961a89e1366c83808fb0bb33333f88a82b7) )
...
MEGADRIVE_ROM_LOAD( jellyboy, "jelly boy (euro) (prototype).bin",                                                        0x000000, 0x100000,  CRC(7cfadc16) SHA1(75be8d5b305e669848b4a5a48cdcfa43b951dc20) )
...
MEGADRIVE_ROM_LOAD( jewelmsj, "jewel master (jpn).bin",                                                                  0x000000, 0x80000,   CRC(2cf6926c) SHA1(52fbcf9902a4a3f70aeb9c3df31019e07e679ea8) )
MEGADRIVE_ROM_LOAD( jimmyw, "jimmy white's whirlwind snooker (euro).bin",                                                0x000000, 0x80000,   CRC(0aef5b1f) SHA1(040c810ccbe6310d369aa147471213d898ec2ad5) )
...
MEGADRIVE_ROM_LOAD( jiujim, "jiu ji ma jiang ii - ye yan bian (china) (unl).bin",                                        0x000000, 0x100000,  CRC(e9829b22) SHA1(c112602c58f9867377bb6a1204d1d7e49a50aa10) )
MEGADRIVE_ROM_LOAD( jlcs, "j. league champion soccer (jpn).bin",                                                         0x000000, 0x80000,   CRC(453c405e) SHA1(c28d8dac0f5582c3c2754342605764ee6e5b8af3) )
MEGADRIVE_ROM_LOAD( jlps, "j. league pro striker (jpn) (v1.3).bin",                                                      0x000000, 0x100000,  CRC(2d5b7a11) SHA1(1e437182fab2980156b101a53623c3c2f27c3a6c) )
MEGADRIVE_ROM_LOAD( jlps2, "mpr-16857.bin",                                                                              0x000000, 0x200000,  CRC(9fe71002) SHA1(924f1ae3d90bec7326a5531cd1d598cdeba30d36) )
MEGADRIVE_ROM_LOAD( jlpsa, "j. league pro striker (jpn) (v1.0).bin",                                                     0x000000, 0x100000,  CRC(ec229156) SHA1(d3dcc24e50373234988061d3ef56c16d28e580ad) )
MEGADRIVE_ROM_LOAD( jlpsfs, "j. league pro striker final stage (jpn).bin",                                               0x000000, 0x200000,  CRC(e35e25fb) SHA1(74e4a3ac4b93e25ace6ec8c3818e0df2390cffa2) )
MEGADRIVE_ROM_LOAD( jlpsp, "mpr-16267.bin",                                                                              0x000000, 0x100000,  CRC(0abed379) SHA1(7cfd8c9119d0565ee9a7708dc46bb34dd3258e37) )
MEGADRIVE_ROM_LOAD( joemac, "joe & mac (usa).bin",                                                                       0x000000, 0x100000,  CRC(85bcc1c7) SHA1(d238ecdbc76affb0b92946a1ee984399b6e8fe27) )
MEGADRIVE_ROM_LOAD( joemont, "mpr-13654.bin",                                                                            0x000000, 0x80000,   CRC(8aa6a1dd) SHA1(64b03ad0b17c022c831d057b9d6087c3b719147a) )
MEGADRIVE_ROM_LOAD( joemont2, "mpr-14356a.bin",                                                                          0x000000, 0x100000,  CRC(a45da893) SHA1(ce006ff3b9bcd71fef4591a63a80d887004abe77) )
MEGADRIVE_ROM_LOAD( joemont2a, "mpr-14356.bin",                                                                          0x000000, 0x100000,  CRC(f2363a4a) SHA1(3925623fafb79a7e8467e9b6fe70361c147cbfd3) )
MEGADRIVE_ROM_LOAD( jordanb, "jordan vs bird (euro, usa) (v1.1).bin",                                                    0x000000, 0x80000,   CRC(4d3ddd7c) SHA1(4c3c6696157a3629f10aa60626f504cd64c36a58) )
MEGADRIVE_ROM_LOAD( jordanb1, "jordan vs bird (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(22d77e6d) SHA1(977430962510867b16c113cff1436cb75c0485ac) )
MEGADRIVE_ROM_LOAD( jordanbj, "jordan vs bird - one on one (jpn).bin",                                                   0x000000, 0x80000,   CRC(8837e896) SHA1(769d7ed746ccbec0bcbe271f81767ffcccd36cea) )
MEGADRIVE_ROM_LOAD( joshua, "joshua & the battle of jericho (usa) (unl).bin",                                            0x000000, 0x40000,   CRC(da9e25aa) SHA1(a6c47babc7d84f8f411e77b9acdf01753d3a5951) )
MEGADRIVE_ROM_LOAD( jpond2j, "james pond ii - codename robocod (jpn, kor).bin",                                          0x000000, 0x80000,   CRC(98794702) SHA1(fa7d4e77fd98eb1fc9f8e1d66269bf86881c695d) )
MEGADRIVE_ROM_LOAD( jpond3, "james pond 3 - operation starfish (euro, usa).bin",                                         0x000000, 0x200000,  CRC(26f64b2a) SHA1(df7fca887e7988e24ab2d08b015c6db2902fe571) )
MEGADRIVE_ROM_LOAD( jpram, "jurassic park - rampage edition (euro, usa).bin",                                            0x000000, 0x200000,  CRC(98b4aa1b) SHA1(535c78d91f76302a882d69ff40b3d0f030a5b6ae) )
MEGADRIVE_ROM_LOAD( jprampa, "jurassic park - rampage edition (prototype - jul 08, 1994).bin",                           0x000000, 0x200000,  CRC(f4c78bd0) SHA1(7dca5ec1440222ce38f085663d0ab6539693feaa) )
MEGADRIVE_ROM_LOAD( jprampb, "jurassic park - rampage edition (prototype - jul 13, 1994).bin",                           0x000000, 0x200000,  CRC(8475a105) SHA1(b840cc1b00bf2f7e75320c1395da3dceaa637071) )
MEGADRIVE_ROM_LOAD( jprampc, "jurassic park - rampage edition (prototype - jul 14, 1994).bin",                           0x000000, 0x200000,  CRC(9bf0e28d) SHA1(534eea52e7c6d8d0fc0a93480c89f89568196d36) )
MEGADRIVE_ROM_LOAD( jprampd, "jurassic park - rampage edition (prototype - jul 15, 1994).bin",                           0x000000, 0x200000,  CRC(d2202be5) SHA1(b10fae841b410525ac83e729983f3e0cda2e7365) )
MEGADRIVE_ROM_LOAD( jprampe, "jurassic park - rampage edition (prototype - jul 17, 1994).bin",                           0x000000, 0x200000,  CRC(2eae6140) SHA1(2d817ad10e9b6b93b6eee23a76f788a73827bbc5) )
MEGADRIVE_ROM_LOAD( jprampf, "jurassic park - rampage edition (prototype - jul 18, 1994).bin",                           0x000000, 0x200000,  CRC(1a62b826) SHA1(cbb44d5d5da1263a4524c747be9afd0aa8547a63) )
MEGADRIVE_ROM_LOAD( jprampg, "jurassic park - rampage edition (prototype - jun 20, 1994).bin",                           0x000000, 0x1f6e60,  CRC(1280fa5c) SHA1(f8f52d23dcd36e8167ec273cf9978ae44f21658b) )
MEGADRIVE_ROM_LOAD( jpramph, "jurassic park - rampage edition (prototype - jun 22, 1994).bin",                           0x000000, 0x200000,  CRC(53582f2b) SHA1(6607cdeb4a5ddb229201f1417d3e693063094a7d) )
MEGADRIVE_ROM_LOAD( jprampi, "jurassic park - rampage edition (prototype - jun 30, 1994).bin",                           0x000000, 0x200000,  CRC(bff4b396) SHA1(f1f763e087065483ed7ff53f95b99bac16bb8484) )
MEGADRIVE_ROM_LOAD( jstrike, "jungle strike (euro, usa).bin",                                                            0x000000, 0x200000,  CRC(a5d29735) SHA1(7a7568e39341b1bb218280ee05c2b37c273317b5) )
...
MEGADRIVE_ROM_LOAD( jstrikej, "jungle strike - uketsugareta kyouki (jpn).bin",                                           0x000000, 0x200000,  CRC(ba7a870b) SHA1(e35c554c52ce31de837c0e73bf2014720657f4d5) )
...
MEGADRIVE_ROM_LOAD( junction, "junction (usa, jpn).bin",                                                                 0x000000, 0x80000,   CRC(94cdce8d) SHA1(7981e5764458f5230184c7b2cf77469e1ed34270) )
MEGADRIVE_ROM_LOAD( jungle, "jungle book, the (euro).bin",                                                               0x000000, 0x200000,  CRC(b9709a99) SHA1(b96dcaf595a713eeec54257e8cee6306d7748baf) )
...
MEGADRIVE_ROM_LOAD( junker, "junker's high (jpn) (beta) (bad dump).bin",                                                 0x000000, 0x100000, BAD_DUMP CRC(23534949) SHA1(81a9b6d29878b4e9313a887b5349c12846b9d77f) )
MEGADRIVE_ROM_LOAD( jurass, "mpr-15679.bin",                                                                             0x000000, 0x200000,  CRC(448341f6) SHA1(2dca183ddb79805b6300d8fcca1163fce88dd9db) )
MEGADRIVE_ROM_LOAD( jurassj, "jurassic park (jpn).bin",                                                                  0x000000, 0x200000,  CRC(ec8e5783) SHA1(d5d0e2ed4c00435ec4a343583bb399b07927de21) )
...
MEGADRIVE_ROM_LOAD( juuouki, "juuouki (jpn) (v1.1).bin",                                                                 0x000000, 0x80000,   CRC(b2233e87) SHA1(d0713d6da20145fe9e13b56a103fce23bc6051d7) )
MEGADRIVE_ROM_LOAD( juuouki1, "juuouki (jpn).bin",                                                                       0x000000, 0x80000,   CRC(1b7c96c0) SHA1(bf5782b6f25dcf2bd1ff987e2821441c77da3c5d) )
...
MEGADRIVE_ROM_LOAD( kagekij, "ka-ge-ki (jpn).bin",                                                                       0x000000, 0x100000,  CRC(391866a1) SHA1(9424e8b759609004748dd6cd4779f917211264ae) )
MEGADRIVE_ROM_LOAD( kawa, "kawasaki superbike challenge (euro, usa).bin",                                                0x000000, 0x100000,  CRC(631cc8e9) SHA1(fa7e07bbab70a7b5c32a0f2713494b2c10ce8e1e) )
...
MEGADRIVE_ROM_LOAD( kickbox, "mpr-15333.bin",                                                                            0x000000, 0x100000,  CRC(9bdc230c) SHA1(c3f74c01e8124d5d08f817ff6e0c9416545b8302) )
MEGADRIVE_ROM_LOAD( kickoff3, "kick off 3 - european challenge (euro).bin",                                              0x000000, 0x100000,  CRC(bc37401a) SHA1(e449cfd4f9d59cf28b4842d465022a399964d0d6) )
MEGADRIVE_ROM_LOAD( kidcham, "mpr-14557.bin",                                                                            0x000000, 0x100000,  CRC(ce36e6cc) SHA1(28b904000b2863b6760531807760b571f1a5fc1d) )
MEGADRIVE_ROM_LOAD( kidchamj, "chameleon kid (jpn).bin",                                                                 0x000000, 0x100000,  CRC(50217c80) SHA1(237ff4041f3e8ce5047f06f695fb55dca51354b8) )
MEGADRIVE_ROM_LOAD( kidouk, "kidou keisatsu patlabor - 98-shiki kidou seyo! (jpn).bin",                                  0x000000, 0x80000,   CRC(21a0e749) SHA1(5595422530e6891042a4a005d11b79af7f09fe9b) )
MEGADRIVE_ROM_LOAD( killshow, "killing game show, the (jpn).bin",                                                        0x000000, 0x100000,  CRC(b8e7668a) SHA1(47cdd668998139c92305e1b5abf7e196901490d6) )
MEGADRIVE_ROM_LOAD( kingcol, "mpr-14929.bin",                                                                            0x000000, 0x100000,  CRC(ffe7b3c7) SHA1(92bfb3548ebff18eedebe07751bf2170f95780d7) )
...
MEGADRIVE_ROM_LOAD( kingsbty, "king's bounty - the conqueror's quest (euro, usa).bin",                                   0x000000, 0x80000,   CRC(aa68a92e) SHA1(32f90806f44a0bd1d65d84ceeb644681b9cee967) )
MEGADRIVE_ROM_LOAD( kingsj, "king salmon (jpn).bin",                                                                     0x000000, 0x80000,   CRC(2cfc9f61) SHA1(62bea17b1e9152bde2355deb98347a802518d08d) )
MEGADRIVE_ROM_LOAD( kishiden, "kishi densetsu (jpn).bin",                                                                0x000000, 0x180000,  CRC(22e1f04a) SHA1(2884f79b8f717fc9e244dac0fb441bdc44c68203) )
MEGADRIVE_ROM_LOAD( kissshot, "kiss shot (jpn) (sn).bin",                                                                0x000000, 0x40000,   CRC(e487088c) SHA1(bc47dceea512c0195e51172ab3a2ff5cad03c9bd) )
MEGADRIVE_ROM_LOAD( klax, "klax (euro, usa).bin",                                                                        0x000000, 0x40000,   CRC(248cd09e) SHA1(b7c07baf74b945549e067405566eeaa6856dd6b1) )
MEGADRIVE_ROM_LOAD( klaxj, "klax (jpn).bin",                                                                             0x000000, 0x40000,   CRC(1afcc1da) SHA1(f084f7a3851161523ab7e9cffb2f729563c17643) )
MEGADRIVE_ROM_LOAD( knucklp, "knuckles in sonic 2 (prototype 0524 - may 27, 1994, 10.46).bin",                           0x000000, 0x400000,  CRC(8878c1a8) SHA1(3a827d575f5a484c24e6c31417f32d6c5f0045de) )
MEGADRIVE_ROM_LOAD( kof98, "king of fighters '98, the (unl).bin",                                                        0x000000, 0x200000,  CRC(cbc38eea) SHA1(aeee33bfc2c440b6b861ac0d1b9bc9bface24861) )
MEGADRIVE_ROM_LOAD( kof98a, "king of fighters '98, the (unl) (pirate).bin",                                              0x000000, 0x200000,  CRC(c79e1074) SHA1(6eb3a12e082ce4074e88ad3cb2b3c51f9a72225c) )
MEGADRIVE_ROM_LOAD( kof99, "the king of fighters 99 (unl).bin",                                                          0x000000, 0x300000,  CRC(54638c11) SHA1(cdef3008dec2ce1a214af8b9cb000053671a3c36) )
MEGADRIVE_ROM_LOAD( kotm, "king of the monsters (euro).bin",                                                             0x000000, 0x100000,  CRC(7a94fd49) SHA1(46dc75f1e4d79fd159fcb4a256881375b63d9a2b) )
...
MEGADRIVE_ROM_LOAD( koutetsu,  "koutetsu teikoku (jpn).bin",                                                             0x000000, 0x100000,  CRC(755d0b8a) SHA1(7ff88050ae9b2f12afe80432781ba25aa3a15e1c) )
MEGADRIVE_ROM_LOAD( krusty, "krusty's super fun house (euro, usa) (v1.1).bin",                                           0x000000, 0x80000,   CRC(56976261) SHA1(6aa026e394dba0e5584c4cf99ad1c166d91f3923) )
MEGADRIVE_ROM_LOAD( krusty1, "krusty's super fun house (euro, usa).bin",                                                 0x000000, 0x80000,   CRC(f764005e) SHA1(ab794df527e9fc5823cc5f08130dc856456980b0) )
MEGADRIVE_ROM_LOAD( kujaku, "kujaku ou 2 - geneijou (jpn).bin",                                                          0x000000, 0x60000,   CRC(affd56bc) SHA1(d48ed88269b4ea4c62a85f8607658f9ce566590c) )
MEGADRIVE_ROM_LOAD( kuuga, "kuuga - operation code 'vapor trail' (jpn).bin",                                             0x000000, 0x100000,  CRC(83b6b6ba) SHA1(54d257ad1f941fdb39f6f7b2a3a168eb30ebd9ff) )
MEGADRIVE_ROM_LOAD( kyuuka, "kyuukai douchuuki (jpn).bin",                                                               0x000000, 0x80000,   CRC(de48dce3) SHA1(40e771ace8f89e40d3315be698aa68effd617c5c) )
MEGADRIVE_ROM_LOAD( kyuukyok, "kyuukyoku tiger (jpn).bin",                                                               0x000000, 0xa0000,   CRC(61276d21) SHA1(cbe207732c6ce5e5e5846e44847ce902315f2bc3) )
MEGADRIVE_ROM_LOAD( labdea, "shi no meikyuu - labyrinth of death (jpn) (sn).bin",                                        0x000000, 0x40000,   CRC(a6d7e02d) SHA1(513732ae1c5a40276959967bbf4775fce1c83a7e) )
MEGADRIVE_ROM_LOAD( labdeagnk, "shi no meikyuu - labyrinth of death (jpn) (gnk).bin",                                    0x000000, 0x20000,   CRC(40c44cd3) SHA1(a854b4fb96e34183fbe462e23a2a0bf7dd6d9f09) )
...
MEGADRIVE_ROM_LOAD( landstlk, "landstalker - the treasures of king nole (euro).bin",                                     0x000000, 0x200000,  CRC(e3c65277) SHA1(9fbadc86319936855831ecd096d82d716b304215) )
...
MEGADRIVE_ROM_LOAD( landstlkj, "landstalker - koutei no zaihou (jpn).bin",                                               0x000000, 0x200000,  CRC(60d4cedb) SHA1(cdbc7cd9ceb181cad9e49b641ff717072546f0d9) )
...
MEGADRIVE_ROM_LOAD( landstlkub, "landstalker (usa) (beta).bin",                                                          0x000000, 0x200000,  CRC(70483d03) SHA1(dfca19397479852584d4ac6fcbe27412f9bc1af0) )
MEGADRIVE_ROM_LOAD( langris2, "langrisser ii (jpn) (v1.2).bin",                                                          0x000000, 0x200000,  CRC(4967c9f9) SHA1(167944091348c89ce43dfa4854f8a51ed7276dde) )
MEGADRIVE_ROM_LOAD( langris2a, "langrisser ii (jpn) (v1.1).bin",                                                         0x000000, 0x200000,  CRC(0caa0593) SHA1(4ba6591dfd85aa75ffe8dc21137a9291aa7f5603) )
MEGADRIVE_ROM_LOAD( langris2b, "langrisser ii (jpn).bin",                                                                0x000000, 0x200000,  CRC(7f891dfc) SHA1(4bbc2502784a61eedf45eca5303dc68062964ff4) )
MEGADRIVE_ROM_LOAD( langriss, "mpr-13845.bin",                                                                           0x000000, 0x80000,   CRC(b6ea5016) SHA1(cc67c5a3b91e706b495eb561a95a038fff72b5da) )
MEGADRIVE_ROM_LOAD( larussa, "la russa baseball 95 (usa, aus).bin",                                                      0x000000, 0x200000,  CRC(3f848a92) SHA1(0e73742113aa3f0aa5b010bb847569589cd3a5b0) )
MEGADRIVE_ROM_LOAD( lastact, "last action hero (euro, usa).bin",                                                         0x000000, 0x100000,  CRC(15357dde) SHA1(8efa876894c8bfb0ea457e86173eb5b233861cd0) )
MEGADRIVE_ROM_LOAD( lastbatt, "mpr-12578.bin",                                                                           0x000000, 0x80000,   CRC(bbfaad77) SHA1(6ebef9c86779040bd2996564caa8631f4c41cf03) )
MEGADRIVE_ROM_LOAD( lawnmowr, "lawnmower man, the (euro, usa).bin",                                                      0x000000, 0x100000,  CRC(a7cacd59) SHA1(9e19ac92bc06954985dd97a9a7f55ef87e8c7364) )
MEGADRIVE_ROM_LOAD( le, "lethal enforcers (euro).bin",                                                                   0x000000, 0x200000,  CRC(ca2bf99d) SHA1(b9cc7ff3c6a50b2624358785bcadd1451e23993e) )
MEGADRIVE_ROM_LOAD( le2, "lethal enforcers ii - gun fighters (euro).bin",                                                0x000000, 0x200000,  CRC(4bfe045c) SHA1(0c99f93ef90d6242b198c99a1e940be432ec861f) )
...
MEGADRIVE_ROM_LOAD( legendgl, "gal01.bin",                                                                               0x000000, 0x100000,  CRC(679557bc) SHA1(3368af01da1f3f9e0ea7c80783170aeb08f5c24d) )
MEGADRIVE_ROM_LOAD( lej, "fz008.bin",                                                                                    0x000000, 0x200000,  CRC(f25f1e49) SHA1(14245fccf4d7e5d1dd4ad5f426507516e71e3a06) )
MEGADRIVE_ROM_LOAD( lemming2, "lemmings 2 - the tribes (euro).bin",                                                      0x000000, 0x200000,  CRC(741eb624) SHA1(b56f9e78dee0186c8f8103c7d125e8b497eb0196) )
...
MEGADRIVE_ROM_LOAD( lemmings, "mpr-15233.bin",                                                                           0x000000, 0x100000,  CRC(6a1a4579) SHA1(f4b86031e348edb4dcffaf969998f368955828ce) )
MEGADRIVE_ROM_LOAD( lemmingsju, "sunsoft_lem8_j.bin",                                                                    0x000000, 0x100000,  CRC(68c70362) SHA1(61d468378c06a3d1044a8e11255294b46d0c094d) )
MEGADRIVE_ROM_LOAD( lemmingsju1, "lemmings (usa, jpn).bin",                                                              0x000000, 0x100000,  CRC(f015c2ad) SHA1(83aebf600069cf053282e813d3ab4910f586706e) )
...
MEGADRIVE_ROM_LOAD( leynos, "assault suit leynos (jpn).bin",                                                             0x000000, 0x80000,   CRC(81a2c800) SHA1(332886d9fe7823092fed6530781269b60f24d792) )
MEGADRIVE_ROM_LOAD( lhx, "lhx04.bin",                                                                                    0x000000, 0x100000,  CRC(70c3428d) SHA1(f23c6d0bc6daae11a3398d73961f621e508c9229) )
MEGADRIVE_ROM_LOAD( lhxj, "lhx attack chopper (jpn).bin",                                                                0x000000, 0x100000,  CRC(224ff103) SHA1(4e98a59fbd25db9fa9a05c84ecfa79154dd49d12) )
...
MEGADRIVE_ROM_LOAD( lightc, "light crusader (euro).bin",                                                                 0x000000, 0x200000,  CRC(52c7252b) SHA1(4352ae7ba1316e4384c4632be80f2fe277443f51) )
MEGADRIVE_ROM_LOAD( lightcj, "light crusader (jpn).bin",                                                                 0x000000, 0x200000,  CRC(237076a4) SHA1(2b8c0931c33c143d41ef7cff6a8dbb9b8351d613) )
MEGADRIVE_ROM_LOAD( lightck, "light crusader (kor).bin",                                                                 0x000000, 0x200000,  CRC(6d0cbcb2) SHA1(0f018f95b4933bb5b3b3a91cee8b9a8ecb376942) )
...
MEGADRIVE_ROM_LOAD( lightfor, "lightening force - quest for the darkstar (usa).bin",                                     0x000000, 0x100000,  CRC(c8f8c0e0) SHA1(ab5bd9ddbfc07d860f44b9c72d098aef2581d1d8) )
MEGADRIVE_ROM_LOAD( lionkin2, "shi zi wang ii - the lion king ii, the (china) (unl).bin",                                0x000000, 0x200000,  CRC(aff46765) SHA1(5649fa1fbfb28d58b0608e8ebc5dc7bd5c4c9678) )
MEGADRIVE_ROM_LOAD( lionkin2a, "shi zi wang ii - the lion king ii, the (china) (unl) (pirate).bin",                      0x000000, 0x200000,  CRC(721b4981) SHA1(70eb5b423948e5a124de4d5d24c14b2c64bfb282) )
MEGADRIVE_ROM_LOAD( lionking, "mpr-17270.bin",                                                                           0x000000, 0x300000,  CRC(5696a5bc) SHA1(24cbe4e75ec10e8e0ffbdb400cf86ecb072d4da9) )
...
MEGADRIVE_ROM_LOAD( longch, "long (china) (unl).bin",                                                                    0x000000, 0x40000,   CRC(1b86e623) SHA1(09e4b59da3344f16ce6173c432c88ee9a12a3561) )
MEGADRIVE_ROM_LOAD( lordmo, "lord monarch - tokoton sentou densetsu (jpn).bin",                                          0x000000, 0x200000,  CRC(238bf5db) SHA1(9b5c71d70de132c8ba6f2adfdeba43077f76ac3e) )
MEGADRIVE_ROM_LOAD( lostvik, "lost vikings, the (euro).bin",                                                             0x000000, 0x100000,  CRC(1f14efc6) SHA1(c977a21d287187c3931202b3501063d71fcaf714) )
MEGADRIVE_ROM_LOAD( lostvikb, "lost vikings, the (euro) (beta).bin",                                                     0x000000, 0x100000,  CRC(17bed25f) SHA1(375eaa9845692db4fdbd0b51985aa0892a8fe425) )
...
MEGADRIVE_ROM_LOAD( lostwrld, "lost world, the - jurassic park (euro, usa).bin",                                         0x000000, 0x400000,  CRC(140a284c) SHA1(25a93bbcfbbe286a36f0b973adf86b0f0f3cfa3f) )
MEGADRIVE_ROM_LOAD( lotus2, "lot205.bin",                                                                                0x000000, 0x100000,  CRC(1d8ee010) SHA1(5a00e8aaae8d987ee0f18fc4604230265aea699e) )
...
MEGADRIVE_ROM_LOAD( m1abrams, "m-1 abrams battle tank (euro, usa).bin",                                                  0x000000, 0x80000,   CRC(1e2f74cf) SHA1(65248727b0b52106007ec1193832f16545db5378) )
...
MEGADRIVE_ROM_LOAD( madden, "john madden football (euro, usa).bin",                                                      0x000000, 0x80000,   CRC(90fb8818) SHA1(10682f1763711b281542fcd5e192e1633809dc75) )
MEGADRIVE_ROM_LOAD( madden92, "john madden football '92 (euro, usa).bin",                                                0x000000, 0x80000,   CRC(046e3945) SHA1(1a4c1dcc2de5018142a770f753ff42667b83e5be) )
MEGADRIVE_ROM_LOAD( madden93, "jmf302.bin",                                                                              0x000000, 0x100000,  CRC(ca323b3e) SHA1(59d2352ecb31bc1305128a9d8df894a3bfd684cf) )
MEGADRIVE_ROM_LOAD( madden94, "madden nfl '94 (euro, usa).bin",                                                          0x000000, 0x200000,  CRC(d14b811b) SHA1(856d68d3e8589df3452096434feef823684d11eb) )
MEGADRIVE_ROM_LOAD( madden95, "madden nfl 95 (euro, usa).bin",                                                           0x000000, 0x200000,  CRC(db0be0c2) SHA1(41cde6211da87a8e61e2ffd42cef5de588f9b9fc) )
MEGADRIVE_ROM_LOAD( madden96, "madden nfl 96 (euro, usa).bin",                                                           0x000000, 0x200000,  CRC(f126918b) SHA1(35a4241eed51f10de2e63c843f162ce5d92c70a2) )
MEGADRIVE_ROM_LOAD( madden97, "madden nfl 97 (euro, usa).bin",                                                           0x000000, 0x200000,  CRC(c4b4e112) SHA1(63544d2a0230be102f2558c03a74855fc712b865) )
...
MEGADRIVE_ROM_LOAD( maddenj, "john madden football - pro football (jpn).bin",                                            0x000000, 0x80000,   CRC(0460611c) SHA1(c4cf3681d86861a823fa3e7ffe0cd451fbafcee6) )
MEGADRIVE_ROM_LOAD( madoum, "madou monogatari i (jpn).bin",                                                              0x000000, 0x200000,  CRC(dd82c401) SHA1(143456600e44f543796cf6ade77830115a8f2f99) )
MEGADRIVE_ROM_LOAD( mahjongc, "mahjong cop ryuu - shiro ookami no yabou (jpn).bin",                                      0x000000, 0x40000,   CRC(1ccbc782) SHA1(7fd5866347067e6111739833595278e192d275fb) )
MEGADRIVE_ROM_LOAD( majian, "ma jiang qing ren - ji ma jiang zhi (china) (unl).bin",                                     0x000000, 0x100000,  CRC(ddd02ba4) SHA1(fe9ec21bd206ad1a178c54a2fee80b553c478fc4) )
MEGADRIVE_ROM_LOAD( mamono, "mamono hunter youko - dai 7 no keishou (jpn).bin",                                          0x000000, 0x80000,   CRC(10bb359b) SHA1(5c8c600ca7468871b0ef301fd82a1909aa8b3b10) )
MEGADRIVE_ROM_LOAD( manover, "mdss12c4.bin",                                                                             0x000000, 0x100000,  CRC(cae0e3a6) SHA1(36c66a1cbf44f4019b84538a6bf452c369239bc9) )
MEGADRIVE_ROM_LOAD( mansell, "newman haas indy car featuring nigel mansell -- nigel mansell indy car (world).bin",       0x000000, 0x200000,  CRC(1233a229) SHA1(e7083aaa4a4f6539b10b054aa4ecdcee52f3f8cc) )
MEGADRIVE_ROM_LOAD( maouren, "maou renjishi (jpn).bin",                                                                  0x000000, 0x80000,   CRC(24a7f28c) SHA1(56253adf20d420233722d428170a646262be226f) )
MEGADRIVE_ROM_LOAD( maqiao, "ma qiao e mo ta - devilish mahjong tower (china) (unl).bin",                                0x000000, 0x100000,  CRC(12e35994) SHA1(84e8bf546283c73396e40c4cfa05986ebeb123bb) )
MEGADRIVE_ROM_LOAD( marble, "mar01.bin",                                                                                 0x000000, 0x80000,   CRC(79eba28a) SHA1(059e99fde8726a45a584007186913eb9a01f738e) )
MEGADRIVE_ROM_LOAD( marioand, "mario andretti racing (euro, usa).bin",                                                   0x000000, 0x200000,  CRC(7f1dc0aa) SHA1(d28d79177cf25c8cbf54b28a7d357ac86b7820b5) )
MEGADRIVE_ROM_LOAD( mariolh, "mpr-14376.bin",                                                                            0x000000, 0x80000,   CRC(f664eb6c) SHA1(34cb9c26030c5a0e66dc7de3302bb50633e4dbb6) )
MEGADRIVE_ROM_LOAD( marko, "mpr-16825.bin",                                                                              0x000000, 0x200000,  CRC(2307b905) SHA1(717e924db1ac7cfd099adb6031a08606fcb30219) )
MEGADRIVE_ROM_LOAD( markob, "marko's magic football (euro) (beta).bin",                                                  0x000000, 0x200000,  CRC(0273e564) SHA1(42b871c3a91697e1d7b8c6f1eae9d2a8b07a0fca) )
...
MEGADRIVE_ROM_LOAD( marsup, "marsupilami (euro).bin",                                                                    0x000000, 0x200000,  CRC(e09bbd70) SHA1(d2b8358ef261f8b5ad54a58e89f3999312d0cec9) )
MEGADRIVE_ROM_LOAD( marsupu, "marsupilami (usa).bin",                                                                    0x000000, 0x200000,  CRC(c76558df) SHA1(3e761bdbf4ab8cb43d4a8d99e22b7de896884819) )
MEGADRIVE_ROM_LOAD( masterm, "master of monsters (usa).bin",                                                             0x000000, 0x80000,   CRC(91354820) SHA1(28f38617911a99504542b30f70c0d9c81996ef65) )
MEGADRIVE_ROM_LOAD( mastermj, "mpr-14120.bin",                                                                           0x000000, 0x80000,   CRC(d51ee8c2) SHA1(ca62d376be5cc7b944bbe9b5f2610f8bb55a2fed) )
MEGADRIVE_ROM_LOAD( maten, "maten no soumetsu (jpn).bin",                                                                0x000000, 0x100000,  CRC(b804a105) SHA1(31bc44b019310e18174eb5e1a6d8e7d351103e4e) )
...
MEGADRIVE_ROM_LOAD( mauimall,  "donald in maui mallard (euro).bin",                                                      0x000000, 0x300000,  CRC(b2dd857f) SHA1(cd3c50b7f9c2f97d7bb0042e4239a05066ae72e0) )
MEGADRIVE_ROM_LOAD( mazin, "mazin wars (euro).bin",                                                                      0x000000, 0x100000,  CRC(4b07a105) SHA1(40e48ce531ed013d5a4a6f689e70781df3e0095c) )
MEGADRIVE_ROM_LOAD( mazinas, "mazin saga (asia).bin",                                                                    0x000000, 0x100000,  CRC(36459b59) SHA1(3509fdf8bd0a589c216a5032eef0c09a51c7a578) )
MEGADRIVE_ROM_LOAD( mazinj, "mazin saga (jpn, kor).bin",                                                                 0x000000, 0x100000,  CRC(45b3a34b) SHA1(bcaf2820f22d4a7bcf6324f288698192996875bd) )
MEGADRIVE_ROM_LOAD( mazinu, "mazin saga - mutant fighter (usa).bin",                                                     0x000000, 0x100000,  CRC(1bd9fef1) SHA1(5cb87bb4efc8fa8754e687b62d0fd858e624997d) )
MEGADRIVE_ROM_LOAD( mcdonald, "mcdonald's treasure land adventure (euro).bin",                                           0x000000, 0x100000,  CRC(6ab6a8da) SHA1(f6178018102df3c92d05a48ff5949db9416acd5c) )
MEGADRIVE_ROM_LOAD( mcdonaldj, "mcdonald's treasure land adventure (jpn).bin",                                           0x000000, 0x100000,  CRC(febcfd06) SHA1(aee7fd6a08ec22f42159b188f23406cbe3229f3d) )
MEGADRIVE_ROM_LOAD( mcdonaldjb, "mcdonald's treasure land adventure (jpn) (beta).bin",                                   0x000000, 0x100000,  CRC(7bf477e8) SHA1(ddf496f9a95b2963fe50f3bcaef8e3b592e2fc64) )
...
MEGADRIVE_ROM_LOAD( medalc, "medal city (jpn) (sn).bin",                                                                 0x000000, 0x40000,   CRC(3ef4135d) SHA1(809bbb203dd2f2542e3b9987380e040631b788cc) )
MEGADRIVE_ROM_LOAD( megaan, "mega anser (jpn).bin",                                                                      0x000000, 0x80000,   CRC(08ece367) SHA1(d353e673bd332aa71370fa541e6fd26d918b5a2b) )
MEGADRIVE_ROM_LOAD( megabm8, "mega bomberman - 8 player demo (unl).bin",                                                 0x000000, 0x100000,  CRC(d41c0d81) SHA1(6cc338e314533d7e4724715ef0d156f5c3f873f3) )
...
MEGADRIVE_ROM_LOAD( megaga1, "mpr-15009.bin",                                                                            0x000000, 0x100000,  CRC(db753224) SHA1(076df34a01094ce0893f32600e24323567e2a23b) )
MEGADRIVE_ROM_LOAD( megaga10, "mega games 10 (bra).bin",                                                                 0x000000, 0x400000,  CRC(c19ae368) SHA1(791a4de13cfe2af4302aac969753d67dd76e89c8) )
MEGADRIVE_ROM_LOAD( megaga2, "mega games 2 (euro).bin",                                                                  0x000000, 0x200000,  CRC(30d59f2f) SHA1(1cf425556de9352c1efe60b07e592b610e78cfbd) )
MEGADRIVE_ROM_LOAD( megaga3, "mega games 3 (euro, asia).bin",                                                            0x000000, 0x200000,  CRC(b4247d98) SHA1(4329d7fa2c4b8e6ed0b4adfc64dca474d0ee5a51) )
MEGADRIVE_ROM_LOAD( megaga61, "mpr-18002+mpr18003.bin",                                                                  0x000000, 0x300000,  CRC(b66fb80d) SHA1(42f29050e071c3086be35452d917debf25648b23) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( megaga62, "mega games 6 vol. 2 (euro).bin",                                                          0x000000, 0x300000,  CRC(e8d10db9) SHA1(1fc777b946874216add624414ef6f5878bab202b) )
MEGADRIVE_ROM_LOAD( megaga63, "mpr-18871.bin",                                                                           0x000000, 0x300000,  CRC(fe3e7e4f) SHA1(cca818d624e95c2d07cfc1b22c44eb53e4bdcd02) )
MEGADRIVE_ROM_LOAD( megalo, "mega-lo-mania (euro) (v1.1).bin",                                                           0x000000, 0x100000,  CRC(ab9fed30) SHA1(3794cb708b1f54675eb6fb272cfee01e6dbcecc1) )
MEGADRIVE_ROM_LOAD( megalo1, "mpr-15230.bin",                                                                            0x000000, 0x100000,  CRC(2148d56d) SHA1(e861551edabe55181ed1b7260169e953af903b5e) )
...
MEGADRIVE_ROM_LOAD( megaloj, "mega-lo-mania (jpn).bin",                                                                  0x000000, 0x100000,  CRC(a60d8619) SHA1(66e391c69dfbe7329654550ebf4464b4f426c5a0) )
MEGADRIVE_ROM_LOAD( megaman, "mega man - the wily wars (euro).bin",                                                      0x000000, 0x200000,  CRC(dcf6e8b2) SHA1(ea9ae2043c97db716a8d31ee90e581c3d75f4e3e) )
MEGADRIVE_ROM_LOAD( megamind, "megamind (jpn) (sn).bin",                                                                 0x000000, 0x40000,   CRC(76df2ae2) SHA1(dc5697f6baeeafe04250b39324464bb6dcdcac7f) )
MEGADRIVE_ROM_LOAD( meganet, "meganet (bra).bin",                                                                        0x000000, 0x40000,   CRC(fab33cc2) SHA1(7969fe1b43d29b65a1e24e118f4a6fea27437e9c) )
MEGADRIVE_ROM_LOAD( megapanl, "megapanel (jpn).bin",                                                                     0x000000, 0x40000,   CRC(6240f579) SHA1(1822905930f5f3627e9f9109760205e617295fda) )
MEGADRIVE_ROM_LOAD( megaswiv, "mega swiv (euro).bin",                                                                    0x000000, 0x100000,  CRC(78c2f046) SHA1(6396fb0f204c9f23d0af0b39d069ff0883e191aa) )
MEGADRIVE_ROM_LOAD( megaswivb, "mega swiv (euro) (pirate).bin",                                                          0x000000, 0x100000,  CRC(1ec66bf7) SHA1(6afc7c86dd9f03d24ca976437d1f70e742a7928d) )
MEGADRIVE_ROM_LOAD( megat, "mega turrican (euro).bin",                                                                   0x000000, 0x100000,  CRC(b1d15d0f) SHA1(00ad2cf231bedbd373253b169e170e8b0db4c86a) )
MEGADRIVE_ROM_LOAD( megatrax, "megatrax (jpn).bin",                                                                      0x000000, 0x80000,   CRC(a0837741) SHA1(9e611f2a70fb2505a661d0906b535c484db99d0b) )
...
MEGADRIVE_ROM_LOAD( menacer, "mpr-15075.bin",                                                                            0x000000, 0x100000,  CRC(936b85f7) SHA1(2357ed0b9da25e36f6a937c99ebc32729b8c10d2) )
MEGADRIVE_ROM_LOAD( menghu, "meng huan shui guo pan - 777 casino (china) (unl).bin",                                     0x000000, 0x100000,  CRC(42dc03e4) SHA1(df20a28d03a2cd481af134ef7602062636c3cc79) )
MEGADRIVE_ROM_LOAD( mercs, "mpr-14242.bin",                                                                              0x000000, 0x100000,  CRC(16113a72) SHA1(ab633913147325190ef13bd10f3ef5b06d3a9e28) )
MEGADRIVE_ROM_LOAD( metalf, "metal fangs (jpn).bin",                                                                     0x000000, 0x80000,   CRC(a8df1c4c) SHA1(489e81d2ac81810d571829e8466374f242e81621) )
MEGADRIVE_ROM_LOAD( mhat, "magical hat no buttobi turbo! daibouken (jpn).bin",                                           0x000000, 0x80000,   CRC(e43e853d) SHA1(1a741125a80ba9207c74a32e5b21dbb347c3c34a) )
...
MEGADRIVE_ROM_LOAD( micro96, "mm96mdeddb.bin",                                                                           0x000000, 0x100000,  CRC(23319d0d) SHA1(e8ff759679a0df2b3f9ece37ef686f248d3cf37b) )
MEGADRIVE_ROM_LOAD( micro96a, "mm96md7cc3.bin",                                                                          0x000000, 0x100000,  CRC(7492b1de) SHA1(9f47fcc7bb2f5921cb1c3beb06b668ffb292cb08) )
MEGADRIVE_ROM_LOAD( microm, "mdmm_acd3.bin",                                                                             0x000000, 0x80000,   CRC(50081a0b) SHA1(56a8844c376f2e79e92cf128681fa3fef81c36d6) )
MEGADRIVE_ROM_LOAD( microm2, "mdm_2bead.bin",                                                                            0x000000, 0x100000,  CRC(42bfb7eb) SHA1(ab29077a6a5c2ccc777b0bf22f4d5908401f4d47) )
MEGADRIVE_ROM_LOAD( microm2a, "micro machines 2 - turbo tournament (euro) (j-cart) (alt).bin",                           0x000000, 0x100000,  CRC(01c22a5d) SHA1(cb5fb33212592809639b37c2babd72a7953fa102) )
MEGADRIVE_ROM_LOAD( microma, "micro machines (euro, usa) (alt).bin",                                                     0x000000, 0x80000,   CRC(e5cf560d) SHA1(bbcf8a40e7bfe09225fdc8fc3f22f8b8cc710d06) )
MEGADRIVE_ROM_LOAD( micromb, "micro machines (euro, usa) (alt2).bin",                                                    0x000000, 0x80000,   CRC(7ffbd1ad) SHA1(6c822ab42a37657aa2a4e70e44b201f8e8365a98) )
MEGADRIVE_ROM_LOAD( micromcn, "micro machines (canada).bin",                                                             0x000000, 0x80000,   CRC(54e4cff1) SHA1(0d4d023a1f9dc8b794bd60bf6e70465b712ffded) ) // spoken about as a "Canada" release, real or hack?
MEGADRIVE_ROM_LOAD( micromm, "micro machines military (euro) (j-cart).bin",                                              0x000000, 0x100000,  CRC(b3abb15e) SHA1(6d3df64ab8bb0b559f216adca62d1cdd74704a26) )
...
MEGADRIVE_ROM_LOAD( midresj, "midnight resistance (jpn).bin",                                                            0x000000, 0x100000,  CRC(8f3f6e4d) SHA1(b11db9fde0955c8aa0ae2d1a234d3295eda75d12) )
MEGADRIVE_ROM_LOAD( midway, "midway presents arcade's greatest hits (euro).bin",                                         0x000000, 0x80000,   CRC(c0dce0e5) SHA1(97e35e8fbe1546b9cf075ab75c8f790edcd9db93) )
MEGADRIVE_ROM_LOAD( mig29, "mpr-15659.bin",                                                                              0x000000, 0x100000,  CRC(70b0a5d7) SHA1(5a2e7f8c752dfd8b301d2c044619c003a15894aa) )
MEGADRIVE_ROM_LOAD( mig29j, "mig-29 fighter pilot (jpn).bin",                                                            0x000000, 0x100000,  CRC(3d239046) SHA1(ef268701f4bce40174997c3cc8ab5148e2656e91) )
MEGADRIVE_ROM_LOAD( mig29u, "mig-29 fighter pilot (usa).bin",                                                            0x000000, 0x100000,  CRC(59ccabb2) SHA1(140245f688c42cb2f6bfd740785742286c71be65) )
MEGADRIVE_ROM_LOAD( mightmag, "might and magic - gates to another world (euro, usa).bin",                                0x000000, 0xc0000,   CRC(f509145f) SHA1(52e7ade244d48bc282db003d87c408e96dcb3d85) )
MEGADRIVE_ROM_LOAD( mikedi, "mike ditka power football (euro, usa).bin",                                                 0x000000, 0x100000,  CRC(6078b310) SHA1(e49b9eb91b2e951efe4509ae8a9a5a083afeb920) )
MEGADRIVE_ROM_LOAD( mikedi1, "mike ditka power football (euro, usa) (alt).bin",                                          0x000000, 0x100000,  CRC(de50ca8e) SHA1(e0832fcd63fb164cac66c3df4b5dfb23eecbb0f6) )
...
MEGADRIVE_ROM_LOAD( miraclen, "chou kyuukai miracle nine (jpn).bin",                                                     0x000000, 0x200000,  CRC(6d8c2206) SHA1(af2fd89dc7fb4ac0647c09edff462c7ae92dc771) )
...
MEGADRIVE_ROM_LOAD( mk2, "s376-u2.1+s382-u1.1.bin",                                                                      0x000000, 0x300000,  CRC(a9e013d8) SHA1(af6d2db16f2b76940ff5a9738f1e00c4e7ea485e) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( mk3, "mortal_kombat_3_pal.bin",                                                                      0x000000, 0x400000,  CRC(af6de3e8) SHA1(7f555d647972fee4e86b66e840848e91082f9c2d) )
...
MEGADRIVE_ROM_LOAD( mk5mor, "mk 5 - mortal combat - subzero (unl).bin",                                                  0x000000, 0x200000,  CRC(11e367a1) SHA1(8f92ce78be753748daeae6e16e1eed785f99d287) )
MEGADRIVE_ROM_LOAD( mk5mor1, "mk 5 - mortal combat - subzero (unl) (pirate).bin",                                        0x000000, 0x200000,  CRC(41203006) SHA1(a558ad8de61c4d21c35d4dbaaede85d771e84f33) )
MEGADRIVE_ROM_LOAD( mka, "s215_ver_1.00.bin",                                                                            0x000000, 0x200000,  CRC(1aa3a207) SHA1(c098bf38ddd755ab7caa4612d025be2039009eb2) )
...
MEGADRIVE_ROM_LOAD( mlhockey, "mutant league hockey (euro, usa).bin",                                                    0x000000, 0x200000,  CRC(3529180f) SHA1(84e203c5226bc1913a485804e59c6418e939bd3d) )
...
MEGADRIVE_ROM_LOAD( mmania, "mpr-17089.bin",                                                                             0x000000, 0x200000,  CRC(cb5a8b85) SHA1(6bcbf683a5d0e9f67b9ed8f79bc593fab594d84a) )
MEGADRIVE_ROM_LOAD( mmaniaj, "mickey mania - the timeless adventures of mickey mouse (jpn).bin",                         0x000000, 0x200000,  CRC(23180cf7) SHA1(afe3e1c9267e2a7f0bec5e3e951307ebea7f0b04) )
...
MEGADRIVE_ROM_LOAD( mmpr, "mighty morphin power rangers (euro).bin",                                                     0x000000, 0x200000,  CRC(7f96e663) SHA1(7bad0db9a96eafa413562b6631487ca847b02466) )
...
MEGADRIVE_ROM_LOAD( mmprtm, "mighty morphin power rangers - the movie (euro).bin",                                       0x000000, 0x200000,  CRC(254a4972) SHA1(b3d105d9f7a8d2fd92015e1ac98d13a4094de5ef) )
...
MEGADRIVE_ROM_LOAD( mpiano, "miracle piano teaching system, the (usa).bin",                                              0x000000, 0x80000,   CRC(a719542e) SHA1(5141cb7cc03bc087c17cc663ea3cd889e6faa16c) )
MEGADRIVE_ROM_LOAD( mrnutz, "mr. nutz (euro).bin",                                                                       0x000000, 0x100000,  CRC(0786ea0b) SHA1(318ff3a44554b75260d5b9b9e7b81a3cfd07581a) )
...
MEGADRIVE_ROM_LOAD( mspacman, "ms. pac-man (euro, usa).bin",                                                             0x000000, 0x20000,   CRC(af041be6) SHA1(29fff97e19a00904846ad99baf6b9037b28df15f) )
...
MEGADRIVE_ROM_LOAD( mtaru, "magical taruruuto-kun (jpn).bin",                                                            0x000000, 0x80000,   CRC(f11060a5) SHA1(208f1d83bb410f9cc5e5308942b83c0e84f64294) )
MEGADRIVE_ROM_LOAD( muhamm, "muhammad ali heavyweight boxing (euro).bin",                                                0x000000, 0x100000,  CRC(8ea4717b) SHA1(d79218ef96d2f1d9763dec2a9e6ad7c2907d024b) )
...
MEGADRIVE_ROM_LOAD( mushaj, "musha aleste - full metal fighter ellinor (jpn).bin",                                       0x000000, 0x80000,   CRC(8fde18ab) SHA1(71d363186b9ee023fd2ae1fb9f518c59bf7b8bee) )
MEGADRIVE_ROM_LOAD( mutantlf, "mutant league football (euro, usa).bin",                                                  0x000000, 0x100000,  CRC(dce29c9d) SHA1(6f8638a1c56229ddcb71c9da9f652b49c2978f44) )
MEGADRIVE_ROM_LOAD( mutantlfj, "mutant league football (jpn).bin",                                                       0x000000, 0x100000,  CRC(2a97e6af) SHA1(ce68da5d70dddc0291b09b1e5790739ef6ac0748) )
...
MEGADRIVE_ROM_LOAD( mvlndj, "marvel land (jpn).bin",                                                                     0x000000, 0x100000,  CRC(5d162d21) SHA1(2f7ef2f956d62373dcd5f3808e7501e3660c0658) )
MEGADRIVE_ROM_LOAD( mwalk, "mpr-13285a.bin",                                                                             0x000000, 0x80000,   CRC(11ce1f9e) SHA1(70d9b760c87196af364492512104fa18c9d69cce) )
MEGADRIVE_ROM_LOAD( mwalk1, "mpr-13285.bin",                                                                             0x000000, 0x80000,   CRC(6a70791b) SHA1(8960bac2027cdeadb07e535a77597fb783e1433b) )
MEGADRIVE_ROM_LOAD( mweapon, "master of weapon (jpn).bin",                                                               0x000000, 0x80000,   CRC(12ad6178) SHA1(574da95ab171b12546daa56dc28761c6bcc4a5fc) )
MEGADRIVE_ROM_LOAD( mworld4, "monster world iv (jpn).bin",                                                               0x000000, 0x200000,  CRC(36a3aaa4) SHA1(46ba5e8775a2223fe5056f54555d9caa7d04f4e1) )
MEGADRIVE_ROM_LOAD( mysticd, "mpr-12707a.bin",                                                                           0x000000, 0x80000,   CRC(50fd5d93) SHA1(aec8aefa11233699eacefdf2cf17d62f68cbdd98) )
MEGADRIVE_ROM_LOAD( mysticd1, "mpr-12707.bin",                                                                           0x000000, 0x80000,   CRC(f9ce1ab8) SHA1(fd82ea9badc892bfabacaad426f57ba04c6183b1) )
...
MEGADRIVE_ROM_LOAD( n3dgdevi, "new 3d golf simulation devil's course (jpn).bin",                                         0x000000, 0x180000,  CRC(bd090c67) SHA1(4509c10ab263175c605111c72c6c63c57321046a) )
MEGADRIVE_ROM_LOAD( n3dgpebb, "new 3d golf simulation pebble beach no hatou (jpn).bin",                                  0x000000, 0x180000,  CRC(96ed2e5d) SHA1(dee8430f4f15b4d04e1e3c0cc9d7d7f55ca1ad7b) )
MEGADRIVE_ROM_LOAD( n3dgwaia, "new 3d golf simulation waialae no kiseki (jpn).bin",                                      0x000000, 0x180000,  CRC(cbe2c1f6) SHA1(5d78c5cf3a514275a7df6d9fdbd708584b42e697) )
MEGADRIVE_ROM_LOAD( nadia, "namcot_mfn_mb838200-20.bin",                                                                 0x000000, 0x100000,  CRC(4762062a) SHA1(bbcd26d5d1f1422051467aacaa835e1f38383f64) )
MEGADRIVE_ROM_LOAD( nakaf1gp, "nakajima satoru kanshuu f1 grand prix (jpn).bin",                                         0x000000, 0x100000,  CRC(93be47cf) SHA1(e108342d53e1542d572d2e45524efbfe9d5dc964) )
MEGADRIVE_ROM_LOAD( nakaf1he, "nakajima satoru kanshuu f1 hero md (jpn).bin",                                            0x000000, 0x100000,  CRC(24f87987) SHA1(1a61809b4637ba48d193d29a5c25d72ab2c6d72d) )
MEGADRIVE_ROM_LOAD( nakaf1sl, "nakajima satoru kanshuu f1 super license (jpn).bin",                                      0x000000, 0x100000,  CRC(8774bc79) SHA1(ad5456259890bcb32098f82f14a1d5355af83f7e) )
MEGADRIVE_ROM_LOAD( nbaa, "nba action (usa).bin",                                                                        0x000000, 0x200000,  CRC(99c348ba) SHA1(e2b5290d656219636e2422fcf93424ae602c4d29) )
MEGADRIVE_ROM_LOAD( nbaa95, "nba action '95 starring david robinson (euro, usa).bin",                                    0x000000, 0x200000,  CRC(aa7006d6) SHA1(34e2df219e09c24c95c588a37d2a2c5e15814d68) )
...
MEGADRIVE_ROM_LOAD( nbaallst, "nba all-star challenge (euro, usa).bin",                                                  0x000000, 0x100000,  CRC(c4674adf) SHA1(fc55c83df4318a17b55418ce14619e42805e497f) )
...
MEGADRIVE_ROM_LOAD( nbahang, "nba hang time (euro).bin",                                                                 0x000000, 0x300000,  CRC(edb4d4aa) SHA1(4594ba338a07dd79639c11b5b96c7f1a6e283d0c) )
...
MEGADRIVE_ROM_LOAD( nbajam, "nba jam (euro, usa) (v1.1).bin",                                                            0x000000, 0x200000,  CRC(eb8360e6) SHA1(55f2b26a932c69b2c7cb4f24f56b43f24f113a7c) )
MEGADRIVE_ROM_LOAD( nbajam1, "s285_ver_1.00.bin",                                                                        0x000000, 0x200000,  CRC(10fa248f) SHA1(99c5bc57fdea7f9df0cd8dec54160b162342344d) )
MEGADRIVE_ROM_LOAD( nbajamj, "nba jam (jpn).bin",                                                                        0x000000, 0x200000,  CRC(a6c6305a) SHA1(2a88b2e1ecf115fa6246397d829448b755a5385e) )
...
MEGADRIVE_ROM_LOAD( nbajamtef, "nba jam tournament edition (world) (fixed).bin",                                         0x000000, 0x300000,  CRC(6e25ebf0) SHA1(0f5bb5d5352fe2ebe4b4051a1dd9b9fde4b505ab) ) // this "1.1" dump was supposedly released in 2002 by one of the original programmers to fix a bug in the first version, was it ever found on a cart?
MEGADRIVE_ROM_LOAD( nbal95, "nba live 95 (euro, usa).bin",                                                               0x000000, 0x200000,  CRC(66018abc) SHA1(f86bc9601751ac94119ab2f3ecce2029d5678f01) )
MEGADRIVE_ROM_LOAD( nbal95k, "lh5370hc.bin",                                                                             0x000000, 0x200000,  CRC(779c1244) SHA1(115c2e8cfa6bc45767ba47efc00aede424a6de66) )
MEGADRIVE_ROM_LOAD( nbal96, "nba live 96 (euro, usa).bin",                                                               0x000000, 0x200000,  CRC(49de0062) SHA1(5fca106c839d3dea11cbf6842d1d7650db06ca72) )
MEGADRIVE_ROM_LOAD( nbal97, "nba live 97 (euro, usa).bin",                                                               0x000000, 0x200000,  CRC(7024843a) SHA1(1671451ab4ab6991e13db70671054c0f2c652a95) )
...
MEGADRIVE_ROM_LOAD( nbaplay, "nba playoffs - bulls vs blazers (jpn).bin",                                                0x000000, 0x100000,  CRC(eae8c000) SHA1(66a25cf2d7ddf17dde137e29381202f48456d173) )
MEGADRIVE_ROM_LOAD( nbaplay1, "nba playoffs - bulls vs blazers (jpn) (alt).bin",                                         0x000000, 0x100000,  CRC(4565ce1f) SHA1(77a048094269fbf5cf9f0ad02ea781ba3bcbecf3) ) // Xacrow's dump info report only the other CRC, this is probably a bad dump
MEGADRIVE_ROM_LOAD( nbapro, "nba pro basketball - bulls vs lakers (jpn).bin",                                            0x000000, 0x100000,  CRC(4416ce39) SHA1(003b01282aff14ccea9390551aba5ac4a9e53825) )
MEGADRIVE_ROM_LOAD( nbapro94, "nba pro basketball '94 (jpn).bin",                                                        0x000000, 0x200000,  CRC(eea19bce) SHA1(99c91fe3a5401e84e7b3fd2218dcb3aeaf10db74) )
MEGADRIVE_ROM_LOAD( nbashow, "nba showdown '94 (euro, usa).bin",                                                         0x000000, 0x200000,  CRC(160b7090) SHA1(3134a3cb63115d2e16e63a76c2708cdaecab83e4) )
...
MEGADRIVE_ROM_LOAD( ncirc, "nightmare circus (bra).bin",                                                                 0x000000, 0x200000,  CRC(06da3217) SHA1(3c80ff5ba54abe4702a3bb7d812571d3dc50c00f) )
MEGADRIVE_ROM_LOAD( ncirc1, "nightmare circus (bra) (alt).bin",                                                          0x000000, 0x200000,  CRC(31de5a94) SHA1(61b7d25e15011d379d07a8dad4f8c5bb5f75e29f) ) // this is marked as unconfirmed beta in Goodgen, but seems an edited final release, needs a redump
...
MEGADRIVE_ROM_LOAD( nekketsu, "nekketsu koukou dodgeball bu - soccer hen md (jpn).bin",                                  0x000000, 0x80000,   CRC(f49c3a86) SHA1(d865b01e58a269400de369fc1fbb3b3e84e1add0) )
...
MEGADRIVE_ROM_LOAD( nfl94j, "nfl football '94 (jpn).bin",                                                                0x000000, 0x200000,  CRC(e490dc4a) SHA1(a530a93d124ccecfbf54f0534b6d3269026e5988) )
MEGADRIVE_ROM_LOAD( nfl95, "nfl '95 (euro, usa).bin",                                                                    0x000000, 0x200000,  CRC(b58e4a81) SHA1(327249456f96ccb3e9758c0162c5f3e3f389072f) )
...
MEGADRIVE_ROM_LOAD( nfl95e, "nfl '95 (prototype - aug 12, 1994 - b).bin",                                                0x000000, 0x200000,  CRC(cc86a259) SHA1(8a7320033449cc9972b2db25752150fe4c2a1fab) )
...
MEGADRIVE_ROM_LOAD( nflqua96, "nfl quarterback club 96 (euro, usa).bin",                                                 0x000000, 0x400000,  CRC(d5a37cab) SHA1(2948419532a6079404f05348bc4bbf2dd989622d) )
MEGADRIVE_ROM_LOAD( nflsport, "mpr-15005+mpr-15006.bin",                                                                 0x000000, 0x180000,  CRC(ce0b1fe1) SHA1(3c97396cb4cc566013d06f055384105983582067) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( nhktaiga, "nhk taiga drama - taiheiki (jpn).bin",                                                    0x000000, 0x100000,  CRC(09fbb30e) SHA1(67358048fc9bc93d8835af852bc437124e015a61) )
MEGADRIVE_ROM_LOAD( nhl95, "nhl 95 (euro, usa).bin",                                                                     0x000000, 0x200000,  CRC(e8ee917e) SHA1(09e87b076aa4cd6f057a1d65bb50fd889b509b44) )
MEGADRIVE_ROM_LOAD( nhl96, "nhl 96 (euro, usa).bin",                                                                     0x000000, 0x200000,  CRC(8135702c) SHA1(7204633fbb9966ac637e7966d02ba15c5acdee6b) )
MEGADRIVE_ROM_LOAD( nhl97, "nhl 97 (euro, usa).bin",                                                                     0x000000, 0x200000,  CRC(f067c103) SHA1(8a90d7921ab8380c0abb0b5515a6b9f96ca6023c) )
...
MEGADRIVE_ROM_LOAD( nhlpah, "h9306.bin",                                                                                 0x000000, 0x80000,   CRC(f361d0bf) SHA1(2ab048fc7209df28b00ef47f2f686f5b7208466e) )
MEGADRIVE_ROM_LOAD( nhlpah1, "nhlpa hockey 93 (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(cbbf4262) SHA1(8efc1cacb079ea223966dda065c16c49e584cac2) )
MEGADRIVE_ROM_LOAD( nigelm, "nigel mansell's world championship racing (euro).bin",                                      0x000000, 0x100000,  CRC(3fe3d63b) SHA1(81b6d231998c0dd90caa9325b9cc6e50c6e622bb) )
...
MEGADRIVE_ROM_LOAD( nikkan, "nikkan sports pro yakyuu van (jpn).bin",                                                    0x000000, 0x80000,   CRC(c3655a59) SHA1(d29f7e70feae3b4f1b423026b7a124514ee48dcf) )
MEGADRIVE_ROM_LOAD( ninjab, "ninja burai densetsu (jpn).bin",                                                            0x000000, 0x100000,  CRC(a8d828a0) SHA1(9cc3419ca7ecaf0d106aa896ffc0266c7145fff7) )
MEGADRIVE_ROM_LOAD( ninjag, "ninja gaiden (jpn) (prototype) (bad dump).bin",                                             0x000000, 0x100000, BAD_DUMP CRC(0d7f74ba) SHA1(dced2e4eb53ae5d9e979b13f093f70d466634c5b) )
...
MEGADRIVE_ROM_LOAD( nobubus, "mpr-14456.bin",                                                                            0x000000, 0x100000,  CRC(30bf8637) SHA1(1ed50cae48405ec8ad9257df3d445521e60636d8) )
MEGADRIVE_ROM_LOAD( nobuhao, "nobunaga no yabou - haouden (jpn).bin",                                                    0x000000, 0x200000,  CRC(96c01fc6) SHA1(9246a29b25e276dc1f7edfae87229549cf87d92e) )
MEGADRIVE_ROM_LOAD( nobuzen, "nobunaga no yabou - zenkoku ban (jpn).bin",                                                0x000000, 0x80000,   CRC(1381b313) SHA1(a1f64afbf3bcdc85b61bce96454105128ca6746a) )
...
MEGADRIVE_ROM_LOAD( normys, "normy's beach babe-o-rama (euro, usa).bin",                                                 0x000000, 0x100000,  CRC(b56a8220) SHA1(286d4f922fa9a95740e791c284d141a49983d871) )
MEGADRIVE_ROM_LOAD( o2019, "mpr-15482.bin",                                                                              0x000000, 0x100000,  CRC(5cb3536a) SHA1(f1a26bd827e9a674cf1dde74dc2c36f61c827c76) )
MEGADRIVE_ROM_LOAD( o2019j, "outrun 2019 (jpn).bin",                                                                     0x000000, 0x100000,  CRC(0eac7440) SHA1(3b26b50f4194408cccd3fb9484ac83b97e94e67f) )
...
MEGADRIVE_ROM_LOAD( o2019ub, "outrun 2019 (usa) (beta).bin",                                                             0x000000, 0x100000,  CRC(d2ecddfa) SHA1(6aca01bd23b99ffbcbd135f7c1dcaa42b8f89e61) )
MEGADRIVE_ROM_LOAD( olympg, "mpr-14753.bin",                                                                             0x000000, 0x80000,   CRC(924e57d3) SHA1(55702a7dee0cd2092a751b19c04d81694b0c0d0f) )
MEGADRIVE_ROM_LOAD( olympgj, "olympic gold (jpn, kor).bin",                                                              0x000000, 0x80000,   CRC(e9c925b8) SHA1(ce640bb979fcb285729b58de4da421c5493ef5e2) )
MEGADRIVE_ROM_LOAD( olympgu, "olympic gold (usa).bin",                                                                   0x000000, 0x80000,   CRC(339594b4) SHA1(f9febd976d98545dee35c10b69755908d6929fd4) )
MEGADRIVE_ROM_LOAD( olympgu1, "olympic gold (usa) (alt).bin",                                                            0x000000, 0x80000,   CRC(af639376) SHA1(089c4013e942fcb3e2e6645cf3e702cdc3f9fc36) )
MEGADRIVE_ROM_LOAD( olympsum, "olympic summer games (euro, usa).bin",                                                    0x000000, 0x200000,  CRC(9e470fb9) SHA1(88c8627d0b5bd5f4847d4b62f3681fbadc477829) )
MEGADRIVE_ROM_LOAD( ondal, "on dal jang goon (kor).bin",                                                                 0x000000, 0x80000,   CRC(67ccb1ca) SHA1(821bcb001cb37b22454979973ed68cee36286abc) )
MEGADRIVE_ROM_LOAD( onslau, "onslaught (euro, usa).bin",                                                                 0x000000, 0x80000,   CRC(9f19d6df) SHA1(dc542ddfa878f2aed3a7fcedc4b0f8d503eb5d70) )
...
MEGADRIVE_ROM_LOAD( ooze, "ooze, the (euro).bin",                                                                        0x000000, 0x100000,  CRC(e16b102c) SHA1(0e45b84e875aa4e27bf003cbc0f857f2e5659625) )
MEGADRIVE_ROM_LOAD( oozeju, "ooze, the (usa, jpn).bin",                                                                  0x000000, 0x100000,  CRC(1c0dd42f) SHA1(dafcda90285e71151072ba36134f94f1e9d76a23) )
MEGADRIVE_ROM_LOAD( oozepa, "ooze, the (euro) (prototype - jul 28, 1995).bin",                                           0x000000, 0x100000,  CRC(7cf868e7) SHA1(1c34cb3fffbaa81d350aea0b81b74c28e86c9bf5) )
...
MEGADRIVE_ROM_LOAD( opeurope, "operation europe - path to victory 1939-45 (usa).bin",                                    0x000000, 0x100000,  CRC(e7cba1d8) SHA1(e2e484c6db2bb058d04288b4dfea0ed199108d24) )
MEGADRIVE_ROM_LOAD( osomatsu, "osomatsu-kun hachamecha gekijou (jpn).bin",                                               0x000000, 0x40000,   CRC(2453350c) SHA1(bf82cb1c4d2144bd0e0d45629f346988cc4cc5b2) )
MEGADRIVE_ROM_LOAD( ottifa, "ottifants, the (euro).bin",                                                                 0x000000, 0x100000,  CRC(41ac8003) SHA1(4bb7cfc41ea7eaaed79ec402ec0d551c1e5c5bb6) )
...
MEGADRIVE_ROM_LOAD( outlandr, "outlander (euro).bin",                                                                    0x000000, 0x100000,  CRC(fe6f2350) SHA1(48b764d85c435ddebba39dc160fd70509b76d94e) )
...
MEGADRIVE_ROM_LOAD( outrun, "outrun (euro, usa).bin",                                                                    0x000000, 0x100000,  CRC(fdd9a8d2) SHA1(95d2055ffd679ab19f0d4ca0af62a0d565bc258e) )
MEGADRIVE_ROM_LOAD( outrunj, "outrun (jpn).bin",                                                                         0x000000, 0x100000,  CRC(ee7d9f4a) SHA1(a94c96ffb53080b2c098be86e715f1dc727be07d) )
...
MEGADRIVE_ROM_LOAD( outrunrj, "outrunners (jpn).bin",                                                                    0x000000, 0x200000,  CRC(e164a09f) SHA1(4225162ed3cf51e16bfe800ae74a9b026f5dee56) )
...
MEGADRIVE_ROM_LOAD( pachinko, "pachinko kuunyan (jpn).bin",                                                              0x000000, 0x100000,  CRC(9d137e7f) SHA1(84c3395c6dc123737d9da94e0392f3f30be59182) )
...
MEGADRIVE_ROM_LOAD( pacmania, "mpr-14392.bin",                                                                           0x000000, 0x40000,   CRC(74bba09b) SHA1(e21546f653607d95f2747305703ddd6bf118f90a) )
MEGADRIVE_ROM_LOAD( paddle, "paddle fighter (jpn) (sn).bin",                                                             0x000000, 0x40000,   CRC(3d8147e6) SHA1(a768f64f394d4185f99da300517521091b6f0de5) )
MEGADRIVE_ROM_LOAD( paddlegnk, "paddle fighter (jpn) (gnk).bin",                                                         0x000000, 0x40000,   CRC(ebef05a4) SHA1(0516b59e35b3c36651852fba231e351cfc239b22) )
MEGADRIVE_ROM_LOAD( pagemast, "pagemaster, the (euro).bin",                                                              0x000000, 0x200000,  CRC(79a180e2) SHA1(c4cf7695127b7ec5e003b5e7e15fdbfb172d1fcb) )
...
MEGADRIVE_ROM_LOAD( paperboy, "paperboy (euro, usa).bin",                                                                0x000000, 0x80000,   CRC(0a44819b) SHA1(10faaf47e585423eec45285be4f5ce1015ae3386) )
MEGADRIVE_ROM_LOAD( paperboyj, "mpr-14774.bin",                                                                          0x000000, 0x80000,   CRC(e14250ae) SHA1(3384e238edaf8b2f6950cd1660864599e476d29f) )
MEGADRIVE_ROM_LOAD( paperby2, "paperboy 2 (euro, usa).bin",                                                              0x000000, 0x100000,  CRC(1de28bb1) SHA1(6421c26000bec21d0c808252c5d9ce75b75cb8a4) )
MEGADRIVE_ROM_LOAD( partyq, "party quiz mega q (jpn).bin",                                                               0x000000, 0x100000,  CRC(9d4b447a) SHA1(3f82b2f028345b6fc84801fa38d70475645d6aa2) )
...
MEGADRIVE_ROM_LOAD( pcotton, "panorama cotton (jpn).bin",                                                                0x000000, 0x280000,  CRC(9e57d92e) SHA1(63d9b71cfe0b7aaa6913ae06c1f2547d6d2aae5c) )
MEGADRIVE_ROM_LOAD( pebble, "pebble beach golf links (euro).bin",                                                        0x000000, 0x200000,  CRC(6cfc7297) SHA1(53e8e8f11fb9950732409b770b7d9c8dabe85a19) )
...
MEGADRIVE_ROM_LOAD( pele, "pele! (euro, usa).bin",                                                                       0x000000, 0x100000,  CRC(5a8abe51) SHA1(c0a91e2d10b98174faa647fb732c335d7438abf7) )
MEGADRIVE_ROM_LOAD( peleii, "pele ii - world tournament soccer (euro, usa).bin",                                         0x000000, 0x200000,  CRC(05a486e9) SHA1(96498065545ed122aa29471d762a2ae1362b2dea) )
MEGADRIVE_ROM_LOAD( pga, "pga09.bin",                                                                                    0x000000, 0x80000,   CRC(c1f0b4e1) SHA1(1b173a1b674a6d5bdcd539c4fe8fe984586c3a8a) )
MEGADRIVE_ROM_LOAD( pga2, "pga tour golf ii (euro, usa) (v1.1).bin",                                                     0x000000, 0x100000,  CRC(e82b8606) SHA1(12d5236a4ff23c5b1e4f452b3abd3d48e6e55314) )
MEGADRIVE_ROM_LOAD( pga2j, "pga tour golf ii (jpn).bin",                                                                 0x000000, 0x100000,  CRC(c05b7a4a) SHA1(a5896f2f019530929194a6d80828d18b859b9174) )
MEGADRIVE_ROM_LOAD( pga3, "pga tour golf iii (euro, usa).bin",                                                           0x000000, 0x200000,  CRC(aeb3f65f) SHA1(702707efcbfe229f6e190f2b6c71b6f53ae9ec36) )
MEGADRIVE_ROM_LOAD( pga96, "pga9601.bin",                                                                                0x000000, 0x200000,  CRC(9698bbde) SHA1(abc2a8d773724cd8fb1aeae483f5ca72f47e77fa) )
MEGADRIVE_ROM_LOAD( pgaa, "pga tour golf (euro, usa) (v1.1).bin",                                                        0x000000, 0x80000,   CRC(0489ff8e) SHA1(73935bfbdf63d3400284a16e464286b7630964aa) )
MEGADRIVE_ROM_LOAD( pgaeuro, "euro03.bin",                                                                               0x000000, 0x100000,  CRC(8ca45acd) SHA1(640615be6891a8457d94bb81b0e8e1fa7c5119a8) )
...
MEGADRIVE_ROM_LOAD( phantom, "phantom 2040 (euro).bin",                                                                  0x000000, 0x200000,  CRC(b024882e) SHA1(6d588fac0fed0e2303082e29cde12d94719cca32) )
...
MEGADRIVE_ROM_LOAD( phelios, "phelios (euro).bin",                                                                       0x000000, 0x80000,   CRC(13abc2b2) SHA1(5b95529dd491266648134f1808f4da55a2ab9296) ) // chip covered with epoxy, proper dump possible?
MEGADRIVE_ROM_LOAD( pheliosj, "phelios (jpn).bin",                                                                       0x000000, 0x80000,   CRC(94596174) SHA1(9834c9963debebb6ee80ffac4191ff260b85e511) )
...
MEGADRIVE_ROM_LOAD( pinocc, "pinocchio (euro).bin",                                                                      0x000000, 0x300000,  CRC(28014bdc) SHA1(7b6c9fdd201341f5319be85b5042870a84e82ae0) )
MEGADRIVE_ROM_LOAD( pinoccu, "pinocchio (usa).bin",                                                                      0x000000, 0x300000,  CRC(cd4128d8) SHA1(ad6098fe3642489d0281b1f168319a753e8bd02a) )
...
MEGADRIVE_ROM_LOAD( pirate1, "pirates of dark water, the (euro, usa) (may 1994).bin",                                    0x000000, 0x200000,  CRC(0a62de34) SHA1(55496714f32eb7f57335201f90b3f437a1500c49) )
MEGADRIVE_ROM_LOAD( pitfall, "pitfall - the mayan adventure (euro).bin",                                                 0x000000, 0x200000,  CRC(c9198e19) SHA1(b7c5f6e5f422c7bb5ec3177328d963c9beace24f) )
...
MEGADRIVE_ROM_LOAD( pmonger, "pm14.bin",                                                                                 0x000000, 0x100000,  CRC(fb599b86) SHA1(f088e8cdb90c037b4ce1c5ae600a75f4e4219c87) )
MEGADRIVE_ROM_LOAD( pmongerj, "power monger (jpn, kor).bin",                                                             0x000000, 0x100000,  CRC(553289b3) SHA1(f0a48f25d87f7a6d17ff76f5e29ea7be2d430ce4) )
MEGADRIVE_ROM_LOAD( pocaho, "mpr-18875.bin",                                                                             0x000000, 0x400000,  CRC(165e7987) SHA1(5ffcdc3e01151837e707ae225a3a845a8b6d3394) )
...
MEGADRIVE_ROM_LOAD( pokecd, "pokemon crazy drummer (unl).bin",                                                           0x000000, 0x200000,  CRC(8838a25d) SHA1(780a81fe6dd2fb9575ccdc506e7dbee13213d01d) )
MEGADRIVE_ROM_LOAD( pokemon, "pocket monsters (unl).bin",                                                                0x000000, 0x200000,  CRC(f68f6367) SHA1(d10de935e099c520384c986b1f00fd5e72d64e03) )
MEGADRIVE_ROM_LOAD( pokemon2, "pocket monsters 2 (unl).bin",                                                             0x000000, 0x200000,  CRC(30f7031f) SHA1(dae100dfaee1b5b7816731cb2f43bcda3da273b7) )
MEGADRIVE_ROM_LOAD( pokemona, "pocket monsters (unl) (alt).bin",                                                         0x000000, 0x200000,  CRC(fb176667) SHA1(3d667aea1b6fa980dddcc10e65845a6831491792) )
MEGADRIVE_ROM_LOAD( populous, "populous (euro).bin",                                                                     0x000000, 0x80000,   CRC(83d56f64) SHA1(fe388caefbad7c08b699ed2d0e8a62ff1d697a16) )
MEGADRIVE_ROM_LOAD( populousj, "populous (jpn).bin",                                                                     0x000000, 0x80000,   CRC(97c26818) SHA1(9abd1806c6e921a6df0f71361aee8024d5c3f049) )
...
MEGADRIVE_ROM_LOAD( powerath, "power athlete (jpn, kor).bin",                                                            0x000000, 0x100000,  CRC(b41b77cf) SHA1(d371e339c5d85b69c34007dc514c1adb524dac2a) )
MEGADRIVE_ROM_LOAD( powerb, "powerball (usa).bin",                                                                       0x000000, 0x80000,   CRC(7adf232f) SHA1(217d64da0b09b88dfa3fd91b7fa081ec7a8666e0) )
MEGADRIVE_ROM_LOAD( powerdrv, "power drive (euro).bin",                                                                  0x000000, 0x100000,  CRC(8c00ad61) SHA1(6ffaaac637fb41a2f94912c382385a9cb17639a9) )
MEGADRIVE_ROM_LOAD( ppengo, "pepenga pengo (jpn).bin",                                                                   0x000000, 0x100000,  CRC(d1e2324b) SHA1(c88c30d9e1fb6fb3a8aadde047158a3683bb6b1a) )
MEGADRIVE_ROM_LOAD( ppersia, "prince of persia (euro).bin",                                                              0x000000, 0x100000,  CRC(61de6fe0) SHA1(6e645b791e6e2b84a206dca6cf47e8f955e60a72) )
MEGADRIVE_ROM_LOAD( ppersia2, "prince of persia 2 - the shadow and the flame (euro) (prototype).bin",                    0x000000, 0x200000,  CRC(3ab44d46) SHA1(ba63dc1e521bee68b4121b626061ebb203ac63c6) )
MEGADRIVE_ROM_LOAD( ppersiab, "prince of persia (beta).bin",                                                             0x000000, 0x100000,  CRC(505314b6) SHA1(addd33ce2f9c022433be1c3ea803371e7f6b694b) )
MEGADRIVE_ROM_LOAD( ppersiab1, "prince of persia (beta) (earlier).bin",                                                  0x000000, 0x40000,   CRC(425e6a87) SHA1(224516e54a4bac00089e61c8e0a4794eac92d8df) )
...
MEGADRIVE_ROM_LOAD( predatr2, "predator 2 (euro, usa).bin",                                                              0x000000, 0x100000,  CRC(bdba113e) SHA1(0d482bae2922c81c8bc7500a62c396b038978114) )
MEGADRIVE_ROM_LOAD( premierm, "mpr-18473.bin",                                                                           0x000000, 0x100000,  CRC(303b889f) SHA1(2916e5ef628e077cde87be873e0ea2507ef5c844) )
MEGADRIVE_ROM_LOAD( premrm97, "premier manager 97 (euro).bin",                                                           0x000000, 0x100000,  CRC(fccbf69b) SHA1(e2df3b48170e1a7bde46af2adbf939803e267e13) )
MEGADRIVE_ROM_LOAD( primal, "primal rage (euro, usa).bin",                                                               0x000000, 0x300000,  CRC(2884c6d1) SHA1(18fc82ae49948128f2347b8b6d7174c8a0c1bf5f) )
...
MEGADRIVE_ROM_LOAD( probot, "probotector (euro).bin",                                                                    0x000000, 0x200000,  CRC(bc597d48) SHA1(69d905751ffa6a921586767263e45ddeb73333c2) )
...
MEGADRIVE_ROM_LOAD( proyakyu, "pro yakyuu super league '91 (jpn).bin",                                                   0x000000, 0x80000,   CRC(a948ab7e) SHA1(9d446471b8fe37b08dc7c4a99de22de9d56a1d16) )
MEGADRIVE_ROM_LOAD( ps2aa, "phantasy star ii - amia's adventure (jpn) (sn).bin",                                         0x000000, 0x40000,   CRC(a3a724aa) SHA1(08c6beab6f02ad533fb814a8a877849da67fc1a4) )
MEGADRIVE_ROM_LOAD( ps2ab, "phantasy star ii - anne's adventure (jpn) (sn).bin",                                         0x000000, 0x40000,   CRC(fafa5b6f) SHA1(cf93d2d5eafc72b9de7aaa6d35b81a813862d9b7) )
MEGADRIVE_ROM_LOAD( ps2ac, "phantasy star ii - huey's adventure (jpn) (sn).bin",                                         0x000000, 0x40000,   CRC(1a076f83) SHA1(abc5a7ac58aefc055ed8ca5fd0f7c802ab3e1ad5) )
MEGADRIVE_ROM_LOAD( ps2ad, "phantasy star ii - kinds's adventure (jpn) (sn).bin",                                        0x000000, 0x40000,   CRC(c334f308) SHA1(f2bd41741add13e8551250cf6afeb746e8cea316) )
MEGADRIVE_ROM_LOAD( ps2ae, "phantasy star ii - nei's adventure (jpn) (sn).bin",                                          0x000000, 0x40000,   CRC(3d9ad465) SHA1(bc1b2955d1ead44d744dacdc072481dff42e4d81) )
MEGADRIVE_ROM_LOAD( ps2af, "phantasy star ii - rudger's adventure (jpn) (sn).bin",                                       0x000000, 0x40000,   CRC(6b5916d2) SHA1(dda0783cd5c6340c8dde665be22366108fadf50b) )
MEGADRIVE_ROM_LOAD( ps2ag, "phantasy star ii - shilka's adventure (jpn) (sn).bin",                                       0x000000, 0x40000,   CRC(1f83beb2) SHA1(114f37a287b51664e52ba483f07911a660f9e7df) )
MEGADRIVE_ROM_LOAD( ps2ah, "phantasy star ii - yushis's adventure (jpn) (sn).bin",                                       0x000000, 0x40000,   CRC(d40c76d6) SHA1(85679e11000387b6ef002c53bb03593f1c3f1c11) )
...
MEGADRIVE_ROM_LOAD( psampras2, "pete sampras tennis (euro, usa) (j-cart).bin",                                           0x000000, 0x100000,  CRC(9ef5bbd1) SHA1(222a66cdb8865a7f89e5a72418413888bb400176) )
MEGADRIVE_ROM_LOAD( pstar2, "mpr-12851a+mpr-12852a.bin",                                                                 0x000000, 0xc0000,   CRC(904fa047) SHA1(0711080e968490a6b8c5fafbb9db3e62ba597231) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( pstar2a, "phantasy star ii (euro, usa).bin",                                                         0x000000, 0xc0000,   CRC(0d07d0ef) SHA1(fcd032ded2235171f51db316ad1b7688fbbdafe4) )
MEGADRIVE_ROM_LOAD( pstar2br, "phantasy star ii (bra).bin",                                                              0x000000, 0xc0000,   CRC(e6688b66) SHA1(ab62fac112cb4dd1f19cb973bd7952b161f6d100) )
MEGADRIVE_ROM_LOAD( pstar2j, "mpr-12140+mpr-12181+mpr-12182.bin",                                                        0x000000, 0xc0000,   CRC(bec8eb5a) SHA1(fc186c681e110723b4be5590f242c73d5004c8a7) ) // three chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( pstar3, "phantasy star iii - generations of doom (euro, usa, kor).bin",                              0x000000, 0xc0000,   CRC(c6b42b0f) SHA1(59d4914e652672fd1e453c76b8250d17e8ca154e) )
MEGADRIVE_ROM_LOAD( pstar3br, "phantasy star iii - generations of doom (bra).bin",                                       0x000000, 0xc0000,   CRC(2e9b4c23) SHA1(59ccfc6b85b95666d0e2c85e3e08c847c4a7ad34) )
MEGADRIVE_ROM_LOAD( pstar3j, "phantasy star iii - toki no keishousha (jpn).bin",                                         0x000000, 0xc0000,   CRC(6c48c06f) SHA1(68b0f8e73dea5dca1b6ac8c0e12bc1d9761edf32) )
...
MEGADRIVE_ROM_LOAD( pstar4j, "phantasy star - sennenki no owari ni (jpn).bin",                                           0x000000, 0x300000,  CRC(f0bfad42) SHA1(9d330d5e395b7caae11fae92f71d259b8391904b) )
MEGADRIVE_ROM_LOAD( pstar4pa, "phantasy star iv (prototype - aug 15, 1994).bin",                                          0x000000, 0x300000,  CRC(60137f25) SHA1(81fe74c288bcf97b70758442c520ec47308cfcee) )
MEGADRIVE_ROM_LOAD( pstar4pb, "phantasy star iv (prototype - jun 08, 1994).bin",                                          0x000000, 0x300000,  CRC(dc2e1c0a) SHA1(d72b9d68cfb54b4221f3a2416eac30a94accd427) )
MEGADRIVE_ROM_LOAD( pstar4pc, "phantasy star iv (prototype - may 30, 1994).bin",                                          0x000000, 0x300000,  CRC(b32b17e1) SHA1(803877f317eeaaec57af07451a5ccf9309db513c) )
MEGADRIVE_ROM_LOAD( pstar4pd, "phantasy star iv (prototype - nov 07, 1994).bin",                                          0x000000, 0x300000,  CRC(bda29cdf) SHA1(e0c3de9991a03fd48dc85caae6415aaac016ab4a) )
MEGADRIVE_ROM_LOAD( pstar4pe, "phantasy star iv (prototype - oct 27, 1994).bin",                                          0x000000, 0x300000,  CRC(12a2590a) SHA1(6720d3afcd28cad06ac15749843d2a6995f403dc) )
MEGADRIVE_ROM_LOAD( psycho, "psycho pinball (euro) (october 1994).bin",                                                  0x000000, 0x180000,  CRC(d704784b) SHA1(699db175ab8a6abdd941b8a3d81cf203e01053f5) )
MEGADRIVE_ROM_LOAD( psycho1, "psycho pinball (euro) (september 1994).bin",                                               0x000000, 0x180000,  CRC(11e9c3f2) SHA1(2ea7befb7e52334111385667030ceb647157a397) )
MEGADRIVE_ROM_LOAD( psyobl, "psy-o-blade (jpn).bin",                                                                     0x000000, 0xa0000,   CRC(8ba7e6c5) SHA1(274d98e0c04caed378f1dd489dc3741b9ad13a88) )
MEGADRIVE_ROM_LOAD( puggsy, "puggsy (euro).bin",                                                                         0x000000, 0x100000,  CRC(5d5c9ade) SHA1(89a347f35c4d0d364c284f2f32f708d0378b8735) )
...
MEGADRIVE_ROM_LOAD( pulseman, "pulseman (jpn).bin",                                                                      0x000000, 0x200000,  CRC(138a104e) SHA1(5fd76a5f80e4684b5f9d445ddb893679985684e6) )
MEGADRIVE_ROM_LOAD( punisher, "punisher, the (euro).bin",                                                                0x000000, 0x200000,  CRC(729edd17) SHA1(d11ec72726498e4608eefc1ef2b8a3cadb025394) )
...
MEGADRIVE_ROM_LOAD( putter, "putter golf (jpn) (sn).bin",                                                                0x000000, 0x40000,   CRC(20f168a6) SHA1(345af8995cf9d88f7c4d8cfd81c8ccd45e6478fc) )
MEGADRIVE_ROM_LOAD( puttergnk, "putter golf (jpn) (gnk).bin",                                                            0x000000, 0x40000,   CRC(a6557faa) SHA1(9c4bc513a00f5bb5f7c72b41999d9c8c12345acf) )
MEGADRIVE_ROM_LOAD( puyo, "puyo puyo (jpn).bin",                                                                         0x000000, 0x80000,   CRC(7f26614e) SHA1(02656b5707cf9452d4cf48378ffd3a95dc84e9c5) )
MEGADRIVE_ROM_LOAD( puyo2, "puyo puyo 2 (jpn) (v1.1).bin",                                                               0x000000, 0x200000,  CRC(25b7b2aa) SHA1(d9c0edaadf66f215565a9dd4178313581fec811c) )
MEGADRIVE_ROM_LOAD( puyo2a, "puyo puyo 2 (jpn).bin",                                                                     0x000000, 0x200000,  CRC(51ad7797) SHA1(b9fd6e14f446a16927b54de0234bcd981a86488f) )
MEGADRIVE_ROM_LOAD( pyramid, "pyramid magic (jpn) (sn).bin",                                                             0x000000, 0x40000,   CRC(306d839e) SHA1(e32382b419d63186dc4f5521045cae2145cb7975) )
MEGADRIVE_ROM_LOAD( pyramid2, "pyramid magic ii (jpn) (sn).bin",                                                         0x000000, 0x40000,   CRC(c9ddac72) SHA1(b74feb0b7f5f6eaac72f0895b51a8f8421dcb768) )
MEGADRIVE_ROM_LOAD( pyramid3, "pyramid magic iii (jpn) (sn).bin",                                                        0x000000, 0x40000,   CRC(8329820a) SHA1(c386a1fc6cf5d0d6f0d2eba0b2ddda649143da67) )
MEGADRIVE_ROM_LOAD( pyramidgnk, "pyramid magic (jpn) (gnk).bin",                                                         0x000000, 0x40000,   CRC(b20272ea) SHA1(8fa4936dabbb662f006367e9fd31595e9bfc7907) )
MEGADRIVE_ROM_LOAD( pyramids, "pyramid magic special (jpn) (sn).bin",                                                    0x000000, 0x40000,   CRC(153a3afa) SHA1(010a336bedc1022846f3498693cd6b5218a05b4c) )
MEGADRIVE_ROM_LOAD( quacksht, "mpr-14371.bin",                                                                           0x000000, 0x80000,   CRC(5dd28dd7) SHA1(ca02845fa49cd46ccb0a4023b91b10695573668e) ) // dump without mirrored data, need proper emulation
...
MEGADRIVE_ROM_LOAD( radrex, "radical rex (euro).bin",                                                                    0x000000, 0x100000,  CRC(d02d3282) SHA1(c8dc73b7cabf43813f9cf09370a4437af4f1573f) )
MEGADRIVE_ROM_LOAD( radrexu, "radical rex (usa).bin",                                                                    0x000000, 0x100000,  CRC(2e6eec7e) SHA1(51019abbb8a4fc246eacd5f553628b74394fab66) )
MEGADRIVE_ROM_LOAD( ragnacen, "shin souseiki ragnacenty (jpn).bin",                                                      0x000000, 0x200000,  CRC(6a3f5ae2) SHA1(e0df9f3cb64beb3ea921653eccdd45aca6abc0aa) )
MEGADRIVE_ROM_LOAD( ragnacenb, "shin souseiki ragnacenty (jpn) (beta).bin",                                              0x000000, 0x100000,  CRC(43797455) SHA1(963f13f74d648c573ced103b2803d15d0a2742e8) )
MEGADRIVE_ROM_LOAD( ragnacenk, "ragnacenty (kor).bin",                                                                   0x000000, 0x200000,  CRC(77b5b10b) SHA1(40265aae1b43f004434194038d32ca6b4841707d) )
MEGADRIVE_ROM_LOAD( raiden, "raiden trad -- raiden densetsu (usa, jpn).bin",                                             0x000000, 0x100000,  CRC(f839a811) SHA1(9d4011d650179c62acdba0ed58143aa77b97d0e9) )
MEGADRIVE_ROM_LOAD( rainbow, "rainbow islands extra (jpn).bin",                                                          0x000000, 0x80000,   CRC(c74dcb35) SHA1(e35fcc88e37d1691cd2572967e1ae193fcd303eb) )
...
MEGADRIVE_ROM_LOAD( rambo3a, "mpr-12651.bin",                                                                            0x000000, 0x40000,   CRC(2232f03d) SHA1(ece53156a43fe14597a44f36a4e65e13cfc6d9d5) )
MEGADRIVE_ROM_LOAD( rampart, "rampart (usa).bin",                                                                        0x000000, 0x80000,   CRC(9c4dd057) SHA1(9dd4ee99e2ccf8759446d355584a9cbf685a3d8b) )
MEGADRIVE_ROM_LOAD( rampartj, "rampart (jpn, kor).bin",                                                                  0x000000, 0x80000,   CRC(16ead64c) SHA1(15f9284da9b27b2803bc53790b51b9dac5185a09) )
MEGADRIVE_ROM_LOAD( rangerx, "ranger-x (euro).bin",                                                                      0x000000, 0x100000,  CRC(b8c04804) SHA1(53908ee1c47f0d9d49e81fc295379552e2198948) )
...
MEGADRIVE_ROM_LOAD( ransei, "ransei no hasha (jpn).bin",                                                                 0x000000, 0x100000,  CRC(a9a0083d) SHA1(7c431e26226b99d09d61c4dc64131b2d81ae870e) )
...
MEGADRIVE_ROM_LOAD( rastans2j, "rastan saga ii (jpn).bin",                                                               0x000000, 0x80000,   CRC(ebacfb5a) SHA1(e7bd8367ae962af48a2e937bf6ced253f428b03d) )
...
MEGADRIVE_ROM_LOAD( rbi4j, "r.b.i. baseball 4 (jpn).bin",                                                                0x000000, 0x100000,  CRC(8f4e1005) SHA1(1cde0942bbbc9e88973ee56da06ccaabdcd34805) )
...
MEGADRIVE_ROM_LOAD( rbi94, "r.b.i. baseball '94 (euro, usa).bin",                                                        0x000000, 0x200000,  CRC(4eb4d5e4) SHA1(3e94f52d311fae140da870f55e3cb103d7923d44) )
MEGADRIVE_ROM_LOAD( redzone, "red zone (euro, usa).bin",                                                                 0x000000, 0x200000,  CRC(56512ee5) SHA1(2e01a1ee8ff31b3eee0c422d30b529aedd7ffdc1) )
MEGADRIVE_ROM_LOAD( renstim, "ren & stimpy show presents stimpy's invention, the (euro).bin",                            0x000000, 0x100000,  CRC(c276c220) SHA1(34d520d8a835e386c26793f216b1dc8f78d8f67a) )
...
MEGADRIVE_ROM_LOAD( renstimub, "ren & stimpy show presents stimpy's invention, the (usa) (beta).bin",                    0x000000, 0x100000,  CRC(fcb86336) SHA1(85e2e41d31bde9acc98070014640c00ba8dba6f8) )
MEGADRIVE_ROM_LOAD( renthero, "mpr-14187.bin",                                                                           0x000000, 0x100000,  CRC(2e515f82) SHA1(a07e4d56c9842e1177df9016fb9478060dc4c1c6) )
MEGADRIVE_ROM_LOAD( resq, "resq (euro) (prototype).bin",                                                                 0x000000, 0x100000,  CRC(558e35e0) SHA1(f572443bd1e0cf956c87e6cd925412cb0f35045f) )
MEGADRIVE_ROM_LOAD( revshin, "mpr-12930b.bin",                                                                           0x000000, 0x80000,   CRC(4d35ebe4) SHA1(7ed6f142884a08bb3c07a2e6e35405440343502f) )
MEGADRIVE_ROM_LOAD( revshin1, "revenge of shinobi, the (euro, usa) (rev a).bin",                                         0x000000, 0x80000,   CRC(fe91ab7e) SHA1(76af6ca97df08f2370f3a7fc2311781a0f147f4b) )
MEGADRIVE_ROM_LOAD( revshin2, "revenge of shinobi, the (euro, usa).bin",                                                 0x000000, 0x80000,   CRC(05f27994) SHA1(a88546e159bc882bf05eba66c09a3b21dee4154e) )
MEGADRIVE_ROM_LOAD( revx, "revolution x (euro, usa).bin",                                                                0x000000, 0x400000,  CRC(5fb0c5d4) SHA1(e1c8011ff878c7d99236ddd4008dd284e1c28333) )
MEGADRIVE_ROM_LOAD( riddle, "riddle wired (jpn) (sn).bin",                                                               0x000000, 0x40000,   CRC(fae3d720) SHA1(662ffc946978030125dc1274aeec5196bc9a721b) )
MEGADRIVE_ROM_LOAD( ringspow, "rin09.bin",                                                                               0x000000, 0x100000,  CRC(41fcc497) SHA1(84851ce4527761b8d74ce581c19e15d0dd17f368) )
MEGADRIVE_ROM_LOAD( risk, "risk (usa).bin",                                                                              0x000000, 0x80000,   CRC(80416d0d) SHA1(6f4bf5e1dc0de79e42934e5867641e1baadba0d9) )
MEGADRIVE_ROM_LOAD( riskyw, "risky woods (euro, usa).bin",                                                               0x000000, 0x100000,  CRC(d975e93c) SHA1(5664febf187d26274996c888778b0ff5268474f2) )
MEGADRIVE_ROM_LOAD( ristar, "ristar (euro, usa) (september 1994).bin",                                                   0x000000, 0x200000,  CRC(6511aa61) SHA1(1d15ff596dd4f3b2c1212a2e0c6e2b72f62c001e) )
MEGADRIVE_ROM_LOAD( ristar1, "ristar (euro, usa) (august 1994).bin",                                                     0x000000, 0x200000,  CRC(9700139b) SHA1(cf0215feddd38f19cd2d27bfa96dd4d742ba8bf7) )
MEGADRIVE_ROM_LOAD( ristarj, "ristar - the shooting star (jpn, kor).bin",                                                0x000000, 0x200000,  CRC(ce464f0e) SHA1(a4dd8dc0b673afe7372ba9c05c8d6090302dcf4e) )
...
MEGADRIVE_ROM_LOAD( roadbj, "roadblasters (jpn).bin",                                                                    0x000000, 0x80000,   CRC(a0015440) SHA1(7127e76ea33512d14cd78e6cac72ff8578454e1e) )
MEGADRIVE_ROM_LOAD( roadrash, "road rash (euro, usa).bin",                                                               0x000000, 0xc0000,   CRC(dea53d19) SHA1(8ff2b2a58b09c42eeb95f633bd8ea5227ac71358) ) // Road Rash seems to suffer the same dumping problems of F22 September 1991 revision, needs a proper dump
MEGADRIVE_ROM_LOAD( robocop3, "robocop 3 (euro, usa).bin",                                                               0x000000, 0x80000,   CRC(34fb7b27) SHA1(7860eb700d85801831ea14501b47bcaa1753c9fc) )
MEGADRIVE_ROM_LOAD( robotb, "robot battler (jpn) (sn).bin",                                                              0x000000, 0x40000,   CRC(fdf23eff) SHA1(1e5cbfa3dfbab399a84f5f249c7f5dec9ecd0026) )
MEGADRIVE_ROM_LOAD( roboterm, "robocop versus the terminator (euro).bin",                                                0x000000, 0x200000,  CRC(85a93f8d) SHA1(21348f50ccb0031108ce3fb999026688e9bef4ed) )
MEGADRIVE_ROM_LOAD( robotermb, "robocop versus the terminator (beta).bin",                                               0x000000, 0x200000,  CRC(2487049f) SHA1(a1625783cf1b42d808ad4f56dde5ce1b1884218a) )
MEGADRIVE_ROM_LOAD( robotermb1, "robocop versus the terminator (beta) (alt).bin",                                        0x000000, 0x200000,  CRC(ecebff29) SHA1(4d35cdf21f50c1cf73bacc9b8747a9eac1141e46) )
...
MEGADRIVE_ROM_LOAD( rocket, "fx004.bin",                                                                                 0x000000, 0x100000,  CRC(8eedfd51) SHA1(cb741f868b0eba17819a27e37cda96f33674c342) )
MEGADRIVE_ROM_LOAD( rocketj, "rocket knight adventures (jpn).bin",                                                       0x000000, 0x100000,  CRC(d1c8c1c5) SHA1(76d33c8549cd86cb1a4d17ac6eb8dd47c2f07d03) )
...
MEGADRIVE_ROM_LOAD( rockman, "rockman mega world (jpn).bin",                                                             0x000000, 0x200000,  CRC(4d87235e) SHA1(4dfcf5c07106f6db4d8b7e73a053bb46a21686c3) )
MEGADRIVE_ROM_LOAD( rockman1, "rockman mega world (jpn) (alt).bin",                                                      0x000000, 0x200000,  CRC(85c956ef) SHA1(a435ac53589a29dbb655662c942daab425d3f6bd) )
MEGADRIVE_ROM_LOAD( rockmnx3, "rockman x3 (unl).bin",                                                                    0x000000, 0x200000,  CRC(3ee639f0) SHA1(37024d0088fab1d76c082014663c58921cdf33df) )
MEGADRIVE_ROM_LOAD( rocknr, "rock n' roll racing (euro).bin",                                                            0x000000, 0x100000,  CRC(bc5a0562) SHA1(c4d84425c007711f006a67d6577fd90f421605e5) )
...
MEGADRIVE_ROM_LOAD( rolo, "rolo to the rescue (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(306861a2) SHA1(8f27907df777124311b7415cd52775641276cf0d) )
MEGADRIVE_ROM_LOAD( ronald, "ronaldinho 98 (pirate).bin",                                                                0x000000, 0x200000,  CRC(dd27c84e) SHA1(183ba7d8fe6bcddf0b7738c9ef2aa163725eb261) )
MEGADRIVE_ROM_LOAD( royalb, "royal blood (jpn).bin",                                                                     0x000000, 0x100000,  CRC(0e0107f1) SHA1(914f684f085927257020ffaa1ca536ec057e1603) )
MEGADRIVE_ROM_LOAD( rrash2, "road rash ii (euro, usa) (v1.2).bin",                                                       0x000000, 0x100000,  CRC(0876e992) SHA1(9afea43ed627671b50dd4a2abdd043b235414b91) )
MEGADRIVE_ROM_LOAD( rrash2a, "rr205.bin",                                                                                0x000000, 0x100000,  CRC(7b29c209) SHA1(6fa6420a2abcf5c2c4620c19b1f2a831996af481) )
MEGADRIVE_ROM_LOAD( rrash2j, "road rash ii (jpn).bin",                                                                   0x000000, 0x100000,  CRC(9a5723b6) SHA1(d89d7707cd4f30eef1fd2fd7e322d760ba8d6786) )
MEGADRIVE_ROM_LOAD( rrash3, "rr3b3.bin",                                                                                 0x000000, 0x200000,  CRC(15785956) SHA1(b2324833bf81223a9626a6060cafc203dd203468) )
...
MEGADRIVE_ROM_LOAD( rthun2, "rolling thunder 2 (euro).bin",                                                              0x000000, 0x100000,  CRC(c440f292) SHA1(e8ae09b2945eac555d6f0d39a1f768724b221357) )
MEGADRIVE_ROM_LOAD( rthun2j, "rolling thunder 2 (jpn).bin",                                                              0x000000, 0x100000,  CRC(965b2628) SHA1(6e15ce792fbe01b918b197deea320f953aa989cc) )
...
MEGADRIVE_ROM_LOAD( rugbyw, "rugby world cup 1995 (euro, usa).bin",                                                      0x000000, 0x200000,  CRC(61f90a8a) SHA1(9b435c82b612e23cb512efaebf4d35b203339e44) )
MEGADRIVE_ROM_LOAD( runark, "runark (jpn, kor).bin",                                                                     0x000000, 0x80000,   CRC(0894d8fb) SHA1(25a0322db3b82e3da6f1dab550b3e52f21be6b58) )
MEGADRIVE_ROM_LOAD( ryuuko, "ryuuko no ken (jpn).bin",                                                                   0x000000, 0x200000,  CRC(054cf5f6) SHA1(c4adc3fc6e1130f64440c7dc2673b239f1523626) )
MEGADRIVE_ROM_LOAD( s3d, "sonic 3d blast -- sonic 3d - flickies' island (euro, usa, kor).bin",                           0x000000, 0x400000,  CRC(44a2ca44) SHA1(89957568386a5023d198ac2251ded9dfb2ab65e7) )
...
MEGADRIVE_ROM_LOAD( sailorm, "bishoujo senshi sailor moon (jpn).bin",                                                    0x000000, 0x200000,  CRC(5e246938) SHA1(7565b0b19fb830ded5e90399f552c14c2aacdeb8) )
MEGADRIVE_ROM_LOAD( samesame, "mpr-13301.bin",                                                                           0x000000, 0x80000,   CRC(77bbd841) SHA1(b0d2552c5aae75dbe2d63600c0dbd64868c2f2c5) )
MEGADRIVE_ROM_LOAD( sampra96, "sampras tennis 96 (euro) (j-cart).bin",                                                   0x000000, 0x200000,  CRC(14e3fb7b) SHA1(139b9cea418c7c932033ddff87bf10466828cbfa) )
MEGADRIVE_ROM_LOAD( samsho, "samurai shodown (euro).bin",                                                                0x000000, 0x300000,  CRC(c972014f) SHA1(86384123c49c05b6f90cffd7327c11882f01e9c0) )
...
MEGADRIVE_ROM_LOAD( samspir, "samurai spirits (jpn).bin",                                                                0x000000, 0x300000,  CRC(0ea2ae36) SHA1(54a54996035b220ce72aa7e725f99860e3cd66a0) )
MEGADRIVE_ROM_LOAD( sangok2, "mpr-14455.bin",                                                                            0x000000, 0x100000,  CRC(437ba326) SHA1(d9a912caacaa476a890564f62b6ce9cc8f60496e) )
MEGADRIVE_ROM_LOAD( sangok3, "sangokushi iii (jpn).bin",                                                                 0x000000, 0x180000,  CRC(a8de6aea) SHA1(c85d03a6bcfeccc66ea3fa3cbda006c83576815f) )
MEGADRIVE_ROM_LOAD( sangokr, "sangokushi retsuden - ransei no eiyuutachi (jpn).bin",                                     0x000000, 0x100000,  CRC(0f56785a) SHA1(9b79f91060e68b9f6f48c8a5f38bc9873d03c4a9) )
...
MEGADRIVE_ROM_LOAD( sanguo5, "san guo zhi v (china) (unl).bin",                                                          0x000000, 0x200000,  CRC(cd7e53d0) SHA1(1a3333983f40dd242ad86187e50d1abed68d5ae9) )
MEGADRIVE_ROM_LOAD( sb2020, "super02.bin",                                                                               0x000000, 0x200000,  CRC(c17acee5) SHA1(a6ea6dcc33d60cf4d3be75b1cc867699811f8b3a) )
MEGADRIVE_ROM_LOAD( sb2020j, "2020 toshi super baseball (jpn).bin",                                                      0x000000, 0x200000,  CRC(2bbee127) SHA1(3d00178aecd7611c7e4ad09ea07e8436de6a5375) )
...
MEGADRIVE_ROM_LOAD( scrabble, "scrabble (euro) (prototype).bin",                                                         0x000000, 0x100000,  CRC(360b2610) SHA1(b2a06070eda30eb2ef745dcb2676dc25d39a07ed) )
MEGADRIVE_ROM_LOAD( scrack, "sonic crackers (jpn) (prototype).bin",                                                      0x000000, 0x100000,  CRC(7fada88d) SHA1(05f460a6ebbc1f86eb40b5f762083a59fb29f3e2) )
MEGADRIVE_ROM_LOAD( sdkong99a, "super donkey kong 99 (unl).bin",                                                         0x000000, 0x200000,  CRC(8e7d9177) SHA1(91f6b10ada917e6dfdafdd5ad9d476723498a7a4) )
MEGADRIVE_ROM_LOAD( sdm, "show do milhao (bra).bin",                                                                     0x000000, 0x200000,  CRC(0a22df04) SHA1(6f6ade812eb18e093a53773b8481c78f5a25631c) )
MEGADRIVE_ROM_LOAD( sdm2, "show do milhao volume 2 (bra).bin",                                                           0x000000, 0x200000,  CRC(48ee66cb) SHA1(8f713ef6035b616877ed9a09bac07913470c1f2f) )
MEGADRIVE_ROM_LOAD( sdm2a, "show do milhao volume 2 (bra) (alt).bin",                                                    0x000000, 0x200000,  CRC(d8c9ac6d) SHA1(d9c3b494086fef2fa59e031436756236f3cfdf22) )
MEGADRIVE_ROM_LOAD( sdvalis, "sd valis (jpn).bin",                                                                       0x000000, 0x80000,   CRC(1aef72ea) SHA1(4b4509936a75cb9b3b6fbf75b617be475cb99ffd) )
MEGADRIVE_ROM_LOAD( seaquest, "seaquest dsv (euro).bin",                                                                 0x000000, 0x200000,  CRC(0bb511bd) SHA1(e0324a23bc26b40f7e564ae864afb8ede1776f6e) )
...
MEGADRIVE_ROM_LOAD( second, "second samurai (euro).bin",                                                                 0x000000, 0x100000,  CRC(78e92143) SHA1(72bfe0d4c56d9600a39fae00399fef157eb1fe6f) )
MEGADRIVE_ROM_LOAD( segachnl, "sega channel (usa).bin",                                                                  0x000000, 0x40000,   CRC(bc79b6ed) SHA1(23a32e7709fc78b1b217a9d4bf2556117d7b431a) )
MEGADRIVE_ROM_LOAD( segasp, "sega sports 1 (euro).bin",                                                                  0x000000, 0x280000,  CRC(07fedaf1) SHA1(ff03bb2aced48c82de0ddfb048b114ec84daf16a) )
MEGADRIVE_ROM_LOAD( segatop, "sega top five (bra).bin",                                                                  0x000000, 0x200000,  CRC(61069069) SHA1(b13ba8e49fb9e8b41835e3d4af86ad25f27c804c) )
MEGADRIVE_ROM_LOAD( sensibie, "sensible soccer - international edition (euro).bin",                                      0x000000, 0x80000,   CRC(04e3bcca) SHA1(b88833ba92e084d4433e2b22eeb67e71ed36cd5c) )
MEGADRIVE_ROM_LOAD( sensible, "mpr-16014.bin",                                                                           0x000000, 0x80000,   CRC(f9b396b8) SHA1(2ee1ad4aac354b6d227b16976f0875f4625ff604) )
...
MEGADRIVE_ROM_LOAD( sf2, "mpr-15910+mpr-15911.bin",                                                                      0x000000, 0x300000,  CRC(56d41136) SHA1(2a406e2e4743de98785c85322f858abfb8221ae0) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( sf2j, "street fighter ii' plus (jpn, asia, kor).bin",                                                0x000000, 0x300000,  CRC(2e487ee3) SHA1(0d624f1a34014ead022dd8d5df1134a88eca69bb) )
MEGADRIVE_ROM_LOAD( sf2pir, "street fighter ii' turbo (pirate).bin",                                                     0x000000, 0x200000,  CRC(a85491ae) SHA1(23e1e1b587a7d2d1a82599d82d01c9931ca7b4cf) )
...
MEGADRIVE_ROM_LOAD( sfzone, "mpr-15124.bin",                                                                             0x000000, 0x100000,  CRC(927975be) SHA1(ed4f8a98eed7838d29fa31a6f34d11f6d8887c7f) )
MEGADRIVE_ROM_LOAD( sfzonej, "super fantasy zone (jpn).bin",                                                             0x000000, 0x100000,  CRC(767780d7) SHA1(14dc8568205f3b1b89ce14b9412541ce4ae47f91) )
...
MEGADRIVE_ROM_LOAD( shangha2, "shanghai ii - dragon's eye (usa).bin",                                                    0x000000, 0x100000,  CRC(ebe9e840) SHA1(7d6dc54b8943880a5fd26af10364eb943e9724c2) )
MEGADRIVE_ROM_LOAD( shangha2b, "shanghai ii - dragon's eye (beta).bin",                                                  0x000000, 0x100000,  CRC(154aca2d) SHA1(89150c5d976870868e2a11b474b4c0f9e2a786a9) )
MEGADRIVE_ROM_LOAD( shangha2b1, "shanghai ii - dragon's eye (beta) (alt).bin",                                           0x000000, 0x100000,  CRC(5e33867b) SHA1(bd136fd6485b653456a8bf27837ce20139b28dcc) )
MEGADRIVE_ROM_LOAD( shanew, "shane warne cricket (aus).bin",                                                             0x000000, 0x100000,  CRC(68865f6f) SHA1(4264625be91c3d96edca9c5bfe6259d00ca8b737) )
MEGADRIVE_ROM_LOAD( shangai3, "dragon's eye plus - shanghai iii (jpn).bin",                                              0x000000, 0x40000,   CRC(81f0c3cf) SHA1(b5a2a3b0b65058614d24853c525505b709f00851) )
MEGADRIVE_ROM_LOAD( shangon, "mpr-12640a.bin",                                                                           0x000000, 0x80000,   CRC(3877d107) SHA1(e58a8e6c472a34d9ecf3b450137df8a63ec9c791) )
MEGADRIVE_ROM_LOAD( shangon1, "mpr-12640.bin",                                                                           0x000000, 0x80000,   CRC(cb2201a3) SHA1(ecfd7b3bf4dcbee472ddf2f9cdbe968a05b814e0) )
MEGADRIVE_ROM_LOAD( shaqfu, "sfb2_u1+sfb2_u2.bin",                                                                       0x000000, 0x300000,  CRC(499955f2) SHA1(1ad8cd54f8fe474da01d1baba98491411c4cedaf) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( sharr, "mpr-12355.bin",                                                                              0x000000, 0x80000,   CRC(e5c9cbb0) SHA1(db4285e4ffb69aa9f1ca68c4103fbfd0843f7b86) )
MEGADRIVE_ROM_LOAD( sharrj, "mpr-11934.bin",                                                                             0x000000, 0x80000,   CRC(edc0fb28) SHA1(5836fbe907610ff15286911457049933b7cdd49c) )
MEGADRIVE_ROM_LOAD( shdanc, "mpr-13571.bin",                                                                             0x000000, 0x80000,   CRC(ebe9ad10) SHA1(c5f096b08470a564a737140b71247748608c32b6) )
...
MEGADRIVE_ROM_LOAD( shdwrunj, "shadowrun (jpn).bin",                                                                     0x000000, 0x200000,  CRC(d32199f7) SHA1(e28bb51227abcc71aaf18d445d3651054247c662) )
...
MEGADRIVE_ROM_LOAD( shijie, "shi jie zhi bang zheng ba zhan - world pro baseball 94 (china) (unl).bin",                  0x000000, 0x200000,  CRC(72dd884f) SHA1(d05c770312feec38c45b910ad09204b87961c01a) )
MEGADRIVE_ROM_LOAD( shikinjo, "shikinjoh (jpn).bin",                                                                     0x000000, 0x80000,   CRC(5ea0c97d) SHA1(34add3f084636d671b48e77a771329f23f8083cd) )
MEGADRIVE_ROM_LOAD( shindark, "shining in the darkness (euro, usa).bin",                                                 0x000000, 0x100000,  CRC(4d2785bc) SHA1(4e10c90199d6edd2030a4ba1c42c7c166bf309ec) )
MEGADRIVE_ROM_LOAD( shindarkbr, "shining in the darkness (bra).bin",                                                     0x000000, 0x100000,  CRC(3ee2bbc4) SHA1(08c6e884d48329c45d9f090aeea03efd4c1918c0) )
MEGADRIVE_ROM_LOAD( shindarkj, "mpr-13807.bin",                                                                          0x000000, 0x100000,  CRC(496af51c) SHA1(c09ff5bcee1a29a48c65be4ad584708b85ca549b) )
MEGADRIVE_ROM_LOAD( shinfrc2, "mpr-16933.bin",                                                                           0x000000, 0x200000,  CRC(83cb46d1) SHA1(a2ba86f4d756f98886f8f9a56f20cbf8c3b2945e) )
MEGADRIVE_ROM_LOAD( shinfrc2j, "shining force ii - koe no fuuin (jpn).bin",                                              0x000000, 0x200000,  CRC(0288f3e1) SHA1(8e1f1a510af4d43716d9ee34d47becf907dec147) )
...
MEGADRIVE_ROM_LOAD( shinfrcej, "shining force - kamigami no isan (jpn).bin",                                             0x000000, 0x180000,  CRC(9378fbcd) SHA1(ef8afbdc9af931d9da34d72efc8a76f0d5f4379d) )
MEGADRIVE_ROM_LOAD( shinobi3, "shinobi iii - return of the ninja master (euro).bin",                                     0x000000, 0x100000,  CRC(0b6d3eb5) SHA1(23579c8f7e2396080b478b113aff36d2382395a3) )
MEGADRIVE_ROM_LOAD( shinobi3u, "shinobi iii - return of the ninja master (usa).bin",                                     0x000000, 0x100000,  CRC(5381506f) SHA1(1e07d7998e3048fcfba4238ae96496460e91b3a5) )
MEGADRIVE_ROM_LOAD( ship, "ship (prototype).bin",                                                                        0x000000, 0x20000,   CRC(4cdc9f16) SHA1(95bab798ecd769567300e1dddfbed3aeee206e87) )
MEGADRIVE_ROM_LOAD( shiten, "shiten myouou (jpn).bin",                                                                   0x000000, 0x80000,   CRC(7e729693) SHA1(7bc3be0753b4ba8bbab2f5096e0efa0c0884dd98) )
MEGADRIVE_ROM_LOAD( shougi, "shougi no hoshi (jpn).bin",                                                                 0x000000, 0x40000,   CRC(4148f816) SHA1(097fc6e7b7d9152f538d973a1837c09b711bf9d2) )
...
MEGADRIVE_ROM_LOAD( shuihu, "shui hu - feng yun zhuan (china) (unl).bin",                                                0x000000, 0x200000,  CRC(3e9e010c) SHA1(7ac1b7a9e36dde9a03b3d0861b473ac9e1324175) )
MEGADRIVE_ROM_LOAD( shuihu1, "shui hu zhuan (china) (unl).bin",                                                          0x000000, 0x200000,  CRC(61e458c3) SHA1(f58c522bd0629833d3943ef4091c3c349c134879) )
MEGADRIVE_ROM_LOAD( shuramon, "shura no mon (jpn).bin",                                                                  0x000000, 0x100000,  CRC(e19da6e5) SHA1(22b58751fe7320c53a49e7c2c3e72b0500192d58) )
MEGADRIVE_ROM_LOAD( sidepock, "side pocket (euro).bin",                                                                  0x000000, 0x100000,  CRC(36e08145) SHA1(a19cd561397dfda55942cf4f9771b0e815f95f65) )
MEGADRIVE_ROM_LOAD( sidepockj, "side pocket (jpn).bin",                                                                  0x000000, 0x100000,  CRC(336bbf3e) SHA1(161c1f67b712d8f4f82115877072486832b913fb) )
...
MEGADRIVE_ROM_LOAD( sinv90, "space invaders 90 (jpn).bin",                                                               0x000000, 0x40000,   CRC(22adbd66) SHA1(d15830fd1070960d1696c1a9d48c9f7db3aa89e4) )
...
MEGADRIVE_ROM_LOAD( skelet, "skeleton krew (euro).bin",                                                                  0x000000, 0x200000,  CRC(5f872737) SHA1(9752fbd8508492dae252ae749393281ed9527de0) )
...
MEGADRIVE_ROM_LOAD( skitchin, "skitchin (euro, usa).bin",                                                                0x000000, 0x200000,  CRC(f785f9d7) SHA1(98be93964c14ebc91727b429dd7a7a563b4e2e9f) )
MEGADRIVE_ROM_LOAD( skpa, "sonic & knuckles (prototype 0525 - may 25, 1994, 15.28).bin",                                 0x000000, 0x400000,  CRC(8e8dadd0) SHA1(5f2c4dc4e739d562e9f0525361ba83f3e0551e21) )
MEGADRIVE_ROM_LOAD( skpb, "sonic & knuckles (prototype 0606 - jun 06, 1994, 10.02).bin",                                 0x000000, 0x200000,  CRC(03a52f63) SHA1(173524ffae78438b5ddd039ec8b8def786f28aee) )
MEGADRIVE_ROM_LOAD( skpc, "sonic & knuckles (prototype 0608 - jun 08, 1994, 05.03).bin",                                 0x000000, 0x200000,  CRC(7a6c1317) SHA1(a55b784590e602a82719d6721b2789f686564d2b) )
MEGADRIVE_ROM_LOAD( skpd, "sonic & knuckles (prototype 0610 - jun 10, 1994, 07.49).bin",                                 0x000000, 0x200000,  CRC(7092f368) SHA1(bc67cb9edb8958a66723a8346c9d58d43d18ca80) )
MEGADRIVE_ROM_LOAD( skpe, "sonic & knuckles (prototype 0612 - jun 12, 1994, 18.27).bin",                                 0x000000, 0x200000,  CRC(b0a253e8) SHA1(8585b617e6828bf0b255d4ef747384db7ff67826) )
MEGADRIVE_ROM_LOAD( skpf, "sonic & knuckles (prototype 0618 - jun 18, 1994, 09.15).bin",                                 0x000000, 0x200000,  CRC(2615f5dc) SHA1(e365c42a2c754b9df98b5b74dbc3e7f94c1a84f4) )
MEGADRIVE_ROM_LOAD( skpg, "sonic & knuckles (prototype 0619 - jun 19, 1994, 08.18).bin",                                 0x000000, 0x200000,  CRC(1ea5b9d1) SHA1(b84d197e646ceece8681d35af3b4014c1bbeae35) )
MEGADRIVE_ROM_LOAD( skph, "sonic & knuckles (s2k chip) (prototype 0606 - jun 05, 1994, 22.25).bin",                      0x000000, 0x40000,   CRC(bd619ea9) SHA1(f557741d93f8d3e8a84099ab88f0331ced2875c8) )
MEGADRIVE_ROM_LOAD( skpi, "sonic & knuckles (s2k chip) (prototype 0608 - jun 08, 1994, 03.35).bin",                      0x000000, 0x40000,   CRC(6a5dcbe6) SHA1(f27434f63ce45de92c361b0b3aabdfde80c237da) )
MEGADRIVE_ROM_LOAD( skpj, "sonic & knuckles (s2k chip) (prototype 0610 - jun 10, 1994, 03.11).bin",                      0x000000, 0x40000,   CRC(0f6ff22b) SHA1(d2b4003a7110f258641b7b76d7716acbcb3b62ab) )
MEGADRIVE_ROM_LOAD( skpk, "sonic & knuckles (s2k chip) (prototype 0612 - jun 12, 1994, 18.18).bin",                      0x000000, 0x40000,   CRC(9a5f8183) SHA1(eb29700a161a1949ed3057a3580911c7932315a5) )
MEGADRIVE_ROM_LOAD( skpl, "sonic & knuckles (s2k chip) (prototype 0618 - jun 18, 1994, 9.07).bin",                       0x000000, 0x40000,   CRC(4dcfd55c) SHA1(70429f1d80503a0632f603bf762fe0bbaa881d22) )
...
MEGADRIVE_ROM_LOAD( slamdunk, "from tv animation slam dunk - kyougou makkou taiketsu! (jpn).bin",                        0x000000, 0x200000,  CRC(cdf5678f) SHA1(7161a12c2a477cff8e29fa51403eea12c03180c7) )
MEGADRIVE_ROM_LOAD( slammast, "saturday night slammasters (euro).bin",                                                   0x000000, 0x400000,  CRC(08fa5a3f) SHA1(f67f324165abdf148f80aabb319375dc3a504e17) )
...
MEGADRIVE_ROM_LOAD( slapfigh, "slap fight md (jpn).bin",                                                                 0x000000, 0x100000,  CRC(d6695695) SHA1(3cb992c70b4a5880a3e5f89211f29fe90486c0e0) )
...
MEGADRIVE_ROM_LOAD( slimew, "todd's adventures in slime world (usa).bin",                                                0x000000, 0x80000,   CRC(652e8b7d) SHA1(e558e39e3e556d20c789bf2823af64e1a5c78784) )
MEGADRIVE_ROM_LOAD( slimewj, "slime world (jpn).bin",                                                                    0x000000, 0x80000,   CRC(7ff5529f) SHA1(02cf05687a7f3f8177b2aff0a0cfbd5c490e557d) )
MEGADRIVE_ROM_LOAD( slord, "stormlord (usa).bin",                                                                        0x000000, 0x80000,   CRC(39ab50a5) SHA1(1bf4b58d50fdc0fdc173ce3dcadcc5d9b58f0723) )
MEGADRIVE_ROM_LOAD( slordj, "stormlord (jpn).bin",                                                                       0x000000, 0x80000,   CRC(0b440fed) SHA1(fe06ea2d7fcccecce337a535ae683c31aae4a637) )
MEGADRIVE_ROM_LOAD( smario2, "super mario 2 1998 (unl).bin",                                                             0x000000, 0x200000,  CRC(f7e1b3e1) SHA1(de10115ce6a7eb416de9cd167df9cf24e34687b1) )
MEGADRIVE_ROM_LOAD( smasters,  "naomichi ozaki no super masters (jpn).bin",                                              0x000000, 0x80000,   CRC(088ba825) SHA1(662a87d679066aad0638b2ffb01c807d9f376121) )
MEGADRIVE_ROM_LOAD( smb, "super mario bros. (unl).bin",                                                                  0x000000, 0x200000,  CRC(9cfa2bd8) SHA1(5011e16f0ab3a6487a1406b85c6090ad2d1fe345) )
MEGADRIVE_ROM_LOAD( smgp, "mpr-13250a.bin",                                                                              0x000000, 0x80000,   CRC(be91b28a) SHA1(1e49a449367f0ec7ba0331b7b0d074f796e48d58) )
MEGADRIVE_ROM_LOAD( smgp1, "super monaco gp (euro, jpn).bin",                                                            0x000000, 0x80000,   CRC(b1823595) SHA1(ed6f80546a7847bf06cf4a62b34d1c3b989e4d3e) )
MEGADRIVE_ROM_LOAD( smgpj, "mpr-13215.bin",                                                                              0x000000, 0x80000,   CRC(90f9bab3) SHA1(631b72e27b394ae6b5a1188dfa980333fc675379) )
MEGADRIVE_ROM_LOAD( smgpu, "super monaco gp (usa).bin",                                                                  0x000000, 0x80000,   CRC(725018ee) SHA1(1947d41598daa3880ecb826303abae2accd1857f) )
MEGADRIVE_ROM_LOAD( smurfs, "mpr-17019a.bin",                                                                            0x000000, 0x100000,  CRC(88b30eff) SHA1(0da7e621e05dc9160122d728e1fca645ff11e670) )
MEGADRIVE_ROM_LOAD( smurfs2, "smurfs travel the world, the (euro).bin",                                                  0x000000, 0x100000,  CRC(b28bdd69) SHA1(b4368369e1d5b9a60bc565fe09a9c5fff6b79fd4) )
MEGADRIVE_ROM_LOAD( smw, "super mario world (unl).bin",                                                                  0x000000, 0x200000,  CRC(cf540ba6) SHA1(517c3a6b091c2c4e8505112a84bae2871243e92c) )
MEGADRIVE_ROM_LOAD( smwa, "super mario world (unl) (pirate).bin",                                                        0x000000, 0x200000,  CRC(97c2695e) SHA1(ff6661d39b2bad26f460e16106ca369421388596) )
MEGADRIVE_ROM_LOAD( snakernr, "snake rattle n' roll (euro).bin",                                                         0x000000, 0x80000,   CRC(543bed30) SHA1(0773ae487319b68695e9a6c3dcd0223695c02609) )
MEGADRIVE_ROM_LOAD( snowbros, "snow bros. - nick & tom (jpn).bin",                                                       0x000000, 0x100000,  CRC(11b56228) SHA1(27caf554f48d2e3c9c6745f32dbff231eca66744) )
...
MEGADRIVE_ROM_LOAD( soleil, "mpr-17499.bin",                                                                             0x000000, 0x200000,  CRC(a30ebdb1) SHA1(110a61671b83fe17fba768ab85b535ca1cc6d7ea) )
...
MEGADRIVE_ROM_LOAD( sonic2i, "sonic the hedgehog 2 (world) (rev 01a).bin",                                               0x000000, 0x100000,  CRC(92d8817d) SHA1(4050c7ba90a53138407c66dcae9891e5a5c73e8f) ) // rip from console Sonic collections?
MEGADRIVE_ROM_LOAD( sonic2j, "sonic the hedgehog 2 (world) (rev sc02).bin",                                              0x000000, 0x100000,  CRC(f23ad4b3) SHA1(2af1003247aec262089c8df22d05e80d04a1b5e4) ) // rip from console Sonic collections?
...
MEGADRIVE_ROM_LOAD( sonic3, "mpr-16342.bin",                                                                             0x000000, 0x200000,  CRC(6a632503) SHA1(2ff45bb056ede0f745e52f8d02c54b4ca724ca4c) )
...
MEGADRIVE_ROM_LOAD( sonic3j, "sonic the hedgehog 3 (jpn, kor).bin",                                                      0x000000, 0x200000,  CRC(f4951d1f) SHA1(7b98b21b7274233e962132bc22a7ccdf548c0ddb) )
MEGADRIVE_ROM_LOAD( sonic3pir, "sonic the hedgehog 3 (pirate).bin",                                                      0x000000, 0x200000,  CRC(c818f6fd) SHA1(bc2b67803bbba89a456a464e679cde4b4bb567fb) )
...
MEGADRIVE_ROM_LOAD( soniccmp, "mpr-19693.bin",                                                                           0x000000, 0x400000,  CRC(c696aee3) SHA1(d96205b8aed14af9805e3375df6e52ed3c223aa4) ) // internal header size is 24 Megabits, but being a single chip size can only be 32 Megabits; needs a proper dump
MEGADRIVE_ROM_LOAD( soniccmp1, "mpr-18203+mpr-18204.bin",                                                                0x000000, 0x300000,  CRC(8c70b84e) SHA1(109e6d7b31d00fbdb9d4ecb304d4ea19e96c8607) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( sonicer, "sonic eraser (jpn) (sn).bin",                                                              0x000000, 0x40000,   CRC(62d8a0e7) SHA1(be70d4246be49c0301a1402bd93f28c58b558a8d) )
MEGADRIVE_ROM_LOAD( sonicj, "mpr-13933.bin",                                                                             0x000000, 0x80000,   CRC(afe05eee) SHA1(69e102855d4389c3fd1a8f3dc7d193f8eee5fe5b) )
MEGADRIVE_ROM_LOAD( sonicjam, "sonic jam 6 (unl).bin",                                                                   0x000000, 0x200000,  CRC(bf39d897) SHA1(3a6fe5a92dc2ada7e9ab17ac120c7e50d1f9a1ed) )
MEGADRIVE_ROM_LOAD( sonicjam1, "sonic jam 6 (unl) (pirate).bin",                                                         0x000000, 0x200000,  CRC(04f0c93e) SHA1(a9e316ccde5b71f6aa85485b6897c1cfc780742d) )
MEGADRIVE_ROM_LOAD( sonicpir, "sonic the hedgehog (euro, usa) (pirate).bin",                                             0x000000, 0x80000,   CRC(7a093f0b) SHA1(ad7502fa15b1819eeb4089783b4a850d898bc71e) )
MEGADRIVE_ROM_LOAD( sor, "mpr-14125a.bin",                                                                               0x000000, 0x80000,   CRC(4052e845) SHA1(731cdf182fe647e4977477ba4dd2e2b46b9b878a) )
MEGADRIVE_ROM_LOAD( sor2, "mpr-15309.bin",                                                                               0x000000, 0x200000,  CRC(42e3efdc) SHA1(a0d3a216278aef5564dcbed83df0dd59222812c8) )
MEGADRIVE_ROM_LOAD( sor2u, "streets of rage 2 (usa).bin",                                                                0x000000, 0x200000,  CRC(e01fa526) SHA1(8b656eec9692d88bbbb84787142aa732b44ce0be) )
MEGADRIVE_ROM_LOAD( sor3, "mpr-16834+mpr-16835.bin",                                                                     0x000000, 0x300000,  CRC(3b78135f) SHA1(5419f5eaf12201a662f03a79298a1b661005f73a) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( sor3k, "streets of rage 3 (kor).bin",                                                                0x000000, 0x300000,  CRC(90ef991e) SHA1(8c0bc5b66703efbdeef2d6ede5745aad89bd8a44) )
MEGADRIVE_ROM_LOAD( sor3pa, "streets of rage 3 (euro) (prototype - apr 12, 1994).bin",                                   0x000000, 0x300000,  CRC(a17ce5ab) SHA1(0b0fa81973bf2f0313e0f2041c8cdd1c220e9839) )
MEGADRIVE_ROM_LOAD( sor3pb, "streets of rage 3 (euro) (prototype - apr 13, 1994).bin",                                   0x000000, 0x300000,  CRC(164e42ae) SHA1(32df74ccf217e8258dee9acc50db540bbc68ca02) )
MEGADRIVE_ROM_LOAD( sor3pc, "streets of rage 3 (euro) (prototype - apr 15, 1994).bin",                                   0x000000, 0x300000,  CRC(c64f1e6b) SHA1(118e4a8a3891956e0b60bcf5a6dd631ba93794a3) )
MEGADRIVE_ROM_LOAD( sor3pd, "streets of rage 3 (euro) (prototype - apr 20, 1994).bin",                                   0x000000, 0x300000,  CRC(6ae4bd8e) SHA1(58feae0110f239ba7a58e447b86158705249b35b) )
MEGADRIVE_ROM_LOAD( sor3pe, "streets of rage 3 (euro) (prototype - apr 25, 1994).bin",                                   0x000000, 0x300000,  CRC(7033878a) SHA1(8a8cfc1e75f89cf72d7d783b29238f4a8b3ff568) )
...
MEGADRIVE_ROM_LOAD( sora, "mpr-14125.bin",                                                                               0x000000, 0x80000,   CRC(bff227c6) SHA1(3d74dbc81f3472a5bde45bf265e636a72a314667) )
...
MEGADRIVE_ROM_LOAD( sorcerkj, "sorcer kingdom (jpn).bin",                                                                0x000000, 0x100000,  CRC(944135ca) SHA1(16394aebece9d03f43505eab0827889e1c61857f) )
MEGADRIVE_ROM_LOAD( sorcern, "mpr-12906.bin",                                                                            0x000000, 0x80000,   CRC(a143a8c5) SHA1(cbd7f0693a0d127138977da7cdf5a7f9440dfd43) )
MEGADRIVE_ROM_LOAD( soukoban, "shijou saidai no soukoban (jpn).bin",                                                     0x000000, 0x40000,   CRC(40f4aacc) SHA1(4f5341f3cd0b648c2116593b3f706b634a7e0128) )
MEGADRIVE_ROM_LOAD( soulblad, "soul blade (unl).bin",                                                                    0x000000, 0x400000,  CRC(f26f88d1) SHA1(7714e01819ab4a0f424d7e306e9f891031d053a8) )
...
MEGADRIVE_ROM_LOAD( sp_sa, "spider-man and venom - separation anxiety (euro, usa).bin",                                  0x000000, 0x300000,  CRC(512ade32) SHA1(563b45254c168aa0de0bba8fadd75a2d1e8e094b) )
...
MEGADRIVE_ROM_LOAD( spacefb, "space funky b.o.b. (jpn).bin",                                                             0x000000, 0x100000,  CRC(e9310d3b) SHA1(2d0e4423e28d7175fc27a9c5b1cb86f1d5cedd3e) )
MEGADRIVE_ROM_LOAD( sparks, "sparkster (euro).bin",                                                                      0x000000, 0x100000,  CRC(d63e9f2d) SHA1(91057f22c5cea9bf08edf62862c56b939d570770) )
MEGADRIVE_ROM_LOAD( sparksj, "sparkster - rocket knight adventures 2 (jpn).bin",                                         0x000000, 0x100000,  CRC(914ec662) SHA1(49e813e108751d502bfb242551b40121c71c5442) )
...
MEGADRIVE_ROM_LOAD( speedbl2, "mpr-14990.bin",                                                                           0x000000, 0x80000,   CRC(056a6e03) SHA1(9c989b31de7de38bc488f825575b7f6c1db9dbee) )
MEGADRIVE_ROM_LOAD( speedbl2j, "speedball 2 (jpn).bin",                                                                  0x000000, 0x80000,   CRC(f5442334) SHA1(7da217a45fafb569baee190be6a660af428cf3e5) )
...
MEGADRIVE_ROM_LOAD( spidrman, "spider-man (euro, usa) (acclaim).bin",                                                    0x000000, 0x200000,  CRC(11b5b590) SHA1(a38d5ad7d503999b7fea3ebf59f3dda9d667758b) )
MEGADRIVE_ROM_LOAD( spidrmanb, "spider-man (usa) (acclaim) (beta).bin",                                                  0x000000, 0x200000,  CRC(b88a710d) SHA1(0bb3131108ed57c0cd12b646eb2b6dd73eb679f9) )
MEGADRIVE_ROM_LOAD( spidrmanb1, "spider-man (usa) (acclaim) (beta) (earlier).bin",                                       0x000000, 0x200000,  CRC(83e1fe76) SHA1(9b9f443499a547acdf029111df58b5a73ec4058f) )
MEGADRIVE_ROM_LOAD( spidsega, "mpr-14027.bin",                                                                           0x000000, 0x80000,   CRC(70ab775f) SHA1(250f7a7301a028450eef2f2a9dcec91f99ecccbd) )
MEGADRIVE_ROM_LOAD( spirit, "spiritual warfare (usa) (unl).bin",                                                         0x000000, 0x80000,   CRC(d9a364ff) SHA1(efd7f8c1d7daf7a0b6cac974de093f224f6e1c32) )
MEGADRIVE_ROM_LOAD( spirou, "spirou (euro).bin",                                                                         0x000000, 0x100000,  CRC(6634b130) SHA1(5f18db9c85df4eaf4647a0519c9dc966aee583fa) )
MEGADRIVE_ROM_LOAD( splatt2, "splatterhouse 2 (euro).bin",                                                               0x000000, 0x100000,  CRC(2559e03c) SHA1(e01940808006a346b8711a74fbfa173ec872624f) )
...
MEGADRIVE_ROM_LOAD( splatt3j, "splatterhouse part 3 (jpn, kor).bin",                                                     0x000000, 0x200000,  CRC(31b83d22) SHA1(1fcb8adfdb19cb772adabac14e78c560d4f2e718) )
MEGADRIVE_ROM_LOAD( sportg, "sport games (bra).bin",                                                                     0x000000, 0x200000,  CRC(7e3ecabf) SHA1(41604a07b0ac7dff9e01e6829cf84ca911620729) )
...
MEGADRIVE_ROM_LOAD( spotgo, "mpr-18680+mpr-18681.bin",                                                                   0x000000, 0x300000,  CRC(fbe254ea) SHA1(be1144c3d9d49dce2d5e1ab598ef0e2b730950b7) ) // two chips cart, needs a proper dump
...
MEGADRIVE_ROM_LOAD( squirrel, "squirrel king (china) (unl).bin",                                                         0x000000, 0x100000,  CRC(b8261ff5) SHA1(2a561b6e47c93272fe5947084837d9f6f514ed38) )
MEGADRIVE_ROM_LOAD( sracer, "mpr-17987.bin",                                                                             0x000000, 0x100000,  CRC(1a58d5fe) SHA1(95aa250ea47d14d60da9f0fed5b1aad1ff2c1862) )
MEGADRIVE_ROM_LOAD( srb, "mpr-13432.bin",                                                                                0x000000, 0x80000,   CRC(f04765ba) SHA1(0197df59951085dc7078c4ec66c75be84566530a) )
MEGADRIVE_ROM_LOAD( srbj, "mpr-12904.bin",                                                                               0x000000, 0x80000,   CRC(4346e11a) SHA1(c86725780027ef9783cb7884c8770cc030b0cd0d) )
MEGADRIVE_ROM_LOAD( sskid, "super skidmarks (euro) (j-cart).bin",                                                        0x000000, 0x200000,  CRC(4a9c62f9) SHA1(957850ce688dcf9c5966f6712b4804f0a5b7457d) )
MEGADRIVE_ROM_LOAD( sskidb, "super skidmarks (euro) (beta).bin",                                                         0x000000, 0x200000,  CRC(a61a0f0c) SHA1(1ec5fb1e7c8adfaf147271bd40454826fffed13e) )
MEGADRIVE_ROM_LOAD( ssmart, "street smart (usa, jpn).bin",                                                               0x000000, 0x80000,   CRC(b1dedfad) SHA1(a9cb2295b9cd42475904cba19b983e075a1b6014) )
MEGADRIVE_ROM_LOAD( ssmashtv, "mpr-15040.bin",                                                                           0x000000, 0x80000,   CRC(f22412b6) SHA1(0459f7c61f152fa0afa98d96ef9fbe4964641f34) )
MEGADRIVE_ROM_LOAD( sspin, "mpr-16077.bin",                                                                              0x000000, 0x100000,  CRC(aea0786d) SHA1(f61a568314133b60de82ac162b5b52473adc9e1c) )
MEGADRIVE_ROM_LOAD( sspinb, "sonic spinball (beta).bin",                                                                 0x000000, 0x140000,  CRC(b1524979) SHA1(b426457e5b440ed33ee1756bc6dad2bdcd0c0d9f) )
MEGADRIVE_ROM_LOAD( sspinj, "sonic spinball (jpn).bin",                                                                  0x000000, 0x100000,  CRC(acd08ce8) SHA1(43b2fdac9c747d6f6a629347c589599074408cd9) )
MEGADRIVE_ROM_LOAD( sspinu, "sonic spinball (usa).bin",                                                                  0x000000, 0x100000,  CRC(677206cb) SHA1(24bf6342b98c09775089c9f39cfb2f6fbe7806f7) )
MEGADRIVE_ROM_LOAD( sspinua, "sonic spinball (usa) (alt).bin",                                                           0x000000, 0x100000,  CRC(e9960371) SHA1(8f372e3552e309d3462adeb700242b251f59def1) )
...
MEGADRIVE_ROM_LOAD( sswordj, "saint sword (jpn).bin",                                                                    0x000000, 0x80000,   CRC(3960a00f) SHA1(e1e2bbbaf3e64c62fa695d1d1ee3496826951d13) )
MEGADRIVE_ROM_LOAD( starcr, "star cruiser (jpn).bin",                                                                    0x000000, 0x80000,   CRC(2b75b52f) SHA1(cb099ecde141beffdfed6bb7f1d3dc6340da81d1) )
...
MEGADRIVE_ROM_LOAD( starfl, "starflight (euro, usa) (v1.1).bin",                                                         0x000000, 0x100000,  CRC(1217dbea) SHA1(41722d8c0b4865ca8044fb53a818b13eded758fc) )
MEGADRIVE_ROM_LOAD( starfl1, "starflight (euro, usa).bin",                                                               0x000000, 0x100000,  CRC(d550c928) SHA1(24252ca934be3f005436cdb85671413a9e6b0489) )
MEGADRIVE_ROM_LOAD( starg, "stargate (euro, usa).bin",                                                                   0x000000, 0x200000,  CRC(e587069e) SHA1(d0843442059c89b11db02615670632fda2b2ee85) )
MEGADRIVE_ROM_LOAD( stargb, "stargate (euro) (beta).bin",                                                                0x000000, 0x200000,  CRC(8dc8ab23) SHA1(95a0dab802a313281d74fe66b21c7877078c57e9) )
MEGADRIVE_ROM_LOAD( stblad, "mpr-12354.bin",                                                                             0x000000, 0x80000,   CRC(b13087ee) SHA1(21810b4a309a5b9a70965dd440e9aeed0b6ca4c5) )
MEGADRIVE_ROM_LOAD( stbladj, "mpr-11996.bin",                                                                            0x000000, 0x80000,   CRC(8bd77836) SHA1(f40bef7a5a2e414d87335e3e56a2c34fb4f83fca) )
MEGADRIVE_ROM_LOAD( stds9, "star trek - deep space nine - crossroads of time (euro).bin",                                0x000000, 0x100000,  CRC(d4b122f9) SHA1(efc96336ccd83c31ab48ab48fe1e262c3ebcf0be) )
...
MEGADRIVE_ROM_LOAD( steeltal, "steel talons (euro, usa).bin",                                                            0x000000, 0x80000,   CRC(10e4ec63) SHA1(b4f0a13646c13911be5550103301af25827fcd0c) )
...
MEGADRIVE_ROM_LOAD( steeltalj, "steel talons (jpn, kor).bin",                                                            0x000000, 0x80000,   CRC(04f388e6) SHA1(93c51ec9fcc56d858642018905b3defc17442c26) )
MEGADRIVE_ROM_LOAD( storytho, "mpr-17588+mpr-17606.bin",                                                                 0x000000, 0x300000,  CRC(1110b0db) SHA1(178ef742dad227d4128fa81dddb116bad0cabe1d) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( storythof, "mpr-17720+mpr-17721.bin",                                                                0x000000, 0x300000,  CRC(b97cca1c) SHA1(677e1fbf2f6f90dd5a016f3bd5f305547249205a) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( storythog, "story of thor, the (germany).bin",                                                       0x000000, 0x300000,  CRC(fa20d011) SHA1(a82ffb7c4bf4b0f89f42a9cdc6600bc5bac1c854) )
MEGADRIVE_ROM_LOAD( storythoj, "story of thor, the - hikari o tsugumono (jpn).bin",                                      0x000000, 0x300000,  CRC(4f39783c) SHA1(54296f5cf1917c568bb29b0086641c282b8884bd) )
MEGADRIVE_ROM_LOAD( storythojb, "story of thor, the (jpn) (beta) (bad dump).bin",                                        0x000000, 0x1b0000, BAD_DUMP CRC(bfc11649) SHA1(ac1952f2f7cd4109561376f3097c4daec2ae64ae) )
MEGADRIVE_ROM_LOAD( storythok, "story of thor, the (kor).bin",                                                           0x000000, 0x300000,  CRC(ee1603c5) SHA1(e0a43fb3d6da940b1fda449753bffae637a802cd) )
MEGADRIVE_ROM_LOAD( storythop, "story of thor, the (prototype - oct 04, 1994).bin",                                      0x000000, 0x300000,  CRC(9e486f91) SHA1(499dd47c325874a231a8d8430aca0bb6feeb3dcd) )
MEGADRIVE_ROM_LOAD( storythop1, "story of thor, the (prototype - oct 17, 1994).bin",                                     0x000000, 0x300000,  CRC(aa43d34a) SHA1(e4b25941aefb58073784616acf7ca7458b213bee) )
MEGADRIVE_ROM_LOAD( storythop2, "story of thor, the (prototype - nov 01, 1994).bin",                                     0x000000, 0x300000,  CRC(fa59f847) SHA1(cb0606faeab0398244d4721d71cf7e1c5724a9ef) )
MEGADRIVE_ROM_LOAD( storythos, "story of thor, the (spain).bin",                                                         0x000000, 0x300000,  CRC(4631f941) SHA1(0fcc02355176e1c96043f4d827a3ff88d2d272df) )
MEGADRIVE_ROM_LOAD( strider, "mpr-13487.bin",                                                                            0x000000, 0x100000,  CRC(b9d099a4) SHA1(26fe42d13a01c8789bbad722ebac05b8a829eb37) )
MEGADRIVE_ROM_LOAD( strider2, "strider ii (euro).bin",                                                                   0x000000, 0x100000,  CRC(e85e5270) SHA1(c048bf092745654bb60a437ef1543abfd407093c) )
...
MEGADRIVE_ROM_LOAD( striderj, "strider hiryuu (jpn, kor).bin",                                                           0x000000, 0x100000,  CRC(859173f2) SHA1(4198030057a1a0479b382fc2d69cfe32a523fa32) )
MEGADRIVE_ROM_LOAD( striker, "striker (euro).bin",                                                                       0x000000, 0x200000,  CRC(cc5d7ab2) SHA1(9917c35a263cc9bd922d55bf59d01bc2733b4e24) )
MEGADRIVE_ROM_LOAD( strikerb, "striker (euro) (beta).bin",                                                               0x000000, 0x200000,  CRC(c10b270e) SHA1(128395e635e948005e89c7f4a6cd5b209be1ffbc) )
...
MEGADRIVE_ROM_LOAD( subt, "mpr-16627.bin",                                                                               0x000000, 0x200000,  CRC(e8ced28d) SHA1(23c6a0616f170f6616bc8214f3d45f1f293bba9f) )
MEGADRIVE_ROM_LOAD( subtb, "subterrania (beta).bin",                                                                     0x000000, 0x200000,  CRC(3a1022d1) SHA1(57279fa2bc9baf07d701be44e51e42d7f1e0e2a2) )
MEGADRIVE_ROM_LOAD( subtb1, "subterrania (beta) (earlier).bin",                                                          0x000000, 0x140000,  CRC(9c13d25c) SHA1(3766bfaf355cc239187255a142daddcd42d1fc58) )
MEGADRIVE_ROM_LOAD( subtj, "subterrania (jpn).bin",                                                                      0x000000, 0x200000,  CRC(7638ea91) SHA1(e4e25a7a9a583be0dd8e7aa0f1ab3e96b2180bc6) )
...
MEGADRIVE_ROM_LOAD( summer, "summer challenge (euro, usa).bin",                                                          0x000000, 0x200000,  CRC(d7d53dc1) SHA1(28d18ba3d2ac3f8fece0bf652e87d491c565b8df) )
MEGADRIVE_ROM_LOAD( sunset, "mpr-15305.bin",                                                                             0x000000, 0x80000,   CRC(0ff33054) SHA1(4a4f2cf397ade091e83e07bb3ffc7aa5862aeedd) )
...
MEGADRIVE_ROM_LOAD( supbub, "super bubble bobble (china) (unl).bin",                                                     0x000000, 0x100000,  CRC(4820a161) SHA1(03f40c14624f1522d6e3105997d14e8eaba12257) )
MEGADRIVE_ROM_LOAD( superair, "mpr-13814.bin",                                                                           0x000000, 0x80000,   CRC(fa451982) SHA1(d24a3d23c9f12eebfbd233fdaab91c4acc362962) )
MEGADRIVE_ROM_LOAD( superd, "mpr-12477.bin",                                                                             0x000000, 0x80000,   CRC(d50a166f) SHA1(56d9366b50cea65b16ed621b9a5bf355ef89e6b5) )
MEGADRIVE_ROM_LOAD( superhq,   "super h.q. (jpn).bin",                                                                   0x000000, 0x80000,   CRC(ab2c52b0) SHA1(0598e452e3d42b5e714bf5b32834000607483813) )
MEGADRIVE_ROM_LOAD( superoff, "super off road (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(8f2fdada) SHA1(89f264afba7aa8764b301d46cc8c51f74c23919e) )
MEGADRIVE_ROM_LOAD( suphy, "super hydlide (euro).bin",                                                                   0x000000, 0x80000,   CRC(1fe2d90b) SHA1(6c0a4b72b90ecfe8c324691bc6e54243746043c1) )
MEGADRIVE_ROM_LOAD( suphyj, "mpr-12632.bin",                                                                             0x000000, 0x80000,   CRC(599be386) SHA1(76bceb5915f3546c68c1fdb5fb0e205cd56a3fe6) )
...
MEGADRIVE_ROM_LOAD( suplg, "super league (euro).bin",                                                                    0x000000, 0x80000,   CRC(55baec6e) SHA1(fefc7abc2f9fbcc7992b1420b62eb3eb3d5ad1bb) )
MEGADRIVE_ROM_LOAD( suplgj, "super league (jpn).bin",                                                                    0x000000, 0x80000,   CRC(ea13cb1d) SHA1(9e975ba4c396617ff9535d51d0929f6d592478fc) )
MEGADRIVE_ROM_LOAD( supman, "mpr-15327.bin",                                                                             0x000000, 0x100000,  CRC(7db434ba) SHA1(c956730af44b737ee3d0c1e83c147f32e3504383) )
...
MEGADRIVE_ROM_LOAD( suprkick, "mpr-15420.bin",                                                                           0x000000, 0x80000,   CRC(f43793ff) SHA1(4e270b13a399d78d919157e50ab11f4645aa6d32) )
MEGADRIVE_ROM_LOAD( supshin, "mpr-12675.bin",                                                                            0x000000, 0x80000,   CRC(5c7e5ea6) SHA1(d5807a44d2059aa4ff27ecb7bdc749fbb0382550) )
MEGADRIVE_ROM_LOAD( supshin2, "super shinobi ii, the (jpn, kor).bin",                                                    0x000000, 0x100000,  CRC(5b412816) SHA1(e3dbe326aa93320d405c561c306fc3954ab8ea7c) )
MEGADRIVE_ROM_LOAD( supshin2b, "super shinobi ii, the (jpn) (beta).bin",                                                 0x000000, 0x100000,  CRC(c47e8aea) SHA1(e1eca5faec785f4e1093b088421a818e2fab29c1) )
MEGADRIVE_ROM_LOAD( supshin2b1, "super shinobi ii, the (jpn) (beta) (earlier).bin",                                      0x000000, 0x100000,  CRC(1ee5bce3) SHA1(182f65e634b6eecdadff55f41cd9b2d0e9e283f6) )
MEGADRIVE_ROM_LOAD( surgin, "surging aura (jpn).bin",                                                                    0x000000, 0x200000,  CRC(65ac1d2b) SHA1(9f14cd11cfa499cdd58248de81db30f9308326e5) )
...
MEGADRIVE_ROM_LOAD( svbj, "super volley ball (jpn).bin",                                                                 0x000000, 0x40000,   CRC(9b5c28ea) SHA1(d0a57b14dc08fad001e96de72a4111f6c9b22825) )
MEGADRIVE_ROM_LOAD( swordsod, "sword of sodan (euro, usa).bin",                                                          0x000000, 0x80000,   CRC(9cb8468f) SHA1(088b81c3bcda86b9803b7e3f8067beb21d1d2553) )
MEGADRIVE_ROM_LOAD( swordsodj, "sword of sodan (jpn).bin",                                                               0x000000, 0x80000,   CRC(58edb3f3) SHA1(9c17187e3eb0842c5300f69616a58baa86b769e7) )
...
MEGADRIVE_ROM_LOAD( sylves, "sylvester & tweety in cagey capers (euro).bin",                                             0x000000, 0x200000,  CRC(89fc54ce) SHA1(bf50d0afe82966907671a46060d27b7b5d92a752) )
...
MEGADRIVE_ROM_LOAD( syndic, "syndicate (euro, usa).bin",                                                                 0x000000, 0x200000,  CRC(95bbf87b) SHA1(87442ecc50df508d54d241cbd468b41c926b974d) )
MEGADRIVE_ROM_LOAD( t2ag, "mpr-15238.bin",                                                                               0x000000, 0x100000,  CRC(a1264f17) SHA1(85cc1cf3379d3ce23ca3c03d84fe6e2b3adc9c56) )
...
MEGADRIVE_ROM_LOAD( t2agj, "t2 - the arcade game (jpn).bin",                                                             0x000000, 0x100000,  CRC(5e6fe52c) SHA1(64d0778d38b5eb0664c1b85e0689de637a416654) )
MEGADRIVE_ROM_LOAD( t2term, "t2 - terminator 2 - judgment day (euro, usa).bin",                                          0x000000, 0x100000,  CRC(2f75e896) SHA1(6144fbb941c1bf0df285f6d13906432c23af2ba6) )
MEGADRIVE_ROM_LOAD( taikou, "taikou risshiden (jpn).bin",                                                                0x000000, 0x140000,  CRC(f96fe15b) SHA1(a96d6492d4e89687d970bc010eb0b93ee2481a44) )
MEGADRIVE_ROM_LOAD( taiwan, "taiwan daheng (china) (unl).bin",                                                           0x000000, 0x100000,  CRC(baf20f81) SHA1(88726c11e5ed7927830bf5ae0b83d85dfff4a2a4) )
MEGADRIVE_ROM_LOAD( talespin, "mpr-15058.bin",                                                                           0x000000, 0x80000,   CRC(f5c0c8d0) SHA1(9b6ab86fea23adb3cfba38b893278d856540c8b8) )
MEGADRIVE_ROM_LOAD( talmit, "talmit's adventure (euro).bin",                                                             0x000000, 0x100000,  CRC(05dc3ffc) SHA1(be80f96bee64bab159614d29f882442abef9de76) )
MEGADRIVE_ROM_LOAD( tantr, "puzzle & action - tanto-r (jpn).bin",                                                        0x000000, 0x200000,  CRC(d2d2d437) SHA1(2bf6965ee883a70b4f0842e9efa17c5e20b5cb47) )
MEGADRIVE_ROM_LOAD( targetea, "target earth (usa).bin",                                                                  0x000000, 0x80000,   CRC(cddf62d3) SHA1(e19f7a02f140882e0364f11cd096aec712e56f83) )
MEGADRIVE_ROM_LOAD( tazem,     "taz in escape from mars (euro).bin",                                                     0x000000, 0x200000,  CRC(62100099) SHA1(1edd44d9f9d1d410b6a9ec37647a04d9b50b549e) )
...
MEGADRIVE_ROM_LOAD( tazmania, "mpr-14838.bin",                                                                           0x000000, 0x80000,   CRC(0e901f45) SHA1(01875bb6484d44a844f3d3e1ae141864664b73b8) )
MEGADRIVE_ROM_LOAD( tcop, "technocop (usa).bin",                                                                         0x000000, 0x80000,   CRC(7459ad06) SHA1(739421dd98d8073030d43cf8f50e411acb82f7d6) )
MEGADRIVE_ROM_LOAD( teamusa, "team usa basketball (euro, usa).bin",                                                      0x000000, 0x100000,  CRC(a0caf97e) SHA1(8d8d833dfc88663408bd7cf9fb821608ad2bef3d) )
MEGADRIVE_ROM_LOAD( technocl, "techno clash (euro, usa).bin",                                                            0x000000, 0x100000,  CRC(4e65e483) SHA1(686afbd7130fe8487d9126e690bf53800ae953ba) )
MEGADRIVE_ROM_LOAD( tecmoc, "tecmo cup (jpn) (pirate).bin",                                                              0x000000, 0x80000,   CRC(e889e218) SHA1(e78f42104c66f49e0492e65c64354baac599369e) )
MEGADRIVE_ROM_LOAD( tecmoc1, "tecmo cup (jpn) (prototype?) (bad dump).bin",                                              0x000000, 0x80000,  BAD_DUMP CRC(88fdd060) SHA1(67e9261097e1ed9c8d7d11fd45a7c7e04ac1145f) )
...
MEGADRIVE_ROM_LOAD( tecmow92, "tecmo world cup '92 (jpn).bin",                                                           0x000000, 0x40000,   CRC(5e93c8b0) SHA1(ebab8f8b4f25aae44900d266c674621db2a831d9) )
MEGADRIVE_ROM_LOAD( teddyboy, "teddy boy blues (jpn) (sn).bin",                                                          0x000000, 0x40000,   CRC(733d2eb3) SHA1(dc858342be31ab9491acfaebf1524ece2c6ef9a3) )
MEGADRIVE_ROM_LOAD( teitoku, "teitoku no ketsudan (jpn).bin",                                                            0x000000, 0x100000,  CRC(9b08e4e4) SHA1(adc4c03636dbd8ca5449a8a66c6a7b7ef281893a) )
MEGADRIVE_ROM_LOAD( tekk3sp, "tekken 3 special (unl).bin",                                                               0x000000, 0x200000,  CRC(7fcae658) SHA1(99349bfe7966d65a4e782615aad9aa688905ad41) )
MEGADRIVE_ROM_LOAD( telebr, "telebradesco residencia (bra).bin",                                                         0x000000, 0x40000,   CRC(1db99045) SHA1(917c0f72e21c98ee2ee367c4d42c992c886a3aa2) )
MEGADRIVE_ROM_LOAD( telmah, "tel-tel mahjong (jpn).bin",                                                                 0x000000, 0x40000,   CRC(44817e92) SHA1(8edaec4944c4b9d876601ee5f8921247a5ffe057) )
MEGADRIVE_ROM_LOAD( telsta, "md-tsd.bin",                                                                                0x000000, 0x80000,   CRC(54cf8c29) SHA1(2924ed0b4266edddbb981f97acb93bbdf90494e6) )
MEGADRIVE_ROM_LOAD( termintr, "mpr-14925.bin",                                                                           0x000000, 0x100000,  CRC(15f4d302) SHA1(c8ee275f2e30aaf6ad713c6cd915a4ede65328e0) )
...
MEGADRIVE_ROM_LOAD( testdrv2, "test drive ii - the duel (euro, usa).bin",                                                0x000000, 0x100000,  CRC(f9bdf8c5) SHA1(cb70e5de149521f20723413cd11c5e661ec63c3e) )
MEGADRIVE_ROM_LOAD( tetris, "mpr-12356+mpr-12357.bin",                                                                   0x000000, 0x40000,   CRC(4ce90db0) SHA1(2f2b559c5855e34500e43fb5cc8aff04dd72eb56) ) // two chips cart, needs a proper dump
...
MEGADRIVE_ROM_LOAD( tfhj, "task force harrier ex (jpn).bin",                                                             0x000000, 0x100000,  CRC(e9a54eed) SHA1(d365d22d9076e98966eb12fdb1d93c3c101f519e) )
MEGADRIVE_ROM_LOAD( tf2, "mpr-12559.bin",                                                                                0x000000, 0x80000,   CRC(9b1561b3) SHA1(b81e7ebc4ceb6c1ae2975d27e0a78ba1e8546b5f) )
MEGADRIVE_ROM_LOAD( tf2j, "thunder force ii md (jpn).bin",                                                               0x000000, 0x80000,   CRC(e75ec3e0) SHA1(44b173b74225e5b562cdf3982926a051f05ed98e) )
MEGADRIVE_ROM_LOAD( tf3, "thunder force iii (usa, jpn).bin",                                                             0x000000, 0x80000,   CRC(1b3f399a) SHA1(9eadee76eb0509d5a0f16372fc9eac7a883e5f2d) )
MEGADRIVE_ROM_LOAD( tf4, "mpr-15209.bin",                                                                                0x000000, 0x100000,  CRC(e7e3c05b) SHA1(ecbc2bfc4f3d8bbd46b398274ed2f5cc3db68454) )
MEGADRIVE_ROM_LOAD( tf4j, "thunder force iv (jpn).bin",                                                                  0x000000, 0x100000,  CRC(8d606480) SHA1(44be21dead3b55f21762a7c5cf640eec0a1769d9) )
MEGADRIVE_ROM_LOAD( tfox, "thunder fox (usa).bin",                                                                       0x000000, 0x100000,  CRC(5463f50f) SHA1(c1699ccabb89c2877dd616471e80d175434bffe3) )
MEGADRIVE_ROM_LOAD( tfoxj, "thunder fox (jpn).bin",                                                                      0x000000, 0x100000,  CRC(eca6cffa) SHA1(4e6dc58327bdbb5d0d885b3cecf89fe139b32532) )
MEGADRIVE_ROM_LOAD( themeprk, "tpb10.bin",                                                                               0x000000, 0x200000,  CRC(289da2c5) SHA1(03c6504b5d797f10c7c361735d801902e4b00981) )
...
MEGADRIVE_ROM_LOAD( timedom, "time dominator 1st (jpn, kor).bin",                                                        0x000000, 0x100000,  CRC(7eba7a5c) SHA1(c9358fb57314be5792af5e97748f7b886a7194d2) )
MEGADRIVE_ROM_LOAD( timekill, "time killers (euro).bin",                                                                 0x000000, 0x200000,  CRC(a4f48a1a) SHA1(5bc883edd092602aac162b42462442e462d3c881) )
...
MEGADRIVE_ROM_LOAD( tintin, "tintin au tibet (euro).bin",                                                                0x000000, 0x200000,  CRC(4243caf3) SHA1(54fb11f601be37418b5bba3e0762d8b87068177a) )
MEGADRIVE_ROM_LOAD( tiny, "mpr-15406.bin",                                                                               0x000000, 0x80000,   CRC(d10fba51) SHA1(9e63b150cc2ec0ef141e68ffda862aa8db604441) )
MEGADRIVE_ROM_LOAD( tinyk, "tiny toon adventures (kor).bin",                                                             0x000000, 0x80000,   CRC(4ca3a8fb) SHA1(365d190088d78813f65610ff2b5b50c0e4060e24) )
...
MEGADRIVE_ROM_LOAD( tje2, "mpr-16179.bin",                                                                               0x000000, 0x200000,  CRC(47b0a871) SHA1(ac05701d86ba8957adb8fe0b67d8b4bb51328d98) )
...
MEGADRIVE_ROM_LOAD( tje2j, "toe jam & earl in panic on funkotron (jpn).bin",                                             0x000000, 0x200000,  CRC(e1b36850) SHA1(141af8fd1e5b4ba5118a384771b0d75f40af312f) )
...
MEGADRIVE_ROM_LOAD( tmhsh, "teenage mutant hero turtles - the hyperstone heist (euro).bin",                              0x000000, 0x100000,  CRC(966d5286) SHA1(ed6c32cae0813cbcf590fad715fa045fbeab6d78) )
MEGADRIVE_ROM_LOAD( tmhshj, "teenage mutant ninja turtles - return of the shredder (jpn).bin",                           0x000000, 0x100000,  CRC(1b003498) SHA1(f64556be092a13de8eaacc78dd630ac9d7bb75ee) )
...
MEGADRIVE_ROM_LOAD( tmtf, "teenage mutant hero turtles - tournament fighters (euro).bin",                                0x000000, 0x200000,  CRC(3cd2b7e6) SHA1(6a6c4ae9d944ad1d459d46ae40d3af09e60b5d7d) )
MEGADRIVE_ROM_LOAD( tmtfj, "teenage mutant ninja turtles - tournament fighters (jpn).bin",                               0x000000, 0x200000,  CRC(8843f2c9) SHA1(5be86d03abdb49b824104e9bbf0ac80023e4908c) )
...
MEGADRIVE_ROM_LOAD( tnzs, "new zealand story, the (jpn).bin",                                                            0x000000, 0x80000,   CRC(1c77ad21) SHA1(07b75c12667c6c5620aa9143b4c5f35b76b15418) )
MEGADRIVE_ROM_LOAD( toejam, "mpr-14236a.bin",                                                                            0x000000, 0x100000,  CRC(7a588f4b) SHA1(85e8d0a4fac591b25b77c35680ac4175976f251b) )
...
MEGADRIVE_ROM_LOAD( toki, "mpr-14464a.bin",                                                                              0x000000, 0x80000,   CRC(7362c3f4) SHA1(77270a6ded838d0263284dcc075aa4b2b2aef234) )
MEGADRIVE_ROM_LOAD( toki1, "toki - going ape spit -- juju densetsu (world).bin",                                         0x000000, 0x80000,   CRC(d09b1ef1) SHA1(1a94cde6392d385271797a6b21ad0eaad920a8da) )
...
MEGADRIVE_ROM_LOAD( tommylb, "mpr-12706.bin",                                                                            0x000000, 0x80000,   CRC(4fb50304) SHA1(dde1b2465f54f4f6f485c1ba063ff47c5d1baf27) )
MEGADRIVE_ROM_LOAD( tonylrb, "tony la russa baseball (usa, aus).bin",                                                    0x000000, 0x100000,  CRC(24629c78) SHA1(0e3f7ebf8661cac9bd7a0c5af64f260e7b5f0a0b) )
...
MEGADRIVE_ROM_LOAD( totlfoot, "total football (euro).bin",                                                               0x000000, 0x200000,  CRC(8360b66a) SHA1(271b13e1c0697d17ad702e97297ed1ea09ddb53b) )
MEGADRIVE_ROM_LOAD( toughman, "toughman contest (euro, usa).bin",                                                        0x000000, 0x400000,  CRC(e19fbc93) SHA1(c7c533b25a50b9c1ccd4c9772bf50957f728c074) )
...
MEGADRIVE_ROM_LOAD( toys, "mpr-15574.bin",                                                                               0x000000, 0x100000,  CRC(cbc9951b) SHA1(debc3a571c2c08a731758113550c040dfcda4782) )
MEGADRIVE_ROM_LOAD( toysto, "mpr-18848.bin",                                                                             0x000000, 0x400000,  CRC(8e89a9f3) SHA1(6e7bb9b191389973922a5ab9978205bb9d2664cc) )
...
MEGADRIVE_ROM_LOAD( tpglda, "triple play gold (usa) (alt).bin",                                                          0x000000, 0x400000,  CRC(a89638a0) SHA1(cb7f4b9b89fbf6162d7d4182229c8ac473f91cf4) )
MEGADRIVE_ROM_LOAD( tpgolf, "mpr-14853.bin",                                                                             0x000000, 0x100000,  CRC(62bad606) SHA1(1663289933b37526e4e07a6ee7fcd5e6cc2b489a) )
MEGADRIVE_ROM_LOAD( tpgolf2, "top pro golf 2 (jpn).bin",                                                                 0x000000, 0x100000,  CRC(b8ce98b3) SHA1(95a8918c98420fdfd59a4cb0be8fd5ec69d3593e) )
MEGADRIVE_ROM_LOAD( tpwres, "mpr-14675.bin",                                                                             0x000000, 0x80000,   CRC(24408c73) SHA1(7f41afbf62d83424067f872a5dfe2c0f0ec40052) )
...
MEGADRIVE_ROM_LOAD( traysiaj, "minato no traysia (jpn).bin",                                                             0x000000, 0x100000,  CRC(bd89fd09) SHA1(dea227a41a5ba28f8c8ea75cba12965bbc5ff8da) )
...
MEGADRIVE_ROM_LOAD( truxton, "truxton -- tatsujin (world).bin",                                                          0x000000, 0x80000,   CRC(5bd0882d) SHA1(90039844478e7cb99951fdff1979c3bda04d080a) )
...
MEGADRIVE_ROM_LOAD( tsba, "tecmo super bowl (usa) (september 1993).bin",                                                 0x000000, 0x100000,  CRC(bd5933ee) SHA1(529b8e86b97c326592540f5e427198a205c127d0) )
...
MEGADRIVE_ROM_LOAD( tsb2j, "tecmo super bowl ii - special edition (jpn).bin",                                            0x000000, 0x200000,  CRC(32fb633d) SHA1(cb9e8cc1651b719054f05e1e1a9e0fbbc3876ebd) )
...
MEGADRIVE_ROM_LOAD( tsbbj, "tecmo super nba basketball (jpn).bin",                                                       0x000000, 0x100000,  CRC(79f33eb6) SHA1(07f160e6eb7e358f54e4fdabfc95bb5525c57fc9) )
MEGADRIVE_ROM_LOAD( tsbj, "tecmo super bowl (jpn).bin",                                                                  0x000000, 0x100000,  CRC(90c6e20c) SHA1(477880e7976ac0f7203fddabba4a6e8799aa604d) )
...
MEGADRIVE_ROM_LOAD( ttacme, "mpr-17066.bin",                                                                             0x000000, 0x100000,  CRC(1227b2b2) SHA1(2672018d9e005a9a3b5006fa8f61e08f2d1909aa) )
MEGADRIVE_ROM_LOAD( ttacmeu, "tiny toon adventures - acme all-stars (usa, kor).bin",                                     0x000000, 0x100000,  CRC(2f9faa1d) SHA1(d64736a69fca430fc6a84a60335add0c765feb71) )
MEGADRIVE_ROM_LOAD( tunshi, "tun shi tian di iii (china) (simple chinese) (unl).bin",                                    0x000000, 0x200000,  CRC(ea57b668) SHA1(7040e96c053f29c75cf0524ddb168a83d0fb526f) )
MEGADRIVE_ROM_LOAD( tunshi1, "tun shi tian di iii (china) (unl).bin",                                                    0x000000, 0x200000,  CRC(b23c4166) SHA1(534bf8f951ee30d47df18202246245b998c0eced) )
MEGADRIVE_ROM_LOAD( turboout, "turbo outrun (euro, jpn).bin",                                                            0x000000, 0x80000,   CRC(0c661369) SHA1(3e4b9881dde758ef7bb090b39d3556d9bc0d9f1e) )
MEGADRIVE_ROM_LOAD( turmad, "turma da monica na terra dos monstros (bra).bin",                                           0x000000, 0x100000,  CRC(f8288de1) SHA1(80fc2a6a6b8b943f781598094f3b5a5fe4f05ede) )
MEGADRIVE_ROM_LOAD( turrican, "turrican (euro, usa).bin",                                                                0x000000, 0x80000,   CRC(634d67a6) SHA1(5a471a276909dcc428cd66c51047aa8a142c76a8) )
...
MEGADRIVE_ROM_LOAD( twinhawk, "twin hawk -- daisenpuu (euro, jpn).bin",                                                  0x000000, 0x80000,   CRC(a2ec8c67) SHA1(f884f2a41dd50f4c1a17c26da7f2d31093bb36b6) )
MEGADRIVE_ROM_LOAD( twinklet, "twinkle tale (jpn).bin",                                                                  0x000000, 0x100000,  CRC(d757f924) SHA1(5377e96b4cb14038675c41d165f1d92ae067cd9b) )
...
MEGADRIVE_ROM_LOAD( twocrude, "two crude dudes (euro).bin",                                                              0x000000, 0x100000,  CRC(b6d90a10) SHA1(babf6ec6dac62e7563c4fe9cb278179dc4343ea4) )
...
MEGADRIVE_ROM_LOAD( twotribe, "mpr-15652.bin",                                                                           0x000000, 0x100000,  CRC(ee988bd9) SHA1(556a79febff1fe4beb41e4e8a2629ff02b20c38f) )
...
MEGADRIVE_ROM_LOAD( ultqix, "ultimate qix (usa).bin",                                                                    0x000000, 0x40000,   CRC(d83369d9) SHA1(400edf467e20f8f43b7f7c8f18f5f46ed54eac86) )
MEGADRIVE_ROM_LOAD( ultraman, "ultraman (jpn).bin",                                                                      0x000000, 0x80000,   CRC(83b4d5fb) SHA1(7af1b66555c636664a73ca2091ef92ac800dc5d8) )
MEGADRIVE_ROM_LOAD( ultsoccr, "mpr-15819.bin",                                                                           0x000000, 0x100000,  CRC(83db6e58) SHA1(91781d0561f84de0d304221bbc26f4035f62010f) )
MEGADRIVE_ROM_LOAD( umk3, "pal_ultimate_mk3.bin",                                                                        0x000000, 0x400000,  CRC(ecfb5cb4) SHA1(044bfdb3761df7c4d54a25898353fabcd3f604a3) )
...
MEGADRIVE_ROM_LOAD( undead, "undead line (jpn).bin",                                                                     0x000000, 0x100000,  CRC(fb3ca1e6) SHA1(cb9f248bfd19b16ed8a11639a73a6e90fa7ee79e) )
MEGADRIVE_ROM_LOAD( universs, "universal soldier (euro, usa).bin",                                                       0x000000, 0x100000,  CRC(352ebd49) SHA1(9ac1416641ba0e6632369ffe69599b08fc3c225f) )
...
MEGADRIVE_ROM_LOAD( urbanstr, "urban strike (euro, usa).bin",                                                            0x000000, 0x200000,  CRC(cf690a75) SHA1(897a8f6a08d6d7d6e5316f8047532b3e4603e705) )
MEGADRIVE_ROM_LOAD( uzukeo, "uzu keobukseon (kor).bin",                                                                  0x000000, 0x80000,   CRC(a7255ba8) SHA1(1d59864916be04640a117082c62453c09bcbf8b8) )
...
MEGADRIVE_ROM_LOAD( valis3j, "valis iii (jpn) (rev a).bin",                                                              0x000000, 0x100000,  CRC(4d49a166) SHA1(640c3d4f341c8a9b19e5deafae33e7742f109e2d) )
MEGADRIVE_ROM_LOAD( valisj, "mugen senshi valis (jpn).bin",                                                              0x000000, 0x100000,  CRC(24431625) SHA1(06208a19ca5f2b25bef7c972ec175d4aff235a77) )
...
MEGADRIVE_ROM_LOAD( vecman, "vectorman (euro, usa).bin",                                                                 0x000000, 0x200000,  CRC(d38b3354) SHA1(57a64d08028b539dc236a693d383f2e1269a5dd4) )
...
MEGADRIVE_ROM_LOAD( vecman2b, "vectorman 2 (beta).bin",                                                                  0x000000, 0x200000,  CRC(ada2b0ef) SHA1(65dc6261179e51d21c3c5fe0c0353befbcc95a2d) )
MEGADRIVE_ROM_LOAD( vecman2pa, "vectorman 2 (prototype - aug 15, 1996).bin",                                             0x000000, 0x300000,  CRC(998b087c) SHA1(0bbbc09e9ac38940ee4a6c927de67196f42e2bdc) )
MEGADRIVE_ROM_LOAD( vecman2pb, "vectorman 2 (prototype - aug 16, 1996).bin",                                             0x000000, 0x300000,  CRC(2986e5ce) SHA1(343527612a0710703486c7335b5939b7099eebba) )
MEGADRIVE_ROM_LOAD( vecman2pc, "vectorman 2 (prototype - aug 19, 1996).bin",                                             0x000000, 0x300000,  CRC(49efab7e) SHA1(fb949c8734655e48a787f0c869b8c48f4b0a113e) )
MEGADRIVE_ROM_LOAD( vecman2pd, "vectorman 2 (prototype - aug 26, 1996).bin",                                             0x000000, 0x2a8e46,  CRC(eb8124c8) SHA1(39f496d8d99a4cb5716f731d9db656e0ca594a74) )
MEGADRIVE_ROM_LOAD( vecman2pe, "vectorman 2 (prototype - aug 27, 1996).bin",                                             0x000000, 0x300000,  CRC(6333d89a) SHA1(d142ce853becc6450c7a3e8b7fe65839e5b68521) )
MEGADRIVE_ROM_LOAD( vecmanb, "vectorman (beta).bin",                                                                     0x000000, 0x200000,  CRC(a315c8aa) SHA1(54d611a0519d34c25ef6b9963543ece4afc23e19) )
MEGADRIVE_ROM_LOAD( vecmanb1, "vectorman (beta) (alt).bin",                                                              0x000000, 0x200000,  CRC(2084d3da) SHA1(e6c0854ff0f5a0b53760677743e9b901b3e5a4b7) )
MEGADRIVE_ROM_LOAD( vecmanp, "vectorman (prototype - jul 24, 1995).bin",                                                 0x000000, 0x200000,  CRC(0145738b) SHA1(f96a51e792edde1ed203054ea9e23fd226d1ed70) )
MEGADRIVE_ROM_LOAD( vermil, "mpr-13430+mpr-13431.bin",                                                                   0x000000, 0xa0000,   CRC(ea1bc9ab) SHA1(c18fc75e0c5fa0e98c8664903e978ec4f73ef5d2) ) // two chips cart, needs a proper dump
MEGADRIVE_ROM_LOAD( vermilj, "vermilion (jpn).bin",                                                                      0x000000, 0xa0000,   CRC(e400dfc3) SHA1(697fb165051179a2bbca77c8cfd0c929e334f8c1) )
MEGADRIVE_ROM_LOAD( verytex, "verytex (jpn).bin",                                                                        0x000000, 0x80000,   CRC(bafc375f) SHA1(420780933e34da0f9b2a22b6bbb0739e363aab3a) )
MEGADRIVE_ROM_LOAD( vf2, "mpr-19107+mpr-19108.bin",                                                                      0x000000, 0x400000,  CRC(937380f3) SHA1(c283bf31b646489c2341f8325c52fb8b788a3702) )
MEGADRIVE_ROM_LOAD( vf2k, "mpr-19369.bin",                                                                               0x000000, 0x400000,  CRC(a95d0949) SHA1(dff095c9c252bf4af5aae52b83bc3c9d243176b7) )
MEGADRIVE_ROM_LOAD( vf2pa, "virtua fighter 2 (prototype - aug 19, 1996).bin",                                            0x000000, 0x400000,  CRC(c5ee3974) SHA1(8d9e1739a40cf64adf0b96918028bac9368b2d89) )
MEGADRIVE_ROM_LOAD( vf2pb, "virtua fighter 2 (prototype - aug 30, 1996).bin",                                            0x000000, 0x400000,  CRC(6a0f3a7b) SHA1(b08e11a477694f50bed2e89ee3269f557b041ab1) )
MEGADRIVE_ROM_LOAD( vf2pc, "virtua fighter 2 (prototype - sep 13, 1996).bin",                                            0x000000, 0x400000,  CRC(fa5bad91) SHA1(b6ae0d56d9fd41df5a577b36fc3717d7399b80fc) )
MEGADRIVE_ROM_LOAD( vf2pd, "virtua fighter 2 (prototype - sep 20, 1996).bin",                                            0x000000, 0x400000,  CRC(af516dad) SHA1(740190e416965ab4b63e82a9a4806178d3463fa9) )
MEGADRIVE_ROM_LOAD( vf2pe, "virtua fighter 2 (prototype - sep 27, 1996).bin",                                            0x000000, 0x400000,  CRC(95ab6ab6) SHA1(4375b574ab6c3aa41576a91f5a263196f6ec8fc1) )
MEGADRIVE_ROM_LOAD( vf2tek, "virtua fighter 2 vs tekken 2 (unl).bin",                                                    0x000000, 0x200000,  CRC(2cdb499d) SHA1(0a5be6d37db5579b9de991b71442a960afcfe902) )
...
MEGADRIVE_ROM_LOAD( virtpb, "virtual pinball (euro, usa).bin",                                                           0x000000, 0x100000,  CRC(d63473aa) SHA1(cd066bb54e0a4c21821639728893462b0218597e) )
MEGADRIVE_ROM_LOAD( vixen357, "vixen 357 (jpn).bin",                                                                     0x000000, 0x100000,  CRC(3afa2d7b) SHA1(460037301df0d67947bd17eddb38a3011896cb43) )
MEGADRIVE_ROM_LOAD( volfied, "volfied (jpn).bin",                                                                        0x000000, 0x40000,   CRC(b0c5e3f7) SHA1(7de808400f64dd0e4f468049fff7d29212ea0215) )
MEGADRIVE_ROM_LOAD( vr, "mpr-16420.bin",                                                                                 0x000000, 0x200000,  CRC(9624d4ef) SHA1(2c3812f8a010571e51269a33a989598787d27c2d) )
MEGADRIVE_ROM_LOAD( vrj, "mpr-16389.bin",                                                                                0x000000, 0x200000,  CRC(53a293b5) SHA1(0ad38a3ab1cc99edac72184f8ae420e13df5cac6) )
MEGADRIVE_ROM_LOAD( vrtroop, "vr troopers (euro, usa).bin",                                                              0x000000, 0x200000,  CRC(2f35516e) SHA1(e4c5271ef2034532841fde323f59d728365d7f6a) )
...
MEGADRIVE_ROM_LOAD( vv, "v-v (jpn).bin",                                                                                 0x000000, 0x100000,  CRC(ad9d0ec0) SHA1(ca344521cb5015d142bdbce0eb44cea050b8e86b) )
...
MEGADRIVE_ROM_LOAD( waniwani, "wani wani world (jpn).bin",                                                               0x000000, 0x80000,   CRC(56f0dbb2) SHA1(4cbe0ad0dbd70fd54432d6ae52d185c39c45260e) )
MEGADRIVE_ROM_LOAD( wardner, "wardner (usa).bin",                                                                        0x000000, 0x80000,   CRC(1e369ae2) SHA1(23bd6421f0e3710350e12f9322e75160a699ace8) )
MEGADRIVE_ROM_LOAD( wardnerj, "wardner no mori special (jpn).bin",                                                       0x000000, 0x80000,   CRC(80f1035c) SHA1(28844399b73628a3507ca38e855d0afe24c59f4b) )
MEGADRIVE_ROM_LOAD( warlock, "warlock (euro, usa).bin",                                                                  0x000000, 0x200000,  CRC(0a46539b) SHA1(b64f3d0fa74ec93782b4c0441653d72b675e23a7) )
...
MEGADRIVE_ROM_LOAD( waterwld, "waterworld (euro) (prototype).bin",                                                       0x000000, 0x200000,  CRC(51c80498) SHA1(35e4186654a677a43d16861f9832199c5cb5e0ef) )
MEGADRIVE_ROM_LOAD( wayneg, "wayne gretzky and the nhlpa all-stars (euro, usa).bin",                                     0x000000, 0x200000,  CRC(c2c13b81) SHA1(0b068f684e206139bcd592daba4613cbf634dd56) )
...
MEGADRIVE_ROM_LOAD( wball, "wrestleball (jpn).bin",                                                                      0x000000, 0x80000,   CRC(d563e07f) SHA1(bb6e6cd4f80ad69265b8c0d16b7581c629fd1770) )
MEGADRIVE_ROM_LOAD( wbmw, "mpr-14556.bin",                                                                               0x000000, 0xc0000,   CRC(1592f5b0) SHA1(87a968f773c7e807e647c0737132457b06b78276) )
MEGADRIVE_ROM_LOAD( wboy3, "mpr-13619.bin",                                                                              0x000000, 0x80000,   CRC(c24bc5e4) SHA1(1fd3f77a2223ebeda547b81e49f3dfc9d0197439) )
MEGADRIVE_ROM_LOAD( wboy5, "wonder boy v - monster world iii (jpn, kor).bin",                                            0x000000, 0xa0000,   CRC(45a50f96) SHA1(1582f159e1969ff0541319a9bd7e6f7a53505d01) )
MEGADRIVE_ROM_LOAD( wc90, "mpr-13239.bin",                                                                               0x000000, 0x40000,   CRC(dd95f829) SHA1(c233313214418300a39afc446e8426cc11f99c6c) )
MEGADRIVE_ROM_LOAD( wclead, "mpr-15278.bin",                                                                             0x000000, 0x80000,   CRC(daca01c3) SHA1(c307a731763c7f858ef27058b4f46017868749d6) )
...
MEGADRIVE_ROM_LOAD( wcs, "mpr-12607b.bin",                                                                               0x000000, 0x40000,   CRC(bf272bcb) SHA1(9da376f266c98c93ae387bec541c513fec84a0e9) )
...
MEGADRIVE_ROM_LOAD( wcs2ub, "world championship soccer ii (usa) (beta).bin",                                             0x000000, 0x100000,  CRC(c1e21c1a) SHA1(d3f4f2f5e165738bde6c6011c3d68322c27d97ed) )
MEGADRIVE_ROM_LOAD( wcsa, "world cup soccer -- world championship soccer (usa, jpn) (v1.2).bin",                         0x000000, 0x40000,   CRC(bf84ede6) SHA1(ef8c106acad9c3b4a5db2cd0d311762491d28392) )
MEGADRIVE_ROM_LOAD( wcsb, "world cup soccer -- world championship soccer (usa, jpn).bin",                                0x000000, 0x40000,   CRC(b01c3d70) SHA1(39bbab6430aad3fa9bf024c4b42387ba4ba3e488) )
MEGADRIVE_ROM_LOAD( wcup94, "world cup usa 94 (euro, usa, kor).bin",                                                     0x000000, 0x100000,  CRC(0171b47f) SHA1(af0e8fada3db7e746aef2c0070deb19602c6d32a) )
MEGADRIVE_ROM_LOAD( weaponl, "weaponlord (usa).bin",                                                                     0x000000, 0x300000,  CRC(b9895365) SHA1(04128e3859d6eca6e044f456f8b0d06b63e3fb0c) )
...
MEGADRIVE_ROM_LOAD( wheroa, "world heroes (jpn).bin",                                                                    0x000000, 0x200000,  CRC(56e3ceff) SHA1(0c806b701069ae72b6cfd19b7b65a123192cff23) )
MEGADRIVE_ROM_LOAD( wherob, "world heroes (euro) (prototype - mar 31, 1994 - b).bin",                                    0x000000, 0x200000,  CRC(d210aa6e) SHA1(de2166ed7b4f51aca63abb63db5aee9cff381a1c) )
MEGADRIVE_ROM_LOAD( wheroc, "world heroes (euro) (prototype - mar 31, 1994).bin",                                        0x000000, 0x200000,  CRC(92e1bf14) SHA1(aea91bc2c65c33a54b0ec1873be5433beb8685b8) )
MEGADRIVE_ROM_LOAD( wherod, "world heroes (jpn) (prototype - apr 08, 1994).bin",                                         0x000000, 0x200000,  CRC(2bea7215) SHA1(eb981388d7d2183a64673810a4a047780743c637) )
MEGADRIVE_ROM_LOAD( wheroe, "world heroes (jpn) (prototype - apr 15, 1994).bin",                                         0x000000, 0x200000,  CRC(6dec07b3) SHA1(a47ac5e017315422194a233d4f0aec9f5cc0e71a) )
MEGADRIVE_ROM_LOAD( wherof, "world heroes (jpn) (prototype - apr 20, 1994 - b).bin",                                     0x000000, 0x200000,  CRC(f5ffb191) SHA1(f1e661306009254797fee5224d4feed4ccaa8610) )
MEGADRIVE_ROM_LOAD( wherog, "world heroes (jpn) (prototype - apr 20, 1994) (broken - c05 missing).bin",                  0x000000, 0x200000,  CRC(b43b518c) SHA1(b4af1c44e32e65f2c167d8fc94e884ed8ff703d1) )
MEGADRIVE_ROM_LOAD( wheroh, "world heroes (jpn) (prototype - mar 30, 1994).bin",                                         0x000000, 0x200000,  CRC(3f93181a) SHA1(cafdd71037782d60b41508e7db7fb5fec654ff71) )
MEGADRIVE_ROM_LOAD( wheroi, "world heroes (usa) (prototype - feb 23, 1994).bin",                                         0x000000, 0x200000,  CRC(f5db477e) SHA1(154d8b2415bcbce62656eef63e4fad026ee2d8d0) )
MEGADRIVE_ROM_LOAD( wheroj, "world heroes (usa) (prototype - feb 24, 1994).bin",                                         0x000000, 0x200000,  CRC(f5db477e) SHA1(154d8b2415bcbce62656eef63e4fad026ee2d8d0) )
MEGADRIVE_ROM_LOAD( wherok, "world heroes (usa) (prototype - mar 03, 1994).bin",                                         0x000000, 0x200000,  CRC(24a63aef) SHA1(0caea512a3e3a56da25ee729213427ecb3ec6380) )
MEGADRIVE_ROM_LOAD( wherol, "world heroes (usa) (prototype - mar 07, 1994).bin",                                         0x000000, 0x200000,  CRC(45c29350) SHA1(f479d845e22dd22f9adf94bf961585bec937898f) )
MEGADRIVE_ROM_LOAD( wherom, "world heroes (usa) (prototype - mar 09, 1994).bin",                                         0x000000, 0x200000,  CRC(2c7f9e64) SHA1(cf7ab91e4cca7f3ab7203d2468e8375adb8fd7c0) )
MEGADRIVE_ROM_LOAD( wheron, "world heroes (usa) (prototype - mar 15, 1994).bin",                                         0x000000, 0x200000,  CRC(2c0b2f4f) SHA1(d02031fe3130d3d313ab2262e82abb0d921a971c) )
MEGADRIVE_ROM_LOAD( wheroo, "world heroes (usa) (prototype - mar 16, 1994).bin",                                         0x000000, 0x200000,  CRC(19c74e2a) SHA1(592e3500a2700059efc878c4360070c5b9f4b056) )
MEGADRIVE_ROM_LOAD( wherop, "world heroes (usa) (prototype - mar 18, 1994).bin",                                         0x000000, 0x200000,  CRC(2bc2a6bb) SHA1(fa925428f0f9b651a2037aa3bd3e05e6f22183d8) )
MEGADRIVE_ROM_LOAD( wheroq, "world heroes (usa) (prototype - mar 22, 1994) (broken - c07 missing).bin",                  0x000000, 0x200000,  CRC(5c3c0931) SHA1(0bd56a492bc9adf862d4b745e6e66909b8acc0d2) )
MEGADRIVE_ROM_LOAD( wheror, "world heroes (usa) (prototype - mar 23, 1994).bin",                                         0x000000, 0x200000,  CRC(587e6739) SHA1(2d0fa212a52a1b418fb061926d515200b3a511fa) )
MEGADRIVE_ROM_LOAD( wheros, "world heroes (usa) (prototype - mar 24, 1994).bin",                                         0x000000, 0x200000,  CRC(8a656942) SHA1(4a03d5d1b5e629ae69f9f8c5f0cbc96bf46a3843) )
MEGADRIVE_ROM_LOAD( wherot, "world heroes (usa) (prototype - mar 30, 1994).bin",                                         0x000000, 0x200000,  CRC(50c797cb) SHA1(8c4dc2b06e0734fc8e39997f8da6295d187e316e) )
...
MEGADRIVE_ROM_LOAD( whiprushj, "whip rush - wakusei voltegas no nazo (jpn).bin",                                         0x000000, 0x80000,   CRC(8084b4d1) SHA1(c7aac47bd0ecd6018ec1f1f4b42e53f27e318b15) )
...
MEGADRIVE_ROM_LOAD( wimbled, "wimbledon championship tennis (euro).bin",                                                 0x000000, 0x100000,  CRC(b791a435) SHA1(6b7d8aa9d4b9d10c26dc079ab78e11766982cef2) )
MEGADRIVE_ROM_LOAD( wimbledj, "wimbledon championship tennis (jpn).bin",                                                 0x000000, 0x100000,  CRC(3e0c9daf) SHA1(73a6dad0bedc5552459e8a74a9b8ae242ad5a78e) )
...
MEGADRIVE_ROM_LOAD( wintc, "acwcsg-1_(1-92).bin",                                                                        0x000000, 0x100000,  CRC(f57c7068) SHA1(6c948c98bbf52b849ffa1920e127c74ae04d75d1) ) // plastic Sega box
MEGADRIVE_ROM_LOAD( wintc1, "acwcsg_(12-91).bin",                                                                        0x000000, 0x100000,  CRC(dbc3ed1c) SHA1(d2afa782f8d05afc0c3a3d6684bd4966034705c6) ) // cardboard Ballistic box
...
MEGADRIVE_ROM_LOAD( wintol, "winter olympics (euro).bin",                                                                0x000000, 0x200000,  CRC(fa537a45) SHA1(84528efaf0729637167774d59a00694deadd5d6d) ) // chip covered with epoxy, proper dump possible?
MEGADRIVE_ROM_LOAD( wintolj, "winter olympics (jpn).bin",                                                                0x000000, 0x200000,  CRC(654a4684) SHA1(aa2fc21eaa833640eaf882d66ca6ceb4f8adabcf) )
...
MEGADRIVE_ROM_LOAD( wiznliz, "wiz'n'liz - the frantic wabbit wescue (euro).bin",                                         0x000000, 0x100000,  CRC(f09353b4) SHA1(2e7a1724a72e89a3f9a66720d9a7c6f293263798) )
MEGADRIVE_ROM_LOAD( wiznlizu, "wiz'n'liz (usa).bin",                                                                     0x000000, 0x100000,  CRC(df036b62) SHA1(1cbd0f820aaf35dd6328a865ecc4b9eedc740807) )
MEGADRIVE_ROM_LOAD( wolfch, "wolfchild (usa).bin",                                                                       0x000000, 0x100000,  CRC(eb5b1cbf) SHA1(000d45769e7e9f72f665e160910ba9fb79eec43f) )
MEGADRIVE_ROM_LOAD( wolver, "wolverine - adamantium rage (euro, usa).bin",                                               0x000000, 0x200000,  CRC(d2437bb7) SHA1(261f8ed75586ca7cdec176eb81550458bf1ff437) )
MEGADRIVE_ROM_LOAD( wondlib, "wonder library (jpn).bin",                                                                 0x000000, 0x80000,   CRC(9350e754) SHA1(57b97d9ddecfa2e9a75c4a05cd2b7e821210155a) )
MEGADRIVE_ROM_LOAD( worldill, "mpr-15271.bin",                                                                           0x000000, 0x100000,  CRC(121c6a49) SHA1(4b7aa8de517516edd9ee5288124f77238fc9ba6b) )
MEGADRIVE_ROM_LOAD( worldillj, "world of illusion - fushigi na magic box (jpn).bin",                                     0x000000, 0x100000,  CRC(cb9ee238) SHA1(c79935fdeb680a1a2e76db1aef2c6897e6ee8e4d) )
MEGADRIVE_ROM_LOAD( worldilljb, "world of illusion - fushigi na magic box (jpn) (beta).bin",                             0x000000, 0x100000,  CRC(577f680f) SHA1(c3d721dc3d6660156f28728d729a2c0d4bb23fdf) )
MEGADRIVE_ROM_LOAD( worldillu, "world of illusion starring mickey mouse and donald duck (usa, kor).bin",                 0x000000, 0x100000,  CRC(921ebd1c) SHA1(adb0a2edebb6f978c3217075a2f29003a8b025c6) )
...
MEGADRIVE_ROM_LOAD( worms, "worms (euro).bin",                                                                           0x000000, 0x200000,  CRC(b9a8b299) SHA1(1a15447a4a791c02b6ad0a609f788d39fe6c3aa6) )
MEGADRIVE_ROM_LOAD( wormsb, "worms (euro) (beta).bin",                                                                   0x000000, 0x200000,  CRC(1d191694) SHA1(23127e9b3a98eea13fb97bed2d8e206adb495d97) )
MEGADRIVE_ROM_LOAD( wresw, "mpr-14025.bin",                                                                              0x000000, 0x80000,   CRC(2d162a85) SHA1(1eac51029fd7fb1da1c5546cbd959220244cf3e5) )
MEGADRIVE_ROM_LOAD( wreswb, "wrestle war (jpn) (beta).bin",                                                              0x000000, 0x80000,   CRC(1cdee87b) SHA1(65c4815c6271bb7d526d84dac1bf177741e35364) )
...
MEGADRIVE_ROM_LOAD( wtime, "where in time is carmen sandiego (euro, usa).bin",                                           0x000000, 0x100000,  CRC(ea19d4a4) SHA1(0b726481cd9333d26aa3fe53fa2f293c0c385509) )
MEGADRIVE_ROM_LOAD( wtimebr, "where in time is carmen sandiego (bra).bin",                                               0x000000, 0x100000,  CRC(d523b552) SHA1(213b6dfc129fe245f2ecd73ad91c772efd628462) )
MEGADRIVE_ROM_LOAD( wukong, "wu kong wai zhuan (china) (unl).bin",                                                       0x000000, 0x200000,  CRC(880a916e) SHA1(dd4d7f7433ab82680d7d36124beca0bacebcd6e4) )
MEGADRIVE_ROM_LOAD( ww, "wacky worlds (usa).bin",                                                                        0x000000, 0x100000,  CRC(8af4552d) SHA1(e331c57ce6a176ab9ff1461e9423514756c5558d) )
...
MEGADRIVE_ROM_LOAD( wwfag, "9539d+9540d.bin",                                                                            0x000000, 0x400000,  CRC(a5d023f9) SHA1(e49ad2f9119b0788bbbb7258908d605c032989b4) )
...
MEGADRIVE_ROM_LOAD( wwfsup, "mpr-15215.bin",                                                                             0x000000, 0x100000,  CRC(b929d6c5) SHA1(a6df2e9887a3f33139e505b5ac739158b987069f) )
MEGADRIVE_ROM_LOAD( wwrld, "where in the world is carmen sandiego (euro, usa).bin",                                      0x000000, 0x100000,  CRC(eef372e8) SHA1(97c1f36e375ac33fbc5724bbb4bb296d974b114f) )
MEGADRIVE_ROM_LOAD( wwrldbr, "where in the world is carmen sandiego (bra).bin",                                          0x000000, 0x100000,  CRC(7d4450ad) SHA1(8441f0eba23c0b013ca3932914f9f8d364e61a01) )
MEGADRIVE_ROM_LOAD( xdrxda, "xdr - x dazedly ray (jpn).bin",                                                             0x000000, 0x80000,   CRC(ab22d002) SHA1(5c700cd69964645f80a852d308d0f0de22d88f83) )
MEGADRIVE_ROM_LOAD( xenon2m, "mpr-15064.bin",                                                                            0x000000, 0x80000,   CRC(59abe7f9) SHA1(055b554f7d61ed671eddc385bce950b2baa32249) )
MEGADRIVE_ROM_LOAD( xiaomo, "xiao monv - magic girl (china) (unl).bin",                                                  0x000000, 0x80000,   CRC(8e49a92e) SHA1(22a48404e77cab473ee65e5d5167d17c28884a7a) )
MEGADRIVE_ROM_LOAD( xinqig, "xin qi gai wang zi (china) (alt) (unl).bin",                                                0x000000, 0x400000,  CRC(da5a4bfe) SHA1(75f8003a6388814c1880347882b244549da62158) )
MEGADRIVE_ROM_LOAD( xinqig1, "xin qi gai wang zi (china) (unl).bin",                                                     0x000000, 0x400000,  CRC(dd2f38b5) SHA1(4a7494d8601149f43ba7e3595a0b2340cde2e9ba) )
MEGADRIVE_ROM_LOAD( xmen, "mpr-15505.bin",                                                                               0x000000, 0x100000,  CRC(0b78ca97) SHA1(111d696b317ad5b57bc66e037a935d3f123d41c2) )
MEGADRIVE_ROM_LOAD( xmen2, "x-men 2 - clone wars (euro, usa).bin",                                                       0x000000, 0x200000,  CRC(710bc628) SHA1(61409e6cf6065ab67d8952b891d8edcf47777193) )
...
MEGADRIVE_ROM_LOAD( xmenu, "x-men (usa).bin",                                                                            0x000000, 0x100000,  CRC(f71b21b4) SHA1(2f2b5d018c98b78faf9ab6b172947f5cd65d5cf0) )
...
MEGADRIVE_ROM_LOAD( yangji, "yang jia jiang - yang warrior family (china) (unl).bin",                                    0x000000, 0x200000,  CRC(6604a79e) SHA1(6fcc3102fc22b42049e6eae9a1c30c8a7f022d14) )
MEGADRIVE_ROM_LOAD( yasech, "ya se chuan shuo (china) (unl).bin",                                                        0x000000, 0x200000,  CRC(095b9a15) SHA1(8fe0806427e123717ba20478ab1410c25fa942e6) )
...
MEGADRIVE_ROM_LOAD( yogibear, "yogi bear's cartoon capers (euro).bin",                                                   0x000000, 0x100000,  CRC(204f97d8) SHA1(9f235fd4ac2612fb398ecbe423f40c901be8f564) )
MEGADRIVE_ROM_LOAD( ys3, "ys iii (usa).bin",                                                                             0x000000, 0x100000,  CRC(ea27976e) SHA1(b3331b41a9a5e2c3f4fb3b64c5b005037a3b6fdd) )
MEGADRIVE_ROM_LOAD( ysj, "ys - wanderers from ys (jpn).bin",                                                             0x000000, 0x100000,  CRC(52da4e76) SHA1(28dc01d5dde8d569bae3fafce2af55ee9b836454) )
MEGADRIVE_ROM_LOAD( yuugai, "yuu yuu hakusho gaiden (jpn).bin",                                                          0x000000, 0x200000,  CRC(7dc98176) SHA1(274b86709b509852ca004ceaa244f3ae1d455c50) )
MEGADRIVE_ROM_LOAD( yuusf, "yuu yuu hakusho - makyou toitsusen (jpn).bin",                                               0x000000, 0x300000,  CRC(71ceac6f) SHA1(89a70d374a3f3e2dc5b430e6d444bea243193b74) )
MEGADRIVE_ROM_LOAD( yuusfbr, "yuu yuu hakusho - sunset fighters (bra).bin",                                              0x000000, 0x300000,  CRC(fe3fb8ee) SHA1(e307363837626d47060f5347d0fccfc568a12b18) )
MEGADRIVE_ROM_LOAD( zanyasha, "zan yasha enbukyoku (jpn).bin",                                                           0x000000, 0x80000,   CRC(637fe8f3) SHA1(f1ea9a88233b76e3df32526be0b64fb653c13b7d) )
MEGADRIVE_ROM_LOAD( zanygolf, "zany golf (euro, usa) (v1.1).bin",                                                        0x000000, 0x80000,   CRC(74ed7607) SHA1(f1c3b211c91edfed9c96f422cd10633afa43fdf0) )
MEGADRIVE_ROM_LOAD( zanygolf1, "zany golf (euro, usa).bin",                                                              0x000000, 0x80000,   CRC(ed5d12ea) SHA1(4f9bea2d8f489bfbc963718a8dca212e033fb5a2) )
MEGADRIVE_ROM_LOAD( zerokami, "zero the kamikaze squirrel (euro).bin",                                                   0x000000, 0x200000,  CRC(45ff0b4b) SHA1(11a501f5dbde889edcc14e366b67bb75b0c5bc13) )
...
MEGADRIVE_ROM_LOAD( zerowing, "mpr-14463.bin",                                                                           0x000000, 0x100000,  CRC(89b744a3) SHA1(98335b97c5e21f7f8c5436427621836660b91075) )
MEGADRIVE_ROM_LOAD( zerowingj, "zero wing (jpn).bin",                                                                    0x000000, 0x100000,  CRC(7e203d2b) SHA1(fad499e21ac55a3b8513110dc1f6e3f6cdeca8dd) )
MEGADRIVE_ROM_LOAD( zhuogu, "zhuo gui da shi - ghost hunter (china) (unl).bin",                                          0x000000, 0x80000,   CRC(76c62a8b) SHA1(3424892e913c20754d2e340c6e79476a9eb6761b) )
MEGADRIVE_ROM_LOAD( zombhigh, "zombie high (usa) (prototype).bin",                                                       0x000000, 0xfa0ef,   CRC(7bea6194) SHA1(56f1a0b616e178315bdb9f2e43ddc942dcf3780e) )
MEGADRIVE_ROM_LOAD( zombies, "zombies (euro).bin",                                                                       0x000000, 0x100000,  CRC(179a1aa2) SHA1(f0b447196d648b282050a52bdfdd9bf0d8f3d57e) )
...
MEGADRIVE_ROM_LOAD( zool, "zool04.bin",                                                                                  0x000000, 0x100000,  CRC(1ee58b03) SHA1(cab14f63b7d00b35a11a3a7f60cf231199121dc8) )
...
MEGADRIVE_ROM_LOAD( zoop, "mpr-18564.bin",                                                                               0x000000, 0x80000,   CRC(2fdac6ab) SHA1(9914956f974b71d24b65e82ae3c980d0eb23c2e5) )
MEGADRIVE_ROM_LOAD( zoopu, "zoop (usa).bin",                                                                             0x000000, 0x80000,   CRC(a899befa) SHA1(e6669f16902caf35337de60027ed2013deed0d40) )
MEGADRIVE_ROM_LOAD( zouzou, "zou! zou! zou! rescue daisakusen (jpn).bin",                                                0x000000, 0x80000,   CRC(1a761e67) SHA1(0cf2e2a7f00fb3d7a1a6424152693138ece586f1) )


MEGADRIVE_ROM_LOAD( actrepl, "action replay (euro).bin",                                                                 0x000000, 0x8000,    CRC(95ff7c3e) SHA1(1e0f246826be4ebc7b99bb3f9de7f1de347122e5) )
MEGADRIVE_ROM_LOAD( gamege, "sgr001-a+sgr002-a.bin",                                                                     0x000000, 0x8000,    CRC(14dbce4a) SHA1(937e1878ebd104f489e6bdbc410a184f79f1144a) )
MEGADRIVE_ROM_LOAD( gamege1, "sgr001+sgr002.bin",                                                                        0x000000, 0x8000,    CRC(5f293e4c) SHA1(ea4b0418d90bc47996f6788ad455391d07cad6cc) )
MEGADRIVE_ROM_LOAD( proact, "pro action replay (euro).bin",                                                              0x000000, 0x20000,   CRC(17255224) SHA1(b0bbfe0c201b2ab2fc17b37e5709785fedc07170) )
MEGADRIVE_ROM_LOAD( proact2a, "pro action replay 2 (euro) (alt).bin",                                                    0x000000, 0x10000,   CRC(e6669a61) SHA1(00e4266f3cd7ab2178ca37d564bc5315efdbe967) )
MEGADRIVE_ROM_LOAD( proact2, "pro action replay 2 (euro).bin",                                                           0x000000, 0x10000,   CRC(a73abd27) SHA1(c488883a0270766d8fff503fd2e4b5e25a15d523) )



MEGADRIVE_ROM_LOAD( unknown, "unknown chinese game 1 (china).bin",                                                       0x000000, 0x200000,  CRC(dfacb9ff) SHA1(4283bb9aec05098b9f6b1739e1b02c1bb1f8242f) )


SOFTWARE_LIST_START( megadriv_cart )

	/* Proper dumps */
	SOFTWARE( f22a, f22, 199?, "Sega License", "F-22 Interceptor (September 1991) (Euro, USA)", 0, 0 )
	...
	SOFTWARE( jpond2, 0, 199?, "Sega License", "James Pond II - Codename Robocod (Euro, USA)", 0, 0 )
	...
	SOFTWARE( 12in1, 0, 199?, "<unlicensed>", "12-in-1", 0, 0 )

	SOFTWARE( 16ton,    0,     199?, "Sega License", "16 Ton (Jpn, SegaNet)", 0, 0 )
	SOFTWARE( 16tongnk, 16ton, 199?, "Sega License", "16 Ton (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )
	...
	SOFTWARE( addfamv, 0, 199?, "Sega License", "Addams Family Values (Euro)", 0, 0 )

	SOFTWARE( addamfam,   0,        199?, "Sega License", "The Addams Family (Euro, USA)", 0, 0 )
	SOFTWARE( addamfamb,  addamfam, 199?, "Sega License", "The Addams Family (USA, Prototype)", 0, 0 )
	SOFTWARE( addamfamb1, addamfam, 199?, "Sega License", "The Addams Family (USA, Prototype Alt)", 0, 0 )
	...
	SOFTWARE( advbatrp10, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype, 19950427)", 0, 0 )
	SOFTWARE( advbatrp11, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype, 19950428)", 0, 0 )
	SOFTWARE( advbatrp12, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype, 19950501)", 0, 0 )
	...
	SOFTWARE( aerobiz, 0,       199?, "Sega License", "Aerobiz (USA)", 0, 0 )
	SOFTWARE( airman,  aerobiz, 199?, "Sega License", "Air Management - Oozora ni Kakeru (Jpn)", 0, 0 )

	SOFTWARE( aerobizs, 0,        199?, "Sega License", "Aerobiz Supersonic (USA)", 0, 0 )
	SOFTWARE( airman2,  aerobizs, 199?, "Sega License", "Air Management II - Koukuuou o Mezase (Jpn)", 0, 0 )

	SOFTWARE( aftbur2,  0,       199?, "Sega License", "After Burner II (Euro, USA)", 0, 0 )
	SOFTWARE( aftbur2j, aftbur2, 199?, "Sega License", "After Burner II (Jpn)", 0, 0 )
	...
	SOFTWARE( airdiverj, airdiver, 199?, "Sega License", "Air Diver (Jpn)", 0, 0 )
	...
	SOFTWARE( alien3a, alien3, 199?, "Sega License", "Alien 3 (Euro, USA)", 0, 0 )
	...
	SOFTWARE( alisiad,  0,       199?, "Sega License", "Alisia Dragoon (Euro)", 0, 0 )
	SOFTWARE( alisiadj, alisiad, 199?, "Sega License", "Alisia Dragoon (Jpn)", 0, 0 )
	SOFTWARE( alisiadu, alisiad, 199?, "Sega License", "Alisia Dragoon (USA)", 0, 0 )
	...
	SOFTWARE( ariel, 0, 199?, "Sega License", "Ariel the Little Mermaid (Euro, USA)", 0, 0 )

	SOFTWARE( arnold,   0,      199?, "Sega License", "Arnold Palmer Tournament Golf (Euro, USA)", 0, 0 )
	SOFTWARE( smasters, arnold, 199?, "Sega License", "Naomichi Ozaki no Super Masters (Jpn)", 0, 0 )
	...
	SOFTWARE( asterixu, asterix, 199?, "Sega License", "Asterix and the Great Rescue (USA)", 0, 0 )

	SOFTWARE( asterpg,  0,       199?, "Sega License", "Asterix and the Power of the Gods (Euro)", 0, 0 )
	SOFTWARE( asterpgb, asterpg, 199?, "Sega License", "Asterix and the Power of the Gods (Euro, Prototype)", 0, 0 )

	SOFTWARE( atomrobo,  0,        199?, "Sega License", "Atomic Robo-Kid (USA)", 0, 0 )
	SOFTWARE( atomroboj, atomrobo, 199?, "Sega License", "Atomic Robo-Kid (Jpn)", 0, 0 )
	...
	SOFTWARE( atptourp1, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940802)", 0, 0 )
	SOFTWARE( atptourp2, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940805)", 0, 0 )
	SOFTWARE( atptourp3, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940808)", 0, 0 )
	SOFTWARE( atptourp4, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940719)", 0, 0 )
	SOFTWARE( atptourp5, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940723)", 0, 0 )
	SOFTWARE( atptourp6, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940725)", 0, 0 )
	SOFTWARE( atptourp7, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940509)", 0, 0 )
	SOFTWARE( atptourp8, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype, 19940908)", 0, 0 )
	...
	SOFTWARE( awesob, aweso, 199?, "Sega License", "Awesome Possum (USA, Prototype)", 0, 0 )

	SOFTWARE( aworgj, 0, 199?, "Sega License", "Aworg (Jpn, SegaNet)", 0, 0 )

	SOFTWARE( awspro, 0, 199?, "Sega License", "AWS Pro Moves Soccer (USA)", 0, 0 )

	SOFTWARE( assmgp,  0,      199?, "Sega License", "Ayrton Senna's Super Monaco GP II (Euro, Jpn)", 0, 0 )
	SOFTWARE( assmgpu, assmgp, 199?, "Sega License", "Ayrton Senna's Super Monaco GP II (USA)", 0, 0 )

	SOFTWARE( bob,     0,   199?, "Sega License", "B.O.B. (Euro, USA)", 0, 0 )
	SOFTWARE( bobb,    bob, 199?, "Sega License", "B.O.B. (USA, Prototype)", 0, 0 )
	SOFTWARE( spacefb, bob, 199?, "Sega License", "Space Funky B.O.B. (Jpn)", 0, 0 )
	...
	SOFTWARE( bahamuts, 0, 199?, "Sega License", "Bahamut Senki (Jpn)", 0, 0 )
	...
	SOFTWARE( berens1,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940428)", 0, 0 )
	SOFTWARE( berens2,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940429)", 0, 0 )
	SOFTWARE( berens3,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940801)", 0, 0 )
	SOFTWARE( berens4,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940802)", 0, 0 )
	SOFTWARE( berens5,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940803)", 0, 0 )
	SOFTWARE( berens6,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940805)", 0, 0 )
	SOFTWARE( berens7,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940808)", 0, 0 )
	SOFTWARE( berens8,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940709)", 0, 0 )
	SOFTWARE( berens9,  berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940716)", 0, 0 )
	SOFTWARE( berens10, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940720)", 0, 0 )
	SOFTWARE( berens11, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940602)", 0, 0 )
	SOFTWARE( berens12, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940610)", 0, 0 )
	SOFTWARE( berens13, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940323)", 0, 0 )
	SOFTWARE( berens14, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940506)", 0, 0 )
	SOFTWARE( berens15, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940511)", 0, 0 )
	SOFTWARE( berens16, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940517)", 0, 0 )
	SOFTWARE( berens17, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940519)", 0, 0 )
	SOFTWARE( berens18, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940523)", 0, 0 )
	SOFTWARE( berens19, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940526)", 0, 0 )
	SOFTWARE( berens20, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype, 19940530)", 0, 0 )

	SOFTWARE( bestof,  0, 199?, "Sega License", "Best of the Best - Championship Karate (USA)", 0, 0 )
	SOFTWARE( bestofb, bestof, 199?, "Sega License", "Best of the Best - Championship Karate (Euro, Prototype)", 0, 0 )
	SOFTWARE( kickbox, bestof, 199?, "Sega License", "The Kick Boxing (Jpn, Korea)", 0, 0 )
	...
	SOFTWARE( bonanz2, bonanz, 199?, "Sega License", "Bonanza Bros. (USA, Korea)", 0, 0 )
	...
	SOFTWARE( boxlgnd, 0,      199?, "Sega License", "Boxing Legends of the Ring (USA)", 0, 0 )
	...
	SOFTWARE( cadash, 0, 199?, "Sega License", "Cadash (USA, Asia, Korea)", 0, 0 )
	...
	SOFTWARE( cal50, 0, 199?, "Sega License", "Caliber .50 (USA)", 0, 0 )
	...
	SOFTWARE( akumajou, cvania, 199?, "Konami", "Akumajou Dracula - Vampire Killer (Jpn)", 0, 0 )
	...
	SOFTWARE( superhq,  chasehq2, 199?, "Sega License", "Super H.Q. (Jpn)", 0, 0 )
	...
	SOFTWARE( chinf3,  0,      199?, "<unlicensed>", "Chinese Fighter III (China)", 0, 0 )
	SOFTWARE( chinf3a, chinf3, 199?, "<unlicensed>", "Chinese Fighter III (China) (Alt)", 0, 0 )
	...
	SOFTWARE( chukrck2ub, chukrck2, 199?, "Sega License", "Chuck Rock II - Son of Chuck (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( columns3j, columns3, 199?, "Sega License", "Columns III - Taiketsu! Columns World (Jpn, Korea)", 0, 0 )
	...
	SOFTWARE( comixp10, comix, 199?, "Sega License", "Comix Zone (Prototype, 19950526)", 0, 0 )
	SOFTWARE( comixp11, comix, 199?, "Sega License", "Comix Zone (Prototype, 19950530)", 0, 0 )
	SOFTWARE( comixpk,  comix, 199?, "Sega License", "Comix Zone (Prototype, 19950609) (Korea)", 0, 0 )
	...
	SOFTWARE( crysta0,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940701)", 0, 0 )
	SOFTWARE( crysta1,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940702)", 0, 0 )
	SOFTWARE( crysta2,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940703)", 0, 0 )
	SOFTWARE( crysta3,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940712-B)", 0, 0 )
	SOFTWARE( crysta4,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940712)", 0, 0 )
	SOFTWARE( crysta5,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940713)", 0, 0 )
	SOFTWARE( crysta6,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940601)", 0, 0 )
	SOFTWARE( crysta7,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940606)", 0, 0 )
	SOFTWARE( crysta8,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940610)", 0, 0 )
	SOFTWARE( crysta9,  crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940623)", 0, 0 )
	SOFTWARE( crysta10, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940628)", 0, 0 )
	SOFTWARE( crysta11, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940630)", 0, 0 )
	SOFTWARE( crysta12, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940511)", 0, 0 )
	SOFTWARE( crysta13, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940519)", 0, 0 )
	SOFTWARE( crysta14, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype, 19940526)", 0, 0 )

	SOFTWARE( curse, 0, 199?, "Sega License", "Curse (Jpn)", 0, 0 )
	...
	SOFTWARE( decapatt, 0, 199?, "Sega License", "DecapAttack (Euro, USA, Korea)", 0, 0 )

	SOFTWARE( demoman,  0,       199?, "Sega License", "Demolition Man (Euro, USA)", 0, 0 )
	SOFTWARE( demomanb, demoman, 199?, "Sega License", "Demolition Man (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( dinolandj, dinoland, 199?, "Sega License", "Chou Touryuu Retsuden - Dino Land (Jpn)", 0, 0 )
	...
	SOFTWARE( disncoll, 0, 199?, "Sega License", "The Disney Collection (Euro)", 0, 0 )
	...
	SOFTWARE( doki,    0,    199?, "Sega License", "Ikazuse! Koi no Doki Doki Penguin Land MD (Jpn, SegaNet)", 0, 0 )
	SOFTWARE( dokignk, doki, 199?, "Sega License", "Ikazuse! Koi no Doki Doki Penguin Land MD (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )
	...
	SOFTWARE( dongguri,  drrobotn, 199?, "Sega License", "Dong Gu Ri Te Chi Jak Jeon (Korea)", 0, 0 )
	...
	SOFTWARE( shangai3, 0, 199?, "Sega License", "Dragon's Eye Plus - Shanghai III (Jpn)", 0, 0 )

	SOFTWARE( dfury,  0,     199?, "Sega License", "Dragon's Fury (Euro, USA)", 0, 0 )
	SOFTWARE( devilc, dfury, 199?, "Sega License", "Devil Crash MD (Jpn)", 0, 0 )
	...
	SOFTWARE( dune2,  0,     199?, "Sega License", "Dune II - Battle for Arrakis (Euro)", 0, 0 )
	SOFTWARE( dune2g, dune2, 199?, "Sega License", "Dune II - Kampf um den Wustenplaneten (Germany) (Euro)", 0, 0 )
	SOFTWARE( duneu,  dune2, 199?, "Sega License", "Dune - The Battle for Arrakis (USA)", 0, 0 )
	...
	SOFTWARE( dynaduke1, dynaduke, 199?, "Sega License", "Dynamite Duke (World)", 0, 0 )
	...
	SOFTWARE( dheadpj, dhead, 199?, "Sega License", "Dynamite Headdy (Jpn, Prototype)", 0, 0 )
	...
	SOFTWARE( ecco,  0,    199?, "Sega License", "Ecco the Dolphin (Euro, USA, Korea)", 0, 0 )
	...
	SOFTWARE( ecco2p,    ecco2, 199?, "Sega License", "Ecco - The Tides of Time (Prototype)", 0, 0 )
	SOFTWARE( ecco2p1,   ecco2, 199?, "Sega License", "Ecco - The Tides of Time (Prototype, Alt)", 0, 0 )
	SOFTWARE( ecco2j,    ecco2, 199?, "Sega License", "Ecco the Dolphin II (Jpn)", 0, 0 )
	SOFTWARE( ecco2px11, ecco2, 199?, "Sega License", "Ecco - The Tides of Time (Prototype X11, 19940413)", 0, 0 )
	SOFTWARE( ecco2u,    ecco2, 199?, "Sega License", "Ecco - The Tides of Time (USA)", 0, 0 )

	SOFTWARE( eccojr,  0,      199?, "Sega License", "Ecco Jr. (February 1995) (USA, Oceania)", 0, 0 )
	SOFTWARE( eccojr1, eccojr, 199?, "Sega License", "Ecco Jr. (March 1995) (USA, Oceania)", 0, 0 )
	...
	SOFTWARE( koutetsu, empire, 199?, "Sega License", "Koutetsu Teikoku (Jpn)", 0, 0 )
	...
	SOFTWARE( espnhnb, espnhn, 199?, "Sega License", "ESPN National Hockey Night (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( eswat,  0,     199?, "Sega License", "ESWAT - City Under Siege (USA)", 0, 0 )
	SOFTWARE( eswatj, eswat, 199?, "Sega License", "Cyber Police ESWAT (Jpn)", 0, 0 )
	...
	SOFTWARE( europecs, 0, 199?, "Sega License", "European Club Soccer (Euro)", 0, 0 )
	...
	SOFTWARE( exile,  0,     199?, "Sega License", "Exile (USA)", 0, 0 )
	SOFTWARE( exilej, exile, 199?, "Sega License", "Exile - Toki no Hazama e (Jpn)", 0, 0 )

	SOFTWARE( exosq,   0,     199?, "Sega License", "Exo Squad (Euro)", 0, 0 )
	SOFTWARE( exosqu,  exosq, 199?, "Sega License", "Exo Squad (USA)", 0, 0 )
	SOFTWARE( exosqub, exosq, 199?, "Sega License", "Exo Squad (USA, Prototype)", 0, 0 )

	SOFTWARE( exodus, 0, 199?, "Wisdom Tree", "Exodus - Journey to the Promised Land (USA)", 0, 0 )

	SOFTWARE( f117,  0,    199?, "Sega License", "F-117 Night Storm (Euro, USA)", 0, 0 )
	SOFTWARE( f117j, f117, 199?, "Sega License", "F-117 Stealth - Operation Night Storm (Jpn)", 0, 0 )

	SOFTWARE( f15str,   0,      199?, "Sega License", "F-15 Strike Eagle II (Euro)", 0, 0 )
	SOFTWARE( f15stru,  f15str, 199?, "Sega License", "F-15 Strike Eagle II (USA)", 0, 0 )
	SOFTWARE( f15strub, f15str, 199?, "Sega License", "F-15 Strike Eagle II (USA, Prototype)", 0, 0 )

	SOFTWARE( f22,  0,   199?, "Sega License", "F-22 Interceptor (June 1992) (Euro, USA)", 0, 0 )
	...
	SOFTWARE( f1,       0,  199?, "Sega License", "F1 (Euro)", 0, 0 )
	SOFTWARE( formula1, f1, 199?, "Sega License", "Formula One (USA)", 0, 0 )
	...
	SOFTWARE( f1circus, 0, 199?, "Sega License", "F1 Circus MD (Jpn)", 0, 0 )

	SOFTWARE( faerytal, 0, 199?, "Sega License", "The Faery Tale Adventure (Euro, USA)", 0, 0 )

	SOFTWARE( famfeud, 0, 199?, "Sega License", "Family Feud (USA)", 0, 0 )
	...
	SOFTWARE( fatalf2, 0,       199?, "Sega License", "Fatal Fury 2 (USA, Korea)", 0, 0 )
	SOFTWARE( garoud2, fatalf2, 199?, "Sega License", "Garou Densetsu 2 - Aratanaru Tatakai (Jpn)", 0, 0 )

	SOFTWARE( fatlab,    0,      199?, "Sega License", "Fatal Labyrinth (Euro, USA)", 0, 0 )
	SOFTWARE( labdea,    fatlab, 199?, "Sega License", "Shi no Meikyuu - Labyrinth of Death (Jpn, SegaNet)", 0, 0 )
	SOFTWARE( labdeagnk, fatlab, 199?, "Sega License", "Shi no Meikyuu - Labyrinth of Death (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )

	SOFTWARE( fatalrew, 0,        199?, "Sega License", "Fatal Rewind (Euro, USA)", 0, 0 )
	SOFTWARE( killshow, fatalrew, 199?, "Sega License", "The Killing Game Show (Jpn)", 0, 0 )
	...
	SOFTWARE( ferrari,  0,       199?, "Sega License", "Ferrari Grand Prix Challenge (Euro, Rev. A)", 0, 0 )
	SOFTWARE( ferrarib, ferrari, 199?, "Sega License", "Ferrari Grand Prix Challenge (Prototype)", 0, 0 )
	SOFTWARE( ferrariu, ferrari, 199?, "Sega License", "Ferrari Grand Prix Challenge (USA)", 0, 0 )
	...
	SOFTWARE( futbol,  fifa95, 199?, "<unlicensed>", "Futbol Argentino 98 - Pasion de Multitudes (Pirate)", 0, 0 )

	SOFTWARE( fifa96, 0,      199?, "Electronic Arts", "FIFA Soccer 96 (Euro, USA)", 0, 0 )
	SOFTWARE( fifa99, fifa96, 199?, "<unlicensed>", "FIFA Soccer 99 (Pirate)", 0, 0 )

	SOFTWARE( fifa2k, fifa97, 199?, "<unlicensed>", "FIFA Soccer 2000 Gold Edition (Pirate)", 0, 0 )
	...
	SOFTWARE( finalz, 0, 199?, "Sega License", "Final Zone / FZ Senki Axis (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( flink, 0, 199?, "Sega License", "Flink (Euro)", 0, 0 )
	...
	SOFTWARE( forgottn,  0,       199?, "Sega License", "Forgotten Worlds (World, v1.1)", 0, 0 )
	SOFTWARE( forgottn1, forgottn, 199?, "Sega License", "Forgotten Worlds (World)", 0, 0 )

	SOFTWARE( franken, 0, 199?, "Sega License", "Mary Shelley's Frankenstein (USA)", 0, 0 )
	...
	SOFTWARE( gaiares, 0, 199?, "Sega License", "Gaiares (USA, Jpn)", 0, 0 )

	SOFTWARE( gaingrnd,  0,        199?, "Sega License", "Gain Ground (World)", 0, 0 )
	SOFTWARE( gaingrnd1, gaingrnd, 199?, "Sega License", "Gain Ground (World, Alt)", 0, 0 )

	SOFTWARE( galaxyf2,  0,        199?, "Sega License", "Galaxy Force II (World, Rev. B)", 0, 0 )
	SOFTWARE( galaxyf2a, galaxyf2, 199?, "Sega License", "Galaxy Force II (World)", 0, 0 )

	SOFTWARE( gamblerj, 0, 199?, "Sega License", "Gambler Jiko Chuushinha - Katayama Masayuki no Mahjong Doujou (Jpn)", 0, 0 )

	SOFTWARE( gamenko, 0, 199?, "Sega License", "Game no Kandume Otokuyou (Jpn)", 0, 0 )
	...
	SOFTWARE( gaunt1, gaunt, 199?, "Sega License", "Gauntlet IV (August 1993) (Euro, USA)", 0, 0 )
	...
	SOFTWARE( genchaos,  0,        199?, "Electronic Arts", "General Chaos (Euro, USA)", 0, 0 )
	SOFTWARE( genchaosj, genchaos, 199?, "Electronic Arts", "General Chaos Daikonsen (Jpn)", 0, 0 )
	...
	SOFTWARE( ghouls,   0,      199?, "Sega License", "Ghouls 'n Ghosts (Euro, USA, Korea, Rev. A)", 0, 0 )
	...
	SOFTWARE( gleylanc, 0, 199?, "Sega License", "Advanced Busterhawk Gleylancer (Jpn)", 0, 0 )
	...
	SOFTWARE( gomora, 0, 199?, "Sega License", "Uchuu Senkan Gomora (Jpn)", 0, 0 )
	...
	SOFTWARE( granada,  0,       199?, "Sega License", "Granada (USA, Jpn, v1.1)", 0, 0 )
	SOFTWARE( granada1, granada, 199?, "Sega License", "Granada (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( grindst, 0,       199?, "Sega License", "Grind Stormer (USA)", 0, 0 )
	SOFTWARE( vv,      grindst, 199?, "Sega License", "V-Five (Jpn)", 0, 0 )

	SOFTWARE( growl,  0,     199?, "Sega License", "Growl (USA)", 0, 0 )
	SOFTWARE( runark, growl, 199?, "Sega License", "Runark (Jpn, Korea)", 0, 0 )
	...
	SOFTWARE( wingswor, gynoug, 199?, "Sega License", "Wings of Wor (USA)", 0, 0 )
	...
	SOFTWARE( havocu, havoc, 199?, "Sega License", "High Seas Havoc (USA)", 0, 0 )
	...
	SOFTWARE( hook, 0, 199?, "Sega License", "Hook (USA)", 0, 0 )
	...
	SOFTWARE( hyokko, 0, 199?, "Sega License", "Hyokkori Hyoutanjima - Daitouryou o Mezase! (Jpn)", 0, 0 )
	...
	SOFTWARE( ddribble, hyperd, 199?, "Sega License", "Double Dribble - The Playoff Edition (USA)", 0, 0 )

	SOFTWARE( hyperm,    0,      199?, "Sega License", "Hyper Marbles (Jpn, SegaNet)", 0, 0 )
	SOFTWARE( hypermgnk, hyperm, 199?, "Sega License", "Hyper Marbles (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )
	...
	SOFTWARE( immortalj, immortal, 199?, "Sega License", "Wizard of the Immortal (Jpn)", 0, 0 )
	...
	SOFTWARE( ronald, issdx, 199?, "<unlicensed>", "Ronaldinho 98 (Pirate)", 0, 0 )
	...
	SOFTWARE( jpond2j, jpond2, 199?, "Sega License", "James Pond II - Codename Robocod (Jpn, Korea)", 0, 0 )
	...
	SOFTWARE( jordanb1, jordanb, 199?, "Sega License", "Jordan Vs Bird (Euro, USA)", 0, 0 )
	SOFTWARE( jordanbj, jordanb, 199?, "Sega License", "Jordan Vs Bird - One on One (Jpn)", 0, 0 )
	...
	SOFTWARE( junction, 0, 199?, "Sega License", "Junction (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( jpram,   0,     199?, "Sega License", "Jurassic Park - Rampage Edition (Euro, USA)", 0, 0 )
	SOFTWARE( jprampa,  jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940708)", 0, 0 )
	SOFTWARE( jprampb, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940713)", 0, 0 )
	SOFTWARE( jprampc, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940714)", 0, 0 )
	SOFTWARE( jprampd, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940715)", 0, 0 )
	SOFTWARE( jprampe, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940717)", 0, 0 )
	SOFTWARE( jprampf, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940718)", 0, 0 )
	SOFTWARE( jprampg, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940620)", 0, 0 )
	SOFTWARE( jpramph, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940622)", 0, 0 )
	SOFTWARE( jprampi, jpram, 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype, 19940630)", 0, 0 )
	...
	SOFTWARE( kidcham,  0,       199?, "Sega License", "Kid Chameleon (Euro, USA)", 0, 0 )
	SOFTWARE( kidchamj, kidcham, 199?, "Sega License", "Chameleon Kid (Jpn)", 0, 0 )

	SOFTWARE( kidouk, 0, 199?, "Sega License", "Kidou Keisatsu Patlabor - 98-shiki Kidou Seyo! (Jpn)", 0, 0 )

	SOFTWARE( kingcol, 0, 199?, "Sega License", "Tougiou King Colossus (Jpn)", 0, 0 )
	...
	SOFTWARE( kishiden, 0, 199?, "Sega License", "Kishi Densetsu (Jpn)", 0, 0 ) // panzer
	...
	SOFTWARE( larussa, 0, 199?, "Sega License", "La Russa Baseball 95 (USA, Oceania)", 0, 0 )
	...
	SOFTWARE( landstlkub, landstlk, 199?, "Sega License", "Landstalker (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( lastbatt, 0,        199?, "Sega License", "Last Battle (Euro, USA, Korea)", 0, 0 )
	...
	SOFTWARE( legendgl, 0, 199?, "Sega License", "The Legend of Galahad (Euro, USA)", 0, 0 )

	SOFTWARE( lemmings,    0,        199?, "Sega License", "Lemmings (Euro)", 0, 0 )
	SOFTWARE( lemmingsju,  lemmings, 199?, "Sega License", "Lemmings (Jpn, USA, Korea, v1.1)", 0, 0 )
	SOFTWARE( lemmingsju1, lemmings, 199?, "Sega License", "Lemmings (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( lionkin2,  0,        199?, "<unlicensed>", "Shi Zi Wang II - The Lion King II", 0, 0 )	// [!]
	SOFTWARE( lionkin2a, lionkin2, 199?, "<unlicensed>", "Shi Zi Wang II - The Lion King II (Pirate)", 0, 0 )

	SOFTWARE( lionkin3, 0, 199?, "<unlicensed>", "Shi Zi Wang 3 - The Lion King 3", 0, 0 )
	...
	SOFTWARE( lotus2b, lotus2, 199?, "Sega License", "Lotus II (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( mansell, 0, 199?, "Sega License", "Newman Haas Indy Car Featuring Nigel Mansell / Nigel Mansell Indy Car (World)", 0, 0 )
	...
	SOFTWARE( masterm,  0,       199?, "Sega License", "Master of Monsters (USA)", 0, 0 )
	SOFTWARE( mastermj, masterm, 199?, "Sega License", "Master of Monsters (Jpn)", 0, 0 )

	SOFTWARE( mweapon, 0, 199?, "Sega License", "Master of Weapon (Jpn)", 0, 0 )
	...
	SOFTWARE( mazin,   0,     199?, "Sega License", "Mazin Wars (Euro)", 0, 0 )
	SOFTWARE( mazinas, mazin, 199?, "Sega License", "Mazin Saga (Asia)", 0, 0 )
	SOFTWARE( mazinj,  mazin, 199?, "Sega License", "Mazin Saga (Jpn, Korea)", 0, 0 )
	SOFTWARE( mazinu,  mazin, 199?, "Sega License", "Mazin Saga - Mutant Fighter (USA)", 0, 0 )
	...
	SOFTWARE( megaga1, 0, 199?, "Sega License", "Mega Games I (Euro)", 0, 0 )

	SOFTWARE( megaga2, 0, 199?, "Sega License", "Mega Games 2 (Euro)", 0, 0 )

	SOFTWARE( megaga3, 0, 199?, "Sega License", "Mega Games 3 (Euro, Asia)", 0, 0 )

	SOFTWARE( megaga61, 0, 199?, "Sega License", "Mega Games 6 Vol. 1 (Euro)", 0, 0 )

	SOFTWARE( megaga62, 0, 199?, "Sega License", "Mega Games 6 Vol. 2 (Euro)", 0, 0 )

	SOFTWARE( megaga63, 0, 199?, "Sega License", "Mega Games 6 Vol. 3 (Euro)", 0, 0 )

	SOFTWARE( megaga10, 0, 199?, "Sega License", "Mega Games 10 (Brazil)", 0, 0 )
	...
	SOFTWARE( micromb,  microm, 199?, "Sega License", "Micro Machines (Alt2) (Euro, USA)", 0, 0 )
	SOFTWARE( micromcn, microm, 199?, "Sega License", "Micro Machines (Canada)", 0, 0 )

	SOFTWARE( micro96,  0,       199?, "Sega License", "Micro Machines Turbo Tournament 96 (Euro, v1.1, J-Cart)", 0, 0 )
	SOFTWARE( micro96a, micro96, 199?, "Sega License", "Micro Machines Turbo Tournament 96 (Euro, J-Cart)", 0, 0 )
	...
	SOFTWARE( mig29,  0,     199?, "Sega License", "Mig-29 Fighter Pilot (Euro)", 0, 0 )
	SOFTWARE( mig29j, mig29, 199?, "Sega License", "Mig-29 Fighter Pilot (Jpn)", 0, 0 )
	SOFTWARE( mig29u, mig29, 199?, "Sega License", "Mig-29 Fighter Pilot (USA)", 0, 0 )
	...
	SOFTWARE( mikedi,  0,      199?, "Sega License", "Mike Ditka Power Football (Euro, USA)", 0, 0 )
	SOFTWARE( mikedi1, mikedi, 199?, "Sega License", "Mike Ditka Power Football (Euro, USA, Alt)", 0, 0 )

	SOFTWARE( minnesot, 0, 199?, "Sega License", "Minnesota Fats - Pool Legend (USA)", 0, 0 )

	SOFTWARE( miraclen, 0, 199?, "Sega License", "Chou Kyuukai Miracle Nine (Jpn)", 0, 0 )

	SOFTWARE( mpiano, 0, 199?, "Sega License", "The Miracle Piano Teaching System (USA)", 0, 0 )
	...
	SOFTWARE( ondal,    mysticd, 199?, "Sega License", "On Dal Jang Goon (Korea)", 0, 0 )

	SOFTWARE( mysticf, 0,       199?, "Sega License", "Mystical Fighter (USA)", 0, 0 )
	SOFTWARE( maouren, mysticf, 199?, "Sega License", "Maou Renjishi (Jpn)", 0, 0 )

	SOFTWARE( nadia, 0, 199?, "Namcot", "Fushigi no Umi no Nadia (Jpn)", 0, 0 )
	...
	SOFTWARE( olympg,   0,      199?, "Sega License", "Olympic Gold (Euro)", 0, 0 )
	SOFTWARE( olympgj,  olympg, 199?, "Sega License", "Olympic Gold (Jpn, Korea)", 0, 0 )
	SOFTWARE( olympgu,  olympg, 199?, "Sega License", "Olympic Gold (USA)", 0, 0 )
	SOFTWARE( olympgu1, olympg, 199?, "Sega License", "Olympic Gold (USA, Alt)", 0, 0 )
	...
	SOFTWARE( oozeju, ooze, 199?, "Sega License", "The Ooze (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( opeurope, 0,        199?, "Koei", "Operation Europe - Path to Victory 1939-45 (USA)", 0, 0 )
	SOFTWARE( europa,   opeurope, 199?, "Koei", "Europa Sensen (Jpn)", 0, 0 )

	SOFTWARE( osomatsu, 0, 199?, "Sega License", "Osomatsu-kun Hachamecha Gekijou (Jpn)", 0, 0 )
	...
	SOFTWARE( o2019ub, o2019, 199?, "Sega License", "OutRun 2019 (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( paddlegnk, paddle, 199?, "Sega License", "Paddle Fighter (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )
	...
	SOFTWARE( pcotton, 0, 199?, "Sega License", "Panorama Cotton (Jpn)", 0, 0 )
	...
	SOFTWARE( n3dgpebb, pebble, 199?, "Sega License", "New 3D Golf Simulation Pebble Beach no Hatou (Jpn)", 0, 0 )
	...
	SOFTWARE( ppengo, 0, 199?, "Sega License", "Pepenga Pengo (Jpn)", 0, 0 )

	SOFTWARE( psampras,  0,        199?, "Sega License", "Pete Sampras Tennis (Euro, USA, J-Cart)", 0, 0 )
	SOFTWARE( psampras1, psampras, 199?, "Sega License", "Pete Sampras Tennis (Alt) (Euro, USA, J-Cart)", 0, 0 )
	SOFTWARE( psampras2, psampras, 199?, "Sega License", "Pete Sampras Tennis (Alt2) (Euro, USA, J-Cart)", 0, 0 )
	...
	SOFTWARE( pstar2br, pstar2, 199?, "Sega License", "Phantasy Star II (Brazil)", 0, 0 )
	...
	SOFTWARE( pstar3,   0,      199?, "Sega License", "Phantasy Star III - Generations of Doom (Euro, USA, Korea)", 0, 0 )
	SOFTWARE( pstar3br, pstar3, 199?, "Sega License", "Phantasy Star III - Generations of Doom (Brazil)", 0, 0 )
	SOFTWARE( pstar3j,  pstar3, 199?, "Sega License", "Phantasy Star III - Toki no Keishousha (Jpn)", 0, 0 )
	...
	SOFTWARE( pstar4pa, pstar4, 199?, "Sega License", "Phantasy Star IV (Prototype, 19940815)", 0, 0 )
	SOFTWARE( pstar4pb, pstar4, 199?, "Sega License", "Phantasy Star IV (Prototype, 19940608)", 0, 0 )
	SOFTWARE( pstar4pc, pstar4, 199?, "Sega License", "Phantasy Star IV (Prototype, 19940530)", 0, 0 )
	SOFTWARE( pstar4pd, pstar4, 199?, "Sega License", "Phantasy Star IV (Prototype, 19941107)", 0, 0 )
	SOFTWARE( pstar4pe, pstar4, 199?, "Sega License", "Phantasy Star IV (Prototype, 19941027)", 0, 0 )
	...
	SOFTWARE( pinoccu, pinocc, 199?, "Sega License", "Pinocchio (USA)", 0, 0 )
	...
	SOFTWARE( powerdrv, 0, 199?, "Sega License", "Power Drive (Euro)", 0, 0 )
	...
	SOFTWARE( ppersiab,  ppersia, 199?, "Sega License", "Prince of Persia (Prototype)", 0, 0 )
	SOFTWARE( ppersiab1, ppersia, 199?, "Sega License", "Prince of Persia (Prototype, Earlier)", 0, 0 )
	...
	SOFTWARE( contra,  probot, 199?, "Sega License", "Contra - Hard Corps (USA, Korea)", 0, 0 )
	...
	SOFTWARE( puttergnk, putter, 199?, "Sega License", "Putter Golf (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )

	SOFTWARE( puyo, 0, 199?, "Sega License", "Puyo Puyo (Jpn)", 0, 0 )
	...
	SOFTWARE( pyramidgnk, pyramid, 199?, "Sega License", "Pyramid Magic (Jpn, Game no Kandume MegaCD Rip)", 0, 0 )
	...
	SOFTWARE( radrex,  0,      199?, "Sega License", "Radical Rex (Euro)", 0, 0 )
	SOFTWARE( radrexu, radrex, 199?, "Sega License", "Radical Rex (USA)", 0, 0 )

	SOFTWARE( raiden, 0, 199?, "Sega License", "Raiden Trad / Raiden Densetsu (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( renstimub, renstim, 199?, "Sega License", "The Ren & Stimpy Show Presents Stimpy's Invention (USA, Prototype)", 0, 0 )

	SOFTWARE( renthero, 0, 199?, "Sega License", "Rent a Hero (Jpn)", 0, 0 )

	SOFTWARE( resq, 0, 199?, "Sega License", "Resq (Prototype) (Euro)", 0, 0 )

	SOFTWARE( revshin,  0,       199?, "Sega License", "The Revenge of Shinobi (Euro, USA, Rev. B)", 0, 0 )
	SOFTWARE( revshin1, revshin, 199?, "Sega License", "The Revenge of Shinobi (Euro, USA, Rev. A)", 0, 0 )
	SOFTWARE( revshin2, revshin, 199?, "Sega License", "The Revenge of Shinobi (Euro, USA)", 0, 0 )
	SOFTWARE( supshin,  revshin, 199?, "Sega License", "The Super Shinobi (Jpn)", 0, 0 )
	...
	SOFTWARE( draxos, riskyw, 199?, "Electronic Arts", "Jashin Draxos (Jpn, Korea)", 0, 0 )

	SOFTWARE( ristar,   0,      199?, "Sega License", "Ristar (September 1994) (Euro, USA)", 0, 0 )
	SOFTWARE( ristar1,  ristar, 199?, "Sega License", "Ristar (August 1994) (Euro, USA)", 0, 0 )
	SOFTWARE( ristarj,  ristar, 199?, "Sega License", "Ristar - The Shooting Star (Jpn, Korea)", 0, 0 )
	SOFTWARE( ristarpa, ristar, 199?, "Sega License", "Ristar (Prototype, 19940812)", 0, 0 )
	SOFTWARE( ristarpb, ristar, 199?, "Sega License", "Ristar (Prototype, 19940826)", 0, 0 )
	SOFTWARE( ristarpc, ristar, 199?, "Sega License", "Ristar (Prototype, 19940701)", 0, 0 )
	SOFTWARE( ristarpd, ristar, 199?, "Sega License", "Ristar (Prototype, 19940718)", 0, 0 )

	SOFTWARE( roadrash, 0, 199?, "Sega License", "Road Rash (Euro, USA)", 0, 0 )

	SOFTWARE( rrash2,  0,      199?, "Sega License", "Road Rash II (Euro, USA, v1.2)", 0, 0 )
	SOFTWARE( rrash2a, rrash2, 199?, "Sega License", "Road Rash II (Euro, USA)", 0, 0 )
	SOFTWARE( rrash2j, rrash2, 199?, "Sega License", "Road Rash II (Jpn)", 0, 0 )
	...
	SOFTWARE( robotermb,  roboterm, 199?, "Sega License", "RoboCop versus The Terminator (Prototype)", 0, 0 )
	SOFTWARE( robotermb1, roboterm, 199?, "Sega License", "Robocop Versus The Terminator (Prototype, Alt)", 0, 0 )
	...
	SOFTWARE( zouzou, rolo, 199?, "Sega License", "Zou! Zou! Zou! Rescue Daisakusen (Jpn)", 0, 0 )
	...
	SOFTWARE( sailorm, 0, 199?, "Sega License", "Bishoujo Senshi Sailor Moon (Jpn)", 0, 0 )

	SOFTWARE( ssword,  0,      199?, "Sega License", "Saint Sword (USA)", 0, 0 )
	SOFTWARE( sswordj, ssword, 199?, "Sega License", "Saint Sword (Jpn)", 0, 0 )

	SOFTWARE( sampra96, 0, 199?, "Sega License", "Sampras Tennis 96 (Euro, J-Cart)", 0, 0 )
	...
	SOFTWARE( shangha2,   0,     199?, "Sega License", "Shanghai II - Dragon's Eye (USA)", 0, 0 )
	SOFTWARE( shangha2b,  shangha2, 199?, "Sega License", "Shanghai II - Dragon's Eye (USA, Prototype)", 0, 0 )
	SOFTWARE( shangha2b1, shangha2, 199?, "Sega License", "Shanghai II - Dragon's Eye (USA, Prototype, Alt)", 0, 0 )
	...
	SOFTWARE( shindarkbr, shindark, 199?, "Sega License", "Shining in the Darkness (Brazil)", 0, 0 )
	SOFTWARE( shindarkj,  shindark, 199?, "Sega License", "Shining and the Darkness (Jpn)", 0, 0 )

	SOFTWARE( shinobi3,   0,        199?, "Sega License", "Shinobi III - Return of the Ninja Master (Euro)", 0, 0 )
	SOFTWARE( shinobi3u,  shinobi3, 199?, "Sega License", "Shinobi III - Return of the Ninja Master (USA)", 0, 0 )
	SOFTWARE( supshin2,   shinobi3, 199?, "Sega License", "The Super Shinobi II (Jpn, Korea)", 0, 0 )
	SOFTWARE( supshin2b,  shinobi3, 199?, "Sega License", "The Super Shinobi II (Jpn, Prototype)", 0, 0 )
	SOFTWARE( supshin2b1, shinobi3, 199?, "Sega License", "The Super Shinobi II (Jpn, Prototype, Earlier)", 0, 0 )

	SOFTWARE( ship, 0, 199?, "Sega License", "Ship (Prototype)", 0, 0 )
	...
	SOFTWARE( soukoban, shoveit, 199?, "Sega License", "Shijou Saidai no Soukoban (Jpn)", 0, 0 )
	...
	SOFTWARE( timedom, socket, 199?, "Sega License", "Time Dominator 1st (Jpn, Korea)", 0, 0 )
	...
	SOFTWARE( ragnacen,  soleil, 199?, "Sega License", "Shin Souseiki Ragnacenty (Jpn)", 0, 0 )
	SOFTWARE( ragnacenb, soleil, 199?, "Sega License", "Shin Souseiki Ragnacenty (Jpn, Prototype)", 0, 0 )
	SOFTWARE( ragnacenk, soleil, 199?, "Sega License", "Ragnacenty (Korea)", 0, 0 )

	SOFTWARE( sk,   0,  199?, "Sega License", "Sonic & Knuckles (World)", 0, 0 )
	SOFTWARE( skpa, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0525, 19940525, 15.28)", 0, 0 )
	SOFTWARE( skpb, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0606, 19940606, 10.02)", 0, 0 )
	SOFTWARE( skpc, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0608, 19940608, 05.03)", 0, 0 )
	SOFTWARE( skpd, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0610, 19940610, 07.49)", 0, 0 )
	SOFTWARE( skpe, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0612, 19940612, 18.27)", 0, 0 )
	SOFTWARE( skpf, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0618, 19940618, 09.15)", 0, 0 )
	SOFTWARE( skpg, sk, 199?, "Sega License", "Sonic & Knuckles (Prototype 0619, 19940619, 08.18)", 0, 0 )
	SOFTWARE( skph, sk, 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0606, 19940605, 22.25)", 0, 0 )
	SOFTWARE( skpi, sk, 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0608, 19940608, 03.35)", 0, 0 )
	SOFTWARE( skpj, sk, 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0610, 19940610, 03.11)", 0, 0 )
	SOFTWARE( skpk, sk, 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0612, 19940612, 18.18)", 0, 0 )
	SOFTWARE( skpl, sk, 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0618, 19940618, 9.07)", 0, 0 )
	...
	SOFTWARE( knucklp, sks2, 199?, "Sega License", "Knuckles in Sonic 2 (Prototype 0524, 19940527, 10.46)", 0, 0 )
	...
	SOFTWARE( s3d,  0,   199?, "Sega License", "Sonic 3D - Flickies' Island / Sonic 3D Blast (Euro, USA, Korea)", 0, 0 )
	...
	SOFTWARE( soniccmp,  0,        199?, "Sega License", "Sonic Compilation / Sonic Classics (Euro, USA, Korea)", 0, 0 )
	...
	SOFTWARE( sspinb,  sspin, 199?, "Sega License", "Sonic Spinball (Prototype)", 0, 0 )
	SOFTWARE( sspinj,  sspin, 199?, "Sega License", "Sonic Spinball (Jpn)", 0, 0 )
	SOFTWARE( sspinu,  sspin, 199?, "Sega License", "Sonic Spinball (USA)", 0, 0 )
	SOFTWARE( sspinua, sspin, 199?, "Sega License", "Sonic Spinball (USA, Alt)", 0, 0 )

	SOFTWARE( sonic,  0, 199?, "Sega License", "Sonic the Hedgehog (Euro, USA)", 0, 0 )
	SOFTWARE( sonicj, sonic, 199?, "Sega License", "Sonic the Hedgehog (Jpn, Korea)", 0, 0 )
	SOFTWARE( sonicpir, sonic, 199?, "Sega License", "Sonic the Hedgehog (Pirate) (Euro, USA)", 0, 0 )
	...
	SOFTWARE( sonic3pir, sonic3, 199?, "Sega License", "Sonic the Hedgehog 3 (Pirate)", 0, 0 )
	...
	SOFTWARE( sharrj, sharr, 199?, "Sega License", "Space Harrier II (Jpn, Launch Cart)", 0, 0 )
	...
	SOFTWARE( spidrmanb,  spidrman, 199?, "Acclaim Entertainment", "Spider-Man (Acclaim) (USA, Prototype)", 0, 0 )
	SOFTWARE( spidrmanb1, spidrman, 199?, "Acclaim Entertainment", "Spider-Man (Acclaim) (USA, Prototype, Earlier)", 0, 0 )
	...
	SOFTWARE( storythof,  storytho, 199?, "Sega License", "La Legende de Thor (France) (Euro)", 0, 0 )
	SOFTWARE( storythog,  storytho, 199?, "Sega License", "The Story of Thor (Germany) (Euro)", 0, 0 )
	SOFTWARE( storythoj,  storytho, 199?, "Sega License", "The Story of Thor - Hikari o Tsugumono (Jpn)", 0, 0 )
	SOFTWARE( storythojb, storytho, 199?, "Sega License", "The Story of Thor (Jpn, Prototype)", 0, 0 )	// BAD DUMP
	SOFTWARE( storythok,  storytho, 199?, "Sega License", "The Story of Thor (Korea)", 0, 0 )
	SOFTWARE( storythop,  storytho, 199?, "Sega License", "The Story of Thor (Prototype, 19941004)", 0, 0 )
	SOFTWARE( storythop1, storytho, 199?, "Sega License", "The Story of Thor (Prototype, 19941017)", 0, 0 )
	SOFTWARE( storythop2, storytho, 199?, "Sega License", "The Story of Thor (Prototype, 19941101)", 0, 0 )
	SOFTWARE( storythos,  storytho, 199?, "Sega License", "The Story of Thor (Spain) (Euro)", 0, 0 )
	...
	SOFTWARE( sf2j,   sf2, 199?, "Sega License", "Street Fighter II' Plus (Jpn, Asia, Korea)", 0, 0 )
	SOFTWARE( sf2pir, sf2, 199?, "Sega License", "Street Fighter II' Turbo (Pirate)", 0, 0 )
	...
	SOFTWARE( ssmart, 0, 199?, "Sega License", "Street Smart (USA, Jpn)", 0, 0 )
	...
	SOFTWARE( sor2,  0,    199?, "Sega License", "Streets of Rage II / Bare Knuckle II - Shitou e no Chingonka (Euro, Jpn)", 0, 0 )
	SOFTWARE( sor2u, sor2, 199?, "Sega License", "Streets of Rage 2 (USA)", 0, 0 )
	...
	SOFTWARE( subtb,  subt, 199?, "Sega License", "SubTerrania (Prototype)", 0, 0 )
	SOFTWARE( subtb1, subt, 199?, "Sega License", "SubTerrania (Prototype, Earlier)", 0, 0 )
	...
	SOFTWARE( sb2020j, sb2020, 199?, "Sega License", "2020 Toshi Super Baseball (Jpn)", 0, 0 )
	...
	SOFTWARE( shangon1, shangon, 199?, "Sega License", "Super Hang-On (World)", 0, 0 )
	...
	SOFTWARE( smgp,  0,    199?, "Sega License", "Super Monaco GP (Euro, Jpn, Rev. A)", 0, 0 )
	SOFTWARE( smgp1, smgp, 199?, "Sega License", "Super Monaco GP (Euro, Jpn)", 0, 0 )
	SOFTWARE( smgpj, smgp, 199?, "Sega License", "Super Monaco GP (Jpn)", 0, 0 )
	SOFTWARE( smgpu, smgp, 199?, "Sega License", "Super Monaco GP (USA)", 0, 0 )
	...
	SOFTWARE( stbladj, stblad, 199?, "Sega License", "Super Thunder Blade (Jpn, Launch Cart)", 0, 0 )
	...
	SOFTWARE( targetea, 0,        199?, "Sega License", "Target Earth (USA)", 0, 0 )
	SOFTWARE( leynos,   targetea, 199?, "Sega License", "Assault Suit Leynos (Jpn)", 0, 0 )
	...
	SOFTWARE( truxton, 0, 199?, "Sega License", "Truxton / Tatsujin (World)", 0, 0 )
	...
	SOFTWARE( tsba, tsb, 199?, "Sega License", "Tecmo Super Bowl (September 1993) (USA)", 0, 0 )
	...
	SOFTWARE( tf2,  0,   199?, "Sega License", "Thunder Force II (Euro, USA)", 0, 0 )
	SOFTWARE( tf2j, tf2, 199?, "Sega License", "Thunder Force II MD (Jpn)", 0, 0 )

	SOFTWARE( tf3, 0, 199?, "Sega License", "Thunder Force III (USA, Jpn)", 0, 0 )

	SOFTWARE( tf4,      0,   199?, "Sega License", "Thunder Force IV (Euro)", 0, 0 )
	SOFTWARE( tf4j,     tf4, 199?, "Sega License", "Thunder Force IV (Jpn)", 0, 0 )
	SOFTWARE( lightfor, tf4, 199?, "Sega License", "Lightening Force - Quest for the Darkstar (USA)", 0, 0 )
	...
	SOFTWARE( ttacmeu, ttacme, 199?, "Sega License", "Tiny Toon Adventures - Acme All-Stars (USA, Korea)", 0, 0 )
	...
	SOFTWARE( slimew,  0,      199?, "Sega License", "Todd's Adventures in Slime World (USA)", 0, 0 )
	SOFTWARE( slimewj, slimew, 199?, "Sega License", "Slime World (Jpn)", 0, 0 )
	...
	SOFTWARE( toki,  0,    199?, "Sega License", "Toki - Going Ape Spit / JuJu Densetsu (World, Rev. A)", 0, 0 )
	SOFTWARE( toki1, toki, 199?, "Sega License", "Toki - Going Ape Spit / JuJu Densetsu (World)", 0, 0 )
	...
	SOFTWARE( tonylrb, 0, 199?, "Sega License", "Tony La Russa Baseball (USA, Oceania)", 0, 0 )
	...
	SOFTWARE( traysiaj, traysia, 199?, "Sega License", "Minato no Traysia (Jpn)", 0, 0 )
	...
	SOFTWARE( kyuukyok, twincobr, 199?, "Sega License", "Kyuukyoku Tiger (Jpn)", 0, 0 )

	SOFTWARE( twinklet, 0, 199?, "Sega License", "Twinkle Tale (Jpn)", 0, 0 )

	SOFTWARE( twinhawk, 0, 199?, "Sega License", "Twin Hawk / Daisenpuu (Euro, Jpn)", 0, 0 )

	SOFTWARE( twocrude,  0,        199?, "Sega License", "Two Crude Dudes (Euro)", 0, 0 )
	SOFTWARE( twocrudeu, twocrude, 199?, "Sega License", "Two Crude Dudes (USA)", 0, 0 )
	...
	SOFTWARE( ultqix,  0,      199?, "Sega License", "Ultimate Qix (USA)", 0, 0 )
	SOFTWARE( volfied, ultqix, 199?, "Sega License", "Volfied (Jpn)", 0, 0 )

	SOFTWARE( ultsoccr, 0, 199?, "Sega License", "Ultimate Soccer (Euro)", 0, 0 )
	...
	SOFTWARE( valisj, valis, 199?, "Sega License", "Mugen Senshi Valis (Jpn)", 0, 0 )
	...
	SOFTWARE( vecmanb,  vecman, 199?, "Sega License", "Vectorman (Prototype)", 0, 0 )
	SOFTWARE( vecmanb1, vecman, 199?, "Sega License", "Vectorman (Prototype, Alt)", 0, 0 )
	SOFTWARE( vecmanp,  vecman, 199?, "Sega License", "Vectorman (Prototype, 19950724)", 0, 0 )

	SOFTWARE( vecman2,   0,       199?, "Sega License", "Vectorman 2 (USA)", 0, 0 )
	SOFTWARE( vecman2b,  vecman2, 199?, "Sega License", "Vectorman 2 (Prototype)", 0, 0 )
	SOFTWARE( vecman2pa, vecman2, 199?, "Sega License", "Vectorman 2 (Prototype, 19960815)", 0, 0 )
	SOFTWARE( vecman2pb, vecman2, 199?, "Sega License", "Vectorman 2 (Prototype, 19960816)", 0, 0 )
	SOFTWARE( vecman2pc, vecman2, 199?, "Sega License", "Vectorman 2 (Prototype, 19960819)", 0, 0 )
	SOFTWARE( vecman2pd, vecman2, 199?, "Sega License", "Vectorman 2 (Prototype, 19960826)", 0, 0 )
	SOFTWARE( vecman2pe, vecman2, 199?, "Sega License", "Vectorman 2 (Prototype, 19960827)", 0, 0 )

	SOFTWARE( vermil,  0,      199?, "Sega License", "Sword of Vermilion (Euro, USA)", 0, 0 )
	SOFTWARE( vermilj, vermil, 199?, "Sega License", "Vermilion (Jpn)", 0, 0 )
	...
	SOFTWARE( vf2k,  vf2, 199?, "Sega License", "Virtua Fighter 2 (Korea)", 0, 0 )
	SOFTWARE( vf2pa, vf2, 199?, "Sega License", "Virtua Fighter 2 (Prototype, 19960819)", 0, 0 )
	SOFTWARE( vf2pb, vf2, 199?, "Sega License", "Virtua Fighter 2 (Prototype, 19960830)", 0, 0 )
	SOFTWARE( vf2pc, vf2, 199?, "Sega License", "Virtua Fighter 2 (Prototype, 19960913)", 0, 0 )
	SOFTWARE( vf2pd, vf2, 199?, "Sega License", "Virtua Fighter 2 (Prototype, 19960920)", 0, 0 )
	SOFTWARE( vf2pe, vf2, 199?, "Sega License", "Virtua Fighter 2 (Prototype, 19960927)", 0, 0 )
	...
	SOFTWARE( ww,  0,  199?, "Sega License", "Wacky Worlds (USA)", 0, 0 )
	...
	SOFTWARE( caesar,  warrior, 199?, "Micronet", "Caesar no Yabou (Jpn)", 0, 0 )

	SOFTWARE( warrior2, 0,        199?, "Sega License", "Warrior of Rome II (USA)", 0, 0 )
	SOFTWARE( caesar2,  warrior2, 199?, "Micronet", "Caesar no Yabou II (Jpn)", 0, 0 )
	...
	SOFTWARE( weaponl, 0, 199?, "Sega License", "Weaponlord (USA)", 0, 0 )
	...
	SOFTWARE( wwrldbr, wwrld, 199?, "Sega License", "Where in the World Is Carmen Sandiego (Brazil)", 0, 0 )

	SOFTWARE( wtime,   0,     199?, "Sega License", "Where in Time Is Carmen Sandiego (Euro, USA)", 0, 0 )
	SOFTWARE( wtimebr, wtime, 199?, "Sega License", "Where in Time Is Carmen Sandiego (Brazil)", 0, 0 )
	...
	SOFTWARE( wintc1, wintc, 199?, "Sega License", "Winter Challenge (Euro, USA)", 0, 0 )
	...
	SOFTWARE( wiznliz,  0,       199?, "Sega License", "Wiz'n'Liz - The Frantic Wabbit Wescue (Euro)", 0, 0 )
	SOFTWARE( wiznlizu, wiznliz, 199?, "Sega License", "Wiz'n'Liz (USA)", 0, 0 )
	...
	SOFTWARE( wcs2ub, wcs2, 199?, "Sega License", "World Championship Soccer II (USA, Prototype)", 0, 0 )
	...
	SOFTWARE( wcs,  0,   199?, "Sega License", "World Championship Soccer / World Cup Soccer (USA, Jpn, Rev. B)", 0, 0 )
	SOFTWARE( wcsa, wcs, 199?, "Sega License", "World Championship Soccer / World Cup Soccer (USA, Jpn, v1.2)", 0, 0 )
	SOFTWARE( wcsb, wcs, 199?, "Sega License", "World Championship Soccer / World Cup Soccer (USA, Jpn)", 0, 0 )
	SOFTWARE( wc90, wcs, 199?, "Sega License", "World Cup Italia '90 (Euro)", 0, 0 )

	SOFTWARE( wcup94, 0, 199?, "Sega License", "World Cup USA 94 (Euro, USA, Korea)", 0, 0 )
	...
	SOFTWARE( worldillu,  worldill, 199?, "Sega License", "World of Illusion Starring Mickey Mouse and Donald Duck (USA, Korea)", 0, 0 )
	...
	SOFTWARE( xmenu, xmen, 199?, "Sega License", "X-Men (USA)", 0, 0 )
	...
	SOFTWARE( xinqig1, xinqig, 199?, "<unlicensed>", "Xin Qi Gai Wang Zi (China)", 0, 0 )
	...
	SOFTWARE( ys3, 0,   199?, "Sega License", "Ys III (USA)", 0, 0 )
	SOFTWARE( ysj, ys3, 199?, "Sega License", "Ys - Wanderers from Ys (Jpn)", 0, 0 )

	SOFTWARE( yuusf,   0,     199?, "Sega License", "Yuu Yuu Hakusho - Makyou Toitsusen (Jpn)", 0, 0 )
	SOFTWARE( yuusfbr, yuusf, 199?, "Sega License", "Yuu Yuu Hakusho - Sunset Fighters (Brazil)", 0, 0 )
	...
	SOFTWARE( zombhigh, 0, 199?, "Sega License", "Zombie High (Prototype) (USA)", 0, 0 )
	...
	/* programs */
	SOFTWARE( flux,     0, 199?, "Sega License", "Flux (Euro)", 0, 0 )	// To be used in conjuction with a MegaCD
	...
	/* radica */
	SOFTWARE( radicav1, 0, 2004, "Radica Games / Sega",   "Radica: Volume 1 (USA)", 0, 0 )
	SOFTWARE( radicasf, 0, 2004, "Radica Games / Capcom", "Radica: Street Fighter Pack (Euro)", 0, 0 )


	/* cheat carts */
	SOFTWARE( actrepl,  0, 199?, "Sega License", "Action Replay (Euro)", 0, 0 )

	SOFTWARE( gamege,   0,      199?, "Sega License", "Game Genie (Euro, USA, Rev. A)", 0, 0 )
	SOFTWARE( gamege1,  gamege, 199?, "Sega License", "Game Genie (Euro, USA)", 0, 0 )
