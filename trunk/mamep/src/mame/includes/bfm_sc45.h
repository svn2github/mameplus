...
#define sc_cyc_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95008249.bin", 0x0000, 0x100000, CRC(e8eac90a) SHA1(f79dc6912a8fbeb12c577c402d84ef4780bf4333) ) \

#define sc_cyccl_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95008310.bin", 0x0000, 0x100000, CRC(4dddf82d) SHA1(4bab8cdc5f6bf59c3686dfd01f2f96858f776df3) ) \
...
#define sc_count_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95008615.bin", 0x0000, 0x100000, CRC(97c602c0) SHA1(cd71c062df3ac700ab72fc992542e08651270ec8) ) \
	ROM_LOAD( "95008616.bin", 0x0000, 0x100000, CRC(2b80b1a5) SHA1(a94b4402ba738a6369f58c73a5b9d66e0476eeb1) ) \
...
#define sc_ttp_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95004148.bin", 0x0000, 0x080000, CRC(6b352d5b) SHA1(b32f08828aad1c8cf0281faa387c9a1536fbd382) ) \

#define sc_lions_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95004142.bin", 0x0000, 0x080000, CRC(aee399f7) SHA1(54c9683f2f3159122ef35855fe19380f1a2771ca) ) \
...
#define sc_ufg_others \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95004167.bin", 0x0000, 0x080000, CRC(9dcd31cc) SHA1(2ce9e167debbc2315b4be964116fdc35e19b6046) ) \
...
#define sc_waw_others \
	...
	\
	ROM_REGION( 0x400000, "altymz", ROMREGION_ERASE00 )/*no alarm sound, is this right */ \
...
/* Orphaned sound (+extra) roms, for which there are no actual program roms supported, or our program roms don't match */

#define PR1032 FIRECRACKER SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	ROM_LOAD( "95004262.bin", 0x0000, 0x080000, CRC(3f5fad9e) SHA1(528a2803baa155d66cb896f643f858238aa7f189) ) \
	/* with Firecracker.. */ \
	ROM_REGION( 0x1000, "others", ROMREGION_ERASE00 ) \
...
#define PR1004_SILVER_GOLD_SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
...
#define PR1008_CASH_BOX_SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
...
#define PR1009_DOUBLE_AG_SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
...
#define PR1014_BOYACASH_SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	/* Ali G? */ \
...
#define PR1236_CashWheel_SNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
	/* On The Up? */ \
...
#define PR3510_RED_HOT_DOND_SOUNDS11 \
	ROM_REGION( 0x400000, "ymz", ROMREGION_ERASE00 ) \
