...
INPUT_PORTS_START( dunhuang )
	...
	PORT_DIPNAME( 0x06, 0x06, "Credits Per Coin" )
	PORT_DIPSETTING(    0x06, "1" )
	PORT_DIPSETTING(    0x04, "2" )
	PORT_DIPSETTING(    0x02, "5" )
	PORT_DIPSETTING(    0x00, "20" )
	PORT_DIPNAME( 0x18, 0x18, "Credits Per Key-In" )
	PORT_DIPSETTING(    0x18, "1" )
	PORT_DIPSETTING(    0x10, "10" )
	PORT_DIPSETTING(    0x08, "50" )
	PORT_DIPSETTING(    0x00, "100" )
	PORT_DIPNAME( 0x20, 0x20, "Credits Per Key-Out" )
	PORT_DIPSETTING(    0x20, "1" )
	PORT_DIPSETTING(    0x00, "100" )
	PORT_DIPNAME( 0xc0, 0xc0, "Max Credits" )
	...
	PORT_DIPSETTING(    0x00, "20" )
	PORT_DIPNAME( 0x30, 0x30, "Renso Bonus Time" )
	...
	PORT_START	// IN3 - DSW4
	PORT_DIPNAME( 0x07, 0x07, "Credits Limit" )
	...
	PORT_DIPNAME( 0x38, 0x38, "Service-In Limit" )
	...
	PORT_DIPNAME( 0x40, 0x40, "Hu Type" )
	...
	PORT_START	// IN4 - DSW5
	PORT_DIPNAME( 0x03, 0x03, "Douple Up Chance (%)" )
	PORT_DIPSETTING(    0x00, "50" )
	PORT_DIPSETTING(    0x01, "60" )
	PORT_DIPSETTING(    0x02, "70" )
	PORT_DIPSETTING(    0x03, "80" )
	PORT_DIPNAME( 0x04, 0x04, "Chinese Word" )
	PORT_DIPSETTING(    0x04, "3..6" )
	PORT_DIPSETTING(    0x00, "5..10" )
	PORT_DIPNAME( 0x08, 0x08, "Big Odds Times" )
	PORT_DIPSETTING(    0x00, "3" )
	PORT_DIPSETTING(    0x08, "5" )
	PORT_DIPNAME( 0x30, 0x30, "Hu Test Times" )
	...
	PORT_DIPNAME( 0x80, 0x80, "Computer Strength" )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_RON )	// tin
	...
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_MAHJONG_REACH )	// eat
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_CHI )	// hu
...
static MACHINE_DRIVER_START( dunhuang )
	...
	MDRV_WATCHDOG_TIME_INIT(MAME_TIME_IN_SEC(5))
