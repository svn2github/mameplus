...
GAME(1980,  obaoba,     0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Oba-Oba (set 1)", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1980,  obaoba1,    obaoba,     taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Oba-Oba (set 2)", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1980,  drakor,     0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Drakor", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1980,  meteort,    0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Meteor (Taito)", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1981,  sureshop,   0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Sure Shot (Pinball)", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1981,  cosmic,     0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Cosmic", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1982,  gemini2k,   0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Gemini 2000 (set 1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1982,  gemini2k1,  gemini2k,   taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Gemini 2000 (set 2)", GAME_IS_SKELETON_MECHANICAL)
GAME(1982,  vortexp,    0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Vortex (Pinball)", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1982,  zarza,      0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Zarza (set 1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1982,  zarza1,     zarza,      taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Zarza (set 2)", GAME_IS_SKELETON_MECHANICAL)
GAME(1982,  sharkt,     0,          taito2, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Shark (Taito)", GAME_IS_SKELETON_MECHANICAL)
GAME(1982,  stest,      0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Speed Test", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )
GAME(1982,  lunelle,    0,          taito2, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Lunelle", GAME_IS_SKELETON_MECHANICAL)
GAME(1980,  rally,      0,          taito,  taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Rally", GAME_MECHANICAL | GAME_IMPERFECT_SOUND )

// dac and vox (sintevox)
GAME(1981,  fireact,    0,          taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Fire Action", GAME_IS_SKELETON_MECHANICAL)
GAME(1981,  cavnegro,   0,          taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Cavaleiro Negro (set 1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1981,  cavnegro1,  cavnegro,   taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Cavaleiro Negro (set 2)", GAME_IS_SKELETON_MECHANICAL)
GAME(1981,  cavnegro2,  cavnegro,   taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Cavaleiro Negro (set 3)", GAME_IS_SKELETON_MECHANICAL)
GAME(1981,  ladylukt,   0,          taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Lady Luck (Taito)", GAME_MECHANICAL | GAME_NO_SOUND )
GAME(198?,  vegast,     ladylukt,   taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Vegas (Taito)", GAME_MECHANICAL | GAME_NO_SOUND )
GAME(1982,  titan,      0,          taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Titan (set 1)", GAME_MECHANICAL | GAME_NO_SOUND )
GAME(1982,  titan1,     titan,      taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Titan (set 2)", GAME_MECHANICAL | GAME_NO_SOUND )
GAME(1982,  hawkman,    0,          taito4, taito, taito_state, taito,  ROT0,   "Taito do Brasil",  "Hawkman (set 1)", GAME_IS_SKELETON_MECHANICAL)
