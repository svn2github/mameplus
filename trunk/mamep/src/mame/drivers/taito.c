...
ROM_START(shock)
	...
	ROM_REGION(0x10000, "cpu2", 0)
	ROM_LOAD("shock_s2.bin", 0x7800, 0x0400, CRC(c03e8009) SHA1(33e7e90f313d4dd2555feae9bd9912989c7d2de2))
	ROM_RELOAD( 0x0800, 0x0400)
	ROM_LOAD("shock_s1.bin", 0x7c00, 0x0400, CRC(1f8543e9) SHA1(209c88198659844aeba1e4c39c04eb4d96b10de4))
