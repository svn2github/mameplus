...
static MACHINE_DRIVER_START( lasso )
	...
	MDRV_CPU_ADD_TAG("audio", M6502, 660000)
	/* audio CPU */		/* ?? (controls music tempo) */
	...
	//MDRV_SOUND_ADD_TAG("sn76496.1", SN76496, 3000000)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.0)

	MDRV_SOUND_ADD_TAG("sn76489.2", SN76489, 2000000)
	//MDRV_SOUND_ADD_TAG("sn76496.2", SN76496, 3000000)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.0)
MACHINE_DRIVER_END
