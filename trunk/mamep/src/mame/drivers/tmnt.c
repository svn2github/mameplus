...
static MACHINE_DRIVER_START( mia )
	...
	/* basic machine hardware */
	MDRV_CPU_ADD("main", M68000, XTAL_24MHz/3)
...
static MACHINE_DRIVER_START( tmnt2 )
	...
	MDRV_CPU_ADD("audio", Z80, 8000000)	/* 8 MHz; clock is correct, but there's 1 cycle wait for ROM/RAM */
...
static MACHINE_DRIVER_START( ssriders )
	...
	MDRV_CPU_ADD("audio", Z80, 4000000)	/* ????? makes the ROM test sync */
	MDRV_CPU_PROGRAM_MAP(ssriders_audio_map,0)
								/* NMIs are generated by the 053260 */
...
ROM_START( cuebrick )
	ROM_REGION( 0x40000, "main", 0 )	/* 2*64k for 68000 code */
...
ROM_START( tmnt )
	ROM_REGION( 0x60000, "main", 0 )	/* 2*128k and 2*64k for 68000 code */
...
ROM_START( blswhstl )
	ROM_REGION( 0x80000, "main", 0 ) /* 4*128k for 68000 code */
...
ROM_START( tmnt2 )
	ROM_REGION( 0x100000, "main", 0 ) /* 4*128k for 68000 code */
...
ROM_START( qgakumon )
	ROM_REGION( 0x100000, "main", 0 ) /* 4*256k for 68000 code */
...
ROM_START( ssriders )
	ROM_REGION( 0xc0000, "main", 0 ) /* 2*256k and 2*128k for 68000 code */
...
ROM_START( sunsetbl )
	ROM_REGION( 0x100000, "main", 0 ) /* 2*32k for 68000 code */
