...
ROM_START( trstar )
	...
	ROM_REGION(0x140000, "audio", 0)	/* 68000 sound CPU */
...
ROM_START( dungeonm )
	...
	ROM_REGION(0x800000, "gfx2" , ROMREGION_DISPOSE) /* Tiles */
...
ROM_START( kaiserkn )
	...
	ROM_REGION(0x1a00000, "gfx1" , ROMREGION_DISPOSE) /* Sprites */
	...
	ROM_REGION(0xc00000, "gfx2" , ROMREGION_DISPOSE) /* Tiles */
...
ROM_START( bublbob2 )
	...
	ROM_REGION(0x180000, "audio", 0)	/* sound CPU */
...
ROM_START( kirameki )
	...
	ROM_REGION(0x400000, "audio", 0)	/* 68000 sound CPU */
...
{
	UINT32 *RAM = (UINT32 *)memory_region(machine, "main");
