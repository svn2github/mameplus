...
static ADDRESS_MAP_START( funkyjet_readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x340000, 0x340bff) AM_READ(SMH_RAM)
	AM_RANGE(0x342000, 0x342bff) AM_READ(SMH_RAM)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( funkyjet_writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x340000, 0x340bff) AM_WRITE(SMH_RAM) AM_BASE(&deco16_pf1_rowscroll)
	AM_RANGE(0x342000, 0x342bff) AM_WRITE(SMH_RAM) AM_BASE(&deco16_pf2_rowscroll)
ADDRESS_MAP_END
