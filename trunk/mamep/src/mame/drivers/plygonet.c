...
static UINT8 dsp56k_bank_group(void)
{
	UINT16 portC = dsp56k_get_peripheral_memory(0xffe3);
...
static UINT8 dsp56k_bank_num(UINT8 bank_group)
{
	UINT16 portC = dsp56k_get_peripheral_memory(0xffe3);
...
{
	UINT8 en_group = dsp56k_bank_group();
	UINT8 bank_num = dsp56k_bank_num(en_group);
