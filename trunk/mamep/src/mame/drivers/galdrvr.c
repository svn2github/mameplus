...
ROM_START( phoenxp2 ) /* Artic Multi-System */
	...
	ROM_REGION( 0x1000, "gfx2", 0 )
	ROM_LOAD( "12",  0x0000, 0x0800, BAD_DUMP CRC(73956244) SHA1(e464b587b5ed636816cc9688593f5b6005cb5216) ) /* possible bad_dump... seems to be missing graphics */
...
ROM_START( froggers2 )
	...
	ROM_LOAD( "epr-1013.ic6",  0x1000, 0x1000, CRC(aeca9c13) SHA1(cdf560adbd7f2813e86e378da7781cccf7928a44) )
	ROM_LOAD( "epr-1014.ic7",  0x2000, 0x1000, CRC(dd251066) SHA1(4612e1fe1ab7182a277140b1a1976cc17e0746a5) )
	ROM_LOAD( "epr-1018.ic8",  0x3000, 0x1000, CRC(bf293a02) SHA1(be94e9f5caa74c3de6fd95bd20928f4a9c514227) )
...
GAME( 1981, armorcar2,armorcar, scobra,   armorcar, scobra,   ROT90,  "Stern", "Armored Car (set 2)", GAME_SUPPORTS_SAVE )
