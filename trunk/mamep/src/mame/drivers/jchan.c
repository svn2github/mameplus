...
ROM_START( jchan )
	...
	ROM_REGION( 0x1000000, "gfx2", 0 ) /* SPB GFX (we haven't used yet, not sure where they map, 2nd sprite layer maybe?) */
	...
	ROM_REGION( 0x300000, "ymz", 0 ) /* Audio 1? */
	...
	ROM_REGION( 0x020000, "user1", 0 ) /* MCU Code? */
