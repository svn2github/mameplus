...
static MACHINE_DRIVER_START( system_A )
	...
	MDRV_SOUND_ADD_TAG("OKIM6295.1", OKIM6295, 4000000)
	MDRV_SOUND_CONFIG(okim6295_interface_region_1_pin7high)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.30)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "right", 0.30)

	MDRV_SOUND_ADD_TAG("OKIM6295.2", OKIM6295, 4000000)
...
static MACHINE_DRIVER_START( system_A2 )
	...
	/* sound hardware */
	MDRV_SOUND_REPLACE("OKIM6295.1", OKIM6295, 4000000)
	MDRV_SOUND_CONFIG(okim6295_interface_region_1_pin7high)
 	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.40)
 
	MDRV_SOUND_REPLACE("OKIM6295.2", OKIM6295, 4000000)
	MDRV_SOUND_CONFIG(okim6295_interface_region_2_pin7high)
