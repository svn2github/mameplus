...
ROM_START( captcomm )
	...
	ROM_REGION( 0x18000, "audiocpu", 0 ) /* 64k for the audio CPU (+banks) */
	ROM_LOAD( "cc_09.12a",     0x00000, 0x08000, CRC(698e8b58) SHA1(b7a3d905a7ed2c430426ca2e185e3d7e75e752a1) ) // == cc_09.11a
	ROM_CONTINUE(              0x10000, 0x08000 )
...
GAME( 1991, sf2thndr, sf2,      cps1_10MHz, sf2,      sf2thndr, ROT0,   "bootleg","Street Fighter II - The World Warrior (Thunder Edition)", GAME_SUPPORTS_SAVE )
...
GAME( 1993, dinohunt, dino,     qsound,     dinoh,    dinohunt, ROT0,   "bootleg", "Dinosaur Hunter (Chinese bootleg of Cadillacs and Dinosaurs)", GAME_SUPPORTS_SAVE )
