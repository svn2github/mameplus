...
GAME( 1991, captcommb,captcomm, cps1_10MHz, captcomm, captcomb, ROT0,   "bootleg","Captain Commando (bootleg)", 0 )
...
GAME( 1992, sf2m9,    sf2ce,    cps1_12MHz, sf2m2,    sf2hack,  ROT0,   "bootleg","Street Fighter II' - Champion Edition (M9, bootleg)", 0 )
GAME( 1992, sf2m10,   sf2ce,    cps1_12MHz, sf2hack,  sf2hack,  ROT0,   "bootleg","Street Fighter II' - Champion Edition (M10, bootleg)", 0 )
GAME( 1992, sf2m11,   sf2ce,    cps1_12MHz, sf2m4,    sf2hack,  ROT0,   "bootleg","Street Fighter II' - Champion Edition (M11, bootleg)", 0 )
GAME( 1992, sf2m12,   sf2ce,    cps1_12MHz, sf2m4,    sf2hack,  ROT0,   "bootleg","Street Fighter II' - Champion Edition (M12, bootleg)", 0 )
