...
{
	UINT8 *mem8 = (UINT8 *)memory_region(machine, "main");
	mem8[0x4B8A] = 0x91;
	mem8[0x4B8D] = 0x0;
	mem8[0x4B8E] = 0x2D;
	mem8[0x4B8F] = 0x8;
...
//	mem16[0x15A4/2] = 0xFFC0; // Alignment
	...
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800012, 0x800013, 0, 0, cps1_hack_in2_r); /* Extra input ports */
//	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800006, 0x800007, 0, 0, cps1hack_soundlatch_w); /* Sound command */
	DRIVER_INIT_CALL(cps1);
}
...
static DRIVER_INIT( sf2m3 )
{
	...
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800010, 0x800011, 0, 0, cps1_in1_r); /* Player input ports */
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800028, 0x80002f, 0, 0, cps1_hack_dsw_r); /* System input ports / Dip Switches */
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800186, 0x800187, 0, 0, cps1_hack_in2_r); /* Extra input ports */
	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800190, 0x800191, 0, 0, cps1_soundlatch_w); /* Sound command */
	DRIVER_INIT_CALL(cps1);
}
...
{
	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800180, 0x800181, 0, 0, dinoh_sound_command_w);
	dino_decode(machine);	
	DRIVER_INIT_CALL(cps1);
}
...
{
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0xfc0000, 0xfc0001, 0, 0, cps1_hack_in2_r); /* Extra input ports */
	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800180, 0x800181, 0, 0, dinoh_sound_command_w);
	dino_decode(machine);	
	DRIVER_INIT_CALL(cps1);
}
...
static DRIVER_INIT( wofsjb )
{
	...
	mem8[0x72B8] = 0x00;
	mem8[0x72B9] = 0x0C;
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x80001a, 0x80001b, 0, 0, cps1_hack_in2_r); /* Extra input ports */
	wof_decode(machine);
	DRIVER_INIT_CALL(cps1);
}
...
{
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x882000, 0x882001, 0, 0, cps1_in1_r); /* Player input ports */
	memory_install_read16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x882008, 0x88200f, 0, 0, cps1_dsw_r); /* System input ports / Dip Switches */
	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x882006, 0x882007, 0, 0, cps1hack_soundlatch_w); /* Sound command */
	DRIVER_INIT_CALL(cps1);
}

static DRIVER_INIT( daimakb )
{
	memory_install_write16_handler(cpu_get_address_space(machine->cpu[0], ADDRESS_SPACE_PROGRAM), 0x800006, 0x800007, 0, 0, cps1_soundlatch_w); /* Sound command */
	DRIVER_INIT_CALL(cps1);
}
#endif
...
GAME( 1991, captcomb, captcomm, cps1_10MHz, captcomm, captcomb, ROT0,   "bootleg","Captain Commando (bootleg)", 0 )
