...
static INPUT_PORTS_START( jdreddp )
	...
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("P1 Jump") PORT_PLAYER(1)
	...
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("P2 Jump") PORT_PLAYER(2)
	...
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("P3 Jump") PORT_PLAYER(3)
