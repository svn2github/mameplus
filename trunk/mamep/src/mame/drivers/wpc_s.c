...
ROM_START(jm_05r)
	...
	ROM_REGION(0x1000*2, "user3", ROMREGION_ERASEFF)
	ROM_REGION(0x800000, "sound1", 0)
	ROM_LOAD("jm_u2_s.038", 0x000000, 0x080000, CRC(3b291732) SHA1(d0ce122b2a8c1ce04fe4ad1bef633514bb0c8f9f))
	ROM_RELOAD(0x000000 +0x080000, 0x080000)
	ROM_LOAD("jm_u3_s.038", 0x100000, 0x080000, CRC(653c2fc5) SHA1(8d462314394f8babed89f7cf70ce2df534cae13e))
	ROM_RELOAD(0x100000 +0x080000, 0x080000)
	ROM_LOAD("jm_u4_s.038", 0x200000, 0x080000, CRC(d0cfd604) SHA1(3844667135645653f1766d12d40752ddac2ec830))
	ROM_RELOAD(0x200000 +0x080000, 0x080000)
	ROM_LOAD("jm_u5_s.038", 0x300000, 0x080000, CRC(58d5276d) SHA1(8b74b9fc87c6df015f32201499e25c0135a65568))
	ROM_RELOAD(0x300000 +0x080000, 0x080000)
	ROM_LOAD("jm_u6_s.038", 0x400000, 0x080000, CRC(534ef536) SHA1(9706ca9f422f10f85e81cea965c31c96c662bc34))
	ROM_RELOAD(0x400000 +0x080000, 0x080000)
	ROM_LOAD("jm_u7_s.038", 0x500000, 0x080000, CRC(ce07e128) SHA1(b65e2bd1263f597320b53300868343ce9b6bd395))
	ROM_RELOAD(0x500000 +0x080000, 0x080000)
	ROM_LOAD("jm_u8_s.038", 0x600000, 0x080000, CRC(f463d70a) SHA1(7fd701dcdd8672d7e4d45f400d507cc0f4db2578))
	ROM_RELOAD(0x600000 +0x080000, 0x080000)
ROM_END
...
GAME(1994,  corv_lx2,   corv_21,    wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Bally",        "Corvette (LX2)",               GAME_IS_SKELETON_MECHANICAL)
GAME(1994,  corv_la1,   corv_21,    wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Bally",        "Corvette (LA1)",               GAME_IS_SKELETON_MECHANICAL)
...
GAME(1995,  i500_10r,   i500_11r,   wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Bally",        "Indianapolis 500 (1.0R)",              GAME_IS_SKELETON_MECHANICAL)
...
GAME(1995,  jm_05r,     jm_12r,     wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Williams",    "Johnny Mnemonic (0.5R)",                GAME_IS_SKELETON_MECHANICAL)
...
GAME(1995,  nf_10,      nf_23x,     wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Williams",    "No Fear: Dangerous Sports (1.0)",               GAME_IS_SKELETON_MECHANICAL)
...
GAME(1994,  wcs_la2,    wcs_l2,     wpc_s,  wpc_s, wpc_s_state,  wpc_s,  ROT0,  "Bally",        "World Cup Soccer (La-2)",              GAME_IS_SKELETON_MECHANICAL)
