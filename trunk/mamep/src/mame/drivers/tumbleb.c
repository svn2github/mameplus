...
ROM_START( jumpkids )
	...
	ROM_REGION( 0x100000, "gfx2", ROMREGION_DISPOSE ) /* GFX */
...
ROM_START( suprtrio )
	...
	ROM_REGION( 0x100000, "gfx2", ROMREGION_DISPOSE ) /* sprites */
...
ROM_START( pangpang )
	...
	ROM_REGION( 0x100000, "gfx1", ROMREGION_DISPOSE ) // PF1 tilemap
...
ROM_START( htchctch )
	...
	ROM_REGION( 0x80000, "gfx2", ROMREGION_DISPOSE ) /* GFX */
