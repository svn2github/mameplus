...
#define CD32_BIOS \
	...
	ROM_LOAD16_WORD( "kickstart v3.1 rev 40.60 (1993)(commodore)(cd32).rom",    0x000000, 0x080000, CRC(1e62d4a5) SHA1(3525be8887f79b5929e017b42380a79edfee542d) ) \
	ROM_LOAD16_WORD( "cd32 extended-rom rev 40.60 (1993)(commodore)(cd32).rom", 0x080000, 0x080000, CRC(87746be2) SHA1(5bef3d628ce59cc02a66e6e4ae0da48f60e78f7f) ) \
...
SYSTEM_BIOS_START( cd32 )
	SYSTEM_BIOS_ADD(0, "cd32", "Kickstart v3.1 rev 40.60 + CD32 Extended-ROM rev 40.60" )
SYSTEM_BIOS_END
