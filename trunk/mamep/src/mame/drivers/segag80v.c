...
INPUT_PORTS_START( elim2 )
	...
	PORT_DIPNAME( 0xc0, 0x40, DEF_STR( Bonus_Life )) PORT_DIPLOCATION("SW1:7,8")
...
INPUT_PORTS_START( elim4 )
	...
	PORT_DIPNAME( 0xe0, 0x00, DEF_STR( Coin_A )) PORT_DIPLOCATION("SW2:6,7,8")
...
INPUT_PORTS_START( spacfury )
	...
	PORT_DIPSETTING(	0x20, DEF_STR( Hard ))
	PORT_DIPSETTING(	0x30, DEF_STR( Very_Hard ))
	PORT_DIPNAME( 0xc0, 0x80, DEF_STR( Bonus_Life )) PORT_DIPLOCATION("SW1:7,8")
...
INPUT_PORTS_START( tacscan )
	...
	PORT_DIPSETTING(	0x02, DEF_STR( Off ))
	PORT_DIPSETTING(	0x00, DEF_STR( On ))
	PORT_DIPNAME( 0x0c, 0x0c, "Number of Ships" ) PORT_DIPLOCATION("SW1:3,4")
	PORT_DIPSETTING(	0x00, "2" )
...
INPUT_PORTS_START( startrek )
	...
	PORT_DIPSETTING(	0x02, DEF_STR( Off ))
	PORT_DIPSETTING(	0x00, DEF_STR( On ))
	PORT_DIPNAME( 0x0c, 0x0c, "Photon Torpedoes" ) PORT_DIPLOCATION("SW1:3,4")
