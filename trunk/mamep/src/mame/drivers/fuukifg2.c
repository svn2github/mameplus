...
ROM_START( gogomile )
	...
	ROM_REGION( 0x200000, "gfx1", ROMREGION_DISPOSE )	/* 16x16x4 Sprites */
	ROM_LOAD( "lh537k2r.20", 0x000000, 0x200000, CRC(525dbf51) SHA1(f21876676cc60ed65bc86884da894b24830826bb) )

	ROM_REGION( 0x200000, "gfx2", ROMREGION_DISPOSE )	/* 16x16x4 Tiles */
	...
	ROM_REGION( 0x800000, "gfx3", ROMREGION_DISPOSE )	/* 16x16x8 Tiles */
	...
	ROM_REGION( 0x200000, "gfx4", ROMREGION_DISPOSE )	/* 16x16x4 Tiles */
...
ROM_START( pbancho )
	...
	ROM_REGION( 0x400000, "gfx3", ROMREGION_DISPOSE )	/* 16x16x8 Tiles */
...
GAME( 1995, gogomilj, gogomile, fuuki16, gogomilj, 0, ROT0, "Fuuki", "Susume! Mile Smile (Japan)", GAME_IMPERFECT_SOUND )
