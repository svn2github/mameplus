...
ROM_START( pkgnsh )
	...
	ROM_REGION( 0x400000, "gfx1", ROMREGION_DISPOSE )	/* Backgrounds */
	...
	ROM_REGION( 0x40000, "gfx2", ROMREGION_DISPOSE )	/* Text Layer */
	...
	ROM_REGION( 0xc00000, "gfx3", ROMREGION_DISPOSE )	/* Sprites (256 colors) */
	...
	ROM_REGION( 0x200000, "gfx4", ROMREGION_DISPOSE )	/* Sprites (16 colors) Not Used */
...
ROM_START( realbrk )
	...
	ROM_REGION( 0x200000, "gfx4", ROMREGION_DISPOSE )	/* Sprites (16 colors) */
...
ROM_START( dai2kaku )
	...
	ROM_REGION( 0x800000, "gfx3", ROMREGION_DISPOSE )	/* Sprites (256 colors) */
