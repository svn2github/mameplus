...
/* 03 */GAME( 1988, gground,  0,        system24, gground,  gground,  ROT270, "Sega", "Gain Ground (World, FD1094 317-0058-03c?)", GAME_SUPPORTS_SAVE )
/* 03 */GAME( 1988, ggroundj, gground,  system24, ggroundj, gground,  ROT270, "Sega", "Gain Ground (Japan, FD1094 317-0058-03b)", GAME_SUPPORTS_SAVE )
/* 04 */GAME( 1989, crkdown,  0,        system24, crkdown,  crkdown,  ROT0,   "Sega", "Crack Down (World, FD1094 317-0058-04c)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE ) // clipping probs / solid layer probs? (radar display)
/* 04 */GAME( 1989, crkdownu, crkdown,  system24, crkdown,  crkdown,  ROT0,   "Sega", "Crack Down (US, FD1094 317-0058-04d)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE ) // clipping probs / solid layer probs? (radar display)
...
/* 08 */GAME( 1991, qsww,     0,        system24, bnzabros, qsww,     ROT0,   "Sega", "Quiz Syukudai wo Wasuremashita (Japan, FD1094 317-0058-08b)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE ) // wrong bg colour on title
/* 09 */GAME( 1991, dcclubfd, 0,        system24, dcclub,   dcclubfd, ROT0,   "Sega", "Dynamic Country Club (FD1094 317-0058-09d)", GAME_SUPPORTS_SAVE )

/* ROM Based */
GAME( 1991, dcclub,   0,        system24, dcclub,   dcclub,   ROT0,   "Sega", "Dynamic Country Club", GAME_SUPPORTS_SAVE )
GAME( 1991, dcclubj,  dcclub,   system24, dcclub,   dcclub,   ROT0,   "Sega", "Dynamic Country Club (Japan)", GAME_SUPPORTS_SAVE )
