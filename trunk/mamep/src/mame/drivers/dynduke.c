...
static ADDRESS_MAP_START( master_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x08000, 0x080ff) AM_RAM AM_BASE_MEMBER(dynduke_state, scroll_ram)
...
static ADDRESS_MAP_START( slave_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x06000, 0x067ff) AM_RAM_WRITE(dynduke_background_w) AM_BASE_MEMBER(dynduke_state, back_data)
	AM_RANGE(0x06800, 0x06fff) AM_RAM_WRITE(dynduke_foreground_w) AM_BASE_MEMBER(dynduke_state, fore_data)
...
static ADDRESS_MAP_START( masterj_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x0c000, 0x0c0ff) AM_RAM AM_BASE_MEMBER(dynduke_state, scroll_ram)
