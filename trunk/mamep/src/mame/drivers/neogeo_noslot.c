...
ROM_START( neonopon )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "nnp-p1.bin", 0x000000, 0x080000, CRC(8a792271) SHA1(6f8db18f9ced0706cb2e4b5545da97be871352dd) )

	NEO_SFIX_64K( "nnp-s1.bin", CRC(93e6fe7d) SHA1(791789c33eeeaa23fe6581db2f0ee3c35c73c052) )

	NEO_BIOS_AUDIO_64K( "nnp-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "nnp-v1.bin", 0x000000, 0x080000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )

	NO_DELTAT_REGION

	ROM_REGION( 0x200000, "sprites", 0 )
	ROM_LOAD16_BYTE( "nnp-c1.bin", 0x000000, 0x100000, CRC(4a718ae3) SHA1(e59515bacd9065c4b2712710a6a9a647e42c31e6) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "nnp-c2.bin", 0x000001, 0x100000, CRC(0e2cbc25) SHA1(3c45eedb2efc6a3a7ec65487f980e117485abc9f) ) /* Plane 2,3 */
ROM_END

ROM_START( neopong )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "pong-p1.bin", 0x000000, 0x020000, CRC(9f35e29d) SHA1(261ce9305950debbc2fe088a45ab0fa83d6cf10d) )

	NEO_SFIX_128K( "pong-s1.bin", CRC(cd19264f) SHA1(531be2305cd56d332fb7a53ab924214ade34a9e8) )

	NEO_BIOS_AUDIO_128K( "pong-m1.bin", CRC(78c851cb) SHA1(a9923c002e4e2171a564af45cff0958c5d57b275) )

	ROM_REGION( 0x200000, "ymsnd", 0 )
	ROM_LOAD( "pong-v1.bin", 0x000000, 0x200000, CRC(6c31223c) SHA1(ede3a2806d7d872a0f737626a23ecce200b534e6) )

	NO_DELTAT_REGION

	ROM_REGION( 0x200000, "sprites", 0 )
	ROM_LOAD16_BYTE( "pong-c1.bin", 0x000000, 0x100000, CRC(f5a57d1a) SHA1(781170ae439f48fcbcee6af4cb3a1367dbb70498) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "pong-c2.bin", 0x000001, 0x100000, CRC(affde64e) SHA1(25ba8b4f6f961027d97d35f13cebeaee2dbb6f5a) ) /* Plane 2,3 */
ROM_END
...
ROM_START( columnsn )
	...
	NEO_BIOS_AUDIO_64K( "2000-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "2000-v1.bin", 0x000000, 0x80000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )
...
ROM_START( beast )
	...
	NEO_BIOS_AUDIO_64K( "2002-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "2002-v1.bin", 0x000000, 0x80000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )
...
ROM_START( poknight )
	...
	NEO_BIOS_AUDIO_64K( "2003-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "2003-v1.bin", 0x000000, 0x80000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )
...
ROM_START( neo2500 )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "2500-p1.bin", 0x000000, 0x80000, CRC(2321c0d8) SHA1(e0d535af20f271794dc14c83ff3ffbc1f6bf98d9) )

	NEO_SFIX_64K( "2500-s1.bin", CRC(1a37925c) SHA1(2060196c3a4d5dcc75aa62e5f02b0d397ec54b1b) )

	NEO_BIOS_AUDIO_64K( "2500-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "2500-v1.bin", 0x000000, 0x80000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )

	NO_DELTAT_REGION

	ROM_REGION( 0x100000, "sprites", 0 )
	ROM_LOAD16_BYTE( "2500-c1.bin", 0x000000, 0x80000, CRC(8c304b56) SHA1(f99298b7942c0bafb6b8038b2ac3b80b75034e34) )
	ROM_LOAD16_BYTE( "2500-c2.bin", 0x000001, 0x80000, CRC(9a0758d6) SHA1(ac1c147fe55c80082c9a68a86c30b516ff086cc4) )
ROM_END

ROM_START( syscheck )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sys-p1.bin", 0x000000, 0x80000, CRC(a4adbe1e) SHA1(eee4a8ebe62a2c97282f0350b3c28c615ea44956) )

	NEO_SFIX_64K( "sys-s1.bin", CRC(4774f28e) SHA1(f381dac250fca3dfe1eb8c8f1b9b3bf0d521000e) )

	NEO_BIOS_AUDIO_64K( "sys-m1.bin", CRC(7669de64) SHA1(caa170b561df4f68000beaad41d942c66a4a10ee) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "sys-v1.bin", 0x000000, 0x80000, CRC(504bf849) SHA1(13a184ec9e176371808938015111f8918cb4df7d) )

	NO_DELTAT_REGION

	ROM_REGION( 0x100000, "sprites", 0 )
	ROM_LOAD16_BYTE( "sys-c1.bin", 0x000000, 0x80000, CRC(75660aac) SHA1(6a521e1d2a632c26e53b83d2cc4b0edecfc1e68c) )
	ROM_LOAD16_BYTE( "sys-c2.bin", 0x000001, 0x80000, CRC(75660aac) SHA1(6a521e1d2a632c26e53b83d2cc4b0edecfc1e68c) )
ROM_END

ROM_START( ltora )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ltora-p1.bin", 0x000000, 0x40000, CRC(353f6b05) SHA1(ae2ebb9a08e936a86cd09aaafda9e90826461bbf) )

	NEO_SFIX_64K( "ltora-s1.bin", CRC(8224d8b7) SHA1(2e7b176e5dffd8a44fa813b928155801d80b1ee6) )

	NEO_BIOS_AUDIO_64K( "ltora-m1.bin", CRC(6847fd52) SHA1(6e6d9045299966d41e3f193b3aff032d5b5e135d) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "ltora-v1.bin", 0x000000, 0x80000, CRC(0329c2e7) SHA1(44c7f04d4e37fb5a06b0366d291f80c3a67a46f5) )

	NO_DELTAT_REGION

	ROM_REGION( 0x100000, "sprites", 0 )
	ROM_LOAD16_BYTE( "ltora-c1.bin", 0x000000, 0x080000, CRC(8b607198) SHA1(23dc0b285518f3e80a8feab4d674d625e76e8896) )
	ROM_LOAD16_BYTE( "ltora-c2.bin", 0x000001, 0x080000, CRC(6b96b59c) SHA1(a62600c337d7f6821ce56bdfd5c484f05c88187f) )
ROM_END

ROM_START( frogfest )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "frog-p1.bin", 0x000000, 0x80000, CRC(c26848da) SHA1(33737f8d2366b3a554ceb9ea2fcd85aaed75f344) )

	NEO_SFIX_128K( "frog-s1.bin", CRC(88f4cd13) SHA1(7f3b28c903ecf90478f2dcddf790714d7363aa2b) )

	NEO_BIOS_AUDIO_128K( "frog-m1.bin", CRC(c825b484) SHA1(7dea872ae39ef83981436aaf3c9b602ac8bec676) )

	ROM_REGION( 0x200000, "ymsnd", 0 )
	ROM_LOAD( "frog-v1.bin", 0x000000, 0x100000, CRC(2639da11) SHA1(4309e46014d623066d427ce3473542c99f678f86) )
	ROM_LOAD( "frog-v2.bin", 0x100000, 0x100000, CRC(e5eda58b) SHA1(ae203cfedf4b563da914939e0a4d7f4697070f82) )

	NO_DELTAT_REGION

	ROM_REGION( 0x200000, "sprites", 0 )
	ROM_LOAD16_BYTE( "frog-c1.bin", 0x000000, 0x100000, CRC(7b2f9fb3) SHA1(62deacf16c3b259422f962c9604b4efc2f32d91b) )
	ROM_LOAD16_BYTE( "frog-c2.bin", 0x000001, 0x100000, CRC(a7f18a6f) SHA1(1a277c79eaacf09d12a4b7c88421e7a6d6153503) )
ROM_END

ROM_START( cnbe )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cnbe-p1.bin", 0x000000, 0x80000, CRC(7ece4186) SHA1(fc4ed3b5ed551744542c2ff1e45a6e97c68eff88) )
...
ROM_START( totcarib )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "totc-p1.bin", 0x000000, 0x100000, CRC(99604539) SHA1(88d5f4fe56516aa36496cafd2508f6864118f1e2) )

	NEO_SFIX_128K( "totc-s1.bin", CRC(0a3fee41) SHA1(0ab2120e462086be942efcf6ffb37f58ea966ca3) )

	NEO_BIOS_AUDIO_128K( "totc-m1.bin", CRC(18b23ace) SHA1(d55495f3d8bb5568c8f2322763278a86ba5297b3) )

	ROM_REGION( 0x500000, "ymsnd", 0 )
	ROM_LOAD( "totc-v1.bin", 0x000000, 0x200000, CRC(15c7f9e6) SHA1(c51328a92dc7c612fd6c2f3841caee4fbd120f36) )
	ROM_LOAD( "totc-v2.bin", 0x200000, 0x200000, CRC(1b264559) SHA1(50c28858304e51cdc60f425483a1d1d2bbfb2f8d) )
	ROM_LOAD( "totc-v3.bin", 0x400000, 0x100000, CRC(84b62c5d) SHA1(30d7f2e16c6d602cebce5e9b4b8a5b2bde20af58) )

	NO_DELTAT_REGION

	ROM_REGION( 0x400000, "sprites", 0 )
	ROM_LOAD16_BYTE( "totc-c1.bin", 0x000000, 0x200000, CRC(cdd6600f) SHA1(85649c199b32db7553012cb5a058a92bbbb7355a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "totc-c2.bin", 0x000001, 0x200000, CRC(f362c271) SHA1(4a2efa043cd2553ff7039cb18a1dba8b41493be7) ) /* Plane 2,3 */
ROM_END

ROM_START( neothndr )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "thndr-p1.bin", 0x000000, 0x100000, CRC(f7050757) SHA1(b73009050905ad2b1f06690e0106e59fb5ede86b) )

	NEO_SFIX_128K( "thndr-s1.bin", CRC(a545b593) SHA1(09077b63595eebb7dddd55e041e7786164df0ead) )

	NEO_BIOS_AUDIO_128K( "thndr-m1.bin", CRC(9c0291ea) SHA1(3fa67c62acba79be6b3a98cc1601e45569fa11ae) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "thndr-v1.bin", 0x000000, 0x080000, CRC(debeb8fb) SHA1(49a3d3578c087f1a0050168571ef8d1b08c5dc05) )

	NO_DELTAT_REGION

	ROM_REGION( 0x200000, "sprites", 0 )
	ROM_LOAD16_BYTE( "thndr-c1.bin", 0x000000, 0x100000, CRC(48b9126e) SHA1(38bf1296c3d8762372d4eab785f34507a4f8776c) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "thndr-c2.bin", 0x000001, 0x100000, CRC(214df62e) SHA1(21e4ce2a0ac636081c9e07a294cb44987692039e) ) /* Plane 2,3 */
ROM_END

ROM_START( neotet )
	ROM_REGION( 0x100000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "tet-p1.bin", 0x000000, 0x080000, CRC(3465569a) SHA1(51506d549fa048581321fc39403c0a3bf8f77467) )

	NEO_SFIX_128K( "tet-s1.bin", CRC(a545b593) SHA1(09077b63595eebb7dddd55e041e7786164df0ead) )

	NEO_BIOS_AUDIO_128K( "tet-m1.bin", CRC(6b3703c6) SHA1(6fa41b713f03e0957f410a387aa896e7d924acb2) )

	ROM_REGION( 0x100000, "ymsnd", 0 )
	ROM_LOAD( "tet-v1.bin", 0x000000, 0x080000, CRC(2be8e290) SHA1(198cff1b1d70f7d05344d6ab38a4354f993dc4b8) )

	NO_DELTAT_REGION

	ROM_REGION( 0x100000, "sprites", 0 )
	ROM_LOAD16_BYTE( "tet-c1.bin", 0x000000, 0x080000, CRC(acc6d1d4) SHA1(1f6ad8578d8edaa22a35ad58dc76de8543a96db9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "tet-c2.bin", 0x000001, 0x080000, CRC(7ec06ab5) SHA1(3a8503be7f14d451f5ae964888b385334c12e8c6) ) /* Plane 2,3 */
ROM_END

ROM_START( cphd )
	ROM_REGION( 0x900000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cphd-p1.bin", 0x000000, 0x100000, CRC(de032a95) SHA1(5566ddbb17c8cc4016e25de1afb0ea5c281844ae) )
	ROM_LOAD16_WORD_SWAP( "cphd-p2.bin", 0x100000, 0x800000, CRC(7a3a2e41) SHA1(a1bd9e20f29f283f892ed3d937b3a79a63d9a04b) )

	NEO_SFIX_128K( "cphd-s1.bin", CRC(1736099a) SHA1(486bb9b5abd43d1739c717f0dd3aff0d6ed37ec0) )

	NEO_BIOS_AUDIO_64K( "cphd-m1.bin", CRC(535a7397) SHA1(3752017175030b05a91078bdf0709af91dee5fc3) )

	ROM_REGION( 0x2000000, "ymsnd", 0 )
	ROM_LOAD( "cphd-v1.bin", 0x000000, 0x2000000, CRC(04eb9c07) SHA1(226f6d6e0365613fb66671775a1f8e5ca62d0549) )

	NO_DELTAT_REGION

	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "cphd-c1.bin", 0x000000, 0x2000000, CRC(f3a4b475) SHA1(07a5e8c3a0a8e29f952e448d8eac772ccef6586e) )
	ROM_LOAD16_BYTE( "cphd-c2.bin", 0x000001, 0x2000000, CRC(05ce93a9) SHA1(a29f7ca6d0b3c53a0b2889e716b34fe921da432c) )
ROM_END

ROM_START( timesupd )
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "tup-p1.bin", 0x000000, 0x200000, CRC(be86adb1) SHA1(4b363bab51dfc43b2302956f79a0b1d5202339ac) )

	NEO_SFIX_128K( "tup-s1.bin", CRC(a545b593) SHA1(09077b63595eebb7dddd55e041e7786164df0ead) )

	NEO_BIOS_AUDIO_128K( "tup-m1.bin", CRC(fe795d11) SHA1(53ba44f2197aa700229f18dee6513bc0c2619904) )

	ROM_REGION( 0x800000, "ymsnd", 0 )
	ROM_LOAD( "tup-v1.bin", 0x000000, 0x400000, CRC(13b8f47b) SHA1(4f0384101f9f6fce8c86a27a11a2b9d43a84a154) )
	ROM_LOAD( "tup-v2.bin", 0x400000, 0x400000, CRC(6fdd663d) SHA1(9667f11b4350285d0722c67052ff4e9a63a3409f) )

	NO_DELTAT_REGION

	ROM_REGION( 0x400000, "sprites", 0 )
	ROM_LOAD16_BYTE( "tup-c1.bin", 0x000000, 0x200000, CRC(c19a300a) SHA1(3ab4ec4b10583257b92f5a989434db89f8130626) )
	ROM_LOAD16_BYTE( "tup-c2.bin", 0x000001, 0x200000, CRC(fdb3f7ed) SHA1(dd1d69515e58e9fba8cefb1c4cd808dfea0475d9) )
ROM_END
...
ROM_START( zupapad ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "070-c1d.c1", 0x0000000, 0x800000, CRC(65d73348) SHA1(69688bb018246fed22201c80909439ace82aa343) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "070-c2d.c2", 0x0000001, 0x800000, CRC(c498708f) SHA1(57c7034ab62ff5bbdf986d77f42387e6f86c8c30) ) /* Plane 2,3 */
ROM_END
...
ROM_START( bbbuster )
	...
	ROM_REGION( 0x400000, "sprites", 0 )
	ROM_LOAD16_BYTE( "071-c1.c1", 0x000000, 0x200000, CRC(23d84a7a) SHA1(9034658ad40e2c45558abc3db312aa2764102fc4) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "071-c2.c2", 0x000001, 0x200000, CRC(ce7b6248) SHA1(ad1cd5adae5c151e183ff88b68afe10f7009f48e) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof96ae )
	...
	ROM_REGION( 0x3000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "214ae-c1.c1",   0x0000000, 0x400000, CRC(b308c1f9) SHA1(0c026b49ef45065c0691255a538921b0b4ad11dd) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c2.c2",   0x0000001, 0x400000, CRC(220a92b2) SHA1(4f33fc76a199aef2880b3ba1760f92973315edfa) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214-c3.c3",     0x0800000, 0x400000, CRC(64989a65) SHA1(e6f3749d43be0afa9dad7b085cb782ba694252ca) ) /* Plane 0,1 */ /* TC5332205 */
	ROM_LOAD16_BYTE( "214-c4.c4",     0x0800001, 0x400000, CRC(afbea515) SHA1(ae875052728de33174827705646bd14cf3937b5c) ) /* Plane 2,3 */ /* TC5332205 */
	ROM_LOAD16_BYTE( "214ae-c5.c5",   0x1000000, 0x400000, CRC(6e03cb0c) SHA1(b75bef8025ab84e8b36404e94901092d19b3543a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c6.c6",   0x1000001, 0x400000, CRC(a90bc55d) SHA1(75e141fc9debe5cb1db3875094c51afc9d852fac) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae-c7.c7",   0x1800000, 0x400000, CRC(08021fd6) SHA1(77c8fed7ac39e6a1a24a294f95c095c098a85c11) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c8.c8",   0x1800001, 0x400000, CRC(bbd21b08) SHA1(4e060195b632e99634ca9c67fb2398c5a91c3341) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae-c9.c9",   0x2000000, 0x400000, CRC(57e5bf80) SHA1(ef9a8f08ba094376257f29beb3fce04324edc4bf) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c10.c10", 0x2000001, 0x400000, CRC(cbe44c81) SHA1(be87a92a1f8f1985b5441608db7329aabb745bbb) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae-c11.c11", 0x2800000, 0x400000, CRC(5c7ddc8b) SHA1(34e0ae91968a58392db273f209dccfa11890fd26) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c12.c12", 0x2800001, 0x400000, CRC(48d8b574) SHA1(fa9be64f0cde68b9685146d5768dc95ddf9d54b8) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof96ae20 )
	...
	ROM_LOAD16_BYTE( "214-c3.c3",     0x0800000, 0x400000, CRC(64989a65) SHA1(e6f3749d43be0afa9dad7b085cb782ba694252ca) ) /* Plane 0,1 */ /* TC5332205 */
	ROM_LOAD16_BYTE( "214-c4.c4",     0x0800001, 0x400000, CRC(afbea515) SHA1(ae875052728de33174827705646bd14cf3937b5c) ) /* Plane 2,3 */ /* TC5332205 */
	ROM_LOAD16_BYTE( "214ae2-c5.c5",  0x1000000, 0x400000, CRC(41dbd677) SHA1(447d081bd8c390df63b9800ef302d2ada660796a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae2-c6.c6",  0x1000001, 0x400000, CRC(1e6a3961) SHA1(ac09dc3e38209033e7797ec6896dd176f3ce6272) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae-c7.c7",   0x1800000, 0x400000, CRC(08021fd6) SHA1(77c8fed7ac39e6a1a24a294f95c095c098a85c11) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae-c8.c8",   0x1800001, 0x400000, CRC(bbd21b08) SHA1(4e060195b632e99634ca9c67fb2398c5a91c3341) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae2-c9.c9",  0x2000000, 0x400000, CRC(2efceab8) SHA1(e38c4d2be4d1101d9463cb7c7295f42676cbedb9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae2-c10.c10",0x2000001, 0x400000, CRC(9f7e1492) SHA1(11315f6ef47210b56004036162767d2e1f7b39b2) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214ae2-c11.c11",0x2800000, 0x400000, CRC(183cd8fd) SHA1(bd4d47780bf80e382759fd4bbe25fefd4a180610) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214ae2-c12.c12",0x2800001, 0x400000, CRC(b3d30499) SHA1(34e8009e05cdc8a2fc41e8551df4a5f681a329c1) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof99kd ) /* Decrypted GFX */ /* KOREAN VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "251-c1d.c1", 0x0000000, 0x800000, CRC(b3d88546) SHA1(C277525F3DB5B4CB07E9842605C7C40E6C203AD9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "251-c2d.c2", 0x0000001, 0x800000, CRC(915c8634) SHA1(685ECB4271EDF61F6A28A2235DE11DD219B999D6) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "251-c3d.c3", 0x1000000, 0x800000, CRC(b047c9d5) SHA1(B840EAB2208E6C0A1DB0CDB28DF46BA07DA2DDCA) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "251-c4d.c4", 0x1000001, 0x800000, CRC(6bc8e4b1) SHA1(674CB8145AEADA1683A70BEB02ED4EA028F5BDF8) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "251-c5d.c5", 0x2000000, 0x800000, CRC(9746268c) SHA1(59D839F01F4827377A752679922BC7281099430D) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "251-c6d.c6", 0x2000001, 0x800000, CRC(238b3e71) SHA1(F929C942972F768E68A5A009A3D174D203029160) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "251-c7d.c7", 0x3000000, 0x800000, CRC(2f68fdeb) SHA1(37167C84A39141C179F94800F207DAC3AABC5478) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "251-c8d.c8", 0x3000001, 0x800000, CRC(4c2fad1e) SHA1(26779E79296EB1988A8C4D60D2E1BAF041F2C0CF) ) /* Plane 2,3 */
ROM_END
...
ROM_START( ganryud ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "252-c1d.c1", 0x0000000, 0x800000, CRC(6bf7605b) SHA1(6710CBC27D6EC35648F98F0CA541AAAEEFFD0980) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "252-c2d.c2", 0x0000001, 0x800000, CRC(596792ce) SHA1(AD9C8F8B0E95396FADE2B485D11A1B3D4CB65F37) ) /* Plane 2,3 */
ROM_END
...
ROM_START( garoud ) /* Decrypted GFX */ /* later revision */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "253-c1d.c1", 0x0000000, 0x800000, CRC(497be3f2) SHA1(3b4e524ff185db326cdefe115851ce282272fb58) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "253-c2d.c2", 0x0000001, 0x800000, CRC(6a9e95ca) SHA1(d9730d2db58edfa660edab5bf0f7fc3ed058bccf) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "253-c3d.c3", 0x1000000, 0x800000, CRC(39373d2f) SHA1(8c0307150bc31001605efbe0e38ae74e1e466d5d) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "253-c4d.c4", 0x1000001, 0x800000, CRC(4de23f6c) SHA1(b40bce471fb1815037e4c3705f8238e659a13a82) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "253-c5d.c5", 0x2000000, 0x800000, CRC(16634ba5) SHA1(e51649efd039270139aa7292a28925e547b2be59) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "253-c6d.c6", 0x2000001, 0x800000, CRC(95671ffd) SHA1(803ebeb74fefe88b9aba53cbca103c0e9145abcb) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "253-c7d.c7", 0x3000000, 0x800000, CRC(e36ce77f) SHA1(71931559293182749ded13c52d8bac988a3a062f) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "253-c8d.c8", 0x3000001, 0x800000, CRC(ddbd1096) SHA1(634cfb61398b3f1b983f7f3966b53f4cc3a78671) ) /* Plane 2,3 */
ROM_END
...
ROM_START( s1945pd ) /* Decrypted GFX Roms */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "254-c1d.c1", 0x0000000, 0x800000, CRC(7b6902f9) SHA1(C974A3CD84FA15D5AE7C9053ADBB004A9AA902CD) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "254-c2d.c2", 0x0000001, 0x800000, CRC(51bd4252) SHA1(5A99563DE1D83B7CD1D7CA7A50C71D5F30439276) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "254-c3d.c3", 0x1000000, 0x800000, CRC(a38993e4) SHA1(0BD3BCECF17ABFDA7DA997E348FE3B0E7A66A828) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "254-c4d.c4", 0x1000001, 0x800000, CRC(d5696530) SHA1(15CBDAA729B8DD4D2489157D778379CFB0F79E51) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "254-c5d.c5", 0x2000000, 0x800000, CRC(28764bd6) SHA1(21158EA89DD88ABD7F73B4513B699089F7944BA5) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "254-c6d.c6", 0x2000001, 0x800000, CRC(9931bdf1) SHA1(FA95FD8621403684E09F01A89F8DF9AE2FA7DE76) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "254-c7d.c7", 0x3000000, 0x800000, CRC(6e12afcd) SHA1(EF45D9B923EC937F9C207CD50D917F0DED5B8FAF) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "254-c8d.c8", 0x3000001, 0x800000, CRC(178d4684) SHA1(3CBF379209C189EE48260A044DC2754035F57E14) ) /* Plane 2,3 */
ROM_END
...
ROM_START( preisl2d ) /* Decrypted GFX */
	...
	ROM_REGION( 0x3000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "255-c1d.c1", 0x0000000, 0x800000, CRC(50fd785e) SHA1(97E03925F3060DF4CFA576B6D2C2000952990530) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "255-c2d.c2", 0x0000001, 0x800000, CRC(ab913f1e) SHA1(E3413D40DC4A2240FF0302EB9EFF4CC64895B6EF) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "255-c3d.c3", 0x1000000, 0x800000, CRC(bc0ee75c) SHA1(50C01B97D5457C2C1B8DF8C0C7EDA69384DEA78B) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "255-c4d.c4", 0x1000001, 0x800000, CRC(29908823) SHA1(2A40263F3866C06EECC209FAEEA7CED6641ED918) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "255-c5d.c5", 0x2000000, 0x800000, CRC(83c56bca) SHA1(54BEC4CCE628BEF3B87BBD6C0339494232A9516B) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "255-c6d.c6", 0x2000001, 0x800000, CRC(59e0e805) SHA1(0D9C9B52BB0672FE70FFBB2780A9449F6A7F0984) ) /* Plane 2,3 */
ROM_END
...
ROM_START( mslug3hd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "256-c1d.c1", 0x0000000, 0x800000, CRC(3540398c) SHA1(0A96F2360EB26C66BF02BBC6F52230B55CC95E4E) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "256-c2d.c2", 0x0000001, 0x800000, CRC(bdd220f0) SHA1(F52851023F3BC120B05F622AF0E0AB1BEDC41604) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "256-c3d.c3", 0x1000000, 0x800000, CRC(bfaade82) SHA1(66B07E592C9A9B35567FE463496F8F75C32A7DB9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "256-c4d.c4", 0x1000001, 0x800000, CRC(1463add6) SHA1(4DB91B46D6430DA272D27D00A6DC0EB25949BEA1) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "256-c5d.c5", 0x2000000, 0x800000, CRC(48ca7f28) SHA1(E903876BE5FB4FA582C988D74C6BEF1C3B9C7083) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "256-c6d.c6", 0x2000001, 0x800000, CRC(806eb36f) SHA1(A412A9CAB80C326733DDE7652D1DB2A46AFB3EBB) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "256-c7d.c7", 0x3000000, 0x800000, CRC(9395b809) SHA1(CA9AC9832017094EEE3623F0B6C4C4B7B4F1374D) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "256-c8d.c8", 0x3000001, 0x800000, CRC(a369f9d4) SHA1(F8146EA80A1A23DA7E7E04C88F778EE9ABDFEB5C) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof2knd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "257-c1d.c1", 0x0000000, 0x800000, CRC(abcdd424) SHA1(1D52AAE8A7806D48C098C2A7A77DFF6E02AC4870) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "257-c2d.c2", 0x0000001, 0x800000, CRC(cda33778) SHA1(A619740364C952C443F27ED9B7C395610F2673C7) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "257-c3d.c3", 0x1000000, 0x800000, CRC(087fb15b) SHA1(F77CB6E670CDF7709D84D770ECF28533CBFBE6DE) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "257-c4d.c4", 0x1000001, 0x800000, CRC(fe9dfde4) SHA1(23750FF0C4BC084D55EEA66A5CDD0EF2D6C32CDC) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "257-c5d.c5", 0x2000000, 0x800000, CRC(03ee4bf4) SHA1(8F26C5BC525A5786DE8E25797E2875A1DFE527BE) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "257-c6d.c6", 0x2000001, 0x800000, CRC(8599cc5b) SHA1(9A05FC12273AEBFBC4AC22E88B32AE9ECD269462) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "257-c7d.c7", 0x3000000, 0x800000, CRC(71dfc3e2) SHA1(1889A8DC88993E35F9FD93CE2BEE1DE52995932D) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "257-c8d.c8", 0x3000001, 0x800000, CRC(0fa30e5f) SHA1(0CB7FA6B0219E1AF2DF9B97786C677651A78F37A) ) /* Plane 2,3 */
ROM_END
...
ROM_START( bangbedd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "259-c1d.c1", 0x000000, 0x800000, CRC(c50a91c3) SHA1(47ef41369b057b07bf143196e929ac5ab3679d33) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "259-c2d.c2", 0x000001, 0x800000, CRC(820ab36e) SHA1(acad44f815989d5908585cfeff5658fe85a50ad8) ) /* Plane 2,3 */
ROM_END
...
ROM_START( nitdd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "260-c1d.c1", 0x0000000, 0x800000, CRC(f3ff4953) SHA1(0E54548387F3056088E89086A30DA05935D08B24) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "260-c2d.c2", 0x0000001, 0x800000, CRC(f1e49faa) SHA1(2A771E318423ADDD9DAAE3A9AF200DE2C70F4021) ) /* Plane 2,3 */
ROM_END
...
ROM_START( sengok3d ) /* Decrypted GFX */
	...
	ROM_REGION( 0x2000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "261-c1d.c1", 0x0000000, 0x800000, CRC(9af7cbca) SHA1(cf2fe3e5265861369f2878140ef33a6715b031aa) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "261-c2d.c2", 0x0000001, 0x800000, CRC(2a1f874d) SHA1(26923ec0bedba56f25e6222aa107b45ccb3def7b) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "261-c3d.c3", 0x1000000, 0x800000, CRC(5403adb5) SHA1(5614ee892e810dc49758f5985b3dc4f227e01b56) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "261-c4d.c4", 0x1000001, 0x800000, CRC(18926df6) SHA1(a4859c9166ef7abec1f3e6af3292051a63a81f93) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof2001d )  /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "262-c1d.c1", 0x0000000, 0x800000, CRC(103225b1) SHA1(41486C7BB421B6B54F3CA07621AABD907BF10E15) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "262-c2d.c2", 0x0000001, 0x800000, CRC(f9d05d99) SHA1(C135DD3D5584DC58A46315D64F663E34BB64BEBF) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "262-c3d.c3", 0x1000000, 0x800000, CRC(4c7ec427) SHA1(0156E2F79E7A62B15ACC2314AC6563A67AF0F256) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "262-c4d.c4", 0x1000001, 0x800000, CRC(1d237aa6) SHA1(B007FE9F1F32F0FF947C6575741B47FB70976728) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "262-c5d.c5", 0x2000000, 0x800000, CRC(c2256db5) SHA1(DAE6B7B0673B431F223D82F7C3A685DE70A1C035) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "262-c6d.c6", 0x2000001, 0x800000, CRC(8d6565a9) SHA1(137C950D588D40C812C36967EC17D04D4FC56362) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "262-c7d.c7", 0x3000000, 0x800000, CRC(d1408776) SHA1(E77C786070B2B851A8A36250722B4C902E7213ED) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "262-c8d.c8", 0x3000001, 0x800000, CRC(954d0e16) SHA1(975803C130DF3A6E835B9BF0F8532D6586058C54) ) /* Plane 2,3 */
ROM_END
...
ROM_START( mslug4d ) /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x3000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "263-c1d.c1", 0x0000000, 0x800000, CRC(a75ffcde) SHA1(97f405a95a56615ae49f79e1a69f98cc2f2434ef) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "263-c2d.c2", 0x0000001, 0x800000, CRC(5ab0d12b) SHA1(8a3d95dd2e9cc1b6dcf6a957fed43ee390248307) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "263-c3d.c3", 0x1000000, 0x800000, CRC(61af560c) SHA1(aa7bc45e03a6bbd18eb56d118d4932102ccb196a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "263-c4d.c4", 0x1000001, 0x800000, CRC(f2c544fd) SHA1(179b064f81b49f5808d7a7a5bce28e95b09e5abe) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "263-c5d.c5", 0x2000000, 0x800000, CRC(84c66c44) SHA1(9273f44bf11891aa04ddd2cbb6442d084c2a2e04) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "263-c6d.c6", 0x2000001, 0x800000, CRC(5ed018ab) SHA1(e78501fa8a80960093a4d54ce952681a98300148) ) /* Plane 2,3 */
ROM_END
...
ROM_START( rotdd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "264-c1d.c1", 0x0000000, 0x800000, CRC(ec9d18c0) SHA1(83EBEDAE9655B6C64421CD131930B27D252853EC) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "264-c2d.c2", 0x0000001, 0x800000, CRC(b1069066) SHA1(0B4E2249EFC782B572B589F72AADBD8007E8778C) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "264-c3d.c3", 0x1000000, 0x800000, CRC(7e636d49) SHA1(1BA15DDBCE8369D7232CC1DA3F833F6CB68FBC10) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "264-c4d.c4", 0x1000001, 0x800000, CRC(76892fda) SHA1(27416585973A6EC7B5721DE1116C8700B38E3A4C) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "264-c5d.c5", 0x2000000, 0x800000, CRC(469061bc) SHA1(34E60E5F93743BE88BFC9E8B7656FE9FAF77F8F5) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "264-c6d.c6", 0x2000001, 0x800000, CRC(2200220a) SHA1(8379B4C89854B3CC9B4F33F4F51AB5387ACD14CA) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "264-c7d.c7", 0x3000000, 0x800000, CRC(edda4baf) SHA1(3F53EB50FD9EC9E9EE05EEE050885C07023B6D53) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "264-c8d.c8", 0x3000001, 0x800000, CRC(82b1ba22) SHA1(B4AD715807F2C15FC06945F0BCB475C3698CF089) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof2002d ) /* Decrypted GFX */
	...
	ROM_LOAD16_BYTE( "265-c7d.c7", 0x3000000, 0x800000, CRC(8a5b561c) SHA1(A19697D4C2CC8EDEBC669C95AE1DB4C8C2A70B2C) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "265-c8d.c8", 0x3000001, 0x800000, CRC(bef667a3) SHA1(D5E8BC185DCF63343D129C31D2DDAB9F723F1A12) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kf2k2ps2 )
	...
	ROM_LOAD16_BYTE( "265-c5d.c5", 0x2000000, 0x800000, CRC(74bba7c6) SHA1(E01ADC7A4633BC0951B9B4F09ABC07D728E9A2D9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "265-c6d.c6", 0x2000001, 0x800000, CRC(e20d2216) SHA1(5D28EEA7B581E780B78F391A8179F1678EE0D9A5) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "265ps2-c7.c7",   0x3000000, 0x800000, CRC(1b1d35fb) SHA1(474e956a627c90508fcda5c12de83743339814aa) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "265ps2-c8.c8",   0x3000001, 0x800000, CRC(a5e35d11) SHA1(dccd445754a07e243f39d06b4b31cb9937f3b3bd) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "265ps2-c9.c9",   0x4000000, 0x800000, CRC(aa8bbc97) SHA1(f0dde66eceb34609473d83e2514b7056a0a22851) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "265ps2-c10.c10", 0x4000001, 0x800000, CRC(9832713d) SHA1(899c00ea88ef536441b9358b4620402ca9851cf5) ) /* Plane 2,3 */
ROM_END
...
ROM_START( matrimd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "266-c1d.c1", 0x0000000, 0x800000, CRC(0ab54c54) SHA1(31bca460462b8545b3e5264804987ab951e9b202) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "266-c2d.c2", 0x0000001, 0x800000, CRC(b834dd89) SHA1(579470839a8d23b2d22cf727d2b43c6c3c113e1f) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "266-c3d.c3", 0x1000000, 0x800000, CRC(f31d68d4) SHA1(a6b8aaf11d25f871b52e9626fe0e4ae0683c3c52) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "266-c4d.c4", 0x1000001, 0x800000, CRC(58cfb6e9) SHA1(106875db996ec29b0254b34f9d935c761cde20c4) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "266-c5d.c5", 0x2000000, 0x800000, CRC(f3c0e3fd) SHA1(3a2f14517617fb98a202ceec88d52891e1438c8e) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "266-c6d.c6", 0x2000001, 0x800000, CRC(b53c8dcf) SHA1(9f4b0bac92262e8c1c1055a70f13c7c326367f73) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "266-c7d.c7", 0x3000000, 0x800000, CRC(3c1fb02a) SHA1(43e170e6d48c01d8c323f9309f97e6038bab20d7) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "266-c8d.c8", 0x3000001, 0x800000, CRC(5ee31f80) SHA1(3cdd8037f5004df92f4c19ba0746c8bccb4e2473) ) /* Plane 2,3 */
ROM_END
...
ROM_START( pnyaad ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "267-c1d.c1", 0x0000000, 0x800000, CRC(75fa4f27) SHA1(05f39dc5bedfecff67a9e5bd0bb8d09d93168f58) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "267-c2d.c2", 0x0000001, 0x800000, CRC(02345689) SHA1(d40c425e73fd8dc0b0f66bf72a79f66b3bf390e1) ) /* Plane 2,3 */
ROM_END
...
ROM_START( mslug5d ) /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "268-c1d.c1", 0x0000000, 0x800000, CRC(e8239365) SHA1(e0a75902a783110049730b66ad3cbccdd804bf62) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "268-c2d.c2", 0x0000001, 0x800000, CRC(89b21d4c) SHA1(862ac31ce9570529b33e6f58ada0ac867a442679) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "268-c3d.c3", 0x1000000, 0x800000, CRC(3cda13a0) SHA1(5d029c92688384eafd65ad711a2954d0b86a3163) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "268-c4d.c4", 0x1000001, 0x800000, CRC(9c00160d) SHA1(c612102f9cd288bba4c245b5855d795e4362b217) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "268-c5d.c5", 0x2000000, 0x800000, CRC(38754256) SHA1(744d91d041998ca27ee2781188746797c65377bd) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "268-c6d.c6", 0x2000001, 0x800000, CRC(59d33e9c) SHA1(ed7f5c7db4c35ec5a7db0ad5436110b3fe80b89a) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "268-c7d.c7", 0x3000000, 0x800000, CRC(c9f8c357) SHA1(7064224afa887f57245f5479b0b46228539a131b) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "268-c8d.c8", 0x3000001, 0x800000, CRC(fafc3eb9) SHA1(f4f73194cc7fd151be3ca2561f993b5be7628369) ) /* Plane 2,3 */
ROM_END
...
ROM_START( svcd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "269-c1d.c1", 0x0000000, 0x800000, CRC(465d473b) SHA1(0b2be2b2657c2ae021ec91515d1d6306179751d5) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "269-c2d.c2", 0x0000001, 0x800000, CRC(3eb28f78) SHA1(df1b096fe95796db1515b69f74266ed13dd9ee56) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "269-c3d.c3", 0x1000000, 0x800000, CRC(f4d4ab2b) SHA1(a19788435173540469fe5d07429a83dde6d701a0) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "269-c4d.c4", 0x1000001, 0x800000, CRC(a69d523a) SHA1(98d8dac2e40f71b5b8426d3c77476a0a20783181) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "269-c5d.c5", 0x2000000, 0x800000, CRC(ba2a7892) SHA1(eed45e1330dcc9f610598dc53977bf3a81dd161a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "269-c6d.c6", 0x2000001, 0x800000, CRC(37371ca1) SHA1(8aaa1b9ea34470085d9944c9ad64cfb0ffe09859) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "269-c7d.c7", 0x3000000, 0x800000, CRC(5595b6cc) SHA1(9d6cc70f435401355b885475ccc3864825887656) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "269-c8d.c8", 0x3000001, 0x800000, CRC(b17dfcf9) SHA1(46af296b12831ee40355f52d2c316f609557d6df) ) /* Plane 2,3 */
ROM_END
...
ROM_START( samsho5d ) /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "270-c1d.c1", 0x0000000, 0x800000, CRC(9adec562) SHA1(069d73384dc320c38db420c8b04db86ac0b76101) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "270-c2d.c2", 0x0000001, 0x800000, CRC(ac0309e5) SHA1(9795fb2fa9eea617ec25656cfa9cd507899ec4fe) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "270-c3d.c3", 0x1000000, 0x800000, CRC(82db9dae) SHA1(0206e1cc2c5f0fbbc074a93add5a44f645951d0c) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "270-c4d.c4", 0x1000001, 0x800000, CRC(f8041153) SHA1(55705c725aff949e668c24b23e2e4cdb4ecf78ae) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "270-c5d.c5", 0x2000000, 0x800000, CRC(e689d62d) SHA1(001a59bb1bb14f263d16f8b7e977cd49e44e265a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "270-c6d.c6", 0x2000001, 0x800000, CRC(a993bdcf) SHA1(d15980afe6d4b33506918186a2efc3f51b2347ca) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "270-c7d.c7", 0x3000000, 0x800000, CRC(707d56a0) SHA1(303ecc621305c8fbeece8d599f9382fe82d191ee) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "270-c8d.c8", 0x3000001, 0x800000, CRC(f5903adc) SHA1(64f867a4e9d23302aa1e884f8fad7872ee347a86) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kf2k3pcd ) /* Decrypted GFX, JAMMA PCB */
	...
	ROM_REGION( 0x6000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "271-c1d.c1", 0x0000000, 0x1000000, CRC(c29acd28) SHA1(8a10409c5a9ad95fa9b56e94c14f1b96101fb179) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c2d.c2", 0x0000001, 0x1000000, CRC(328e80b1) SHA1(c7f8069488be1a88a2ea03718b6a131f5c96bd3f) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c3d.c3", 0x2000000, 0x1000000, CRC(020a11f1) SHA1(85cfae76234f72b0039ebc02f931bb2a9c10b1af) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c4d.c4", 0x2000001, 0x1000000, CRC(991b5ed2) SHA1(99c4c470bc9cb388773e27de6df4a16803fc7b45) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c5d.c5", 0x4000000, 0x1000000, CRC(c2de8b66) SHA1(40c2ea48fc20d470163a9dbb40c0276fc4cfceb9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c6d.c6", 0x4000001, 0x1000000, CRC(3ff750db) SHA1(714f14a2eb2df6f25d10a6b6aff4b3adfbc7a5dc) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof2003d ) /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "271-c1cd.c1", 0x0000000, 0x800000, CRC(e42fc226) SHA1(1cd9364993e141facdcdd53ec2277df7b275d8a7) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c2cd.c2", 0x0000001, 0x800000, CRC(1b5e3b58) SHA1(0eb254477a9479541291e43e415310852a0f0bed) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c3cd.c3", 0x1000000, 0x800000, CRC(d334fdd9) SHA1(1efe30b4f56a55e25ab518cf6999de797b5e407c) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c4cd.c4", 0x1000001, 0x800000, CRC(0d457699) SHA1(ec73d0c9fc7094d0ac6c0986a6e07cde25893e57) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c5cd.c5", 0x2000000, 0x800000, CRC(8a91aae4) SHA1(802f4baacf801646be1ef686e105b2e867a6a5df) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c6cd.c6", 0x2000001, 0x800000, CRC(9f8674b8) SHA1(65964f40b2227d020023fb436579927e65807dcd) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c7cd.c7", 0x3000000, 0x800000, CRC(8ee6b43c) SHA1(c78b749c7c8e1d8ab8335b96da03764cc8e9eb21) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c8cd.c8", 0x3000001, 0x800000, CRC(6d8d2d60) SHA1(841698eead0f7d422937ce2f2329e17c383d90a6) ) /* Plane 2,3 */
ROM_END
...
ROM_START( kof2k3hd ) /* Decrypted GFX */ /* AES VERSION */
	...
	ROM_LOAD16_BYTE( "271-c5cd.c5", 0x2000000, 0x800000, CRC(8a91aae4) SHA1(802f4baacf801646be1ef686e105b2e867a6a5df) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c6cd.c6", 0x2000001, 0x800000, CRC(9f8674b8) SHA1(65964f40b2227d020023fb436579927e65807dcd) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c7kd.c7", 0x3000000, 0x800000, CRC(efe714f8) SHA1(c239744cf372f6f7b2cd1b539a59f792038fe179) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c8kd.c8", 0x3000001, 0x800000, CRC(c015cdb7) SHA1(baa1bf179f13e07bd93d33bf40b37deaf65d0b0c) ) /* Plane 2,3 */
ROM_END
...
ROM_START( sams5spd ) /* Decrypted GFX */ /* MVS VERSION */
	...
	ROM_REGION( 0x4000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "272-c1d.c1", 0x0000000, 0x800000, CRC(8548097e) SHA1(99177f64039d2914fa4ebd4afc7eb0fbf4ffe0af) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "272-c2d.c2", 0x0000001, 0x800000, CRC(8c1b48d0) SHA1(3f20288ed369e6276cfaedff7e9703d4ea1cf6f6) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "272-c3d.c3", 0x1000000, 0x800000, CRC(96ddb28c) SHA1(7ebe5166d279c0d3efef65618d015b4ea13f2c49) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "272-c4d.c4", 0x1000001, 0x800000, CRC(99ef7a0a) SHA1(9ac3ef339bc1d6e3482e0b32d40b259ec2b44fc1) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "272-c5d.c5", 0x2000000, 0x800000, CRC(772e8b1e) SHA1(8de4898bbd8ede593763bfa93bbf26492492d23a) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "272-c6d.c6", 0x2000001, 0x800000, CRC(5fff21fc) SHA1(5d0a23a41f5277ab09fd11f227be35f1713a4b4f) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "272-c7d.c7", 0x3000000, 0x800000, CRC(9ac56a0e) SHA1(ea4ffec3fe2e58df16b40fdf33e1708680010414) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "272-c8d.c8", 0x3000001, 0x800000, CRC(cfde7aff) SHA1(25185f471dd35e5d388b75b83d8652085cd5e17d) ) /* Plane 2,3 */
ROM_END
...
ROM_START( jockygpd ) /* Decrypted GFX */
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "008-c1d.c1", 0x0000000, 0x800000, CRC(ea259019) SHA1(c14dc59a43e255ef12d8d832b2860f1a84c48170) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "008-c2d.c2", 0x0000001, 0x800000, CRC(97f270be) SHA1(06e03b26bacb8568c69ccf22e58175426a69e01b) ) /* Plane 2,3 */
ROM_END
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof96ep)
{
	DRIVER_INIT_CALL(neogeo);
	m_bootleg_prot->kof96ep_px_decrypt(cpuregion, cpuregion_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,kof97pla)
{
	DRIVER_INIT_CALL(neogeo);
	m_bootleg_prot->neogeo_bootleg_sx_decrypt(fix_region, fix_region_size,1);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k1pls)
{
	DRIVER_INIT_CALL(neogeo);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k1pla)
{
	DRIVER_INIT_CALL(neogeo);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,cthd2k3a)
{
 	DRIVER_INIT_CALL(neogeo);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k2plc)
{
	DRIVER_INIT_CALL(neogeo);
	m_kof2002_prot->kof2002_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 0);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k4pls)
{
	DRIVER_INIT_CALL(neogeo);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof10thu)
{
	DRIVER_INIT_CALL(neogeo);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,mslug5b)
{
	DRIVER_INIT_CALL(neogeo);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 2);
	m_sprgen->m_fixed_layer_bank_type = 1;
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,svcplusb)
{
	DRIVER_INIT_CALL(neogeo);
	m_bootleg_prot->svcboot_cx_decrypt(spr_region, spr_region_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,gfxdec42)
{
	DRIVER_INIT_CALL(neogeo);
	m_sprgen->m_fixed_layer_bank_type = 1;
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,gfxdec50)
{
	DRIVER_INIT_CALL(neogeo);
	m_sprgen->m_fixed_layer_bank_type = 2;
	m_cmc_prot->neogeo_sfix_decrypt(spr_region, spr_region_size, fix_region, fix_region_size);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,garoud)
{
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,garouhd)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_sma_prot->garouh_decrypt_68k(cpuregion);
	m_sma_prot->garouh_install_protection(m_maincpu,m_banked_cart);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof2knd)
{
	DRIVER_INIT_CALL(gfxdec50);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,kof2001d)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,cthd2k3d)
{
	DRIVER_INIT_CALL(neogeo);
	m_bootleg_prot->cthd2003_AES_protection(cpuregion, cpuregion_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,mslug4d)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
	m_pcm2_prot->neo_pcm2_snk_1999(ym_region, ym_region_size, 8);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,rotdd)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
	m_pcm2_prot->neo_pcm2_snk_1999(ym_region, ym_region_size, 16);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof2002d)
{
	DRIVER_INIT_CALL(neogeo);
	m_kof2002_prot->kof2002_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 0);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof10thd)
{
	DRIVER_INIT_CALL(neogeo);
	m_bootleg_prot->kof10thd_AES_protection(cpuregion, cpuregion_size);
}

DRIVER_INIT_MEMBER(neogeo_noslot_state,matrimd)
{
	DRIVER_INIT_CALL(gfxdec50);
	m_kof2002_prot->matrim_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 1);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,pnyaad)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_pcm2_prot->neo_pcm2_snk_1999(ym_region, ym_region_size, 4);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,mslug5d)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 2);
	m_pvc_prot->mslug5_decrypt_68k(cpuregion, cpuregion_size);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,mslug5n)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 2);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,ms5plusd)
{
	DRIVER_INIT_CALL(neogeo);
	m_sprgen->m_fixed_layer_bank_type = 1;
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 2);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,svcd)
{
	DRIVER_INIT_CALL(gfxdec50);
	m_pvc_prot->svc_px_decrypt(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 3);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,samsho5d)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_kof2002_prot->samsho5_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 4);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k3pcd)
{
	DRIVER_INIT_CALL(neogeo);
	m_pvc_prot->kf2k3pcb_decrypt_68k(cpuregion, cpuregion_size);
	kf2k3pcb_sp1_decrypt();
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof2003d)
{
	DRIVER_INIT_CALL(gfxdec50);
	m_pvc_prot->kof2003_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 5);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kof2k3hd)
{
	DRIVER_INIT_CALL(gfxdec50);
	m_pvc_prot->kof2003h_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 5);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k3bd)
{
	DRIVER_INIT_CALL(neogeo);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 5);
	m_sprgen->m_fixed_layer_bank_type = 2;
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,sams5spd)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_kof2002_prot->samsh5sp_decrypt_68k(cpuregion, cpuregion_size);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 6);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,jockygpd)
{
	DRIVER_INIT_CALL(gfxdec42);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
...
DRIVER_INIT_MEMBER(neogeo_noslot_state,kf2k2ps2)
{
	DRIVER_INIT_CALL(neogeo);
	m_pcm2_prot->neo_pcm2_swap(ym_region, ym_region_size, 0);
	m_cmc_prot->neogeo_cmc50_m1_decrypt(audiocrypt_region, audiocrypt_region_size, audiocpu_region,audio_region_size);
...
/* SNK */
GAME( 1990, nam1975,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "NAM-1975 (NGM-001)(NGH-001)", GAME_SUPPORTS_SAVE )
...
GAME( 1990, bstarsh,    bstars,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Baseball Stars Professional (NGH-002)", GAME_SUPPORTS_SAVE )
GAME( 1990, tpgolf,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Top Player's Golf (NGM-003)(NGH-003)", GAME_SUPPORTS_SAVE )
GAME( 1990, mahretsu,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Mahjong Kyo Retsuden (NGM-004)(NGH-004)", GAME_SUPPORTS_SAVE ) // does not support mahjong panel in MVS mode
GAME( 1990, ridhero,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Riding Hero (NGM-006)(NGH-006)", GAME_SUPPORTS_SAVE )
GAME( 1990, ridheroh,   ridhero,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Riding Hero (set 2)", GAME_SUPPORTS_SAVE )
GAME( 1991, alpham2,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Alpha Mission II / ASO II - Last Guardian (NGM-007)(NGH-007)", GAME_SUPPORTS_SAVE )
GAME( 1991, alpham2p,   alpham2,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Alpha Mission II / ASO II - Last Guardian (prototype)", GAME_SUPPORTS_SAVE )
GAME( 1990, cyberlip,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Cyber-Lip (NGM-010)", GAME_SUPPORTS_SAVE )
GAME( 1990, superspy,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The Super Spy (NGM-011)(NGH-011)", GAME_SUPPORTS_SAVE )
GAME( 1992, mutnat,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Mutation Nation (NGM-014)(NGH-014)", GAME_SUPPORTS_SAVE )
GAME( 1991, kotm,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "King of the Monsters (set 1)", GAME_SUPPORTS_SAVE )
GAME( 1991, kotmh,      kotm,     neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "King of the Monsters (set 2)", GAME_SUPPORTS_SAVE )
...
GAME( 1991, burningf,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Burning Fight (NGM-018)(NGH-018)", GAME_SUPPORTS_SAVE )
GAME( 1991, burningfh,  burningf, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Burning Fight (NGH-018)(US)", GAME_SUPPORTS_SAVE )
GAME( 1991, burningfp,  burningf, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Burning Fight (prototype)", GAME_SUPPORTS_SAVE )
GAME( 1990, lbowling,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "League Bowling (NGM-019)(NGH-019)", GAME_SUPPORTS_SAVE )
GAME( 1991, gpilots,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Ghost Pilots (NGM-020)(NGH-020)", GAME_SUPPORTS_SAVE )
GAME( 1991, gpilotsh,   gpilots,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Ghost Pilots (NGH-020)(US)", GAME_SUPPORTS_SAVE )
GAME( 1990, joyjoy,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Puzzled / Joy Joy Kid (NGM-021)(NGH-021)", GAME_SUPPORTS_SAVE )
GAME( 1991, quizdais,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Quiz Daisousa Sen - The Last Count Down (NGM-023)(NGH-023)", GAME_SUPPORTS_SAVE )
GAME( 1991, quizdaisk,  quizdais, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Quiz Daisousa Sen - The Last Count Down (Korean release)", GAME_SUPPORTS_SAVE )
GAME( 1992, lresort,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Last Resort", GAME_SUPPORTS_SAVE )
GAME( 1991, eightman,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK / Pallas", "Eight Man (NGM-025)(NGH-025)", GAME_SUPPORTS_SAVE )
GAME( 1991, legendos,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Legend of Success Joe / Ashita no Joe Densetsu", GAME_SUPPORTS_SAVE )
GAME( 1991, 2020bb,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (set 1)", GAME_SUPPORTS_SAVE )
GAME( 1991, 2020bba,    2020bb,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (set 2)", GAME_SUPPORTS_SAVE )
GAME( 1991, 2020bbh,    2020bb,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK / Pallas", "2020 Super Baseball (set 3)", GAME_SUPPORTS_SAVE )
GAME( 1991, socbrawl,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Soccer Brawl (NGM-031)", GAME_SUPPORTS_SAVE )
GAME( 1991, socbrawlh,  socbrawl, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Soccer Brawl (NGH-031)", GAME_SUPPORTS_SAVE )
...
GAME( 1991, roboarmy,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Robo Army", GAME_SUPPORTS_SAVE )
GAME( 1992, fbfrenzy,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Football Frenzy (NGM-034)(NGH-034)", GAME_SUPPORTS_SAVE )
GAME( 1992, kotm2,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "King of the Monsters 2 - The Next Thing (NGM-039)(NGH-039)", GAME_SUPPORTS_SAVE )
GAME( 1992, kotm2p,     kotm2,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "King of the Monsters 2 - The Next Thing (prototype)", GAME_SUPPORTS_SAVE )
GAME( 1993, sengoku2,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Sengoku 2 / Sengoku Denshou 2", GAME_SUPPORTS_SAVE )
GAME( 1992, bstars2,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Baseball Stars 2", GAME_SUPPORTS_SAVE )
...
GAME( 1992, aof,        neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Art of Fighting / Ryuuko no Ken (NGM-044)(NGH-044)", GAME_SUPPORTS_SAVE )
...
GAME( 1992, ssideki,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   fatfury2, ROT0, "SNK", "Super Sidekicks / Tokuten Ou", GAME_SUPPORTS_SAVE )
GAME( 1994, kof94,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '94 (NGM-055)(NGH-055)", GAME_SUPPORTS_SAVE )
GAME( 1994, aof2,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Art of Fighting 2 / Ryuuko no Ken 2 (NGM-056)", GAME_SUPPORTS_SAVE )
GAME( 1994, aof2a,      aof2,     neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Art of Fighting 2 / Ryuuko no Ken 2 (NGH-056)", GAME_SUPPORTS_SAVE )
...
GAME( 1995, savagere,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Savage Reign / Fu'un Mokushiroku - kakutou sousei", GAME_SUPPORTS_SAVE )
...
GAME( 1994, samsho2k,   samsho2,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Saulabi Spirits / Jin Saulabi Tu Hon (Korean release of Samurai Shodown II, set 1)", GAME_SUPPORTS_SAVE ) // official or hack?
...
GAME( 1995, kof95,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '95 (NGM-084)", GAME_SUPPORTS_SAVE )
GAME( 1995, kof95a,     kof95,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '95 (NGM-084), alternate board", GAME_SUPPORTS_SAVE )
GAME( 1995, kof95h,     kof95,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '95 (NGH-084)", GAME_SUPPORTS_SAVE )
GAME( 1995, samsho3,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Samurai Shodown III / Samurai Spirits - Zankurou Musouken (NGM-087)", GAME_SUPPORTS_SAVE )
GAME( 1995, samsho3h,   samsho3,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Samurai Shodown III / Samurai Spirits - Zankurou Musouken (NGH-087)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, aof3,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Art of Fighting 3 - The Path of the Warrior / Art of Fighting - Ryuuko no Ken Gaiden", GAME_SUPPORTS_SAVE )
GAME( 1996, aof3k,      aof3,     neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Art of Fighting 3 - The Path of the Warrior (Korean release)", GAME_SUPPORTS_SAVE ) // no Japanese title / mode
GAME( 1996, kof96,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '96 (NGM-214)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, kizuna,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Kizuna Encounter - Super Tag Battle / Fu'un Super Tag Battle", GAME_SUPPORTS_SAVE )
GAME( 1996, kizuna4p,   kizuna,   neogeo_noslot,   kizuna4p, neogeo_state, neogeo,   ROT0, "SNK", "Kizuna Encounter - Super Tag Battle 4 Way Battle Version / Fu'un Super Tag Battle Special Version", GAME_SUPPORTS_SAVE )
...
GAME( 1997, kof97,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '97 (NGM-2320)", GAME_SUPPORTS_SAVE )
...
GAME( 1997, kof97oro,   kof97,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof97oro, ROT0, "bootleg", "The King of Fighters '97 Oroshi Plus 2003 (bootleg set 2)", GAME_SUPPORTS_SAVE )
...
GAME( 1997, irrmaze,    neogeo,   neogeo_noslot,   irrmaze, neogeo_state,  neogeo,   ROT0, "SNK / Saurus", "The Irritating Maze / Ultra Denryu Iraira Bou", GAME_SUPPORTS_SAVE )
...
GAME( 1998, mslug2,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Metal Slug 2 - Super Vehicle-001/II (NGM-2410)(NGH-2410)", GAME_SUPPORTS_SAVE )
GAME( 1998, kof98,      neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof98,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (NGM-2420)", GAME_SUPPORTS_SAVE )
GAME( 1998, kof98a,     kof98,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof98,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (NGM-2420, alternate board)", GAME_SUPPORTS_SAVE )
GAME( 1998, kof98k,     kof98,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof98,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (Korean board)", GAME_SUPPORTS_SAVE )
GAME( 1998, kof98ka,    kof98,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof98,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (Korean board 2)", GAME_SUPPORTS_SAVE )
GAME( 1998, kof98h,     kof98,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (NGH-2420)", GAME_SUPPORTS_SAVE )
...
GAME( 1999, mslugx,     neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslugx,   ROT0, "SNK", "Metal Slug X - Super Vehicle-001 (NGM-2500)(NGH-2500)", GAME_SUPPORTS_SAVE )
GAME( 1999, kof99,      neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof99,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (NGM-2510)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
GAME( 1999, kof99h,     kof99,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof99,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (NGH-2510)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code & GFX, crashes going into attract demo */
GAME( 1999, kof99e,     kof99,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof99,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (earlier)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
GAME( 1999, kof99k,     kof99,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof99k,   ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release)" , GAME_SUPPORTS_SAVE )   /* Encrypted GFX */
GAME( 1999, kof99p,     kof99,    neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (prototype)", GAME_SUPPORTS_SAVE )
...
GAME( 2000, mslug3,     neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug3,   ROT0, "SNK", "Metal Slug 3 (NGM-2560)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
GAME( 2000, mslug3h,    mslug3,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug3h,  ROT0, "SNK", "Metal Slug 3 (NGH-2560)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2000, mslug3b6,   mslug3,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug3b6, ROT0, "bootleg", "Metal Slug 6 (Metal Slug 3 bootleg)", GAME_SUPPORTS_SAVE ) /* real Metal Slug 6 is an Atomiswave HW game, see naomi.c ;-) */
GAME( 2000, kof2000,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2000,  ROT0, "SNK", "The King of Fighters 2000 (NGM-2570) (NGH-2570)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
GAME( 2000, kof2000n,   kof2000,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2000n, ROT0, "SNK", "The King of Fighters 2000 (not encrypted)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2001, zupapa,     neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   zupapa,   ROT0, "SNK", "Zupapa!" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
...
GAME( 2001, kof2001,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2001,  ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGM-262?)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2001, kof2001h,   kof2001,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2001,  ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGH-2621)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2003, cthd2003,   neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   cthd2003, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 1)", GAME_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
GAME( 2003, ct2k3sp,    cthd2003, neogeo_noslot,   neogeo, neogeo_noslot_state,   ct2k3sp,  ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 Super Plus (The King of Fighters 2001 bootleg)", GAME_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
GAME( 2003, ct2k3sa,    cthd2003, neogeo_noslot,   neogeo, neogeo_noslot_state,   ct2k3sa,  ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 Super Plus alternate (The King of Fighters 2001 bootleg)", GAME_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2001 */
GAME( 2002, kof2002,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2002,  ROT0, "Eolith / Playmore", "The King of Fighters 2002 (NGM-2650)(NGH-2650)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2002, kof2002b,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2002b, ROT0, "bootleg", "The King of Fighters 2002 (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2002, kf2k2pls,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg set 1)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2002, kf2k2pla,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg set 2)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2002, kf2k2mp,    kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2mp,  ROT0, "bootleg", "The King of Fighters 2002 Magic Plus (bootleg)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2002, kf2k2mp2,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2mp2, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus II (bootleg)" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2004, kof10th,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof10th,  ROT0, "bootleg", "The King of Fighters 10th Anniversary (The King of Fighters 2002 bootleg)", GAME_SUPPORTS_SAVE ) // fake SNK copyright
GAME( 2005, kf10thep,   kof10th,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf10thep, ROT0, "bootleg", "The King of Fighters 10th Anniversary Extra Plus (The King of Fighters 2002 bootleg)", GAME_SUPPORTS_SAVE ) // fake SNK copyright
GAME( 2005, kf2k5uni,   kof10th,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k5uni, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (The King of Fighters 2002 bootleg, set 2)", GAME_SUPPORTS_SAVE ) // fake SNK copyright
GAME( 2004, kof2k4se,   neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2k4se, ROT0, "bootleg", "The King of Fighters Special Edition 2004 (The King of Fighters 2002 bootleg)", GAME_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2002 */
GAME( 2003, mslug5,     neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5,   ROT0, "SNK Playmore", "Metal Slug 5 (NGM-2680)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5h,    mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5,   ROT0, "SNK Playmore", "Metal Slug 5 (NGH-2680)", GAME_SUPPORTS_SAVE ) /* Also found in later MVS carts */
GAME( 2003, ms5pcb,     0,        neogeo_noslot,   dualbios, neogeo_noslot_state, ms5pcb,   ROT0, "SNK Playmore", "Metal Slug 5 (JAMMA PCB)", GAME_SUPPORTS_SAVE )
GAME( 2003, ms5plus,    mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   ms5plus,  ROT0, "bootleg", "Metal Slug 5 Plus (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcpcb,     0,        neogeo_noslot,   dualbios, neogeo_noslot_state, svcpcb,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 1)", GAME_SUPPORTS_SAVE ) // not a clone of neogeo because it's NOT a neogeo cart.
GAME( 2003, svcpcba,    svcpcb,   neogeo_noslot,   dualbios, neogeo_noslot_state, svcpcb,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 2)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code */
GAME( 2003, svc,        neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   svc,      ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (NGM-2690)(NGH-2690)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcboot,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   svcboot,  ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcplus,    svcboot,  neogeo_noslot,   neogeo, neogeo_noslot_state,   svcplus,  ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg set 1)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcplusa,   svcboot,  neogeo_noslot,   neogeo, neogeo_noslot_state,   svcplusa, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg set 2)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcsplus,   svcboot,  neogeo_noslot,   neogeo, neogeo_noslot_state,   svcsplus, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Super Plus (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsho5,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   samsho5,  ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGM-2700)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsho5h,   samsho5,  neogeo_noslot,   neogeo, neogeo_noslot_state,   samsho5,  ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGH-2700)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsho5b,   samsho5,  neogeo_noslot,   neogeo, neogeo_noslot_state,   samsho5b, ROT0, "bootleg", "Samurai Shodown V / Samurai Spirits Zero (bootleg)", GAME_SUPPORTS_SAVE ) // different program scrambling
GAME( 2003, kf2k3pcb,   0,        neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3pcb, ROT0, "SNK Playmore", "The King of Fighters 2003 (Japan, JAMMA PCB)", GAME_SUPPORTS_SAVE ) // not a clone of neogeo because it's NOT a neogeo cart.
GAME( 2003, kof2003,    neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2003,  ROT0, "SNK Playmore", "The King of Fighters 2003 (NGM-2710)", GAME_SUPPORTS_SAVE )
GAME( 2003, kof2003h,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2003h, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3bl,    kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3bl , ROT0, "bootleg", "The King of Fighters 2003 (bootleg set 1)", GAME_SUPPORTS_SAVE ) // zooming is wrong because its a bootleg of the pcb version on a cart (unless it was a bootleg pcb with the new bios?)
GAME( 2003, kf2k3bla,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3pl,  ROT0, "bootleg", "The King of Fighters 2003 (bootleg set 2)", GAME_SUPPORTS_SAVE ) // zooming is wrong because its a bootleg of the pcb version on a cart
GAME( 2003, kf2k3pl,    kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3pl,  ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (The King of Fighters 2003 bootleg)", GAME_SUPPORTS_SAVE ) // zooming is wrong because its a bootleg of the pcb version on a cart
GAME( 2003, kf2k3upl,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3upl, ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (The King of Fighters 2003 bootleg)", GAME_SUPPORTS_SAVE ) // zooming is wrong because its a bootleg of the pcb version on a cart
GAME( 2004, samsh5sp,   neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   samsh5sp, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGM-2720)", GAME_SUPPORTS_SAVE )
GAME( 2004, samsh5sph,  samsh5sp, neogeo_noslot,   neogeo, neogeo_noslot_state,   samsh5sp, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720) (2nd release, less censored)", GAME_SUPPORTS_SAVE )
GAME( 2004, samsh5spho, samsh5sp, neogeo_noslot,   neogeo, neogeo_noslot_state,   samsh5sp, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720) (1st release, censored)", GAME_SUPPORTS_SAVE )
...
GAME( 1990, ncombat,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Combat (NGM-009)", GAME_SUPPORTS_SAVE )
GAME( 1990, ncombath,   ncombat,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Combat (NGH-009)", GAME_SUPPORTS_SAVE )
...
GAME( 1991, crsword,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Alpha Denshi Co.", "Crossed Swords (ALM-002)(ALH-002)", GAME_SUPPORTS_SAVE )
...
GAME( 1992, ncommand,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Alpha Denshi Co.", "Ninja Commando", GAME_SUPPORTS_SAVE )
...
GAME( 1993, wh2,        neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK",              "World Heroes 2 (ALM-006)(ALH-006)", GAME_SUPPORTS_SAVE )
...
GAME( 1994, aodk,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK / SNK",        "Aggressors of Dark Kombat / Tsuukai GANGAN Koushinkyoku (ADM-008)(ADH-008)", GAME_SUPPORTS_SAVE )
GAME( 1995, whp,        neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK / SNK",        "World Heroes Perfect", GAME_SUPPORTS_SAVE )
GAME( 1995, mosyougi,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK / SNK",        "Syougi No Tatsujin - Master of Syougi", GAME_SUPPORTS_SAVE )
GAME( 1996, overtop,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK",              "Over Top", GAME_SUPPORTS_SAVE )
...
GAME( 1996, twinspri,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "ADK / SNK",        "Twinkle Star Sprites", GAME_SUPPORTS_SAVE )
GAME( 1996, zintrckb,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "hack",             "Zintrick / Oshidashi Zentrix (hack)", GAME_SUPPORTS_SAVE )

/* Aicom (was a part of Sammy) / Yumekobo (changed name in 1996) */
GAME( 1992, viewpoin,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Sammy / Aicom", "Viewpoint", GAME_SUPPORTS_SAVE )
...
GAME( 1995, pulstar,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Aicom", "Pulstar", GAME_SUPPORTS_SAVE )
GAME( 1998, blazstar,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Yumekobo", "Blazing Star", GAME_SUPPORTS_SAVE )
GAME( 1999, preisle2,   neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   preisle2, ROT0, "Yumekobo", "Prehistoric Isle 2" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */

/* Data East Corporation */
GAME( 1993, spinmast,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Spin Master / Miracle Adventure", GAME_SUPPORTS_SAVE )
GAME( 1994, wjammers,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Windjammers / Flying Power Disc", GAME_SUPPORTS_SAVE )
GAME( 1994, karnovr,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Karnov's Revenge / Fighter's History Dynamite", GAME_SUPPORTS_SAVE )
GAME( 1994, strhoop,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Street Hoop / Street Slam / Dunk Dream (DEM-004)(DEH-004)", GAME_SUPPORTS_SAVE )
GAME( 1996, ghostlop,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Ghostlop (prototype)", GAME_SUPPORTS_SAVE )
GAME( 1996, magdrop2,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Magical Drop II", GAME_SUPPORTS_SAVE )
GAME( 1997, magdrop3,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Data East Corporation", "Magical Drop III", GAME_SUPPORTS_SAVE )

/* Eleven */
GAME( 2000, nitd,       neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   nitd,     ROT0, "Eleven / Gavaking", "Nightmare in the Dark" , GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2001, nitdbl,     nitd,     neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "bootleg", "Nightmare in the Dark (bootleg)" , GAME_SUPPORTS_SAVE )

/* Face */
GAME( 1994, gururin,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Face", "Gururin", GAME_SUPPORTS_SAVE )
GAME( 1997, miexchng,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Face", "Money Puzzle Exchanger / Money Idol Exchanger", GAME_SUPPORTS_SAVE )

/* Hudson Soft */
GAME( 1994, panicbom,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Eighting / Hudson", "Panic Bomber", GAME_SUPPORTS_SAVE )
...
GAME( 1997, neobombe,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Hudson", "Neo Bomberman", GAME_SUPPORTS_SAVE )

/* Monolith Corp. */
GAME( 1990, minasan,    neogeo,   neogeo_noslot,   mjneogeo, neogeo_state, neogeo,   ROT0, "Monolith Corp.", "Minasanno Okagesamadesu! Daisugorokutaikai (MOM-001)(MOH-001)", GAME_SUPPORTS_SAVE )
GAME( 1991, bakatono,   neogeo,   neogeo_noslot,   mjneogeo, neogeo_state, neogeo,   ROT0, "Monolith Corp.", "Bakatonosama Mahjong Manyuuki (MOM-002)(MOH-002)", GAME_SUPPORTS_SAVE )

/* Nazca (later acquired by SNK) */
GAME( 1996, turfmast,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Nazca", "Neo Turf Masters / Big Tournament Golf", GAME_SUPPORTS_SAVE )
GAME( 1996, mslug,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Nazca", "Metal Slug - Super Vehicle-001", GAME_SUPPORTS_SAVE )
...
/* Saurus */
GAME( 1995, quizkof,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Quiz King of Fighters (SAM-080)(SAH-080)", GAME_SUPPORTS_SAVE )
GAME( 1995, quizkofk,   quizkof,  neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Quiz King of Fighters (Korean release)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, pgoal,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Pleasure Goal / Futsal - 5 on 5 Mini Soccer (NGM-219)", GAME_SUPPORTS_SAVE )
GAME( 1996, ironclad,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Choutetsu Brikin'ger - Iron clad (Prototype)", GAME_SUPPORTS_SAVE )
GAME( 1996, ironclado,  ironclad, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "bootleg", "Choutetsu Brikin'ger - Iron clad (Prototype, bootleg)", GAME_SUPPORTS_SAVE )
GAME( 1996, stakwin2,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Stakes Winner 2", GAME_SUPPORTS_SAVE )
GAME( 1997, shocktro,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Shock Troopers (set 1)", GAME_SUPPORTS_SAVE )
GAME( 1997, shocktroa,  shocktro, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Shock Troopers (set 2)", GAME_SUPPORTS_SAVE )
GAME( 1998, shocktr2,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Saurus", "Shock Troopers - 2nd Squad", GAME_SUPPORTS_SAVE )
GAME( 1998, lans2004,   shocktr2, neogeo_noslot,   neogeo, neogeo_noslot_state,   lans2004, ROT0, "bootleg", "Lansquenet 2004 (Shock Troopers - 2nd Squad bootleg)", GAME_SUPPORTS_SAVE )

/* Sunsoft */
GAME( 1995, galaxyfg,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Sunsoft", "Galaxy Fight - Universal Warriors", GAME_SUPPORTS_SAVE )
GAME( 1996, wakuwak7,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Sunsoft", "Waku Waku 7", GAME_SUPPORTS_SAVE )
...
GAME( 1999, pbobbl2n,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Taito (SNK license)", "Puzzle Bobble 2 / Bust-A-Move Again (Neo-Geo)", GAME_SUPPORTS_SAVE )
GAME( 2003, pnyaa,      neogeo,   neogeo_noslot,   neogeo, neogeo_noslot_state,   pnyaa,    ROT0, "Aiky / Taito", "Pochi and Nyaa", GAME_SUPPORTS_SAVE )

/* Takara */
GAME( 1995, marukodq,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Takara", "Chibi Marukochan Deluxe Quiz", GAME_SUPPORTS_SAVE )
...
GAME( 1995, gowcaizr,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Technos Japan", "Voltage Fighter - Gowcaizer / Choujin Gakuen Gowcaizer", GAME_SUPPORTS_SAVE )
GAME( 1996, sdodgeb,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Technos Japan", "Super Dodge Ball / Kunio no Nekketsu Toukyuu Densetsu", GAME_SUPPORTS_SAVE )

/* Tecmo */
GAME( 1996, tws96,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Tecmo", "Tecmo World Soccer '96", GAME_SUPPORTS_SAVE )

/* Viccom */
GAME( 1994, fightfev,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Viccom", "Fight Fever (set 1)", GAME_SUPPORTS_SAVE )
GAME( 1994, fightfeva,  fightfev, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Viccom", "Fight Fever (set 2)", GAME_SUPPORTS_SAVE )
...
GAME( 1997, popbounc,   neogeo,   neogeo_noslot,   popbounc, neogeo_state, neogeo,   ROT0, "Video System Co.", "Pop 'n Bounce / Gapporin", GAME_SUPPORTS_SAVE )

/* Visco */
GAME( 1992, androdun,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Andro Dunos (NGM-049)(NGH-049)", GAME_SUPPORTS_SAVE )
GAME( 1995, puzzledp,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Taito (Visco license)", "Puzzle De Pon!", GAME_SUPPORTS_SAVE )
GAME( 1996, neomrdo,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Neo Mr. Do!", GAME_SUPPORTS_SAVE )
GAME( 1995, goalx3,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Goal! Goal! Goal!", GAME_SUPPORTS_SAVE )
GAME( 1996, neodrift,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Neo Drift Out - New Technology", GAME_SUPPORTS_SAVE )
GAME( 1996, breakers,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Breakers", GAME_SUPPORTS_SAVE )
GAME( 1997, puzzldpr,   puzzledp, neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Taito (Visco license)", "Puzzle De Pon! R!", GAME_SUPPORTS_SAVE )
GAME( 1998, breakrev,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Breakers Revenge", GAME_SUPPORTS_SAVE )
GAME( 1998, flipshot,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Battle Flip Shot", GAME_SUPPORTS_SAVE )
...
GAME( 2002, mslug4h,    mslug4,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug4,   ROT0, "Mega / Playmore", "Metal Slug 4 (NGH-2630)", GAME_SUPPORTS_SAVE )
GAME( 2002, ms4plus,    mslug4,   neogeo_noslot,   neogeo, neogeo_noslot_state,   ms4plus,  ROT0, "bootleg", "Metal Slug 4 Plus (bootleg)", GAME_SUPPORTS_SAVE )
...
/* BrezzaSoft */
GAME( 2001, jockeygp,   neogeo,   neogeo_noslot,   jockeygp, neogeo_noslot_state, jockeygp, ROT0, "Sun Amusement / BrezzaSoft", "Jockey Grand Prix (set 1)", GAME_SUPPORTS_SAVE )
GAME( 2001, jockeygpa,  jockeygp, neogeo_noslot,   jockeygp, neogeo_noslot_state, jockeygp, ROT0, "Sun Amusement / BrezzaSoft", "Jockey Grand Prix (set 2)", GAME_SUPPORTS_SAVE )
GAME( 2001, vliner,     neogeo,   neogeo_noslot,   vliner, neogeo_noslot_state,   vliner,   ROT0, "Dyna / BrezzaSoft", "V-Liner (set 1)", GAME_SUPPORTS_SAVE )
GAME( 2001, vlinero,    vliner,   neogeo_noslot,   vliner, neogeo_noslot_state,   vliner,   ROT0, "Dyna / BrezzaSoft", "V-Liner (set 2)", GAME_SUPPORTS_SAVE )
...
/* Neo Geo homebrew */
GAME( 2002, neonopon,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Neo no Panepon", GAME_SUPPORTS_SAVE )
GAME( 2002, neopong,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Neodev", "Neo Pong", GAME_SUPPORTS_SAVE )
GAME( 1990, columnsn,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Sega", "Columns (Neo-Geo)", GAME_SUPPORTS_SAVE )
GAME( 1989, beast,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "NEC / Psygnosis", "Shadow of the Beast (Neo Demo)", GAME_SUPPORTS_SAVE )
GAME( 2003, poknight,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "JMK", "Poker Night", GAME_SUPPORTS_SAVE )
GAME( 2004, neo2500,    neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Neo 2500 Demo", GAME_SUPPORTS_SAVE )
GAME( 2004, syscheck,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Neo System Check (ver 1.0b)", GAME_SUPPORTS_SAVE )
GAME( 2005, ltora,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Jonas Indiana and the Lost Temple of RA (beta 050717)", GAME_SUPPORTS_SAVE )
GAME( 2006, frogfest,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Rastersoft", "Frog Feast", GAME_SUPPORTS_SAVE )
GAME( 2006, cnbe,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Codename: Blut Engel (060119)", GAME_SUPPORTS_SAVE )
GAME( 2006, ngem2k,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Blastar", "Ngem2k", GAME_SUPPORTS_SAVE )
GAME( 2011, totcarib,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Face", "Treasure of the Caribbean", GAME_SUPPORTS_SAVE )
GAME( 2012, neothndr,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Sebastian Mihai", "Neo Thunder", GAME_SUPPORTS_SAVE )
GAME( 2013, neotet,     neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Crim / Stephen", "NeoGeo 2-Player Tetris", GAME_SUPPORTS_SAVE )
GAME( 2013, cphd,       neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Le Cortex", "Crouching Pony Hidden Dragon", GAME_SUPPORTS_SAVE )
GAME( 2012, timesupd,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "NGF Dev. Inc.", "Time's UP! (Demo)", GAME_SUPPORTS_SAVE )
GAME( 2011, bbbuster,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "Visco", "Bang Bang Busters", GAME_SUPPORTS_SAVE )

/* NGCD Conversion */
GAME( 1990, tpgolfcd,   tpgolf,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Top Player's Golf (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1991, sengokcd,   sengoku,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Sengoku / Sengoku Denshou (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1991, gpilotcd,   gpilots,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Ghost Pilots (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1990, joyjoycd,   joyjoy,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Puzzled / Joy Joy Kid (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1991, 2020bbcd,   2020bb,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "2020 Super Baseball (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1994, strhopcd,   strhoop,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Street Hoop / Street Slam / Dunk Dream (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1994, pbobblcd,   pbobblen, neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Puzzle Bobble / Bust-A-Move (Neo-Geo)(NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1995, fr2ch,      neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Idol Mahjong - final romance 2 (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 1996, zintrkcd,   zintrckb, neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Zintrick / Oshidashi Zentrix (NGCD Conversion)", GAME_SUPPORTS_SAVE )
GAME( 2007, lasthpcd,   neogeo,   neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "NG:Dev.Team", "Last Hope (NGCD Conversion)", GAME_SUPPORTS_SAVE )

/* Neo Geo bootleg */
GAME( 1996, kof96ep,    kof96,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof96ep,  ROT0, "bootleg", "The King of Fighters '96 (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, kof97pla,   kof97,    neogeo_noslot,   neogeo, neogeo_noslot_state,   kof97pla, ROT0, "bootleg", "The King of Fighters '97 Orochi Plus 2003 (bootleg set 1)", GAME_SUPPORTS_SAVE )
GAME( 2001, kf2k1pls,   kof2001,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k1pls, ROT0, "bootleg", "The King of Fighters 2001 Plus (bootleg set 1)", GAME_SUPPORTS_SAVE )
GAME( 2001, kf2k1pla,   kof2001,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k1pla, ROT0, "bootleg", "The King of Fighters 2001 Plus (bootleg set 2)", GAME_SUPPORTS_SAVE )
GAME( 2003, cthd2k3a,   cthd2003, neogeo_noslot,   neogeo, neogeo_noslot_state,   cthd2k3a, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 2)", GAME_SUPPORTS_SAVE )
GAME( 2002, kf2k2plb,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg set 3)", GAME_SUPPORTS_SAVE )
GAME( 2002, kf2k2plc,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2plc, ROT0, "bootleg", "The King of Fighters 2002 Super (bootleg set 4)", GAME_SUPPORTS_SAVE )
GAME( 2004, kf2k4pls,   kof2k4se, neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k4pls, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (The King of Fighters 2002 bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2005, kof10thu,   kof10th,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof10thu, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (The King of Fighters 2002 bootleg, set 1)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5b,    mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5b,  ROT0, "bootleg", "Metal Slug 5 (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcplusb,   svcboot,  neogeo_noslot,   neogeo, neogeo_noslot_state,   svcplusb, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg set 3)", GAME_SUPPORTS_SAVE )

/* Neo Geo decrypted */
GAME( 1994, samsho2k2,  samsho2,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "SNK", "Saulabi Spirits / Jin Saulabi Tu Hon (Korean release of Samurai Shodown II, set 2)", GAME_SUPPORTS_SAVE )
GAME( 2001, zupapad,    zupapa,   neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "SNK", "Zupapa! (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, kof99kd,    kof99,    neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release, decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, ganryud,    ganryu,   neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Visco", "Ganryu / Musashi Ganryuki (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, garoud,     garou,    neogeo_noslot,   neogeo, neogeo_noslot_state,   garoud,   ROT0, "SNK", "Garou - Mark of the Wolves (NGM-2530)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, garouhd,    garou,    neogeo_noslot,   neogeo, neogeo_noslot_state,   garouhd,  ROT0, "SNK", "Garou - Mark of the Wolves (NGM-2530)(NGH-2530)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, s1945pd,    s1945p,   neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Psikyo", "Strikers 1945 Plus (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, preisl2d,   preisle2, neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Yumekobo", "Prehistoric Isle 2 (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, mslug3hd,   mslug3,   neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "SNK", "Metal Slug 3 (NGH-2560)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, kof2knd,    kof2000,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2knd,  ROT0, "SNK", "The King of Fighters 2000 (non encrypted P, decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, bangbedd,   bangbead, neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Visco", "Bang Bead (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, nitdd,      nitd,     neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Eleven / Gavaking", "Nightmare in the Dark (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, sengok3d,   sengoku3, neogeo_noslot,   neogeo, neogeo_noslot_state,   gfxdec42, ROT0, "Noise Factory / SNK", "Sengoku 3 / Sengoku Densho 2001 (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, kof2001d,   kof2001,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2001d, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGM-262?)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, kof2k1hd,   kof2001,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2001d, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGH-2621)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, cthd2k3d,   cthd2003, neogeo_noslot,   neogeo, neogeo_noslot_state,   cthd2k3d, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, ct2k3spd,   cthd2003, neogeo_noslot,   neogeo, neogeo_noslot_state,   cthd2k3d, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 Super Plus (The King of Fighters 2001 bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2002, mslug4d,    mslug4,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug4d,  ROT0, "Mega / Playmore", "Metal Slug 4 (NGM-2630)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, mslug4hd,   mslug4,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug4d,  ROT0, "Mega / Playmore", "Metal Slug 4 (NGH-2630)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, rotdd,      rotd,     neogeo_noslot,   neogeo, neogeo_noslot_state,   rotdd,    ROT0, "Evoga / Playmore", "Rage of the Dragons (NGM-264?)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, kof2002d,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2002d, ROT0, "Eolith / Playmore", "The King of Fighters 2002 (NGM-2650)(NGH-2650)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2004, kof10thd,   kof10th,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof10thd, ROT0, "bootleg", "The King of Fighters 10th Anniversary (The King of Fighters 2002 bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2002, matrimd,    matrim,   neogeo_noslot,   neogeo, neogeo_noslot_state,   matrimd,  ROT0, "Noise Factory / Atlus", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (NGM-2660)(NGH-2660)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, pnyaad,     pnyaa,    neogeo_noslot,   neogeo, neogeo_noslot_state,   pnyaad,   ROT0, "Aiky / Taito", "Pochi and Nyaa (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5d,    mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5d,  ROT0, "SNK / Playmore", "Metal Slug 5 (NGM-2680)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5hd,   mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5d,  ROT0, "SNK / Playmore", "Metal Slug 5 (NGH-2680)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5n,    mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5n,  ROT0, "SNK / Playmore", "Metal Slug 5 (not encrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5nd,   mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   mslug5n,  ROT0, "SNK / Playmore", "Metal Slug 5 (fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, ms5plusd,   mslug5,   neogeo_noslot,   neogeo, neogeo_noslot_state,   ms5plusd, ROT0, "bootleg", "Metal Slug 5 Plus (bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
...
GAME( 2003, samsho5d,   samsho5,  neogeo_noslot,   neogeo, neogeo_noslot_state,   samsho5d, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGM-2700)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsh5hd,   samsho5,  neogeo_noslot,   neogeo, neogeo_noslot_state,   samsho5d, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGH-2700)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsh5bd,   samsho5,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "bootleg", "Samurai Shodown V / Samurai Spirits Zero (bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3pcd,   kf2k3pcb, neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3pcd, ROT0, "SNK Playmore", "The King of Fighters 2003 (Japan, JAMMA PCB, decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, kof2003d,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2003d, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGM-2710)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, kof2k3hd,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kof2k3hd, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3bd,    kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3bd,  ROT0, "bootleg", "The King of Fighters 2003 (bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3pd,    kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3bd,  ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (The King of Fighters 2003 bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3upd,   kof2003,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k3bd,  ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (The King of Fighters 2003 bootleg, fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, sams5spd,   samsh5sp, neogeo_noslot,   neogeo, neogeo_noslot_state,   sams5spd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGM-2720)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, sams5shd,   samsh5sp, neogeo_noslot,   neogeo, neogeo_noslot_state,   sams5spd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720)(2nd release, less censored)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, sams5sod,   samsh5sp, neogeo_noslot,   neogeo, neogeo_noslot_state,   sams5spd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720)(1st release, censored)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, jockygpd,   jockeygp, neogeo_noslot,   jockeygp, neogeo_noslot_state, jockygpd, ROT0, "Sun Amusement / BrezzaSoft", "Jockey Grand Prix (decrypted C)", GAME_SUPPORTS_SAVE )

/* Neo Geo hack */
GAME( 2007, kof96ae,    kof96,    neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "EGHT", "The King of Fighters '96 Anniversary Edition (hack)", GAME_SUPPORTS_SAVE )
GAME( 2009, kof96ae20,  kof96,    neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "EGHT", "The King of Fighters '96 Anniversary Edition (2.0, hack)", GAME_SUPPORTS_SAVE )
GAME( 2007, kf2k2ps2,   kof2002,  neogeo_noslot,   neogeo, neogeo_noslot_state,   kf2k2ps2, ROT0, "EGHT", "The King of Fighters 2002 PlayStation II (hack)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsho5x,   samsho5,  neogeo_noslot,   neogeo, neogeo_state,          neogeo,   ROT0, "hack", "Samurai Shodown V / Samurai Spirits Zero (XBOX version, hack)", GAME_SUPPORTS_SAVE )
