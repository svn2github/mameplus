...
ROM_START( harddriv )
	ROM_REGION( 0x100000, "main", 0 )		/* 1MB for 68000 code */
	...
	ROM_REGION( 0x20000, "sound", 0 )		/* 2*64k for audio 68000 code */
...
ROM_START( stunrun )
	...
	ROM_REGION( 0x100000, "adpcm", 0 )	/* 256k for ADPCM samples */
...
ROM_START( strtdriv )
	ROM_REGION( 0x200000, "main", 0 )		/* 2MB for 68000 code */
