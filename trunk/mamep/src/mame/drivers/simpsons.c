...
static MACHINE_DRIVER_START( simpsons )
	...
	MDRV_CPU_ADD("main", KONAMI, XTAL_24MHz/2/4) /* pin 18 of konami cpu is 12Mhz, while pin 17 is 3mhz. Clock probably divided internally by 4  */
...
ROM_START( simpsons ) /* World 4 Player */
	ROM_REGION( 0x8b000, "main", 0 ) /* code + banked roms + banked ram */
	...
	ROM_REGION( 0x28000, "audio", 0 ) /* Z80 code + banks */
