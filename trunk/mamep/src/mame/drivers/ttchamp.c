...
static ADDRESS_MAP_START( ttchamp_map, ADDRESS_SPACE_PROGRAM, 16 )
    ...
    AM_RANGE(0x20000, 0x7ffff) AM_READ(MRA16_BANK1) // ?
    AM_RANGE(0x80000, 0xfffff) AM_READ(MRA16_BANK2) // ?
ADDRESS_MAP_END

static ADDRESS_MAP_START( ttchamp_io, ADDRESS_SPACE_IO, 16 )
    AM_RANGE(0x0000, 0x0001) AM_WRITE(MWA16_NOP)
...
//  AM_RANGE(0x0010, 0x0010) AM_WRITE(pcup_prgbank_w)
    AM_RANGE(0x0010, 0x0011) AM_WRITE(MWA16_NOP)

    AM_RANGE(0x0020, 0x0021) AM_WRITE(MWA16_NOP)

    AM_RANGE(0x0034, 0x0035) AM_READ(peno_rand) AM_WRITE(MWA16_NOP)
ADDRESS_MAP_END
