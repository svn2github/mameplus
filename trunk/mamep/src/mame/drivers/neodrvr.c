...
READ16_MEMBER(neogeo_state::popbounc_sfix_16_r)
{
	if (space.device().safe_pc()==0x6b10)
		return 0;
	return m_save_ram[0x4fbc/2];
}

/* Pop and Bounce and use a custom Spinner for Controls */
DRIVER_INIT_MEMBER(neogeo_state,popbounc)
{
	DRIVER_INIT_CALL(neogeo);

	/* the game hangs after a while without this patch */
	if (!machine().sample_rate())
		machine().device("maincpu")->memory().space(AS_PROGRAM).install_read_handler(0x104fbc, 0x104fbd, read16_delegate(FUNC(neogeo_state::popbounc_sfix_16_r),this));
}
...
// mamep
		else if(strcmp(crypt_feature,"gfxdec42_prot") == 0) { DRIVER_INIT_CALL(gfxdec42); }
		else if(strcmp(crypt_feature,"gfxdec50_prot") == 0) { DRIVER_INIT_CALL(gfxdec50); }
		else if(strcmp(crypt_feature,"kof96ep_prot") == 0)  { DRIVER_INIT_CALL(kof96ep); }
		else if(strcmp(crypt_feature,"garoud_prot") == 0)   { DRIVER_INIT_CALL(garoud); }
		else if(strcmp(crypt_feature,"kof2000d_prot") == 0) { DRIVER_INIT_CALL(kof2000d); }
		else if(strcmp(crypt_feature,"kof2001d_prot") == 0) { DRIVER_INIT_CALL(kof2001d); }
		else if(strcmp(crypt_feature,"kf2k1pls_prot") == 0) { DRIVER_INIT_CALL(kf2k1pls); }
		else if(strcmp(crypt_feature,"kf2k1pa_prot") == 0)  { DRIVER_INIT_CALL(kf2k1pa); }
		else if(strcmp(crypt_feature,"cthd2k3a_prot") == 0) { DRIVER_INIT_CALL(cthd2k3a); }
		else if(strcmp(crypt_feature,"cthd2k3d_prot") == 0) { DRIVER_INIT_CALL(cthd2k3d); }
		else if(strcmp(crypt_feature,"mslug4d_prot") == 0)  { DRIVER_INIT_CALL(mslug4d); }
		else if(strcmp(crypt_feature,"popbounc_prot") == 0) { DRIVER_INIT_CALL(popbounc); }
		else if(strcmp(crypt_feature,"rotdd_prot") == 0)    { DRIVER_INIT_CALL(rotdd); }
		else if(strcmp(crypt_feature,"kf2k2plc_prot") == 0) { DRIVER_INIT_CALL(kf2k2plc); }
		else if(strcmp(crypt_feature,"kf2k2ps2_prot") == 0) { DRIVER_INIT_CALL(kf2k2ps2); }
		else if(strcmp(crypt_feature,"kof2002d_prot") == 0) { DRIVER_INIT_CALL(kof2002d); }
		else if(strcmp(crypt_feature,"kof10thd_prot") == 0) { DRIVER_INIT_CALL(kof10thd); }
		else if(strcmp(crypt_feature,"kf2k4pls_prot") == 0) { DRIVER_INIT_CALL(kf2k4pls); }
		else if(strcmp(crypt_feature,"matrimd_prot") == 0)  { DRIVER_INIT_CALL(matrimd); }
		else if(strcmp(crypt_feature,"pnyaad_prot") == 0)   { DRIVER_INIT_CALL(pnyaad); }
		else if(strcmp(crypt_feature,"mslug5b_prot") == 0)  { DRIVER_INIT_CALL(mslug5b); }
		else if(strcmp(crypt_feature,"mslug5d_prot") == 0)  { DRIVER_INIT_CALL(mslug5d); }
		else if(strcmp(crypt_feature,"svcd_prot") == 0)	    { DRIVER_INIT_CALL(svcd); }
		else if(strcmp(crypt_feature,"samsho5d_prot") == 0) { DRIVER_INIT_CALL(samsho5d); }
		else if(strcmp(crypt_feature,"kof2003d_prot") == 0) { DRIVER_INIT_CALL(kof2003d); }
		else if(strcmp(crypt_feature,"kf2k3pcd_prot") == 0) { DRIVER_INIT_CALL(kf2k3pcd); }
		else if(strcmp(crypt_feature,"samsh5sd_prot") == 0) { DRIVER_INIT_CALL(samsh5sd); }
		else if(strcmp(crypt_feature,"kof97pla_prot") == 0) { DRIVER_INIT_CALL(kof97pla); }
		else if(strcmp(crypt_feature,"jckeygpd_prot") == 0) { DRIVER_INIT_CALL(jckeygpd); }
// mamep end
...
/* Neo Geo bootleg */
GAME( 1996, kof96ep,    kof96,    neogeo,   neogeo, neogeo_state,   kof96ep,  ROT0, "bootleg", "The King of Fighters '96 (bootleg / hack)", GAME_SUPPORTS_SAVE )
GAME( 2003, kof97pla,   kof97,    neogeo,   neogeo, neogeo_state,   kof97pla, ROT0, "bootleg", "The King of Fighters '97 Plus 2003 (bootleg / hack)", GAME_SUPPORTS_SAVE )
GAME( 2002, kf2k1pls,   kof2001,  neogeo,   neogeo, neogeo_state,   kf2k1pls, ROT0, "bootleg", "The King of Fighters 2001 Plus (set 1, bootleg / hack)", GAME_SUPPORTS_SAVE )
GAME( 2002, kf2k1pa,    kof2001,  neogeo,   neogeo, neogeo_state,   kf2k1pa,  ROT0, "bootleg", "The King of Fighters 2001 Plus (set 2, bootleg / hack)", GAME_SUPPORTS_SAVE )
GAME( 2003, cthd2k3a,   kof2001,  neogeo,   neogeo, neogeo_state,   cthd2k3a, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 2)", GAME_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
GAME( 2002, kf2k2plb,   kof2002,  neogeo,   neogeo, neogeo_state,   kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (set 3, bootleg / hack)", GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2002, kf2k2plc,   kof2002,  neogeo,   neogeo, neogeo_state,   kf2k2plc, ROT0, "bootleg", "The King of Fighters 2002 Super (set 4, bootleg / hack)", GAME_SUPPORTS_SAVE ) /* Encrypted GFX */
GAME( 2004, kf2k4pls,   kof2002,  neogeo,   neogeo, neogeo_state,   kf2k4pls, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (The King of Fighters 2002 bootleg)", GAME_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2002 */
GAME( 2003, mslug5b,    mslug5,   neogeo,   neogeo, neogeo_state,   mslug5b,  ROT0, "bootleg", "Metal Slug 5 (bootleg)", GAME_SUPPORTS_SAVE )

/* Neo Geo prototype */
GAME( 2000, bangbedp,   bangbead, neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Visco", "Bang Bead (prototype)", GAME_SUPPORTS_SAVE )

/* CD to MVS Conversion */
GAME( 1996, zintrkcd,   zintrckb, neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "Zintrick / Oshidashi Zentrix (CD to MVS Conversion, Hack)", GAME_SUPPORTS_SAVE )
GAME( 1995, fr2ch,      neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "Idol Mahjong - final romance 2 (CD to MVS Conversion, Hack)", GAME_SUPPORTS_SAVE )
GAME( 1994, sthoopcd,   strhoop,  neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack / bootleg", "Street Hoop / Street Slam / Dunk Dream (CD to MVS Conversion, Hack)", GAME_SUPPORTS_SAVE )

/* AES Conversion */
GAME( 2007, lhcdb,      neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "NG:Dev.Team", "Last Hope (AES Beta Conversion)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE )

/* Neo Geo decrypted */
GAME( 1999, kof99kd,    kof99,    neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release, not encrypted P, decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, garoud,     garou,    neogeo,   neogeo, neogeo_state,   garoud,   ROT0, "SNK", "Garou - Mark of the Wolves (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, mslug3hd,   mslug3,   neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "SNK", "Metal Slug 3 (NGH-2560)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, kof2000d,   kof2000,  neogeo,   neogeo, neogeo_state,   kof2000d, ROT0, "SNK", "The King of Fighters 2000 (not encrypted P, decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, zupapad,    zupapa,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Zupapa! (custom decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, sengok3d,   sengoku3, neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "SNK", "Sengoku 3 (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, kof2001d,   kof2001,  neogeo,   neogeo, neogeo_state,   kof2001d, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGM-262?)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, kof2k1hd,   kof2001,  neogeo,   neogeo, neogeo_state,   kof2001d, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGM-2621)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, kof2002d,   kof2002,  neogeo,   neogeo, neogeo_state,   kof2002d, ROT0, "Eolith / Playmore", "The King of Fighters 2002 (NGM-2650)(NGH-2650) (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2000, nitdd,      nitd,     neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "Eleven / Gavaking", "Nightmare in the Dark (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, s1945pd,    s1945p,   neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "Psikyo", "Strikers 1945 Plus (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, preisl2d,   preisle2, neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "Yumekobo", "Prehistoric Isle 2 (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 1999, ganryud,    ganryu,   neogeo,   neogeo, neogeo_state,   gfxdec42, ROT0, "Visco", "Ganryu / Musashi Ganryuki (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, rotdd,      rotd,     neogeo,   neogeo, neogeo_state,   rotdd,    ROT0, "Evoga / Playmore", "Rage of the Dragons (NGM-264?)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, ct2k3ad,    kof2001,  neogeo,   neogeo, neogeo_state,   cthd2k3d, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg / set 2 fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, cthd2k3d,   kof2001,  neogeo,   neogeo, neogeo_state,   cthd2k3d, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg / set 1 fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2004, kof10thd,   kof2002,  neogeo,   neogeo, neogeo_state,   kof10thd, ROT0, "bootleg", "The King of Fighters 10th Anniversary - All Team Battle (The King of Fighters 2002 bootleg / Fully Decrypted)", GAME_SUPPORTS_SAVE ) // fake SNK copyright
GAME( 2003, kof2003d,   kof2003,  neogeo,   neogeo, neogeo_state,   kof2003d, ROT0, "SNK Playmore", "The King of Fighters 2003 (Decrypted P&C)", GAME_SUPPORTS_SAVE ) /* Encrypted Code & Sound */
GAME( 2003, kof2k3d,    kof2003,  neogeo,   neogeo, neogeo_state,   kof2k3d,  ROT0, "SNK Playmore", "The King of Fighters 2003 (NGM-2710)(decrypted C)", GAME_SUPPORTS_SAVE ) /* Encrypted Code & Sound */
GAME( 2003, kof2k3hd,   kof2003,  neogeo,   neogeo, neogeo_state,   kof2k3hd, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710)(decrypted C)", GAME_SUPPORTS_SAVE ) /* Encrypted Code & Sound */
GAME( 2002, matrimd,    matrim,   neogeo,   neogeo, neogeo_state,   matrimd,  ROT0, "Noise Factory / Atlus", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (NGM-2660)(NGH-2660) (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, mslug4d,    mslug4,   neogeo,   neogeo, neogeo_state,   mslug4d,  ROT0, "Mega", "Metal Slug 4 (NGM-2630) (Custom Decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2002, mslug4hd,   mslug4,   neogeo,   neogeo, neogeo_state,   mslug4d,  ROT0, "Mega", "Metal Slug 4 (NGH-2630) (Custom Decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5d,    mslug5,   neogeo,   neogeo, neogeo_state,   mslug5d,  ROT0, "SNK / Playmore", "Metal Slug 5 (NGM-2680) (fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, mslug5hd,   mslug5,   neogeo,   neogeo, neogeo_state,   mslug5hd, ROT0, "SNK / Playmore", "Metal Slug 5 (NGH-2680) (Decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, samsho5d,   samsho5,  neogeo,   neogeo, neogeo_state,   samsho5d, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGM-2700)(decrypted C)", GAME_SUPPORTS_SAVE ) // different program scrambling
GAME( 2003, samsh5hd,   samsho5,  neogeo,   neogeo, neogeo_state,   samsho5d, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGH-2700)(decrypted C)", GAME_SUPPORTS_SAVE ) // different program scrambling
GAME( 2003, sams5spd,   samsh5sp, neogeo,   neogeo, neogeo_state,   samsh5sd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGM-2720)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, sams5sphd,  samsh5sp, neogeo,   neogeo, neogeo_state,   samsh5sd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720)(1st release, censored)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, sams5spnd,  samsh5sp, neogeo,   neogeo, neogeo_state,   samsh5sd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720)(2nd release, less censored)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2004, lans2k4d,   shocktr2, neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "bootleg", "Lansquenet 2004 (Shock Troopers - 2nd Squad Bootleg / fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcd,       svc,      neogeo,   neogeo, neogeo_state,   svcd,     ROT0, "SNK Playmore", "SNK vs. CAPCOM SVC CHAOS (NGM-2690)(NGH-2690)(decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2001, jckeygpd,   jockeygp, neogeo,   jockeygp, neogeo_state, jckeygpd, ROT0, "Sun Amusement / BrezzaSoft", "Jockey Grand Prix (decrypted C)", GAME_SUPPORTS_SAVE )
GAME( 2003, kf2k3pcd,   kf2k3pcb, neogeo,   neogeo, neogeo_state,   kf2k3pcd, ROT0, "SNK Playmore", "The King of Fighters 2003 (Japan, JAMMA PCB / decrypted C&Bios)", GAME_SUPPORTS_SAVE ) /* Encrypted Code & Sound */
GAME( 2005, kogd,       kof97,    neogeo,   kog, neogeo_state,      neogeo,   ROT0, "bootleg", "King of Gladiator (The King of Fighters '97 bootleg / fully decrypted)", GAME_SUPPORTS_SAVE )
GAME( 2003, pnyaad,     pnyaa,    neogeo,   neogeo, neogeo_state,   pnyaad,   ROT0, "Aiky / Taito", "Pochi and Nyaa (decrypted C)", GAME_SUPPORTS_SAVE ) /* Encrypted Sound */

/* Neo Geo homebrew */
GAME( 1989, beast,      neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Psygnosis", "Shadow of the Beast (Homebrew, No sound edition)", GAME_SUPPORTS_SAVE )
GAME( 2003, poknight,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "JMK", "Poker Night (Homebrew, No sound edition)", GAME_SUPPORTS_SAVE )
GAME( 2002, neonopon,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "Neo No Panepon (Beta, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2002, neopong,    neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Neodev", "Neo Pong (ver 1.1, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2002, neoponga,   neopong,  neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Neodev", "Neo Pong (ver 1.0, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 200?, syscheck,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "Neo System Check (ver 1.0b, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2006, frogfest,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Rastersoft", "Frog Feast (Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2005, ltorb1,     neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "Jonas Indiana and the Lost Temple of RA (050717, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2002, neodemo,    neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Chaos", "Neo-Demo (Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2006, cnbe,       neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "Codename: Blut Engel (060119, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2006, ngem2k,     neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "NGEM2K (Beta 060118, Homebrew)", GAME_SUPPORTS_SAVE )
GAME( 2004, neo2500,    neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Blastar", "Neo 2500 Demo (Homebrew)", GAME_SUPPORTS_SAVE )

/* Neo Geo hack */
GAME( 200?, kof96cn,    kof96,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "The King of Fighters '96 (Chinese Edition ver 1.0, hack)", GAME_SUPPORTS_SAVE )
GAME( 2007, kof96ae,    kof96,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "The King of Fighters '96 (Anniversary Edition, EGHT hack)", GAME_SUPPORTS_SAVE )
GAME( 2007, kof97cn,    kof97,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "The King of Fighters '97 (10th Anniversary Chinese Edition, EGHT hack)", GAME_SUPPORTS_SAVE )
GAME( 2007, kof97xt,    kof97,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "The King of Fighters '97 - Final Battle (hack)", GAME_SUPPORTS_SAVE )
GAME( 2009, kof98ae,    kof98,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "The King of Fighters '98 (Anniversary Edition, EGHT hack)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
GAME( 2007, kf2k2ps2,   kof2002,  neogeo,   neogeo, neogeo_state,   kf2k2ps2, ROT0, "hack", "The King of Fighters 2002 (PlayStation 2 ver 0.4, EGHT hack)", GAME_SUPPORTS_SAVE )
GAME( 1990, columnsh,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "hack", "Columns (Sega hardware hack, No sound edition)", GAME_SUPPORTS_SAVE )
