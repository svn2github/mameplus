...
void neogeo_set_lower_resolution(running_machine* machine)
{
    ...
    */
	...
	if (!strcmp(machine->gamedrv->name,"nam1975") ||
		...
		!strcmp(Machine->gamedrv->name,"kof97pla") ||	// added
	...
	video_screen_set_visarea(0, 8 + NEOGEO_HBEND, 39 * 8 - 1 + NEOGEO_HBEND,
	                         machine->screen[0].visarea.min_y, machine->screen[0].visarea.max_y);
}
...
#define ROM_Y_ZOOM																								\
	ROM_REGION( 0x10000, NEOGEO_REGION_ZOOM_Y_TABLE, 0 )														\
...
ROM_START( nam1975 )
	...
	NEO_BIOS_AUDIO_64K( "001-m1.bin", CRC(cd088502) SHA1(939f745cd576905f326e6246a2eed78e9fa88178) )
...
ROM_START( bstars )
	...
	NEO_BIOS_AUDIO_64K( "002-m1.bin", CRC(79a8f4c2) SHA1(08ca2b72fd9b0ed068dc918ecda51d13203a3481) )
...
ROM_START( tpgolf )
	...
	NEO_BIOS_AUDIO_64K( "003-m1.bin", CRC(7851d0d9) SHA1(d021cef958cc37ab170b78d7a4b3ae94947e4d13) )
...
ROM_START( mahretsu )
	...
	NEO_BIOS_AUDIO_64K( "004-m1.bin", CRC(37965a73) SHA1(61ad03c74169f9f50a37048fb74300ee926ee766) )
...
ROM_START( maglord )
	...
	NEO_BIOS_AUDIO_64K( "005-m1.bin", CRC(91ee1f73) SHA1(f060728543333a99216cc2879f7666a1f4235068) )
...
ROM_START( cyberlip )
	...
	NEO_BIOS_AUDIO_64K( "010-m1.bin", CRC(47980d3a) SHA1(afd7be531d2ba69400dff5927202446873266c06) )
...
ROM_START( superspy )
	...
	NEO_BIOS_AUDIO_128K( "011-m1.bin", CRC(d59d5d12) SHA1(0692b6f35c9ee3840f945703c4eb51ab83eb0714) )
...
ROM_START( joyjoy )
	...
	NEO_BIOS_AUDIO_64K( "021-m1.bin", CRC(058683ec) SHA1(2aff3dc18d078911ed3a09d48664faf5958b4ab5) )
...
ROM_START( bjourney )
	...
	NEO_BIOS_AUDIO_64K( "022-m1.bin",  CRC(a9e30496) SHA1(c7a42dc64007408fd9b3b9d3a54c523da3acf475) )
...
ROM_START( minasan )
	...
	NEO_BIOS_AUDIO_128K( "027-m1.bin", CRC(add5a226) SHA1(99995bef2584abbba16777bac52f55523f7aa97d) )
...
ROM_START( legendos )
	...
	NEO_BIOS_AUDIO_64K( "029-m1.bin", CRC(909d4ed9) SHA1(5230b423b3f629bb955a5b2dab7e502fa7d83254) )
...
ROM_START( socbrawl )
	...
	NEO_BIOS_AUDIO_64K( "031-m1.bin", CRC(2f38d5d3) SHA1(0fc01750277e554978e68e7e6d596f8bd6b1e178) )
...
ROM_START( roboarmy )
	...
	NEO_BIOS_AUDIO_128K( "032-m1.bin", CRC(98edc671) SHA1(04ed65ccaa1197fa55fcefe2caed2772e7040bdb) )
...
ROM_START( roboarma )
	...
	NEO_BIOS_AUDIO_128K( "032-m1h.bin", CRC(35ec952d) SHA1(8aed30e26d7e2c70dbce5de752df416091066f7b) )
...
ROM_START( fatfury1 )
	...
	NEO_BIOS_AUDIO_128K( "033-m1.bin", CRC(a8603979) SHA1(512f2280a43892d4ca003ac63945ce86c5211b97) )
...
ROM_START( bstars2 )
	...
	NEO_BIOS_AUDIO_64K( "041-m1.bin", CRC(b2611c03) SHA1(a2c8b850b53e445edabdfd44f05c64de596618b8) )
...
ROM_START( janshin )
	...
	NEO_BIOS_AUDIO_64K( "048-m1.bin", CRC(e191f955) SHA1(fc19705644ffb3d1ae76bcf2b6b78fef05bcf701) )
...
ROM_START( viewpoin )
	...
	NEO_BIOS_AUDIO_64K( "051-m1.bin", CRC(d57bd7af) SHA1(9ed766dbc3c07dbba7869ff335eeb7e297c8e2d9) )
...
ROM_START( pbobblen )
	...
	NEO_BIOS_AUDIO_64K( "083-m1.bin", CRC(129e6054) SHA1(4edd18c44759e7a140705f1544413c649131c551) )
...
ROM_START( tws96 )
	...
	NEO_BIOS_AUDIO_64K( "086-m1.bin", CRC(860ba8c7) SHA1(6457964fd2fdda1d4f57787fff0cec76b47692cb) )
...
ROM_START( goalx3 )
	...
	NEO_BIOS_AUDIO_64K( "209-m1.bin", CRC(dd945773) SHA1(2304d070864da79dceb29c64e8d71b7db0992d1e) )
...
ROM_START( zintrkcd )
	...
	ROM_REGION( 0x400000, NEOGEO_REGION_SPRITES, 0 )
	ROM_LOAD16_BYTE( "zin_c1.rom", 0x000000, 0x200000, CRC(76aee189) SHA1(ad6929804c5b9a59aa609e6baebc6aa37e858a47) )
	ROM_LOAD16_BYTE( "zin_c2.rom", 0x000001, 0x200000, CRC(844ed4b3) SHA1(fb7cd057bdc6cbe8b78097dd124118bae7402256) )
ROM_END
...
ROM_START( kof96ep )
	...
	ROM_REGION( 0x2000000, NEOGEO_REGION_SPRITES, 0 )
	ROM_LOAD16_BYTE( "214-c1.bin", 0x0000000, 0x400000, CRC(7ecf4aa2) SHA1(f773c4c1f05d58dd37e7bb2ac1d1e0ec43998a71) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214-c2.bin", 0x0000001, 0x400000, CRC(05b54f37) SHA1(cc31653fe4cb05201fba234e080cb9c7a7592b1b) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "214-c3.bin", 0x0800000, 0x400000, CRC(64989a65) SHA1(e6f3749d43be0afa9dad7b085cb782ba694252ca) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "214-c4.bin", 0x0800001, 0x400000, CRC(afbea515) SHA1(ae875052728de33174827705646bd14cf3937b5c) ) /* Plane 2,3 */
...
//  NEO_BIOS_AUDIO_128K( "262-m1d.bin",  CRC(73c1f5b0) SHA1(27975713e091ecc2a370061080d0920a3c4fde63) )
...
ROM_START( mslug4d )
	...
	ROM_REGION( 0x3000000, NEOGEO_REGION_SPRITES, 0 )
...
ROM_START( rotd ) /* Encrypted Set */
	...
	/* Decrypted */
	NEO_BIOS_AUDIO_64K( "264-m1_decrypted.bin", CRC(7e06206d) SHA1(ba32dd6ffbfbf532bba9bed4c2d70cfbe959ac23) )
...
ROM_START( mslug5 ) /* Encrypted Set */
	...
	/* Decrypted */
	NEO_BIOS_AUDIO_64K( "268-m1_decrypted.bin",  CRC(3c0655a7) SHA1(ae839d4c2b87a7aa3dd8e5caddc43eb75ee9b732) )
...
ROM_START( svc ) /* Encrypted Set, MVS Set */
	...
	ROM_LOAD( "269-m1.bin", 0x00000, 0x20000, CRC(7d337756) SHA1(205b8b5be7acc8d564fe17835795f25b13c27d7a) )
	/* Decrypted */
	NEO_BIOS_AUDIO_128K( "269-m1_decrypted.bin", CRC(447b3123) SHA1(a09adc2c0ee2ee0f01287ceb97474a1a58093bd2) )
...
ROM_START( kf2k2plc ) /* bootleg */
	ROM_REGION( 0x500000, NEOGEO_REGION_MAIN_CPU_CARTRIDGE, 0 )
	ROM_LOAD16_WORD_SWAP( "265-p1pc.bin",0x000000, 0x100000, CRC(ebedae17) SHA1(5f84562f9ef7a6b007290e59b31a62aca208f579) )
	ROM_LOAD16_WORD_SWAP( "265-p2.bin", 0x100000, 0x400000, CRC(327266b8) SHA1(98f445cc0a94f8744d74bca71cb420277622b034) )
...
//  use neopong rom
	...
	ROM_REGION( 0x100000, NEOGEO_REGION_SPRITES, 0 )
...
ROM_START( neodemo )
	...
	ROM_REGION( 0x200000, NEOGEO_REGION_SPRITES, 0 )
...
ROM_START( fr2ch ) /* CD to MVS Conversion */
	...
	ROM_REGION( 0x600000, NEOGEO_REGION_SPRITES, 0 )
	/* Encrypted */
...
ROM_START( kf2k3pcd ) /* Decrypted C ROMs Version - Encrypted Code & Sound */
	...
	ROM_REGION( 0x6000000, NEOGEO_REGION_SPRITES, 0 )
	/* decrypted */
...
ROM_START( pnyaad ) /* Decrypted C ROMs Version -  Encrypted Sound */
	...
	ROM_REGION( 0x1000000, NEOGEO_REGION_SPRITES, 0 )
	/* Decrypted */
...
ROM_START( kogd )
	...
	ROM_REGION( 0x2800000, NEOGEO_REGION_SPRITES, 0 )
...
static DRIVER_INIT( kof2002b )
{
	kof2002_decrypt_68k();
	neo_pcm2_swap(0);
	kof2002b_gfx_decrypt(memory_region(NEOGEO_REGION_SPRITES),0x4000000);
	kof2002b_gfx_decrypt(memory_region(NEOGEO_REGION_FIXED_LAYER_CARTRIDGE),0x20000);
	driver_init_neogeo(machine);
}
...
static DRIVER_INIT( kf2k3pcb )
{
	...
	driver_init_neogeo(machine);
	install_pvc_protection();
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0xc00000, 0xc7ffff, 0, 0, MRA16_BANK5 );  // 512k bios
}
...
/* new decrypted */
DRIVER_INIT( kof2003d ) // decrypted C & decrypted P
{
	neo_pcm2_swap(5);
	driver_init_gfxdec50(machine);
}
...
DRIVER_INIT( kof10thd ) // decrypted P
{
	neo_pcm2_swap(0);
	driver_init_neogeo(machine);
}

DRIVER_INIT( svcd ) // decrypted C
{
	svcchaos_px_decrypt();
	neo_pcm2_swap(3);
	driver_init_gfxdec50(machine);
...
DRIVER_INIT( pnyaad ) // decrypted C
{
	neo_pcm2_snk_1999(4);
	neogeo_fixed_layer_bank_type = 1;
	neogeo_sfix_decrypt();
...
DRIVER_INIT( samsho5d ) // decrypted C
{
	samsho5_decrypt_68k();
	neo_pcm2_swap(4);
	driver_init_gfxdec42(machine);
...
static void fr2ch_cx_hack( void )
{
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0x200000, 0x2fffff, 0, 0, fr2ch_cx_hack_w);
}

static void fr2ch_patches( void )
{
	UINT16 *src = (UINT16*)memory_region( NEOGEO_REGION_MAIN_CPU_CARTRIDGE );
...
GAMEB( 1990, mahretsu, neogeo,   neogeo, neogeo, mjneogeo,neogeo,   ROT0, "SNK", "Mahjong Kyoretsuden", 0 )
...
GAMEB( 1996, kof96ep,  kof96,    neogeo, neogeo, neogeo,  kof96ep,  ROT0, "bootleg", "The King of Fighters '96 (bootleg / hack)", 0 )
GAMEB( 1996, ssideki4, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "The Ultimate 11 - The SNK Football Championship / Tokuten Ou - Honoo no Libero", 0 )
...
GAMEB( 2003, kof97pls, kof97,    neogeo, neogeo, neogeo,  neogeo,   ROT0, "bootleg", "The King of Fighters '97 Plus (bootleg / hack)", 0 )
...
GAMEB( 1997, lastblad, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "The Last Blade / Bakumatsu Roman - Gekka no Kenshi (set 1)", 0 )
GAMEB( 1997, lastbldh, lastblad, neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "The Last Blade / Bakumatsu Roman - Gekka no Kenshi (set 2)", 0 )
...
GAMEB( 1998, lastbld2, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "The Last Blade 2 / Bakumatsu Roman - Dai Ni Maku Gekka no Kenshi", 0 )
...
GAMEB( 2003, cthd2003, kof2001,  neogeo, neogeo, neogeo,  cthd2003, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 1)", 0 ) /* Protected Hack / Bootleg of kof2001 */
...
GAMEB( 2002, kf2k1pls, kof2001,  neogeo, neogeo, neogeo,  kf2k1pls, ROT0, "bootleg", "The King of Fighters 2001 Plus (set 1, bootleg / hack)", 0 )
GAMEB( 2002, kf2k1pa,  kof2001,  neogeo, neogeo, neogeo,  kf2k1pa,  ROT0, "bootleg", "The King of Fighters 2001 Plus (set 2, bootleg / hack)", 0 )
...
GAMEB( 2002, kf2k2pls, kof2002,  neogeo, neogeo, neogeo,  kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (set 1, bootleg / hack)" , 0) /* Encrypted GFX */
GAMEB( 2002, kf2k2pla, kof2002,  neogeo, neogeo, neogeo,  kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (set 2, bootleg / hack)" , 0) /* Encrypted GFX */
GAMEB( 2002, kf2k2plb, kof2002,  neogeo, neogeo, neogeo,  kf2k2pls, ROT0, "bootleg", "The King of Fighters 2002 Plus (set 3, bootleg / hack)" , 0) /* Encrypted GFX */
GAMEB( 2002, kf2k2plc, kof2002,  neogeo, neogeo, neogeo,  kf2k2plc, ROT0, "bootleg", "The King of Fighters 2002 Super (set 4, bootleg / hack)", 0 ) /* Encrypted GFX */
GAMEB( 2002, kf2k2mp,  kof2002,  neogeo, neogeo, neogeo,  kf2k2mp,  ROT0, "bootleg", "The King of Fighters 2002 Magic Plus (bootleg / hack)" , 0) /* Encrypted GFX */
GAMEB( 2002, kf2k2mp2, kof2002,  neogeo, neogeo, neogeo,  kof2km2,  ROT0, "bootleg", "The King of Fighters 2002 Magic Plus II (bootleg / hack)" , 0) /* Encrypted GFX */
...
GAMEB( 2004, kf2k4pls, kof2002,  neogeo, neogeo, neogeo,  kf2k4pls, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (The King of Fighters 2002 bootleg)", 0 ) /* Hack / Bootleg of kof2002 */
GAMEB( 2003, mslug5,   neogeo,   neogeo, neogeo, neogeo,  mslug5,   ROT0, "SNK Playmore", "Metal Slug 5", 0 )
GAME ( 2003, ms5pcb,   0,                neogeo, svcpcb,  ms5pcb,   ROT0, "SNK Playmore", "Metal Slug 5 (JAMMA PCB)", 0 ) // not a clone of neogeo because it's NOT a neogeo cart.
GAMEB( 2003, ms5plus,  mslug5,   neogeo, neogeo, neogeo,  ms5plus,  ROT0, "bootleg", "Metal Slug 5 Plus (bootleg / hack)",0 )
...
GAME ( 2003, svcpcba,  svcpcb,           neogeo, svcpcb,  svcpcb,   ROT0, "Playmore", "SVC Chaos - SNK vs CAPCOM (JAMMA PCB, set 2)" , 0 ) // not a clone of neogeo because it's NOT a neogeo cart.
...
GAMEB( 2003, svcplus,  svc,      neogeo, neogeo, neogeo,  svcplus,  ROT0, "bootleg", "SvC Chaos - SNK vs Capcom Plus (set 1, bootleg / hack)",0 )
GAMEB( 2003, svcplusa, svc,      neogeo, neogeo, neogeo,  svcplusa, ROT0, "bootleg", "SvC Chaos - SNK vs Capcom Plus (set 2, bootleg / hack)",0 )
GAMEB( 2003, svcsplus, svc,      neogeo, neogeo, neogeo,  svcsplus, ROT0, "bootleg", "SvC Chaos - SNK vs Capcom Super Plus (bootleg / hack)",0 )
...
GAMEB( 2003, kf2k3pl,  kof2003,  neogeo, neogeo, neogeo,  kof2k3pl, ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (bootleg / hack)",0 ) // zooming is wrong because its a bootleg of the pcb version on a cart
GAMEB( 2003, kf2k3upl, kof2003,  neogeo, neogeo, neogeo,  kof2k3up, ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (bootleg / hack)",0 ) // zooming is wrong because its a bootleg of the pcb version on a cart
...
GAMEB( 1996, zintrckb, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "hack",             "Zintrick / Oshidashi Zentrix (hack / bootleg)", 0 )


/* Aicom */
GAMEB( 1994, janshin,  neogeo,   neogeo, neogeo, mjneogeo,neogeo,   ROT0, "Aicom", "Jyanshin Densetsu - Quest of Jongmaster", 0 )
...
/* Monolith Corp. */
GAMEB( 1990, minasan,  neogeo,   neogeo, neogeo, mjneogeo,neogeo,   ROT0, "Monolith Corp.", "Minnasanno Okagesamadesu", 0 )
GAMEB( 1991, bakatono, neogeo,   neogeo, neogeo, mjneogeo,neogeo,   ROT0, "Monolith Corp.", "Bakatonosama Mahjong Manyuki", 0 )
...
/* homebrew */
GAMEB( 1989, beast,    neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "Psygnosis", "Shadow of the Beast (Neo Demo)", GAME_NO_SOUND )
GAMEB( 1990, columnsn, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "Sega / hack", "Columns (Neo-Geo)", GAME_NO_SOUND )
GAMEB( 200?, poknight, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "JMK", "Poker Night", GAME_NO_SOUND )
GAMEB( 2002, neonopon, neogeo,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "Blastar", "Neo No Panepon (beta)", 0 )
...
GAMEB( 1996, zintrkcd, zintrckb, neogeo, neogeo, neogeo,  neogeo,   ROT0, "hack",          "Zintrick / Oshidashi Zentrix (CD to MVS Conversion)", 0 )
...
GAMEB( 2003, ct2k3ad,  kof2001,  neogeo, neogeo, neogeo,  cthd2k3d, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg / set 2 fully decrypted)", 0 )
...
GAMEB( 2004, kof10thd, kof2002,  neogeo, neogeo, neogeo,  kof10thd, ROT0, "bootleg", "The King of Fighters 10th Anniversary - All Team Battle (The King of Fighters 2002 bootleg / Fully Decrypted)", 0 ) // fake SNK copyright
...
GAMEB( 2003, mslug5d,  mslug5,   neogeo, neogeo, neogeo,  mslug5d,  ROT0, "SNK / Playmore", "Metal Slug 5 (fully decrypted)", 0 )
GAMEB( 2003, samsho5d, samsho5,  neogeo, neogeo, neogeo,  samsho5d, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (decrypted C)", 0 ) // different program scrambling
GAMEB( 2003, samsh5sd, samsh5sp, neogeo, neogeo, neogeo,  samsh5sd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (decrypted C)", 0 )
...
GAMEB( 2003, svcd,     svc,      neogeo, neogeo, neogeo,  svcd,     ROT0, "bootleg", "SVC Chaos - SNK vs CAPCOM (MVS / decrypted C)",0 )
...
GAMEB( 2005, kogd,     kof97,    neogeo, neogeo, kog,     neogeo,   ROT0, "bootleg", "King of Gladiator (The King of Fighters '97 bootleg / fully decrypted)", 0 )
