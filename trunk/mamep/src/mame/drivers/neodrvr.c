...
ROM_START( legendos )
	...
	/* TC531001 */
	NEO_BIOS_AUDIO_128K( "029-m1.bin", CRC(6f2843f0) SHA1(975fb1598b87a2798fff05e951fca2e2e0329e79) )
...
ROM_START( crsword ) /* MVS AND AES VERSION */
	...
	/* TC531001 */
	NEO_BIOS_AUDIO_128K( "037-m1.bin", CRC(9504b2c6) SHA1(9ce8e681b9df6eacd0d23a36bad836bd5074233d) )
...
ROM_START( savagere )
	...
	ROM_REGION( 0x1000000, "sprites", 0 )
	ROM_LOAD16_BYTE( "059-c1.bin", 0x000000, 0x200000, CRC(45622698) SHA1(25e7e61ae128b124be9c9e28278a2fed916dd3a1) ) /* Plane 0,1 */
...
ROM_START( kizuna )
	...
	ROM_REGION( 0x1c00000, "sprites", 0 )
	ROM_LOAD16_BYTE( "059-c1.bin", 0x0000000, 0x200000, CRC(45622698) SHA1(25e7e61ae128b124be9c9e28278a2fed916dd3a1) ) /* Plane 0,1 */
