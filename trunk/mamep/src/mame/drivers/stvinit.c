...
void install_stvbios_speedups(running_machine *machine)
{
	...
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60154b2);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6013aee);

	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60154b2);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6013aee);
}
...
DRIVER_INIT(shienryu)
{
	...
	// slave
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x600440e);
...
*/
	// master
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6018640);
	// slave
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6018c6e);
...
*/
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6010160);
...
DRIVER_INIT(puyosun)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6021cf0);

	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60236fe);
...
DRIVER_INIT(mausuke)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60461A0);
...
{
//  sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6030ee2);
//  sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6032b52);
...
DRIVER_INIT(cotton2)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6031c7a);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60338ea);
...
DRIVER_INIT(dnmtdeka)
{
	...
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6027c90);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0xd04);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60051f2);

	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6027c90);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0xd04);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60051f2);
...
{
	// install all 3 speedups on both master and slave
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6027c98);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0xd04);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60051f2);

	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6027c98);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0xd04);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60051f2);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60041c2);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x600bb0a);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x600b31e);
...
DRIVER_INIT( groovef )
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6005e7c);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6005e86);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60a4970);

	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60060c2);
...
DRIVER_INIT( danchih )
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6028b28);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6028c8e);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x602ae26);
...
DRIVER_INIT( astrass )
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60011b8);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x605b9da);
...
DRIVER_INIT(thunt)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x602A024);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6013EEA);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x602AAF8);
...
DRIVER_INIT(sandor)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x602a0f8);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6013fbe);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x602abcc);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6041e32);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6043aa2);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x60121c0);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60125bc);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60298a2);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6098aea);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x609ae4e);
...
DRIVER_INIT(seabass)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x602cbfa);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60321ee);
...
DRIVER_INIT(vfremix)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x602c30c);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x604c332);
...
DRIVER_INIT(sss)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6026398);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6028cd6);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x602bcbe);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x602d92e);
...
DRIVER_INIT(sasissu)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60710be);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6012ee4);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6013f7a);
...
DRIVER_INIT(znpwfv)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6012ec2);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x60175a6);
...
DRIVER_INIT(twcup98)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x605edde);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6063bf4);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6062bca);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6064d60);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x601ba46);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x601ba46);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x605eb78);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6020c5c);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x604eac0);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x605340a);
...
DRIVER_INIT(rsgun)
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x6034d04);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x6036152);
...
{
	sh2drc_add_pcflush(cputag_get_cpu(machine, "maincpu"), 0x601eb4c);
	sh2drc_add_pcflush(cputag_get_cpu(machine, "slave"), 0x602b80e);
