...
static INPUT_PORTS_START( iceclmrj )
	...
	PORT_DIPSETTING(	0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(	0x40, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x00, "Service Mode (Left Side)" ) PORT_TOGGLE PORT_CODE(KEYCODE_F2)
	PORT_DIPSETTING(	0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(	0x80, DEF_STR( On ) )
	...
	PORT_DIPSETTING(	0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(	0x40, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x00, "Service Mode (Right Side)" ) PORT_TOGGLE PORT_CODE(KEYCODE_F1)
	PORT_DIPSETTING(	0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(	0x80, DEF_STR( On ) )
INPUT_PORTS_END
...
ROM_START( vsgshoe )
	ROM_REGION( 0x14000,"main", 0 ) /* 6502 memory */
...
ROM_START( vsfdf )
	ROM_REGION( 0x30000,"main", 0 ) /* 6502 memory */
...
ROM_START( goonies )
	ROM_REGION( 0x20000,"main", 0 ) /* 6502 memory */
...
ROM_START( vsskykid )
	ROM_REGION( 0x18000,"main",0 ) /* 6502 memory */
