...
{
	fg_tilemap          = tilemap_create(get_tile_info2, tilemap_scan_rows, TILEMAP_TYPE_TRANSPARENT, 8,8, 32,32);
	bg_tilemap          = tilemap_create(get_tile_info,  tilemap_scan_rows, TILEMAP_TYPE_OPAQUE,      8,8, 32,32);
	bg_tilemap_noscroll = tilemap_create(get_tile_info,  tilemap_scan_rows, TILEMAP_TYPE_OPAQUE,      8,8, 32,32);
