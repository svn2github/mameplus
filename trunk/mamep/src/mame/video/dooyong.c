...
VIDEO_START( lastday )
{
	...
	bg_tilerom = memory_region(machine, REGION_GFX5);
	fg_tilerom = memory_region(machine, REGION_GFX6);
	bg_tilerom2 = NULL;
	fg_tilerom2 = NULL;
	bg_gfx = 2;
	fg_gfx = 3;
...
{
	/* Configure tilemap callbacks */
	bg_tilerom = memory_region(machine, REGION_GFX3) + 0x78000;
	fg_tilerom = memory_region(machine, REGION_GFX4) + 0x78000;
	fg2_tilerom = memory_region(machine, REGION_GFX5) + 0x38000;
	bg_tilerom2 = NULL;
	fg_tilerom2 = NULL;
	fg2_tilerom2 = NULL;
	bg_gfx = 2;
...
{
	/* Configure tilemap callbacks */
	bg_tilerom = memory_region(machine, REGION_GFX2) + memory_region_length(machine, REGION_GFX2) - 0x8000;
	fg_tilerom = memory_region(machine, REGION_GFX3) + memory_region_length(machine, REGION_GFX3) - 0x8000;
	bg_tilerom2 = NULL;
	fg_tilerom2 = NULL;
	bg_gfx = 1;
	fg_gfx = 2;
...
VIDEO_START( rshark )
{
	/* Configure tilemap callbacks */
	bg_tilerom = memory_region(machine, REGION_GFX5);
	bg2_tilerom = memory_region(machine, REGION_GFX4);
	fg_tilerom = memory_region(machine, REGION_GFX3);
	fg2_tilerom = memory_region(machine, REGION_GFX2);
	bg_tilerom2 = memory_region(machine, REGION_GFX6) + 0x60000;
	bg2_tilerom2 = memory_region(machine, REGION_GFX6) + 0x40000;
	fg_tilerom2 = memory_region(machine, REGION_GFX6) + 0x20000;
	fg2_tilerom2 = memory_region(machine, REGION_GFX6) + 0x00000;
	bg_gfx = 4;
	bg2_gfx = 3;
	fg_gfx = 2;
	fg2_gfx = 1;
...
{
	/* Configure tilemap callbacks */
	bg_tilerom = memory_region(machine, REGION_GFX2);
	bg_gfx = 1;
