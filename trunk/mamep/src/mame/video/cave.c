...
static TILE_GET_INFO( get_tile_info_0 )	{ cave_state *state = (cave_state *)machine->driver_data; get_tile_info(machine, tileinfo, tile_index, 0, state->vram_0, state->tiledim_0); }
static TILE_GET_INFO( get_tile_info_1 )	{ cave_state *state = (cave_state *)machine->driver_data; get_tile_info(machine, tileinfo, tile_index, 1, state->vram_1, state->tiledim_1); }
static TILE_GET_INFO( get_tile_info_2 )	{ cave_state *state = (cave_state *)machine->driver_data; get_tile_info(machine, tileinfo, tile_index, 2, state->vram_2, state->tiledim_2); }
