...
{
	background_tilemap = tilemap_create(machine, get_back_info,back_scan, 16, 16, 32, 32);
	text_tilemap = tilemap_create(machine, get_text_info,tilemap_scan_rows, 8, 8, 32, 32);
