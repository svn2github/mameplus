...
{
	bg_tilemap = tilemap_create(machine, holeland_get_tile_info,tilemap_scan_rows,16,16,32,32);
...
{
	bg_tilemap = tilemap_create(machine, crzrally_get_tile_info,tilemap_scan_cols,8,8,32,32);
}
