...
#define ERROR_CORRUPT _("The zipfile seems to be corrupt, please check it")
#define ERROR_FILESYSTEM _("Your filesystem seems to be corrupt, please check it")
#define ERROR_UNSUPPORTED _("The format of this zipfile is not supported, please recompress it")
