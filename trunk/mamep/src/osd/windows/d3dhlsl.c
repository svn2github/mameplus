...
void shaders::deconverge_pass(render_target *rt, vec2f &texsize, vec2f &delta, vec2f &sourcedims)
{
	...
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device set_render_target call 6\n"), (int)result);
	result = (*d3dintf->device.clear)(d3d->get_device(), 0, NULL, D3DCLEAR_TARGET, D3DCOLOR_ARGB(0,0,0,0), 0, 0);
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device clear call\n"), (int)result);
...
void shaders::defocus_pass(render_target *rt, vec2f &texsize)
{
	...
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device set_render_target call 7\n"), (int)result);
...
void shaders::phosphor_pass(render_target *rt, cache_target *ct, vec2f &texsize, bool focus_enable)
{
	...
	HRESULT result = (*d3dintf->device.set_render_target)(d3d->get_device(), 0, rt->target[0]);
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device set_render_target call 4\n"), (int)result);
	result = (*d3dintf->device.clear)(d3d->get_device(), 0, NULL, D3DCLEAR_TARGET, D3DCOLOR_ARGB(0,0,0,0), 0, 0);
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device clear call\n"), (int)result);
	...
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device set_render_target call 5\n"), (int)result);
	result = (*d3dintf->device.clear)(d3d->get_device(), 0, NULL, D3DCLEAR_TARGET, D3DCOLOR_ARGB(0,0,0,0), 0, 0);
	if (result != D3D_OK) osd_printf_verbose(_WINDOWS("Direct3D: Error %08X during device clear call\n"), (int)result);
