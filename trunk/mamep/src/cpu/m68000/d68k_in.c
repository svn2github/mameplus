...
M68KMAKE_OP(asr, 8, s, .)
{
	...
	int update_flag = m68kdrc_update_vncxz_check();
...
M68KMAKE_OP(ror, 8, r, .)
{
	...
	link_info link2;
	link_info link3;
	int update_flag = m68kdrc_update_vncz_check();
