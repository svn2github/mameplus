...
ROM_START( g_ssf2e )
	...
	ROM_LOAD( "g_ssf2e.bin", 0x000000, 0x500000, CRC(682c192f) SHA1(56768a0524fa13fcd76474c8bb89b995bb471847) )
ROM_END
ROM_START( g_ssf2j )
	ROM_REGION( 0x1400000, REGION_CPU1, 0 ) /* 68000 Code */
	ROM_LOAD( "g_ssf2j.bin", 0x000000, 0x500000, CRC(d8eeb2bd) SHA1(24c8634f59a481118f8350125fa6e00d33e04c95) )
ROM_END
ROM_START( g_talmit )
	ROM_REGION( 0x400000, REGION_CPU1, 0 ) /* 68000 Code */
...
ROM_START( radicav1 )
	ROM_REGION( 0xc00000, REGION_CPU1, 0 ) /* 68000 Code */
...
ROM_START( ssf2ghw )
	ROM_REGION( 0x1400000, REGION_CPU1, 0 ) /* 68000 Code */
	/* Special Case, leave this area empty and let the INIT / banking take care of it */
	ROM_LOAD16_BYTE( "rom_a", 0x400000, 0x200000,  CRC(59726521) SHA1(3120bac17f56c01ffb9d3f9e31efa0263e3774af) )
	ROM_LOAD16_BYTE( "rom_b", 0x400001, 0x200000,  CRC(7dad5540) SHA1(9279068b2218d239fdd557dd959ac70e74853178) )
	ROM_LOAD16_BYTE( "rom_c", 0x800000, 0x080000,  CRC(deb48624) SHA1(39ffa7de7b808e0b95cb039bb381705d77420933) )
	ROM_LOAD16_BYTE( "rom_d", 0x800001, 0x080000,  CRC(b99f6a5b) SHA1(adbe28a7522024bc66328ac86fecf9ded3310e8e) )
ROM_END
...
void init_backupram(int backupram_base, int length)
{
	...
	//memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, backupram_base, backupram_base+megadriv_backupram_length, 0, 0, megadriv_backupram_r);
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, backupram_base, backupram_base+megadriv_backupram_length, 0, 0, megadriv_backupram_w);
}
...
void init_sks3_backupram(int backupram_base, int length)
{
	...
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0xA130f0, 0xa130f1, 0, 0, sks3_backupram_enable_w);
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, backupram_base, backupram_base+megadriv_backupram_length, 0, 0, sks3_backupram_w);
...
DRIVER_INIT( g_virrac )
{
	...
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x300000, 0x31ffff, 0, 0, virrac_unk_r );
	memory_install_write16_handler(0,ADDRESS_SPACE_PROGRAM, 0x300000, 0x31ffff, 0, 0, virrac_unk_w );
...
GAME( 1994, ssf2ghw,  g_ssf2,   megadriv,    megadri6,    g_ssf2j,  ROT0,   "Capcom", "Super Street Fighter II - The New Challengers (J) (Arcade bootleg)", GAME_NOT_WORKING ) // has protected? banking
...
// This has a special maths DSP in the cart.  The internal ROM of the DSP is not dumped, this does not work
GAME( 199?, g_virr,   0,        megadriv,   megadriv,     g_virrac, ROT0,   "Sega", "Virtua Racing (U) [!]", GAME_NOT_WORKING )
GAME( 199?, g_virraj, g_virr,   megadriv,   megadriv,     g_virrac, ROT0,   "Sega", "Virtua Racing (J) [!]", GAME_NOT_WORKING )
GAME( 199?, g_virrae, g_virr,   megadpal,   megadriv,     g_virrac, ROT0,   "Sega", "Virtua Racing (E) [!]", GAME_NOT_WORKING )
GAME( 199?, g_virrea, g_virr,   megadpal,   megadriv,     g_virrac, ROT0,   "Sega", "Virtua Racing (E) [a1]", GAME_NOT_WORKING )
