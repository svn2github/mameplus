...
static INPUT_PORTS_START( multi32_generic )
	...
	PORT_BIT( 0x0f, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SERVICE3 )	/* sometimes mirrors SERVICE1 */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )	/* tends to also work as a test switch */
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_SPECIAL )	/* EEPROM data */
	...
	PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_SERVICE4 ) PORT_TOGGLE PORT_NAME("Monitor Switch") PORT_CODE(KEYCODE_EQUALS) 
INPUT_PORTS_END
...
static MACHINE_DRIVER_START( multi32 )
	...
	{
		MDRV_VIDEO_ATTRIBUTES(VIDEO_TYPE_RASTER | VIDEO_NEEDS_6BITS_PER_GUN | VIDEO_RGB_DIRECT | VIDEO_DUAL_MONITOR)
