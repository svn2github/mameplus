...
GAME( 1988, pdrift,   0,       yboard, pdrift,   generic_yboard, ROT0, "Sega", "Power Drift (World Set 1)", GAME_SUPPORTS_SAVE | GAME_IMPERFECT_SOUND ) // bad sound rom
GAME( 1988, pdrifta,  pdrift,  yboard, pdrifta,   generic_yboard, ROT0, "Sega", "Power Drift (World Set 2)", GAME_SUPPORTS_SAVE | GAME_IMPERFECT_SOUND ) // bad sound rom
GAME( 1988, pdriftj,  pdrift,  yboard, pdriftj,   generic_yboard, ROT0, "Sega", "Power Drift (Japan)", GAME_SUPPORTS_SAVE | GAME_IMPERFECT_SOUND ) // bad sound rom
