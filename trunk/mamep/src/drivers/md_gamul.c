...
DRIVER_INIT( g_l3alt )
{
	...
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0x600000, 0x6fffff, 0, 0, g_l3alt_protw );
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0x700000, 0x7fffff, 0, 0, g_l3alt_bank_w );
...
DRIVER_INIT( g_topfig )
{
	...
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x6F5344, 0x6F5345, 0, 0, g_topfig_0x6F5344_r );
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x6BD294, 0x6BD295, 0, 0, g_topfig_0x6BD294_r );
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x645B44, 0x645B45, 0, 0, g_topfig_0x645B44_r );

	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0x689B80, 0x689B81, 0, 0, MWA16_NOP );
	memory_install_write16_handler(0, ADDRESS_SPACE_PROGRAM, 0x6D8B02, 0x6D8B03, 0, 0, MWA16_NOP );
...
ROM_END
ROM_START( g_3in1a )
	ROM_REGION( 0x400000, REGION_CPU1, 0 ) /* 68000 Code */ // no menu??
...
ROM_START( g_dte )
	ROM_REGION( 0x1400000, REGION_CPU1, ROMREGION_ERASE00 ) /* 68000 Code */
	/* Has custom banking */
