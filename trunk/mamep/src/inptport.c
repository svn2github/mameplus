...
#ifdef USE_JOY_MOUSE_MOVE
	INPUT_PORT_DIGITAL_DEF( 2, IPG_PLAYER2,	JOYSTICK_UP,		"P2 Up",				SEQ_DEF_5(KEYCODE_UP, CODE_OR, JOYCODE_2_UP, CODE_OR, MOUSECODE_2_UP) )
	INPUT_PORT_DIGITAL_DEF( 2, IPG_PLAYER2,	JOYSTICK_DOWN,      "P2 Down",				SEQ_DEF_5(KEYCODE_DOWN, CODE_OR, JOYCODE_2_DOWN, CODE_OR, MOUSECODE_2_DOWN) )
	INPUT_PORT_DIGITAL_DEF( 2, IPG_PLAYER2,	JOYSTICK_LEFT,      "P2 Left",    			SEQ_DEF_5(KEYCODE_LEFT, CODE_OR, JOYCODE_2_LEFT, CODE_OR, MOUSECODE_2_LEFT) )
	INPUT_PORT_DIGITAL_DEF( 2, IPG_PLAYER2,	JOYSTICK_RIGHT,     "P2 Right",   			SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_2_RIGHT, CODE_OR, MOUSECODE_2_RIGHT) )
#else /* USE_JOY_MOUSE_MOVE */
