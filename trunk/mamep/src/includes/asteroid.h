...
extern discrete_sound_block asteroid_discrete_interface[];
extern discrete_sound_block astdelux_discrete_interface[];
...
extern discrete_sound_block llander_discrete_interface[];
