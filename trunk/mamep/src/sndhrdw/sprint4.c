...
DISCRETE_SOUND_START(sprint4_discrete_interface)
	...
	DISCRETE_GAIN(NODE_142, NODE_141, 65534.0/(777.2+777.2+1000.0+298.9+298.9))
	...
	DISCRETE_GAIN(NODE_152, NODE_151, 65534.0/(777.2+777.2+1000.0+298.9+298.9))

	DISCRETE_OUTPUT(NODE_142, 100)
	DISCRETE_OUTPUT(NODE_152, 100)
DISCRETE_SOUND_END
