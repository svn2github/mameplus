...
{
	tmp_bitmap[0] = auto_bitmap_alloc(Machine->screen[0].width,Machine->screen[0].height);
	tmp_bitmap[1] = auto_bitmap_alloc(Machine->screen[0].width,Machine->screen[0].height);
	tmp_bitmap[2] = auto_bitmap_alloc(Machine->screen[0].width,Machine->screen[0].height);
	tmp_bitmap[3] = auto_bitmap_alloc(Machine->screen[0].width,Machine->screen[0].height);
