...
VIDEO_START( tank8 )
{
	...
	helper3 = auto_bitmap_alloc(Machine->drv->screen_width, Machine->drv->screen_height);
...
VIDEO_EOF( tank8 )
{
	...
	draw_sprites(helper2, &Machine->visible_area);
	draw_bullets(helper3, &Machine->visible_area);
