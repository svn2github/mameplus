...
#define HACK_B_2 0x00,0x0000, 0x40,0x42,0x44,0x46, 0x66,{0x68,0x6a,0x6c,0x6e},0x70, {0x3f,0x3f,0x3f,0x30,0x30}
#define HACK_B_3 0x00,0x0000, 0x00,0x00,0x00,0x00, 0x60,{0x68,0x6a,0x6c,0x6e},0x70, {0x02,0x04,0x08,0x00,0x00}
#define HACK_B_4 0x00,0x0000, 0x00,0x00,0x00,0x00, 0xc4,{0x52,0x50,0x4e,0x4c},0x4a, {0xff,0xff,0xff,0x00,0x00}
...
static struct CPS1config cps1_config_table[]=
{
	...
	{"sf2m2",   NOBATTRY, 2,2,2, 0x0000,0xffff,0x0000,0xffff, 10 },
	...
	{"wofha",   HACK_B_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 11 },
	{"wof3js",  CPS_B_01, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"wof3sj",  HACK_B_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 11 },
	{"wof3sja", HACK_B_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 11 },
	{"wofsj",   HACK_B_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 11 },
	{"wofsja",  HACK_B_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 11 },
...
void cps1_get_video_base(void )
{
	...
	else if (cps1_game_config->kludge == 11)
	{
		cps1_obj=cps1_base(CPS1_OBJ_BASE, cps1_obj_size);
		scroll1xoff = 0xffc0;
		scroll2xoff = 0xffc0;
