...
PALETTE_INIT( lvpoker ) //Ever so slightly different, but different enough.
{
	int i;
...
WRITE8_HANDLER( ponttehk_videoram_w )
{
...
WRITE8_HANDLER( ponttehk_colorram_w )
{
