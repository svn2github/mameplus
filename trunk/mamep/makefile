...
ifdef WINUI
$(MAMEUIEXE): $(OBJ)/osd/winui/mui_main.o $(VERSIONOBJ) $(DRVLIBS) $(LIBOSD) $(LIBEMU) $(LIBCPU) $(LIBDASM) $(LIBSOUND) $(LIBUTIL) $(EXPAT) $(SOFTFLOAT) $(ZLIB) $(RESFILE) $(LIBOCORE_NOMAIN) $(GUIRESFILE)
	@echo Linking $@...
