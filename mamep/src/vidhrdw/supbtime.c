...
UINT16 *supbtime_pf2_data,*supbtime_pf1_data,*supbtime_pf1_row;
static UINT16 supbtime_control_0[8];
...
{
	UINT16 oldword=supbtime_pf2_data[offset];
...
{
	UINT16 oldword=supbtime_pf1_data[offset];
