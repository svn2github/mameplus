...
static int win_d3d_test_hardware_caps(void)
{
	...
	switch (win_d3d_use_filter)
	{
		...
		case 2:
		{
			...
			{
				fprintf(stderr, _WINDOWS("Warning: flat bi-cubic filtering not supported, falling back to bi-linear\n"));
			}
			break;
		}
		...
		case 3:
		{
			...
			{
				fprintf(stderr, _WINDOWS("Warning: gaussian bi-cubic filtering not supported, falling back to bi-linear\n"));
			}
			break;
		}
		...
		case 4:
		{
			...
			{
				fprintf(stderr, _WINDOWS("Warning: anisotropic (mag) filtering not supported, falling back to bi-linear\n"));
			}
			...
			{
				fprintf(stderr, _WINDOWS("Warning: anisotropic (min) filtering not supported, falling back to bi-linear\n"));
			}
			break;
		}
	}
