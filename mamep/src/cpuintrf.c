...
void m68000c_get_info(UINT32 state, union cpuinfo *info);
void m68000drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68000asm_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68008c_get_info(UINT32 state, union cpuinfo *info);
void m68008drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68008asm_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68010c_get_info(UINT32 state, union cpuinfo *info);
void m68010drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68010asm_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68ec020c_get_info(UINT32 state, union cpuinfo *info);
void m68ec020drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68ec020asm_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68020c_get_info(UINT32 state, union cpuinfo *info);
void m68020drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68020asm_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
void m68040c_get_info(UINT32 state, union cpuinfo *info);
void m68040drc_get_info(UINT32 state, union cpuinfo *info);	//ks hcmame switch m68k core
