...
INPUT_PORTS_START( sfzch )
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME( DEF_STR( Pause ) ) PORT_CODE(KEYCODE_F1)
...
ROM_START( sf2m8 )
	...
	ROM_LOAD16_BYTE( "k4-196", 0x000001, 0x80000, CRC(95ea597e) )
	ROM_LOAD16_BYTE( "u221.epr", 0x100000, 0x20000, CRC(d8276822) )
	ROM_LOAD16_BYTE( "u195.epr", 0x100001, 0x20000, CRC(924c6ce2) )
...
ROM_START( sf2m13 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "222-040.13",   0x000000, 0x80000, CRC(ec6f5cb3) )
	ROM_LOAD16_BYTE( "196-040.13",   0x000001, 0x80000, CRC(0e9ac52b) )
	ROM_LOAD16_BYTE( "221-010.13",   0x100000, 0x20000, CRC(8226c11c) )
	ROM_LOAD16_BYTE( "195-010.13",   0x100001, 0x20000, CRC(924c6ce2) )
...
ROM_START( sf2ceh )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sf2ceh.23",    0x000000, 0x80000, CRC(25dc14c8) )
...
ROM_START( wofh )
	...
	ROM_REGION( 0x400000, REGION_GFX1, 0 )
	ROMX_LOAD( "sgyx-1.160",   0x000000, 0x80000, CRC(a60be9f6), ROM_GROUPWORD | ROM_SKIP(6) )
	ROM_CONTINUE(              0x000004, 0x80000 )
	ROM_CONTINUE(              0x200000, 0x80000 )
	ROM_CONTINUE(              0x200004, 0x80000 )
	ROMX_LOAD( "sgyx-2.160",   0x000002, 0x80000, CRC(6ad9d048), ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( wof3js )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "3js_23.rom",  0x000000, 0x80000, CRC(1ebb76da) )
	ROM_LOAD16_WORD_SWAP( "3js_22.rom",  0x080000, 0x80000, CRC(f41d6153) )
	ROM_LOAD16_BYTE( "3js_24.rom",       0x0c0000, 0x20000, CRC(06ead409) )
	ROM_LOAD16_BYTE( "3js_28.rom",       0x0c0001, 0x20000, CRC(8ba934e6) )
	...
	ROMX_LOAD( "tk2_gfx2.rom",   0x000004, 0x80000, CRC(c5ca2460) SHA1(cbe14867f7b94b638ca80db7c8e0c60881183469) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk2_gfx4.rom",   0x000006, 0x80000, CRC(e349551c) SHA1(1d977bdf256accf750ad9930ec4a0a19bbf86964) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "3js_gfx5.rom",   0x200000, 0x80000, CRC(94b58f82), ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "3js_gfx7.rom",   0x200002, 0x80000, CRC(df4fb386), ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "3js_gfx6.rom",   0x200004, 0x80000, CRC(c22c5bd8), ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "3js_gfx8.rom",   0x200006, 0x80000, CRC(f9cfd08b), ROM_GROUPWORD | ROM_SKIP(6) )

	ROM_REGION( 0x8000, REGION_GFX2, 0 )
	ROM_COPY( REGION_GFX1, 0x000000, 0x000000, 0x8000 )	/* stars */

	ROM_REGION( 2*0x28000, REGION_CPU2, 0 ) /* QSound Z80 code + space for decrypted opcodes */
	ROM_LOAD( "3js_09.rom",     0x00000, 0x08000, CRC(21ce044c) )
	ROM_CONTINUE(               0x10000, 0x08000 )
	ROM_LOAD( "tk2_qa.rom",     0x00000, 0x08000, CRC(c9183a0d) SHA1(d8b1d41c572f08581f8ab9eb878de77d6ea8615d) )
	ROM_CONTINUE(               0x10000, 0x18000 )

	ROM_REGION( 0x200000, REGION_SOUND1, 0 ) /* QSound samples */
	ROM_LOAD( "3js_18.rom",     0x000000, 0x20000, CRC(ac6e307d) )
	ROM_LOAD( "3js_19.rom",     0x020000, 0x20000, CRC(068741db) )
	ROM_LOAD( "tk2_q1.rom",     0x000000, 0x80000, CRC(611268cf) SHA1(83ab059f2110fb25fdcff928d56b790fc1f5c975) )
	ROM_LOAD( "tk2_q2.rom",     0x080000, 0x80000, CRC(20f55ca9) SHA1(90134e9a9c4749bb65c728b66ea4dac1fd4d88a4) )
	ROM_LOAD( "tk2_q3.rom",     0x100000, 0x80000, CRC(bfcf6f52) SHA1(2a85ff3fc89b4cbabd20779ec12da2e116333c7c) )
	ROM_LOAD( "tk2_q4.rom",     0x180000, 0x80000, CRC(36642e88) SHA1(8ab25b19e2b67215a5cb1f3aa81b9d26009cfeb8) )
...
ROM_START( wof3sj )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "k6b.040",  0x000000, 0x80000, CRC(7b365108) )
	ROM_LOAD16_BYTE( "k6a.040",  0x000001, 0x80000, CRC(10488a51) )

	ROM_REGION( 0x400000, REGION_GFX1, 0 )
	ROMX_LOAD( "k6a.160",   0x000000, 0x80000, CRC(a121180d), ROM_GROUPWORD | ROM_SKIP(6) )
	ROM_CONTINUE(              0x000004, 0x80000 )
	ROM_CONTINUE(              0x200000, 0x80000 )
	ROM_CONTINUE(              0x200004, 0x80000 )
	ROMX_LOAD( "k6b.160",   0x000002, 0x80000, CRC(a4db96c4), ROM_GROUPWORD | ROM_SKIP(6) )
	ROM_CONTINUE(              0x000006, 0x80000 )
	ROM_CONTINUE(              0x200002, 0x80000 )
	ROM_CONTINUE(              0x200006, 0x80000 )
...
static DRIVER_INIT( wofh )
{
	...
	mem8[0x5E82B] = 0x5A;
	wof_decode();
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880000, 0x880001, 0, 0, input_port_4_word_r); /* Player input ports */
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880006, 0x880007, 0, 0, cps1_input2_r); /* Input ports */
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880006, 0x88000f, 0, 0, cps1_input_r); /* Input ports */
...
static DRIVER_INIT( wof3sj )
{
	...
	wof_decode();
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880000, 0x880001, 0, 0, input_port_4_word_r); /* Player input ports */
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880008, 0x880009, 0, 0, cps1_input2_r); /* Input ports */
	memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, 0x880008, 0x88000f, 0, 0, cps1_input_r); /* Input ports */
...
{
	UINT8 *mem8 = memory_region(REGION_CPU1);
	UINT8 *z80mem8 = memory_region(REGION_CPU2);
	// Patch protection? check
	mem8[0x412] = 0x6;
	mem8[0x414] = 0x64;
	mem8[0x415] = 0x71;
...
GAME( 1991, kodb,     kod,      cps1,     kod,      kodb,     ROT0,   "bootleg", "The King of Dragons (bootleg)" )		// 910731  "ETC"
...
#ifdef EXTRA_GAMES
GAME( 1991, knightsh, knights,  cps1,     knightsh, cps1,     ROT0,   "hack",   "Knights of the Round (hack)" )
#endif /* EXTRA_GAMES */
...
GAME( 1992, sf2m2,    sf2ce,    sf2,      sf2,      sf2m2,    ROT0,   "hack","Street Fighter II' - Champion Edition (M2)" )
GAMEX(1992, sf2m3,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (M3)", GAME_NOT_WORKING )
GAME (1992, sf2m4,    sf2ce,    sf2,      sf2j,     cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (M4)" )
GAME (1992, sf2m5,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (M5)" )
GAME (1992, sf2m6,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (Xiang Long set 2)" )
GAME (1992, sf2m7,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (M7)" )
#ifdef EXTRA_GAMES
GAMEX(1992, sf2m8,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (M8)", GAME_NOT_WORKING )
GAMEX(1992, sf2m13,   sf2ce,    sf2,      sf2j,     cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (M13)", GAME_NOT_WORKING )
GAME( 1999, sf2ceh,   sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Hispanic 990804)" )
GAME( 1992, sf2tlona, sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",	"Street Fighter II' - Champion Edition (Tu Long set 1)" )
GAME( 1992, sf2tlonb, sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",	"Street Fighter II' - Champion Edition (Tu Long set 2)" )
#endif /* EXTRA_GAMES */
GAME (1992, sf2yyc,   sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (YYC)" )
GAME (1992, sf2koryu, sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack","Street Fighter II' - Champion Edition (Xiang Long set 1)" )	// title should use Chinese Reading instead of Japanese
...
#ifdef EXTRA_GAMES
GAMEX(1999, wofh,     wof,      qsound,   wofh,     wofh,     ROT0,   "hack",  "Sanguo Yingxiong Zhuan", GAME_IMPERFECT_SOUND )
GAME( 1997, wof3js,   wof,      qsound,   wofh,     wof3js,   ROT0,   "hack",  "San Jian Sheng" )
GAMEX(1997, wof3sj,   wof,      qsound,   wofh,     wof3sj,   ROT0,   "hack",  "San Sheng Jian", GAME_IMPERFECT_SOUND )
#endif /* EXTRA_GAMES */
...
#ifdef EXTRA_GAMES
GAME( 1993, dinoh,    dino,     qsound,   dinoh,    dinoh,    ROT0,   "hack",   "Cadillacs and Dinosaurs (hack)" )
#endif /* EXTRA_GAMES */
...
#ifdef EXTRA_GAMES
GAME( 1994, pnicku,   pnickj,   cps1,     pnickj,   cps1,     ROT0,   "Compile (Capcom license)", "Pnickies (US 940608)" )
#endif /* EXTRA_GAMES */
...
GAME( 1995, sfach,    sfzch,    cps1,     sfzch,    cps1,     0,      "Capcom", "Street Fighter Alpha (Publicity US 950727)" )
#endif /* EXTRA_GAMES */
