...
static MACHINE_DRIVER_START( system_A )
	...
	MDRV_SOUND_ADD_TAG("OKIM6295.1", OKIM6295, 4000000/132)
	MDRV_SOUND_CONFIG(okim6295_interface_region_1)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.30)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "right", 0.30)

	MDRV_SOUND_ADD_TAG("OKIM6295.2", OKIM6295, 4000000/132)
	MDRV_SOUND_CONFIG(okim6295_interface_region_2)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.30)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "right", 0.30)
MACHINE_DRIVER_END

static MACHINE_DRIVER_START( system_A2 )

	/* basic machine hardware */
	MDRV_IMPORT_FROM(system_A)

	/* sound hardware */
	MDRV_SOUND_REPLACE("OKIM6295.1", OKIM6295, 4000000/132)
  	MDRV_SOUND_CONFIG(okim6295_interface_region_1)
 	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.40)
 
	MDRV_SOUND_REPLACE("OKIM6295.2", OKIM6295, 4000000/132)
 	MDRV_SOUND_CONFIG(okim6295_interface_region_2)
...
GAME( 1989, plusalph, 0,        system_A2,         plusalph, plusalph, ROT270, "Jaleco", "Plus Alpha", 0 )
GAME( 1989, stdragon, 0,        system_A,          stdragon, stdragon, ROT0,   "Jaleco", "Saint Dragon", 0 )
GAME( 1990, rodland,  0,        system_A2,         rodland,  rodland,  ROT0,   "Jaleco", "Rod-Land (World)", 0 )
GAME( 1990, rodlandj, rodland,  system_A2,         rodland,  rodlandj, ROT0,   "Jaleco", "Rod-Land (Japan)", 0 )
GAME( 1990, rodlndjb, rodland,  system_A2,         rodland,  0,        ROT0,   "Jaleco", "Rod-Land (Japan bootleg)", 0 )
